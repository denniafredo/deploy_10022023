...
<html><title>SPAJ List</title>
	...
	<body>
		...
		// Tambahan untuk penagih
		$sqli = "select nopenagih from $DBUser.tabel_500_penagih ".
			 	 "where kdrayonpenagih='$kdkantor' --and penagihautodebet='1'";
		...
		while($arr=$DB->nextrow()) {
			...
			if ($arr['DOKUMENLENGKAP'] == '0') { // Jika dokumen lengkap
				...
				$a = "<td align=center>
					<a href=\"#\" onclick=\"javascript:window.opener.document.".$formname.".nosp.value='".$arr["NOSP"]."';javascript:window.opener.document.".$formname.".nospx.value='".$arr["NOSP"]."';javascript:window.opener.document.".$formname.".noagen.value='".$arr["NOAGEN"]."';javascript:window.opener.document.".$formname.".taltup.value='".$arr["TALTUP"]."';".$taltupc.";window.close();\" >".$arr["NOSP"]."</a>
					</td>";
			} else if ($arr['SPAJOL']) { // Jika sumber dari SPAJOL
				
				$a = "<td align='center'>
					<a href='javascript:void(0);' onclick=\"javascript:window.opener.document.".$formname.".nosp.value='".$arr["NOSP"]."';javascript:window.opener.document.ntryprop.nopenagih.value='".$arp["NOPENAGIH"]."';javascript:window.opener.document.".$formname.".nospx.value='".$arr["NOSP"]."';javascript:window.opener.document.".$formname.".noagen.value='".$arr["NOAGEN"]."';javascript:window.opener.getdataespaj('$arr[NOSP]');window.close();\">$arr[NOSP]</a>
					</td>";
				/*
				$a = "<td align='center'>
					<a href='javascript:void(0);' onclick=\"javascript:window.opener.document.".$formname.".nosp.value='".$arr["NOSP"]."';javascript:window.opener.document.".$formname.".nospx.value='".$arr["NOSP"]."';javascript:window.opener.document.".$formname.".noagen.value='".$arr["NOAGEN"]."';javascript:window.opener.getdataespaj('$arr[NOSP]');window.close();\">$arr[NOSP]</a>
					</td>";
				*/
			}
