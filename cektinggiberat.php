...
<!--- Edit dari rizal, karena di chrome gak bisa --->
<?php  if($stsmd == "M") {?>
	<body onload="notOK()">
<?php }else{?>
	<?php if($rokok>=8) {?>
		<body onload="notOKRokok();">
	<?php } else {?>
		<body onload="OK();">
<?php } }?>
<!-- <?
...
<script type="text/javascript">
	...
	function notOK()
	{
		// confirm("Untuk Non-Medical, tinggi/berat tertanggung tidak sesuai kriteria.\n Setuju untuk masuk Medical ?")
	 //  //let  tb = confirm("Untuk Non-Medical, tinggi/berat tertanggung tidak sesuai kriteria.\n Setuju untuk masuk Medical ?");
	 //  // if (tb==true){
	 //  //   window.opener.document.ntryprop.kdstatusmedical[0].checked=true;
	 //  // } else {
