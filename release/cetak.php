...
class SPAJPDF extends FPDF {
	...
	public function body() {
		...
		**/
		...
		$this->Cell(50, $this->height, 'No Agen Penutup', $this->border, 0, 'L');
		$this->Cell(2, $this->height, ':', $this->border, 0, 'C');
		$this->Cell($this->PG_W-52, $this->height, @$r['id_agen'], $this->border, 1, 'L');
		$this->Cell(50, $this->height, 'Nama Agen Penutup', $this->border, 0, 'L');
		$this->Cell(2, $this->height, ':', $this->border, 0, 'C');
		...
		$this->Cell($this->PG_W, $this->height+2, 'Identitas Calon Tertanggung Utama', $this->border, 1, 'L', true);
		$this->SetFont('Monserrat', '', 7);
		...
		$this->ln(2);
		$this->SetFont('Monserrat', '', 8);
		$this->Cell($this->PG_W, $this->height+2, 'Alamat KTP Calon Tertanggung Utama', $this->border, 1, 'L', true);
		...
		$this->ln(2);
		$this->Cell($this->PG_W, $this->height+2, 'Alamat Surat Menyurat Calon Tertanggung Utama', $this->border, 1, 'L', true);
		$this->Cell(50, $this->height, 'Status', $this->border, 0, 'L');
		$this->Cell(2, $this->height, ':', $this->border, 0, 'C');
		...
		$this->ln(2);
		$this->Cell($this->PG_W, $this->height+2, 'Data Pendukung Calon Tertanggung', $this->border, 1, 'L', true);
		$this->MultiCell($this->PG_W, $this->height, 'Hubungan Dengan Calon Pemegang Polis : '.@$hubunganttg[@$r['data_diri_tertanggung']['hubdgnPempol']], $this->border, 'J');
		...
		**/
		if(!in_array(@$r['data_produk']['jenisAsuransi'], $premierAnnuity)) {
			...
			$this->ln(2);
			$this->Cell($this->PG_W, $this->height+2, 'Calon Tertanggung Tambahan', $this->border, 1, 'L', true);
			$this->Cell(60, $this->height, 'Jumlah Calon Tertanggung Tambahan', $this->border, 0, 'L');
			...
			if (@$r['data_diri_tertanggung']['jmlTertanggungTambahan'] > 0) {
				for ($i = 1; $i <= @$r['data_diri_tertanggung']['jmlTertanggungTambahan']; $i++) {
					$this->ln(2);
					$this->Cell($this->PG_W, $this->height+2, "Calon Tertanggung Tambahan $i", $this->border, 1, 'L', true);
		...
		**/
		...
		$this->ln(2);
		$this->Cell($this->PG_W, $this->height+2, 'Pekerjaan Calon Tertanggung', $this->border, 1, 'L', true);
		...
		$this->ln(2);
		$this->Cell($this->PG_W, $this->height+2, 'Hobi Calon Tertanggung', $this->border, 1, 'L', true);
		...
		**/
		...
		// Pembayar Premi
		$this->ln(2);
		$this->Cell($this->PG_W, $this->height+2, 'Calon Pembayar Premi', $this->border, 1, 'L', true);
		$this->MultiCell($this->PG_W, $this->height, 'Hubungan Dengan Calon Tertanggung Utama : '.(@$r['data_produk']['pempolIsPembayarPremi'] ? @$hubunganttg[@$r['data_diri_pemegang_polis']['hubdgnTertanggung']] : @$hubunganttg[@$r['data_produk']['hubunganPembayarPremiDenganTTU']]), $this->border, 'J');
		$this->Cell(50, $this->height, 'Jenis Kelamin', $this->border, 0, 'L');
		$this->Cell(2, $this->height, ':', $this->border, 0, 'C');
		...
		$this->ln(2);
		$this->Cell($this->PG_W, $this->height+2, 'Pekerjaan Calon Pembayar Premi', $this->border, 1, 'L', true);
		$this->Cell(50, $this->height, 'Nama Perusahaan', $this->border, 0, 'L');
		$this->Cell(2, $this->height, ':', $this->border, 0, 'C');
		...
		/** Di hide karena di entry spaj tidak ada untuk LPP **/
		if(@$r['data_produk']['jenisAsuransi'] != 'JL4BPRO'){
			$this->ln(2);
			$this->Cell($this->PG_W, $this->height+2, 'Rekening Calon Pembayar Premi', $this->border, 1, 'L', true);
		...
		if (!in_array(@$r['data_produk']['jenisAsuransi'], array('PAA', 'PAB')) && (!in_array(@$r['data_produk']['jenisAsuransi'], $premierAnnuity))) {
			$this->ln(2);
			$this->Cell($this->PG_W, $this->height+2, 'SKK Calon Tertanggung Utama', $this->border, 1, 'L', true);
			...
			if(@$r['data_produk']['jenisAsuransi'] == 'JL4BPRO'){
					$this->Cell(5, $this->height, '-', $this->border, 0, 'L');
					$this->MultiCell($this->PG_W-5, $this->height, 'Apakah Anda tidak menginginkan pemberlakuan masa tunggu (waiting period) sesuai ketentuan polis dan bersedia melakukan pemeriksaan kesehatan sesuai ketentuan dengan biaya ditanggung oleh Calon Pemegang Polis ? '.(@$r['data_skk']['isWaitingPeriode'] ? "\nYa," : 'Tidak'), $this->border, 'J');
			}
			...
			if (@$r['data_diri_tertanggung']['jmlTertanggungTambahan'] > 0) {
				for ($i = 1; $i <= @$r['data_diri_tertanggung']['jmlTertanggungTambahan']; $i++) {
					$this->ln(2);
					$this->Cell($this->PG_W, $this->height+2, "SKK Calon Tertanggung Tambahan $i", $this->border, 1, 'L', true);
		...
		$this->ln(2);
		$this->Cell($this->PG_W, $this->height+2, 'Identitas Calon Pemegang Polis', $this->border, 1, 'L', true);
		$this->Cell(50, $this->height, 'Nama Lengkap', $this->border, 0, 'L');
		$this->Cell(2, $this->height, ':', $this->border, 0, 'C');
		...
		$this->ln(2);
		$this->SetFont('Monserrat', '', 8);
		$this->Cell($this->PG_W, $this->height+2, 'Alamat KTP Calon Pemegang Polis', $this->border, 1, 'L', true);
		$this->Cell(50, $this->height, 'Status', $this->border, 0, 'L');
		$this->Cell(2, $this->height, ':', $this->border, 0, 'C');
		...
		$this->ln(2);
		$this->Cell($this->PG_W, $this->height+2, 'Alamat Surat Menyurat Calon Pemegang Polis', $this->border, 1, 'L', true);
		$this->Cell(50, $this->height, 'Status', $this->border, 0, 'L');
		$this->Cell(2, $this->height, ':', $this->border, 0, 'C');
		...
		$this->ln(2);
		$this->Cell($this->PG_W, $this->height+2, 'Data Pendukung Calon Pemegang Polis', $this->border, 1, 'L', true);
		$this->MultiCell($this->PG_W, $this->height, 'Hubungan Dengan Calon Tertanggung Utama : '.@$hubunganttg[@$r['data_diri_pemegang_polis']['hubdgnTertanggung']], $this->border, 'L');
		$this->Cell(50, $this->height, 'Tinggi Badan', $this->border, 0, 'L');
		$this->Cell(2, $this->height, ':', $this->border, 0, 'C');
		...
		$this->ln(2);
		$this->Cell($this->PG_W, $this->height+2, 'Pekerjaan Calon Pemegang Polis', $this->border, 1, 'L', true);
		$this->Cell(50, $this->height, 'Pekerjaan', $this->border, 0, 'L');
		$this->Cell(2, $this->height, ':', $this->border, 0, 'C');
		...
		/** Range Pendapatan **/
		if(@$r['data_pekerjaan_pempol']['rangePendapatanPasanganPempolLainnya'] == '' || @$r['data_pekerjaan_pempol']['rangePendapatanPasanganPempolLainnya'] == null){
			@$r['data_pekerjaan_pempol']['rangePendapatanPasanganPempolLainnya'] = 0;
		}

		$this->Cell(70, $this->height, number_format(@$r['data_pekerjaan_pempol']['rangePendapatanPasanganPempolLainnya']*1, 0, ',', '.'), $this->border, 0, 'L');
		$this->Cell(50, $this->height, 'Usia Produktif Suami/Istri', $this->border, 0, 'L');
		$this->Cell(2, $this->height, ':', $this->border, 0, 'C');

		/** Usia  **/
		if(@$r['data_pekerjaan_pempol']['usiaProduktifPasanganPempol'] == '' || @$r['data_pekerjaan_pempol']['usiaProduktifPasanganPempol'] == null){
			@$r['data_pekerjaan_pempol']['usiaProduktifPasanganPempol'] = '-';
		}

		$this->Cell(30, $this->height, @$r['data_pekerjaan_pempol']['usiaProduktifPasanganPempol'].' Tahun', $this->border, 1, 'L');
		$this->Cell(50, $this->height, 'Pendapatan Hasil Investasi', $this->border, 0, 'L');
		$this->Cell(2, $this->height, ':', $this->border, 0, 'C');

		if(@$r['data_pekerjaan_pempol']['rangeHasilInvestasiPempolLainnya'] == '' || @$r['data_pekerjaan_pempol']['rangeHasilInvestasiPempolLainnya'] == null){
			@$r['data_pekerjaan_pempol']['rangeHasilInvestasiPempolLainnya'] = 0;
		}

		$this->Cell($this->PG_W-52, $this->height, number_format(@$r['data_pekerjaan_pempol']['rangeHasilInvestasiPempolLainnya']*1, 0, ',', '.'), $this->border, 1, 'L');
		$this->Cell(50, $this->height, 'Pendapatan Hasil Bisnis', $this->border, 0, 'L');
		$this->Cell(2, $this->height, ':', $this->border, 0, 'C');

		if(@$r['data_pekerjaan_pempol']['rangeBisnisPempolLainnya'] == '' || @$r['data_pekerjaan_pempol']['rangeBisnisPempolLainnya'] == null){
			@$r['data_pekerjaan_pempol']['rangeBisnisPempolLainnya'] = 0;
		}

		$this->Cell($this->PG_W-52, $this->height, number_format(@$r['data_pekerjaan_pempol']['rangeBisnisPempolLainnya']*1, 0, ',', '.'), $this->border, 1, 'L');
		$this->Cell(50, $this->height, 'Bonus/Investasi/Komisi', $this->border, 0, 'L');
		$this->Cell(2, $this->height, ':', $this->border, 0, 'C');

		if(@$r['data_pekerjaan_pempol']['rangeBonusPempolLainnya'] == '' || @$r['data_pekerjaan_pempol']['rangeBonusPempolLainnya'] == null){
			@$r['data_pekerjaan_pempol']['rangeBonusPempolLainnya'] = 0;
		}

		$this->Cell($this->PG_W-52, $this->height, number_format(@$r['data_pekerjaan_pempol']['rangeBonusPempolLainnya']*1, 0, ',', '.'), $this->border, 1, 'L');
		$this->Cell(50, $this->height, 'Pendapatan Orang Tua', $this->border, 0, 'L');
		$this->Cell(2, $this->height, ':', $this->border, 0, 'C');
		...
		/** Test **/
		if(@$r['data_pekerjaan_pempol']['sumberPendapatanPempolLainnya'] == null || @$r['data_pekerjaan_pempol']['sumberPendapatanPempolLainnya'] == ''){
			@$r['data_pekerjaan_pempol']['sumberPendapatanPempolLainnya'] = '-';
		}

		$this->Cell($this->PG_W-52, $this->height, @$r['data_pekerjaan_pempol']['sumberPendapatanPempolLainnya'], $this->border, 1, 'L');
		...
		$this->Cell(85, $this->height, 'Negara', $this->border, 0, 'L');
		$this->Cell(2, $this->height, ':', $this->border, 0, 'C');
		...
		$this->Cell(30, $this->height, 'Nomor Wajib Pajak / ', $this->border, 0, 'L');
		$this->SetFont('Monserrat', 'I', 8);
		$this->Cell(49, $this->height, 'Taxpayer Identification Number ', $this->border, 0, 'L');
		$this->SetFont('Monserrat', '', 8);
		$this->Cell(7, $this->height, '(TIN) :', $this->border, 0, 'C');
		...
		$this->Cell(85, $this->height, 'Alasan Jika Tidak Ada TIN, Jelaskan', $this->border, 0, 'L');
		$this->Cell(2, $this->height, ':', $this->border, 0, 'C');
		$this->Cell($this->PG_W-52, $this->height, $jelaskanWajibPajakLuarNegeri, $this->border, 1, 'L');

		// Rekening Pemegang Polis
		$this->ln(2);
		$this->Cell($this->PG_W, $this->height+2, 'Rekening Calon Pemegang polis', $this->border, 1, 'L', true);
		$this->Cell(50, $this->height, 'Nama Bank', $this->border, 0, 'L');
		$this->Cell(2, $this->height, ':', $this->border, 0, 'C');
		...
		$this->ln(2);
		$this->Cell($this->PG_W, $this->height+2, 'Pernyataan Calon Pemegang Polis', $this->border, 1, 'L', true);
		if (substr(@$r['data_produk']['jenisAsuransi'], 0, 2) == 'PA') {
			...
			if(@$r['data_produk']['jenisAsuransi'] == 'JL4BPRO'){
			$this->Cell(5, $this->height, '-', $this->border, 0, 'L');
			$this->MultiCell($this->PG_W-5, $this->height, 'Saya memahami bahwa jika saya memilih untuk tidak melakukan pemeriksaan kesehatan terlebih dahulu maka apabila terjadi risiko yang dipertanggungkan sebagaimana dinyatakan dalam ketentuan Polis pada masa tunggu (waiting period), saya tidak berhak menerima manfaat perlindungan risiko berdasarkan Ketentuan Polis. Risiko yang tidak dijamin dalam masa tunggu (waiting period) tersebut sebagaimana dinyatakan dalam Polis Asuransi.', $this->border, 'J');
			}
		}		
		$this->Cell(5, $this->height, '-', $this->border, 0, 'L');
		...
		if (substr(@$r['data_produk']['jenisAsuransi'], 0, 2) == 'JL') {
			...
			$khusus = '';
			if(@$r['data_produk']['jenisAsuransi'] == 'JL4BPRO'){
				$khusus = 'IFG Life Protection Platinum';
			}else{
				$khusus = 'IFG Life Prime Protection & IFG Life Ultimate Protection';
			}

			$this->MultiCell($this->PG_W-5, $this->height, 'Bahwa Saya/Kami yang memberikan tanda tangan di bawah ini telah mendapatkan penjelasan secara menyeluruh dari Agen Penutup dan selanjutnya mengerti dan menerima (khusus produk '.$khusus.') mengenai :', $this->border, 'J');
			$this->Cell(5, $this->height, '', $this->border, 0, 'L');
			$this->Cell(5, $this->height, '-', $this->border, 0, 'L');
			...
			$this->Cell(5, $this->height, '', $this->border, 0, 'L');
			$this->Cell(5, $this->height, '-', $this->border, 0, 'L');
			$this->MultiCell($this->PG_W-10, $this->height, 'Seluruh Manfaat Asuransi hanya dapat diberikan oleh PT Asuransi Jiwa IFG ("IFG Life") jika seluruh Biaya Asuransi dipenuhi.', $this->border, 'J');
			$this->Cell(5, $this->height, '', $this->border, 0, 'L');
			$this->Cell(5, $this->height, '-', $this->border, 0, 'L');
		...
		$this->Cell(5, $this->height, '-', $this->border, 0, 'L');
		$this->MultiCell($this->PG_W-5, $this->height, 'Calon Tertanggung dalam keadaan '.(@$r['data_persetujuan']['nyatakanTertanggungUtamaSehat'] == 'TTU_SEHAT' ? 'sehat' : 'tidak sehat').' sewaktu mengisi SPAJ ini', $this->border, 'J');
		$this->Cell(5, $this->height, '-', $this->border, 0, 'L');
		...
		// $this->Cell($this->PG_W, $this->height, 'Dengan ini Pemegang Polis telah mengerti dan menyetujui hal-hal sebagai berikut:', $this->border, 1, 'L');
				// Setuju 
		$this->ln(2);
		$this->Cell($this->PG_W, $this->height+2, 'Dengan ini Calon Pemegang Polis telah mengerti dan menyetujui hal-hal sebagai berikut:', $this->border, 1, 'L', true);
		$this->MultiCell($this->PG_W, $this->height,'Calon Pemegang Polis wajib melakukan pembayaran premi asuransi melalui kanal/channel pembayaran resmi yang telah disediakan oleh Perusahaan.', 0, 'J');
		$this->MultiCell($this->PG_W, $this->height, 'Perusahaan hanya mengakui pembayaran premi asuransi yang dilakukan Calon Pemegang Polis melalui kanal/channel pembayaran resmi yang disediakan Perusahaan.', 0, 'J');
		...
		$this->Cell(50, $this->height, 'Calon Tertanggung Utama', $this->border, 0, 'L');
		$this->Cell(2, $this->height, ':', $this->border, 0, 'C');
		...
		$this->Cell(50, $this->height, 'Calon Pemegang Polis', $this->border, 0, 'L');
		$this->Cell(2, $this->height, ':', $this->border, 0, 'C');
		...
		$this->Cell(50, $this->height, 'Agen Penutup', $this->border, 0, 'L');
		$this->Cell(2, $this->height, ':', $this->border, 0, 'C');
