...
<!--[if !IE]>
    <script src="./includes/entryprop_fix_chrome.js" type="text/javascript"></script>
...
<script language="JavaScript" type="text/javascript">
	function getdataespaj(nospajol) {
		...
		$.ajax({
			...
			success : function (data) {
				...
				updatekdcarabayar(r.jenisasuransi);
				$("select[name='kdcarabayar']").val(r.carabayar);
				$("input[name='mulas']").val(r.mulas);
				$("input[name='nilai']").val(r.premi);
				$("input[name='juamainproduk']").val(r.uangasuransi);
				$("#juax").val(r.uangasuransi);
				$("#kdproduk").val(r.jenisasuransi);
	...
	function updatekdcarabayar(val)
	{	
		for(index=0; index < 4; index++)
		{
			document.ntryprop.kdcarabayar.options[index].text = '';
			document.ntryprop.kdcarabayar.options[index].value = '';
		}

		whichSelected = document.ntryprop.kdproduk.selectedIndex;
		if($("select[name='kdproduk']").val() == 'JL4BLN')
		{
			document.ntryprop.pariabel.value = '99';
			document.ntryprop.usia_lpp.value = 'U';
			document.ntryprop.lama_min.value = '5';
			document.ntryprop.lama_max.value = '20';
			document.ntryprop.kdcarabayar.options[0].value = 'M';
			document.ntryprop.kdcarabayar.options[0].text = 'BULANAN';

			document.ntryprop.kdcarabayar.options[1].value = 'Q';
			document.ntryprop.kdcarabayar.options[1].text = 'KUARTALAN';

			document.ntryprop.kdcarabayar.options[2].value = 'H';
			document.ntryprop.kdcarabayar.options[2].text = 'SEMESTERAN';

			document.ntryprop.kdcarabayar.options[3].value = 'A';
			document.ntryprop.kdcarabayar.options[3].text = 'TAHUNAN';

		}

		if($("select[name='kdproduk']").val() == 'JL4BPRO')
		{
			document.ntryprop.pariabel.value = '99';
			document.ntryprop.usia_lpp.value = 'U';
			document.ntryprop.lama_min.value = '5';
		...
		if($("select[name='kdproduk']").val() == 'JL4XN')
		{
			document.ntryprop.pariabel.value = '99';
			document.ntryprop.usia_lpp.value = 'U';
			document.ntryprop.lama_min.value = '1';
			document.ntryprop.lama_max.value = '1';
			document.ntryprop.kdcarabayar.options[0].value = 'X';
			document.ntryprop.kdcarabayar.options[0].text = 'Sekaligus';
...
<div align="center">
<br>
<table border="0" cellpadding="1" cellspacing="1" width="900" class="tblborder">
	<tr>
  ...
  <tr>
		...
		<input type="button" value="Cari SPAJ"  onclick="Klear(document.ntryprop);NewWindow('spajlist.php','popuppage',800,600,1);" class="buton">
  ...
  <tr>
     ...
     $disabled="disabled";
		 ...
		 <input type="button" value="Cari Klien" name="cari" class="buton" <?php echo $disabled; ?> onClick="Cari(this.form);" onBlur="javascript:TanggalMulas()" ></td>
  ...
  <tr>
   	 ...
   	 <td width="2%" class="arial10">:</td>
   	 <td width="25%" class="ver8ungu"><input type="text" name="lamapembpremi_th" id="lamapembpremi_th" size="2" maxlength="2"  onfocus="highlight(event)" class="c" onBlur="return cek_masapremi()"  value="<? echo $lprth; ?>" readonly>tahun
  ...
  <tr>
   	 ...
   	 <td width="2%" class="arial10">:</td>
   	 <td width="45%" colspan="2" class="arial10"><select size="1" name="kdvaluta" id="kdvaluta" onChange="return IndexAwal(document.ntryprop);" onBlur="return IndexAwal(document.ntryprop);" onFocus="highlight(event)" class="c">
      <?
...
-->
  ...
  <tr class="tblisi">
             ...
             <tr>
    					 <td width="100%" colspan="5" align="center" class="arial10">
	   					 <input type="button" class="buton" name="kurang" value="Kurangi Data Beneficiary" onClick="javascript:BeneficiariDel();">
	 	 					 <input type="button" class="buton" name="tambah" value="Tambah Data Beneficiary" onClick="addBeneficiari()"></td>
							</tr>	
	...
	<td>
	 ...
	 <tr>
   	 ...
   	 <td width="2%" class="arial10">:</td>
   	 <td width="25%" class="arial10"><input type="text" name="nilai" size="15" maxlength="15" onBlur="javascript:JuaPremi();MaxJuaPremi();"  class="c" placeholder='a'></td>
	...
	<tr class="tblisi">
	 ...
	 No. Rekening 
      ...
      ?>
		 ...
		 Tgl. Transfer <input type="text" name="tgltransfer" id="tgltransfer" size="10" maxlength="10" class="c" onBlur="convert_date(tgltransfer);cektransfer();return cek_masapremi();"> 
		 Jumlah Transfer <input type="text" name="jmltransfer" id="jmltransfer" size="15" maxlength="15" class="c" onBlur="cektransfer();javascript:convert_date(document.ntryprop.akhirpremi);javascript:convert_date(document.ntryprop.expirasi);"> 
		 </font>
		 </td>
	</td>
  ...
  <tr>
   	 <td width="100%" class="tblhead" align="center">
		  <input  type="button" value="Polis Lain Yg Dimiliki" name="cekpolis" id="cekpolis" onClick="return CekPolis()" class="buton">
...
<script type="text/javascript">
	...
	function addBeneficiari()
	{
		...
		isi = `<tr>
					<td width="3%">
						<input class="buton" type="button" value="${i}" onclick=NewWindow('./insurable.php?n=${i}&c=${a}','popuppage',600,400,1)>
					</td>
					<td>
						<input type="text" id="no${i}" name="no${i}" maxlength="1" size="1" readonly class="a">
					</td>
					<td>
						<input type="text" id="nama${i}"  name="nama${i}" size="40" readonly class="a">
					</td>
					<td>
						<input type="text" id="klienno${i}"  name="klienno${i}" maxlength="10" size="10" readonly class="a">
					</td>
					<td>
						<input type="text" id="hubungan${i}" name="hubungan${i}" size="30" readonly class="a">
					</td>
				</tr>`;
		 	if (document.layers) {
