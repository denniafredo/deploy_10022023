...
var tglmulas = theForm.mulas.value;
 if ((ttgg=='')||(ttgg=='0000000000')){
  ...
  return false;
			   ...
			   NewWindow('./hitungusia1-lpp.php?prd='+prd+'&a='+tglmulas+'&c='+ttgg+'','popupusia',350,200,1)
  return true
 }
}
...
function HitungUsia(theForm){
 ...
 if ((ttgg=='')||(ttgg=='0000000000')||(tglmulas=='')){
   return false
	 ...
	 NewWindow('./hitungusia1-lpp.php?cb='+cb+'&prd='+prd+'&a='+tglmulas+'&c='+ttgg+'','popupusia',350,200,1)
   return true
 }
}
...
function HitungJUA () {
 ...
 //alert(premi1)
//hitung benefit
 NewWindow('./hitungpremijua-lpp.php?prefixpertanggungan='+prefixpertanggungan+'&kdper='+kdper+'&bpo='+bpo+'&vara='+vara+'&kdproduk='+kdproduk+'&nopertanggungan='+nopertanggungan+'&noproposal='+noproposal+'&kdstatusmedical='+kdstatusmedical+'&akhirpremi='+akhirpremi+
