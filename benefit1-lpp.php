...
if ($propmtc14lanjut == "Lanjut") { //submit
	foreach ($result as $foo => $arr) {
		...
		if ($kdproduk == "JL4X" || $kdproduk == "JL4XG")
			$benefit = $premi * 1.25;
		$expirasi = ${"exp" . $kdbenefit};
		if (strlen($expirasi) == 0) $expirasi = "null";
		//echo $benefit;
	...
	<form name="propmtc14" method="POST" action="<? PHP_SELF; ?>">
		...
		<font face="Verdana" size="2">
			<table width="100%">
				<tr>
					<td align="right">
						<font face="Verdana" size="1" color="#0033CC">F1336</font>
					</td>
				</tr>
				<tr>
		...
		?>
			<table>
				...
				?>
					<tr>
						<td>
							<font size="2">Premi Top UP Berkala</font>
						</td>
						<td>
							<?
							if ($premitopup == "") {
				...
				<tr>
					<td>
						<font size="2">Premi Top UP Sekaligus</font>
					</td>
					<td>
						<?
						if ($premitopupskg == "") {
			...
			<table border=0 width="100%" bgcolor="d5e7fd">
				<tr>
					<td colspan="3" align="center">
						<font size="2"><b>Entry Porsi Fund</b></font>
					</td>
				</tr>
				<tr>
					<td class=verdana8 align="center">
						<font size="2">Cek <!--(Pilih 2)--></font>
					</td>
					<td class=verdana8>
						<font size="2">Nama Fund</font>
					</td>
					<td class=verdana8>
						<font size="2">Porsi (%)</font>
					</td>
				</tr>
				<?
...
?> <? //=$jmlpremi.$cabayar; 
	?>
				...
				<tr>
					...
					<td></td>
					<td align="center">
						<font size="2"><input type="submit" name="sporsi" value="SIMPAN" /></font>
					</td>
				</tr>
			</table>
...
?>
		...
		?>
			<table width="100%">
				<tr>
					<td class="arial10"><a href="benefit-lpp.php?state=0&premijua=<? echo $premijua; ?>&noproposal=<? echo $noproposal; ?>&nopertanggungan=<? echo $nopertanggungan; ?>&prefixpertanggungan=<? echo $prefixpertanggungan; ?>&kdper=<? echo $kdper; ?>&vara=<? echo $vara; ?>&kdproduk=<? echo $kdproduk; ?>">Back</a></td>
					<td align="right">
