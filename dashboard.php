...
<body>
	<div class="container">
		<div class="row">
				...
				<div class="well no-padding">
					<div>
						<ul class="nav nav-list nav-menu-list-style " data-toggle="collapse">
							...
							<li class="divider"></li>
							<li>
								<label  data-toggle="collapse" class="tree-toggle nav-header"><span class="glyphicon glyphicon-user m5"></span>&nbsp; JAIM</label>
								<ul class="nav nav-list tree">
									<li><a href="#" id='back'> Kembali ke JAIM</a></li>
								</ul>
							</li>
						</ul>
					</div>
			...
			<div class="col-md-9" >
				<iframe id="iframe-spaj" src="https://jaim.jiwasraya.co.id/spajonline/blank"
	...
	<script>
		$mew = null;
		var $base_url_api = 'https://jaim.jiwasraya.co.id/api/spajonline_v1/';
		var idagen = <?=$idagen?>;
		var token = <?=$token?>;
		var android_ver = '00';
		...
		//iframe-spaj-entri
		$('a').on('click', function() {
			$strauth = '?idagen=' + idagen + '&token=' + token + '&android_ver=' + android_ver;
			$mew = this;
