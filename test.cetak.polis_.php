<?php
    ...
    // cek apakah produk yang ingin dicetak adalah produk LPP, jika ya redirect ke cetak LPP
    else if ($produk['KDPRODUK'] == 'JL4BPRO') {
        header("Location: test.cetak.polis.lpp.php?prefix=$data[prefix]&nopertanggungan=$data[nopertanggungan]");
    }
	// cek apakah produk yang ingin dicetak adalah produk jl4 (js promapan), jika ya redirect ke cetak newlink
	else if (substr($produk['KDPRODUK'],0,3) == 'JL4' && $produk['KDPRODUK'] != 'JL4BPRO') {
