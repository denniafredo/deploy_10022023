...
//     echo "http://10.170.64.152" . base64_encode($rows->META_FILES);
// };
?>
                            ...
                            <div class="portlet-body form">
                                <form id="form-needassesment" class="form-horizontal" role="form" action="<?="$this->url/submit"?>" method="post">
                                    ...
                                    <div class="form-body">
                                        ...
                                        ?>
										<?php if(@$rows): ?>
											<a target="_blank" href="<?= $filename.base64_encode($rows->META_FILES) ?>" >File Needed Assesment</a>
                                        <?php endif; ?>
										<?php } ?>
                                        </span>   
                            ...
                            <div class="portlet-body form">
                                ...
                                <input type="hidden" name="buildid" class="form-control" value="<?=$this->input->get('buildid')?>" readonly>
                                    ...
                                    <div class="form-body">
                                        ...
                                        ?>
										<?php if(@$rows): ?>
											<a target="_blank" href="<?= $filename.base64_encode($rows->META_FILES) ?>" >File Pernyataan Pemahaman</a>
                                        <?php endif; ?>
										<?php } ?>   
                                        </span>   
                            ...
                            <div class="portlet-body form">
                                <form id="form-profileresiko" class="form-horizontal" role="form" action="<?="$this->url/submit"?>" method="post">
                                    ...
                                    <div class="form-body">
                                        ...
                                        ?>
										<?php if(@$rows): ?>
											<a target="_blank" href="<?= $filename.base64_encode($rows->META_FILES) ?>" >File Profil Resiko</a>
                                        <?php endif; ?>
										<?php } ?>
                            ...
                            <div class="portlet-body form">
                                ...
                                <input type="hidden" name="buildid" class="form-control" value="<?=$this->input->get('buildid')?>" readonly>
                                    ...
                                    <div class="form-body">
                                        ...
                                        ?>
										<?php if(@$rows): ?>
											<a target="_blank" href="<?= $filename.base64_encode($rows->META_FILES) ?>" >File Recording Pernyataan</a>
                                        <?php endif; ?>
										<?php } ?>
                                        </span>
										</div>
