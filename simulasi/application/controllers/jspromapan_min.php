...
class Jspromapan extends CI_Controller{
	...
	function hitungjshcpjspromapan(){
		$this->load->model('ModSimulasi');
		
		$uangasuransihcpjspromapan = $this->input->post("uangasuransihcpjspromapan");
		
		$uahcpjspromapan = $this->input->post("uahcpjspromapan");
		...
		$result = $this->ModSimulasi->getBiayaAsuransiPerBulanHCPDwigunaMenaik($usiasekarang, $uahcpjspromapan, $jeniskelamin);
		
		$carabayarjspromapan = $this->input->post("carabayarjspromapan");
		
		if ($carabayarjspromapan == 'Tahunan')
		{
			$faktorkali = 1;
		}
		else if ($carabayarjspromapan == 'Semesteran')
		{
			$faktorkali = 0.52;
		}
		else if ($carabayarjspromapan == 'Kuartalan')
		{
			$faktorkali = 0.27;
		}
		else if ($carabayarjspromapan == 'Bulanan')
		{
			$faktorkali = 0.095;
		}
		else if ($carabayarjspromapan == 'Sekaligus')
		{
			$faktorkali = 0;
		}
	...
	function hitunghcpbjspromapan(){
		$this->load->model('ModSimulasi');
		
		$uangasuransihcpbjspromapan = $this->input->post("uangasuransihcpbjspromapan");
		
		$uahcpbjspromapan = $this->input->post("uahcpbjspromapan");
		...
		$result = $this->ModSimulasi->getBiayaAsuransiPerBulanHCPBedahDwigunaMenaik($usiasekarang, $jeniskelamin, $uahcpbjspromapan);
	...
	function hitungjstpdjspromapan() {
		$this->load->model('ModSimulasi');
		
		$usiasekarang = $this->input->post("usiasekarang");
		
		$uangasuransijstpdjspromapan = $this->input->post("uangasuransijstpdjspromapan");
		...
		$hasil = (($result[$jeniskelamin]/1000) * $uangasuransijstpdjspromapan) * $faktorkali;
		
		echo round($hasil);
		
	}
	
	function hitungjswpjspromapan() {
		$this->load->model('ModSimulasi');
	...
	function hasil(){
		...
		$data['hasil']['biayaasuransiperbulanad'] = $biayaasuransiperbulanad * (($data['hasil']['uangpertanggungan'] / 12) / 1000);
		...
		for($i=1;$i<=100;$i++)
		{
			...
			if ($i == 1)
			{
				$biayapremiberkala = 10;
			}
			else if ($i == 2)
			{
				$biayapremiberkala = 50;
			}
			else if ($i == 3)
			{
				$biayapremiberkala = 60;
			}
			else if ($i == 4)
			{
				$biayapremiberkala = 70;
			}
			else if ($i == 5)
			{
				$biayapremiberkala = 90;
			}
			else if ($i == 6)
			{
				$biayapremiberkala = 100;
			}
			
			$masaPembayaranPremi = $data['hasil']['asumsicutitahunan'];
			
			if ($i <= $masaPembayaranPremi)
			{
				$data['hasil']['nilai'][$i]['premi'] = (($data['hasil']['premiberkala'] + $data['hasil']['topupberkala']) * $pengalipremi) / 1000;
				$data['hasil']['nilai'][$i]['premiberkala'] = $data['hasil']['premiberkala'];
				$data['hasil']['nilai'][$i]['topupberkala'] = $data['hasil']['topupberkala'];
				
				$data['hasil']['nilai'][$i]['premikomparasiringkasan'] = (($data['hasil']['premiberkalakomparasiringkasan'] + $data['hasil']['topupberkala']) * $pengalipremi) / 1000;
				$data['hasil']['nilai'][$i]['premiberkalakomparasiringkasan'] = $data['hasil']['premiberkalakomparasiringkasan'];
				
			}
			else if ($i > $masaPembayaranPremi) 
			{
				$data['hasil']['nilai'][$i]['premiberkala'] = 0;
				$data['hasil']['nilai'][$i]['topupberkala'] = 0;
			...
			if ($i == 1)
			{
				$data['hasil']['nilai'][$i]['usiacalontertanggung'] = $data['hasil']['usiacalontertanggung'];	
				$data['hasil']['nilai'][$i]['usianasabah'] = $data['hasil']['usianasabah'];	

				$biayaasuransiperbulanasuransidasar = $this->ModSimulasi->getBiayaAsuransiPerBulanAsuransiDasar($data['hasil']['nilai'][$i]['usiacalontertanggung']);
				$biayaasuransiperbulanad = $biayaasuransiperbulanasuransidasar[$statusperokok];
				$data['hasil']['nilai'][$i]['biayaasuransiperbulanad'] = ((($biayaasuransiperbulanad / 1000) * $data['hasil']['uangpertanggungan'])/12);	

				if ($data['hasil']['juaaddb'] != "")
				{
					$biayaasuransiperbulanaddb = $this->ModSimulasi->getBiayaAsuransiPerBulanADDB($data['hasil']['nilai'][$i]['usiacalontertanggung']);
					$biayaasuransiperbulanjsaddb = $biayaasuransiperbulanaddb[$statuskelamin];
					$data['hasil']['nilai'][$i]['biayaasuransiperbulanjsaddb'] = ((($biayaasuransiperbulanjsaddb / 1000) * $data['hasil']['juaaddb'])/12);
				}	
				
				if ($data['hasil']['juaci53'] != "")
				{
					$biayaasuransiperbulanci53 = $this->ModSimulasi->getBiayaAsuransiPerBulanCI53($data['hasil']['nilai'][$i]['usiacalontertanggung']);
					$biayaasuransiperbulanjsci53 = $biayaasuransiperbulanci53[$statuskelamin];
					$data['hasil']['nilai'][$i]['biayaasuransiperbulanjsci53'] = ((($biayaasuransiperbulanjsci53 / 1000) * $data['hasil']['juaci53'])/12);
				}
				
				if ($data['hasil']['juahcp'] != "")
				{
					$biayaasuransiperbulanhcp = $this->ModSimulasi->getBiayaAsuransiPerBulanHCP($data['hasil']['nilai'][$i]['usiacalontertanggung'], $ranap, $statkelaminhcp);
					$biayaasuransiperbulanjshcp = $biayaasuransiperbulanhcp['tarif'];
					$data['hasil']['nilai'][$i]['biayaasuransiperbulanjshcp'] = $biayaasuransiperbulanjshcp / 12;
				}

				
				if ($data['hasil']['juahcpbedah'] != "")
				{
					$biayaasuransiperbulanhcpbedah = $this->ModSimulasi->getBiayaAsuransiPerBulanHCPBedah($data['hasil']['nilai'][$i]['usiacalontertanggung'], $statkelaminhcp, $plafonhcpbedah);
					$biayaasuransiperbulanjshcpbedah = $biayaasuransiperbulanhcpbedah['tarif'];
					$data['hasil']['nilai'][$i]['biayaasuransiperbulanjshcpbedah'] = $biayaasuransiperbulanjshcpbedah / 12;
				}
				
				
				if ($data['hasil']['juatpd'] != "")
				{
					$biayaasuransiperbulantpd = $this->ModSimulasi->getBiayaAsuransiPerBulanTPD($data['hasil']['nilai'][$i]['usiacalontertanggung']);
					$biayaasuransiperbulanjstpd = $biayaasuransiperbulantpd[$statuskelamin];
					$data['hasil']['nilai'][$i]['biayaasuransiperbulanjstpd'] = ((($biayaasuransiperbulanjstpd / 1000) * $data['hasil']['juatpd'])/12);
				}
				
				if ($data['hasil']['juatermlife'] != "")
				{
					$biayaasuransiperbulantermlife = $this->ModSimulasi->getBiayaAsuransiPerBulanTermLife($data['hasil']['nilai'][$i]['usiacalontertanggung']);
					$biayaasuransiperbulantl = $biayaasuransiperbulantermlife[$statusperokok];
					$data['hasil']['nilai'][$i]['biayaasuransiperbulantl'] = ((($biayaasuransiperbulantl / 1000) * $data['hasil']['juatermlife'])/12);
				}
				
				if ($data['hasil']['juapayorbenefitdeath'] != "")
				{
					$biayaasuransiperbulanpbd = $this->ModSimulasi->getBiayaAsuransiPerBulanPBD($data['hasil']['nilai'][$i]['usianasabah']);
					$biayaasuransiperbulanjspbd = $biayaasuransiperbulanpbd[$statuskelamin];
					$data['hasil']['nilai'][$i]['biayaasuransiperbulanjspbd'] = ((($biayaasuransiperbulanjspbd / 100) * $data['hasil']['juapayorbenefitdeath'])/12);
				}
				
				if ($data['hasil']['juapayorbenefittpd'] != "")
				{
					$biayaasuransiperbulanpbtpd = $this->ModSimulasi->getBiayaAsuransiPerBulanPBTPD($data['hasil']['nilai'][$i]['usianasabah']);
					$biayaasuransiperbulanjspbtpd = $biayaasuransiperbulanpbtpd[$statuskelamin];
					$data['hasil']['nilai'][$i]['biayaasuransiperbulanjspbtpd'] = ((($biayaasuransiperbulanjspbtpd/ 100) * $data['hasil']['juapayorbenefittpd'])/12);
				}
				
				if ($data['hasil']['juaspousepayordeath'] != "")
				{
					$biayaasuransiperbulanspd = $this->ModSimulasi->getBiayaAsuransiPerBulanSPD($data['hasil']['nilai'][$i]['usianasabah']);
					$biayaasuransiperbulanjsspd = $biayaasuransiperbulanspd[$statuskelamin];
					$data['hasil']['nilai'][$i]['biayaasuransiperbulanjsspd'] = ((($biayaasuransiperbulanjsspd/ 100) * $data['hasil']['juaspousepayordeath'])/12);
				}
				
				if ($data['hasil']['juaspousepayortpd'] != "")
				{
					$biayaasuransiperbulansptpd = $this->ModSimulasi->getBiayaAsuransiPerBulanSPTPD($data['hasil']['nilai'][$i]['usianasabah']);
					$biayaasuransiperbulanjssptpd = $biayaasuransiperbulansptpd[$statuskelamin];
					$data['hasil']['nilai'][$i]['biayaasuransiperbulanjssptpd'] = ((($biayaasuransiperbulanjssptpd/ 100) * $data['hasil']['juaspousepayortpd'])/12);
				}
											
				//MANFAAT INVESTASI
				
				$data['hasil']['nilai'][$i]['manfaatinvestasirendah'] = (((((((((((((((((((((((($biayapremiberkala / 100) * $data['hasil']['premiberkala'])+((95 / 100) * ($data['hasil']['topupberkala'] + $data['hasil']['topupsekaligus']))
																		*(1+(($data['hasil']['asumsi_inv_min1']/100)/12)) + (($biayapremiberkala / 100) * $data['hasil']['premiberkala'])+((95 / 100) * ($data['hasil']['topupberkala'])))
																		*(1+(($data['hasil']['asumsi_inv_min1']/100)/12))) + (($biayapremiberkala / 100) * $data['hasil']['premiberkala'])+((95 / 100) * ($data['hasil']['topupberkala'])))
																		*(1+(($data['hasil']['asumsi_inv_min1']/100)/12))) + (($biayapremiberkala / 100) * $data['hasil']['premiberkala'])+((95 / 100) * ($data['hasil']['topupberkala'])))
																		*(1+(($data['hasil']['asumsi_inv_min1']/100)/12))) + (($biayapremiberkala / 100) * $data['hasil']['premiberkala'])+((95 / 100) * ($data['hasil']['topupberkala'])))
																		*(1+(($data['hasil']['asumsi_inv_min1']/100)/12))) + (($biayapremiberkala / 100) * $data['hasil']['premiberkala'])+((95 / 100) * ($data['hasil']['topupberkala'])))
																		...
																		*(1+(($data['hasil']['asumsi_inv_min1']/100)/12))) + (($biayapremiberkala / 100) * $data['hasil']['premiberkala'])+((95 / 100) * ($data['hasil']['topupberkala'])))
																		*(1+(($data['hasil']['asumsi_inv_min1']/100)/12))) + (($biayapremiberkala / 100) * $data['hasil']['premiberkala'])+((95 / 100) * ($data['hasil']['topupberkala'])))
																		*(1+(($data['hasil']['asumsi_inv_min1']/100)/12))) ;
				
				$data['hasil']['nilai'][$i]['manfaatinvestasisedang'] = (((((((((((((((((((((((($biayapremiberkala / 100) * $data['hasil']['premiberkala'])+((95 / 100) * ($data['hasil']['topupberkala'] + $data['hasil']['topupsekaligus']))
																		*(1+(($data['hasil']['asumsi_inv_med1']/100)/12)) + (($biayapremiberkala / 100) * $data['hasil']['premiberkala'])+((95 / 100) * ($data['hasil']['topupberkala'])))
																		*(1+(($data['hasil']['asumsi_inv_med1']/100)/12))) + (($biayapremiberkala / 100) * $data['hasil']['premiberkala'])+((95 / 100) * ($data['hasil']['topupberkala'])))
																		*(1+(($data['hasil']['asumsi_inv_med1']/100)/12))) + (($biayapremiberkala / 100) * $data['hasil']['premiberkala'])+((95 / 100) * ($data['hasil']['topupberkala'])))
																		*(1+(($data['hasil']['asumsi_inv_med1']/100)/12))) + (($biayapremiberkala / 100) * $data['hasil']['premiberkala'])+((95 / 100) * ($data['hasil']['topupberkala'])))
																		*(1+(($data['hasil']['asumsi_inv_med1']/100)/12))) + (($biayapremiberkala / 100) * $data['hasil']['premiberkala'])+((95 / 100) * ($data['hasil']['topupberkala'])))
																		...
																		*(1+(($data['hasil']['asumsi_inv_med1']/100)/12))) + (($biayapremiberkala / 100) * $data['hasil']['premiberkala'])+((95 / 100) * ($data['hasil']['topupberkala'])))
																		*(1+(($data['hasil']['asumsi_inv_med1']/100)/12))) + (($biayapremiberkala / 100) * $data['hasil']['premiberkala'])+((95 / 100) * ($data['hasil']['topupberkala'])))
																		*(1+(($data['hasil']['asumsi_inv_med1']/100)/12))) ;
													
				$data['hasil']['nilai'][$i]['manfaatinvestasitinggi'] = (((((((((((((((((((((((($biayapremiberkala / 100) * $data['hasil']['premiberkala'])+((95 / 100) * ($data['hasil']['topupberkala'] + $data['hasil']['topupsekaligus']))
																		*(1+(($data['hasil']['asumsi_inv_max1']/100)/12)) + (($biayapremiberkala / 100) * $data['hasil']['premiberkala'])+((95 / 100) * ($data['hasil']['topupberkala'])))
																		*(1+(($data['hasil']['asumsi_inv_max1']/100)/12))) + (($biayapremiberkala / 100) * $data['hasil']['premiberkala'])+((95 / 100) * ($data['hasil']['topupberkala'])))
																		*(1+(($data['hasil']['asumsi_inv_max1']/100)/12))) + (($biayapremiberkala / 100) * $data['hasil']['premiberkala'])+((95 / 100) * ($data['hasil']['topupberkala'])))
																		*(1+(($data['hasil']['asumsi_inv_max1']/100)/12))) + (($biayapremiberkala / 100) * $data['hasil']['premiberkala'])+((95 / 100) * ($data['hasil']['topupberkala'])))
																		*(1+(($data['hasil']['asumsi_inv_max1']/100)/12))) + (($biayapremiberkala / 100) * $data['hasil']['premiberkala'])+((95 / 100) * ($data['hasil']['topupberkala'])))
																		...
																		*(1+(($data['hasil']['asumsi_inv_max1']/100)/12))) + (($biayapremiberkala / 100) * $data['hasil']['premiberkala'])+((95 / 100) * ($data['hasil']['topupberkala'])))
																		*(1+(($data['hasil']['asumsi_inv_max1']/100)/12))) + (($biayapremiberkala / 100) * $data['hasil']['premiberkala'])+((95 / 100) * ($data['hasil']['topupberkala'])))
																		*(1+(($data['hasil']['asumsi_inv_max1']/100)/12))) ;
																		
				$data['hasil']['nilai'][$i]['manfaatinvestasirendah2'] = (((((((((((((((((((((((($biayapremiberkala / 100) * $data['hasil']['premiberkala'])+((95 / 100) * ($data['hasil']['topupberkala'] + $data['hasil']['topupsekaligus']))
																		*(1+(($data['hasil']['asumsi_inv_min2']/100)/12)) + (($biayapremiberkala / 100) * $data['hasil']['premiberkala'])+((95 / 100) * ($data['hasil']['topupberkala'])))
																		*(1+(($data['hasil']['asumsi_inv_min2']/100)/12))) + (($biayapremiberkala / 100) * $data['hasil']['premiberkala'])+((95 / 100) * ($data['hasil']['topupberkala'])))
																		*(1+(($data['hasil']['asumsi_inv_min2']/100)/12))) + (($biayapremiberkala / 100) * $data['hasil']['premiberkala'])+((95 / 100) * ($data['hasil']['topupberkala'])))
																		*(1+(($data['hasil']['asumsi_inv_min2']/100)/12))) + (($biayapremiberkala / 100) * $data['hasil']['premiberkala'])+((95 / 100) * ($data['hasil']['topupberkala'])))
																		*(1+(($data['hasil']['asumsi_inv_min2']/100)/12))) + (($biayapremiberkala / 100) * $data['hasil']['premiberkala'])+((95 / 100) * ($data['hasil']['topupberkala'])))
																		...
																		*(1+(($data['hasil']['asumsi_inv_min2']/100)/12))) + (($biayapremiberkala / 100) * $data['hasil']['premiberkala'])+((95 / 100) * ($data['hasil']['topupberkala'])))
																		*(1+(($data['hasil']['asumsi_inv_min2']/100)/12))) + (($biayapremiberkala / 100) * $data['hasil']['premiberkala'])+((95 / 100) * ($data['hasil']['topupberkala'])))
																		*(1+(($data['hasil']['asumsi_inv_min2']/100)/12))) ;
				
				$data['hasil']['nilai'][$i]['manfaatinvestasisedang2'] = (((((((((((((((((((((((($biayapremiberkala / 100) * $data['hasil']['premiberkala'])+((95 / 100) * ($data['hasil']['topupberkala'] + $data['hasil']['topupsekaligus']))
																		*(1+(($data['hasil']['asumsi_inv_med2']/100)/12)) + (($biayapremiberkala / 100) * $data['hasil']['premiberkala'])+((95 / 100) * ($data['hasil']['topupberkala'])))
																		*(1+(($data['hasil']['asumsi_inv_med2']/100)/12))) + (($biayapremiberkala / 100) * $data['hasil']['premiberkala'])+((95 / 100) * ($data['hasil']['topupberkala'])))
																		*(1+(($data['hasil']['asumsi_inv_med2']/100)/12))) + (($biayapremiberkala / 100) * $data['hasil']['premiberkala'])+((95 / 100) * ($data['hasil']['topupberkala'])))
																		*(1+(($data['hasil']['asumsi_inv_med2']/100)/12))) + (($biayapremiberkala / 100) * $data['hasil']['premiberkala'])+((95 / 100) * ($data['hasil']['topupberkala'])))
																		*(1+(($data['hasil']['asumsi_inv_med2']/100)/12))) + (($biayapremiberkala / 100) * $data['hasil']['premiberkala'])+((95 / 100) * ($data['hasil']['topupberkala'])))
																		...
																		*(1+(($data['hasil']['asumsi_inv_med2']/100)/12))) + (($biayapremiberkala / 100) * $data['hasil']['premiberkala'])+((95 / 100) * ($data['hasil']['topupberkala'])))
																		*(1+(($data['hasil']['asumsi_inv_med2']/100)/12))) + (($biayapremiberkala / 100) * $data['hasil']['premiberkala'])+((95 / 100) * ($data['hasil']['topupberkala'])))
																		*(1+(($data['hasil']['asumsi_inv_med2']/100)/12))) ;
													
				$data['hasil']['nilai'][$i]['manfaatinvestasitinggi2'] = (((((((((((((((((((((((($biayapremiberkala / 100) * $data['hasil']['premiberkala'])+((95 / 100) * ($data['hasil']['topupberkala'] + $data['hasil']['topupsekaligus']))
																		*(1+(($data['hasil']['asumsi_inv_max2']/100)/12)) + (($biayapremiberkala / 100) * $data['hasil']['premiberkala'])+((95 / 100) * ($data['hasil']['topupberkala'])))
																		*(1+(($data['hasil']['asumsi_inv_max2']/100)/12))) + (($biayapremiberkala / 100) * $data['hasil']['premiberkala'])+((95 / 100) * ($data['hasil']['topupberkala'])))
																		*(1+(($data['hasil']['asumsi_inv_max2']/100)/12))) + (($biayapremiberkala / 100) * $data['hasil']['premiberkala'])+((95 / 100) * ($data['hasil']['topupberkala'])))
																		*(1+(($data['hasil']['asumsi_inv_max2']/100)/12))) + (($biayapremiberkala / 100) * $data['hasil']['premiberkala'])+((95 / 100) * ($data['hasil']['topupberkala'])))
																		*(1+(($data['hasil']['asumsi_inv_max2']/100)/12))) + (($biayapremiberkala / 100) * $data['hasil']['premiberkala'])+((95 / 100) * ($data['hasil']['topupberkala'])))
																		...
																		*(1+(($data['hasil']['asumsi_inv_max2']/100)/12))) + (($biayapremiberkala / 100) * $data['hasil']['premiberkala'])+((95 / 100) * ($data['hasil']['topupberkala'])))
																		*(1+(($data['hasil']['asumsi_inv_max2']/100)/12))) + (($biayapremiberkala / 100) * $data['hasil']['premiberkala'])+((95 / 100) * ($data['hasil']['topupberkala'])))
																		*(1+(($data['hasil']['asumsi_inv_max2']/100)/12))) ;
				
				
				if ($data['hasil']['nilai'][$i]['manfaatinvestasirendah'] < 0) 
				{
					$data['hasil']['nilai'][$i]['manfaatinvestasirendah'] = 0;
					$data['hasil']['nilai'][$i]['manfaatmeninggalduniarendah'] = 0;
				}
				if ($data['hasil']['nilai'][$i]['manfaatinvestasisedang'] < 0) 
				{
					$data['hasil']['nilai'][$i]['manfaatinvestasisedang'] = 0;
					$data['hasil']['nilai'][$i]['manfaatmeninggalduniasedang'] = 0;
				}
				if ($data['hasil']['nilai'][$i]['manfaatinvestasitinggi'] < 0) 
				{
					$data['hasil']['nilai'][$i]['manfaatinvestasitinggi'] = 0;
					$data['hasil']['nilai'][$i]['manfaatmeninggalduniatinggi'] = 0;
				}
				...
				{
					$data['hasil']['nilai'][$i]['manfaatinvestasirendah2'] = 0;
					$data['hasil']['nilai'][$i]['manfaatmeninggalduniarendah2'] = 0;
				}
				if ($data['hasil']['nilai'][$i]['manfaatinvestasisedang2'] < 0) 
				{
					$data['hasil']['nilai'][$i]['manfaatinvestasisedang2'] = 0;
					$data['hasil']['nilai'][$i]['manfaatmeninggalduniasedang2'] = 0;
				}
				if ($data['hasil']['nilai'][$i]['manfaatinvestasitinggi2'] < 0) 
				{
					$data['hasil']['nilai'][$i]['manfaatinvestasitinggi2'] = 0;
					$data['hasil']['nilai'][$i]['manfaatmeninggalduniatinggi2'] = 0;
				}
				...
				//RINGKASAN
				$data['hasil']['nilai'][$i]['manfaatinvestasirendahringkasan'] = $data['hasil']['nilai'][$i]['manfaatinvestasirendah'] * ($data['hasil']['persentasealokasidana1'] / 100) + $data['hasil']['nilai'][$i]['manfaatinvestasirendah2'] * ($data['hasil']['persentasealokasidana2'] / 100);
				
				$data['hasil']['nilai'][$i]['manfaatinvestasisedangringkasan'] = $data['hasil']['nilai'][$i]['manfaatinvestasisedang'] * ($data['hasil']['persentasealokasidana1'] / 100) + $data['hasil']['nilai'][$i]['manfaatinvestasisedang2'] * ($data['hasil']['persentasealokasidana2'] / 100);
				
				$data['hasil']['nilai'][$i]['manfaatinvestasitinggiringkasan'] = $data['hasil']['nilai'][$i]['manfaatinvestasitinggi'] * ($data['hasil']['persentasealokasidana1'] / 100) + $data['hasil']['nilai'][$i]['manfaatinvestasitinggi2'] * ($data['hasil']['persentasealokasidana2'] / 100);
																		
				//MANFAAT MENINGGAL DUNIA 
				
				$data['hasil']['nilai'][$i]['manfaatmeninggalduniarendah'] = $data['hasil']['uangpertanggungan'] +  $data['hasil']['nilai'][$i]['manfaatinvestasirendah'];
				
				$data['hasil']['nilai'][$i]['manfaatmeninggalduniasedang'] = $data['hasil']['uangpertanggungan'] +  $data['hasil']['nilai'][$i]['manfaatinvestasisedang'];
				
				$data['hasil']['nilai'][$i]['manfaatmeninggalduniatinggi'] = $data['hasil']['uangpertanggungan'] +  $data['hasil']['nilai'][$i]['manfaatinvestasitinggi'];
				
				$data['hasil']['nilai'][$i]['manfaatmeninggalduniarendah2'] = $data['hasil']['uangpertanggungan'] +  $data['hasil']['nilai'][$i]['manfaatinvestasirendah2'];
				
				$data['hasil']['nilai'][$i]['manfaatmeninggalduniasedang2'] = $data['hasil']['uangpertanggungan'] +  $data['hasil']['nilai'][$i]['manfaatinvestasisedang2'];
				
				$data['hasil']['nilai'][$i]['manfaatmeninggalduniatinggi2'] = $data['hasil']['uangpertanggungan'] +  $data['hasil']['nilai'][$i]['manfaatinvestasitinggi2'];
				
				//RINGKASAN
				$data['hasil']['nilai'][$i]['manfaatmeninggalduniarendahringkasan'] = $data['hasil']['nilai'][$i]['manfaatmeninggalduniarendah'] * ($data['hasil']['persentasealokasidana1'] / 100) + $data['hasil']['nilai'][$i]['manfaatmeninggalduniarendah2'] * ($data['hasil']['persentasealokasidana2'] / 100);
				
				$data['hasil']['nilai'][$i]['manfaatmeninggalduniasedangringkasan'] = $data['hasil']['nilai'][$i]['manfaatmeninggalduniasedang'] * ($data['hasil']['persentasealokasidana1'] / 100) + $data['hasil']['nilai'][$i]['manfaatmeninggalduniasedang2'] * ($data['hasil']['persentasealokasidana2'] / 100);
				
				$data['hasil']['nilai'][$i]['manfaatmeninggalduniatinggiringkasan'] = $data['hasil']['nilai'][$i]['manfaatmeninggalduniatinggi'] * ($data['hasil']['persentasealokasidana1'] / 100) + $data['hasil']['nilai'][$i]['manfaatmeninggalduniatinggi2'] * ($data['hasil']['persentasealokasidana2'] / 100);
				
				//KOMPARASI RINGKASAN
				$data['hasil']['nilai'][$i]['manfaatinvestasirendahkomparasiringkasan'] = (((((((((((((((((((((((($biayapremiberkala / 100) * $data['hasil']['premiberkalakomparasiringkasan'])+((95 / 100) * ($data['hasil']['topupberkala'] + $data['hasil']['topupsekaligus']))
																		*(1+(($data['hasil']['asumsi_inv_min1']/100)/12)) + (($biayapremiberkala / 100) * $data['hasil']['premiberkala'])+((95 / 100) * ($data['hasil']['topupberkala'])))
																		*(1+(($data['hasil']['asumsi_inv_min1']/100)/12))) + (($biayapremiberkala / 100) * $data['hasil']['premiberkala'])+((95 / 100) * ($data['hasil']['topupberkala'])))
																		*(1+(($data['hasil']['asumsi_inv_min1']/100)/12))) + (($biayapremiberkala / 100) * $data['hasil']['premiberkala'])+((95 / 100) * ($data['hasil']['topupberkala'])))
																		*(1+(($data['hasil']['asumsi_inv_min1']/100)/12))) + (($biayapremiberkala / 100) * $data['hasil']['premiberkala'])+((95 / 100) * ($data['hasil']['topupberkala'])))
				...
				$data['hasil']['nilai'][$i]['manfaatinvestasisedangkomparasiringkasan'] = (((((((((((((((((((((((($biayapremiberkala / 100) * $data['hasil']['premiberkalakomparasiringkasan'])+((95 / 100) * ($data['hasil']['topupberkala'] + $data['hasil']['topupsekaligus']))
																		*(1+(($data['hasil']['asumsi_inv_med1']/100)/12)) + (($biayapremiberkala / 100) * $data['hasil']['premiberkala'])+((95 / 100) * ($data['hasil']['topupberkala'])))
																		*(1+(($data['hasil']['asumsi_inv_med1']/100)/12))) + (($biayapremiberkala / 100) * $data['hasil']['premiberkala'])+((95 / 100) * ($data['hasil']['topupberkala'])))
																		*(1+(($data['hasil']['asumsi_inv_med1']/100)/12))) + (($biayapremiberkala / 100) * $data['hasil']['premiberkala'])+((95 / 100) * ($data['hasil']['topupberkala'])))
																		*(1+(($data['hasil']['asumsi_inv_med1']/100)/12))) + (($biayapremiberkala / 100) * $data['hasil']['premiberkala'])+((95 / 100) * ($data['hasil']['topupberkala'])))
				...
				$data['hasil']['nilai'][$i]['manfaatinvestasitinggikomparasiringkasan'] = (((((((((((((((((((((((($biayapremiberkala / 100) * $data['hasil']['premiberkalakomparasiringkasan'])+((95 / 100) * ($data['hasil']['topupberkala'] + $data['hasil']['topupsekaligus']))
																		*(1+(($data['hasil']['asumsi_inv_max1']/100)/12)) + (($biayapremiberkala / 100) * $data['hasil']['premiberkala'])+((95 / 100) * ($data['hasil']['topupberkala'])))
																		*(1+(($data['hasil']['asumsi_inv_max1']/100)/12))) + (($biayapremiberkala / 100) * $data['hasil']['premiberkala'])+((95 / 100) * ($data['hasil']['topupberkala'])))
																		*(1+(($data['hasil']['asumsi_inv_max1']/100)/12))) + (($biayapremiberkala / 100) * $data['hasil']['premiberkala'])+((95 / 100) * ($data['hasil']['topupberkala'])))
																		*(1+(($data['hasil']['asumsi_inv_max1']/100)/12))) + (($biayapremiberkala / 100) * $data['hasil']['premiberkala'])+((95 / 100) * ($data['hasil']['topupberkala'])))
				...
				$data['hasil']['nilai'][$i]['manfaatinvestasirendahkomparasiringkasan2'] = (((((((((((((((((((((((($biayapremiberkala / 100) * $data['hasil']['premiberkalakomparasiringkasan'])+((95 / 100) * ($data['hasil']['topupberkala'] + $data['hasil']['topupsekaligus']))
																		*(1+(($data['hasil']['asumsi_inv_min2']/100)/12)) + (($biayapremiberkala / 100) * $data['hasil']['premiberkala'])+((95 / 100) * ($data['hasil']['topupberkala'])))
																		*(1+(($data['hasil']['asumsi_inv_min2']/100)/12))) + (($biayapremiberkala / 100) * $data['hasil']['premiberkala'])+((95 / 100) * ($data['hasil']['topupberkala'])))
																		*(1+(($data['hasil']['asumsi_inv_min2']/100)/12))) + (($biayapremiberkala / 100) * $data['hasil']['premiberkala'])+((95 / 100) * ($data['hasil']['topupberkala'])))
																		*(1+(($data['hasil']['asumsi_inv_min2']/100)/12))) + (($biayapremiberkala / 100) * $data['hasil']['premiberkala'])+((95 / 100) * ($data['hasil']['topupberkala'])))
				...
				$data['hasil']['nilai'][$i]['manfaatinvestasisedangkomparasiringkasan2'] = (((((((((((((((((((((((($biayapremiberkala / 100) * $data['hasil']['premiberkalakomparasiringkasan'])+((95 / 100) * ($data['hasil']['topupberkala'] + $data['hasil']['topupsekaligus']))
																		*(1+(($data['hasil']['asumsi_inv_med2']/100)/12)) + (($biayapremiberkala / 100) * $data['hasil']['premiberkala'])+((95 / 100) * ($data['hasil']['topupberkala'])))
																		*(1+(($data['hasil']['asumsi_inv_med2']/100)/12))) + (($biayapremiberkala / 100) * $data['hasil']['premiberkala'])+((95 / 100) * ($data['hasil']['topupberkala'])))
																		*(1+(($data['hasil']['asumsi_inv_med2']/100)/12))) + (($biayapremiberkala / 100) * $data['hasil']['premiberkala'])+((95 / 100) * ($data['hasil']['topupberkala'])))
																		*(1+(($data['hasil']['asumsi_inv_med2']/100)/12))) + (($biayapremiberkala / 100) * $data['hasil']['premiberkala'])+((95 / 100) * ($data['hasil']['topupberkala'])))
				...
				$data['hasil']['nilai'][$i]['manfaatinvestasitinggikomparasiringkasan2'] = (((((((((((((((((((((((($biayapremiberkala / 100) * $data['hasil']['premiberkalakomparasiringkasan'])+((95 / 100) * ($data['hasil']['topupberkala'] + $data['hasil']['topupsekaligus']))
																		*(1+(($data['hasil']['asumsi_inv_max2']/100)/12)) + (($biayapremiberkala / 100) * $data['hasil']['premiberkala'])+((95 / 100) * ($data['hasil']['topupberkala'])))
																		*(1+(($data['hasil']['asumsi_inv_max2']/100)/12))) + (($biayapremiberkala / 100) * $data['hasil']['premiberkala'])+((95 / 100) * ($data['hasil']['topupberkala'])))
																		*(1+(($data['hasil']['asumsi_inv_max2']/100)/12))) + (($biayapremiberkala / 100) * $data['hasil']['premiberkala'])+((95 / 100) * ($data['hasil']['topupberkala'])))
																		*(1+(($data['hasil']['asumsi_inv_max2']/100)/12))) + (($biayapremiberkala / 100) * $data['hasil']['premiberkala'])+((95 / 100) * ($data['hasil']['topupberkala'])))
				...
				if ($data['hasil']['nilai'][$i]['manfaatinvestasirendahkomparasiringkasan'] < 0) 
				{
					$data['hasil']['nilai'][$i]['manfaatinvestasirendahkomparasiringkasan'] = 0;
					$data['hasil']['nilai'][$i]['manfaatmeninggalduniarendahkomparasiringkasan'] = 0;
				}
				if ($data['hasil']['nilai'][$i]['manfaatinvestasisedangkomparasiringkasan'] < 0) 
				{
					$data['hasil']['nilai'][$i]['manfaatinvestasisedangkomparasiringkasan'] = 0;
					$data['hasil']['nilai'][$i]['manfaatmeninggalduniasedangkomparasiringkasan'] = 0;
				}
				if ($data['hasil']['nilai'][$i]['manfaatinvestasitinggikomparasiringkasan'] < 0) 
				{
					$data['hasil']['nilai'][$i]['manfaatinvestasitinggikomparasiringkasan'] = 0;
					$data['hasil']['nilai'][$i]['manfaatmeninggalduniatinggikomparasiringkasan'] = 0;
				}
				if ($data['hasil']['nilai'][$i]['manfaatmeninggalduniarendahkomparasiringkasan'] < 0) 
				{
					$data['hasil']['nilai'][$i]['manfaatmeninggalduniarendahkomparasiringkasan'] = 0;
				}
				if ($data['hasil']['nilai'][$i]['manfaatmeninggalduniasedangkomparasiringkasan'] < 0) 
				{
					$data['hasil']['nilai'][$i]['manfaatmeninggalduniasedangkomparasiringkasan'] = 0;
				}
				if ($data['hasil']['nilai'][$i]['manfaatmeninggalduniatinggikomparasiringkasan'] < 0) 
				{
					$data['hasil']['nilai'][$i]['manfaatmeninggalduniatinggikomparasiringkasan'] = 0;
				}
				
				if ($data['hasil']['nilai'][$i]['manfaatinvestasirendahkomparasiringkasan2'] < 0) 
				{
					$data['hasil']['nilai'][$i]['manfaatinvestasirendahkomparasiringkasan2'] = 0;
					$data['hasil']['nilai'][$i]['manfaatmeninggalduniarendahkomparasiringkasan2'] = 0;
				}
				if ($data['hasil']['nilai'][$i]['manfaatinvestasisedangkomparasiringkasan2'] < 0) 
				{
					$data['hasil']['nilai'][$i]['manfaatinvestasisedangkomparasiringkasan2'] = 0;
					$data['hasil']['nilai'][$i]['manfaatmeninggalduniasedangkomparasiringkasan2'] = 0;
				}
				if ($data['hasil']['nilai'][$i]['manfaatinvestasitinggikomparasiringkasan2'] < 0) 
				{
					$data['hasil']['nilai'][$i]['manfaatinvestasitinggikomparasiringkasan2'] = 0;
					$data['hasil']['nilai'][$i]['manfaatmeninggalduniatinggikomparasiringkasan2'] = 0;
				}
				if ($data['hasil']['nilai'][$i]['manfaatmeninggalduniarendahkomparasiringkasan2'] < 0) 
				{
					$data['hasil']['nilai'][$i]['manfaatmeninggalduniarendahkomparasiringkasan2'] = 0;
				}
				if ($data['hasil']['nilai'][$i]['manfaatmeninggalduniasedangkomparasiringkasan2'] < 0) 
				{
					$data['hasil']['nilai'][$i]['manfaatmeninggalduniasedangkomparasiringkasan2'] = 0;
				}
				if ($data['hasil']['nilai'][$i]['manfaatmeninggalduniatinggikomparasiringkasan2'] < 0) 
				{
					$data['hasil']['nilai'][$i]['manfaatmeninggalduniatinggikomparasiringkasan2'] = 0;
				}
				
				$data['hasil']['nilai'][$i]['manfaatmeninggalduniarendahkomparasiringkasan'] = $data['hasil']['uangpertanggungan'] +  $data['hasil']['nilai'][$i]['manfaatinvestasirendahkomparasiringkasan'];
				
				$data['hasil']['nilai'][$i]['manfaatmeninggalduniasedangkomparasiringkasan'] = $data['hasil']['uangpertanggungan'] +  $data['hasil']['nilai'][$i]['manfaatinvestasisedangkomparasiringkasan'];
				
				$data['hasil']['nilai'][$i]['manfaatmeninggalduniatinggikomparasiringkasan'] = $data['hasil']['uangpertanggungan'] +  $data['hasil']['nilai'][$i]['manfaatinvestasitinggikomparasiringkasan'];
				
				$data['hasil']['nilai'][$i]['manfaatmeninggalduniarendahkomparasiringkasan2'] = $data['hasil']['uangpertanggungan'] +  $data['hasil']['nilai'][$i]['manfaatinvestasirendahkomparasiringkasan2'];
				
				$data['hasil']['nilai'][$i]['manfaatmeninggalduniasedangkomparasiringkasan2'] = $data['hasil']['uangpertanggungan'] +  $data['hasil']['nilai'][$i]['manfaatinvestasisedangkomparasiringkasan2'];
				
				$data['hasil']['nilai'][$i]['manfaatmeninggalduniatinggikomparasiringkasan2'] = $data['hasil']['uangpertanggungan'] +  $data['hasil']['nilai'][$i]['manfaatinvestasitinggikomparasiringkasan2'];
				
				$data['hasil']['nilai'][$i]['manfaatinvestasirendahkr'] = $data['hasil']['nilai'][$i]['manfaatinvestasirendahkomparasiringkasan'] * ($data['hasil']['persentasealokasidana1'] / 100) + $data['hasil']['nilai'][$i]['manfaatinvestasirendahkomparasiringkasan2'] * ($data['hasil']['persentasealokasidana2'] / 100);
				
				$data['hasil']['nilai'][$i]['manfaatinvestasisedangkr'] = $data['hasil']['nilai'][$i]['manfaatinvestasisedangkomparasiringkasan'] * ($data['hasil']['persentasealokasidana1'] / 100) + $data['hasil']['nilai'][$i]['manfaatinvestasisedangkomparasiringkasan2'] * ($data['hasil']['persentasealokasidana2'] / 100);
				
				$data['hasil']['nilai'][$i]['manfaatinvestasitinggikr'] = $data['hasil']['nilai'][$i]['manfaatinvestasitinggikomparasiringkasan'] * ($data['hasil']['persentasealokasidana1'] / 100) + $data['hasil']['nilai'][$i]['manfaatinvestasitinggikomparasiringkasan2'] * ($data['hasil']['persentasealokasidana2'] / 100);
				
				$data['hasil']['nilai'][$i]['manfaatmeninggalduniarendahkr'] = $data['hasil']['nilai'][$i]['manfaatmeninggalduniarendahkomparasiringkasan'] * ($data['hasil']['persentasealokasidana1'] / 100) + $data['hasil']['nilai'][$i]['manfaatmeninggalduniarendahkomparasiringkasan2'] * ($data['hasil']['persentasealokasidana2'] / 100);
				
				$data['hasil']['nilai'][$i]['manfaatmeninggalduniasedangkr'] = $data['hasil']['nilai'][$i]['manfaatmeninggalduniasedangkomparasiringkasan'] * ($data['hasil']['persentasealokasidana1'] / 100) + $data['hasil']['nilai'][$i]['manfaatmeninggalduniasedangkomparasiringkasan2'] * ($data['hasil']['persentasealokasidana2'] / 100);
				
				$data['hasil']['nilai'][$i]['manfaatmeninggalduniatinggikr'] = $data['hasil']['nilai'][$i]['manfaatmeninggalduniatinggikomparasiringkasan'] * ($data['hasil']['persentasealokasidana1'] / 100) + $data['hasil']['nilai'][$i]['manfaatmeninggalduniatinggikomparasiringkasan2'] * ($data['hasil']['persentasealokasidana2'] / 100);
				

			}
			else if ($i > 1)
			{
				$data['hasil']['nilai'][$i]['usiacalontertanggung'] = $data['hasil']['nilai'][$i-1]['usiacalontertanggung'] + 1;
				$data['hasil']['nilai'][$i]['usianasabah'] = $data['hasil']['nilai'][$i-1]['usianasabah'] + 1;
				
				$biayaasuransiperbulanasuransidasar = $this->ModSimulasi->getBiayaAsuransiPerBulanAsuransiDasar($data['hasil']['nilai'][$i-1]['usiacalontertanggung']);
				$biayaasuransiperbulanad = $biayaasuransiperbulanasuransidasar[$statusperokok];
				$data['hasil']['nilai'][$i]['biayaasuransiperbulanad'] = ((($biayaasuransiperbulanad / 1000) * $data['hasil']['uangpertanggungan'])/12);	
				
				if ($data['hasil']['juaaddb'] != "")
				{
					$biayaasuransiperbulanaddb = $this->ModSimulasi->getBiayaAsuransiPerBulanADDB($data['hasil']['nilai'][$i-1]['usiacalontertanggung']);
					$biayaasuransiperbulanjsaddb = $biayaasuransiperbulanaddb[$statuskelamin];
					$data['hasil']['nilai'][$i]['biayaasuransiperbulanjsaddb'] = ((($biayaasuransiperbulanjsaddb / 1000) * $data['hasil']['juaaddb'])/12);
				}	
				...
				if ($data['hasil']['juaci53'] != "")
				{
					$biayaasuransiperbulanci53 = $this->ModSimulasi->getBiayaAsuransiPerBulanCI53($data['hasil']['nilai'][$i-1]['usiacalontertanggung']);
					$biayaasuransiperbulanjsci53 = $biayaasuransiperbulanci53[$statuskelamin];
					$data['hasil']['nilai'][$i]['biayaasuransiperbulanjsci53'] = ((($biayaasuransiperbulanjsci53 / 1000) * $data['hasil']['juaci53'])/12);
				}
				...
				if ($data['hasil']['juahcp'] != "")
				{
					$biayaasuransiperbulanhcp = $this->ModSimulasi->getBiayaAsuransiPerBulanHCP($data['hasil']['nilai'][$i-1]['usiacalontertanggung'], $ranap, $statkelaminhcp);
					$biayaasuransiperbulanjshcp = $biayaasuransiperbulanhcp['tarif'];
					$data['hasil']['nilai'][$i]['biayaasuransiperbulanjshcp'] = $biayaasuransiperbulanjshcp / 12;
				}
				...
				if ($data['hasil']['juahcpbedah'] != "")
				{
					$biayaasuransiperbulanhcpbedah = $this->ModSimulasi->getBiayaAsuransiPerBulanHCPBedah($data['hasil']['nilai'][$i-1]['usiacalontertanggung'], $statkelaminhcp, $plafonhcpbedah);
					$biayaasuransiperbulanjshcpbedah = $biayaasuransiperbulanhcpbedah['tarif'];
					$data['hasil']['nilai'][$i]['biayaasuransiperbulanjshcpbedah'] = $biayaasuransiperbulanjshcpbedah / 12;
				}
				...
				if ($data['hasil']['juatpd'] != "")
				{
					$biayaasuransiperbulantpd = $this->ModSimulasi->getBiayaAsuransiPerBulanTPD($data['hasil']['nilai'][$i-1]['usiacalontertanggung']);
					$biayaasuransiperbulanjstpd = $biayaasuransiperbulantpd[$statuskelamin];
					$data['hasil']['nilai'][$i]['biayaasuransiperbulanjstpd'] = ((($biayaasuransiperbulanjstpd / 1000) * $data['hasil']['juatpd'])/12);
				}
				...
				if ($data['hasil']['juatermlife'] != "")
				{
					$biayaasuransiperbulantermlife = $this->ModSimulasi->getBiayaAsuransiPerBulanTermLife($data['hasil']['nilai'][$i-1]['usiacalontertanggung']);
					$biayaasuransiperbulantl = $biayaasuransiperbulantermlife[$statusperokok];
					$data['hasil']['nilai'][$i]['biayaasuransiperbulantl'] = ((($biayaasuransiperbulantl / 1000) * $data['hasil']['juatermlife'])/12);
				}
				...
				if ($data['hasil']['juapayorbenefitdeath'] != "")
				{
					$biayaasuransiperbulanpbd = $this->ModSimulasi->getBiayaAsuransiPerBulanPBD($data['hasil']['nilai'][$i-1]['usianasabah']);
					$biayaasuransiperbulanjspbd = $biayaasuransiperbulanpbd[$statuskelamin];
					$data['hasil']['nilai'][$i]['biayaasuransiperbulanjspbd'] = ((($biayaasuransiperbulanjspbd / 100) * $data['hasil']['juapayorbenefitdeath'])/12);
				}
				...
				if ($data['hasil']['juapayorbenefittpd'] != "")
				{
					$biayaasuransiperbulanpbtpd = $this->ModSimulasi->getBiayaAsuransiPerBulanPBTPD($data['hasil']['nilai'][$i-1]['usianasabah']);
					$biayaasuransiperbulanjspbtpd = $biayaasuransiperbulanpbtpd[$statuskelamin];
					$data['hasil']['nilai'][$i]['biayaasuransiperbulanjspbtpd'] = ((($biayaasuransiperbulanjspbtpd/ 100) * $data['hasil']['juapayorbenefittpd'])/12);
				}
				...
				if ($data['hasil']['juaspousepayordeath'] != "")
				{
					$biayaasuransiperbulanspd = $this->ModSimulasi->getBiayaAsuransiPerBulanSPD($data['hasil']['nilai'][$i-1]['usianasabah']);
					$biayaasuransiperbulanjsspd = $biayaasuransiperbulanspd[$statuskelamin];
					$data['hasil']['nilai'][$i]['biayaasuransiperbulanjsspd'] = ((($biayaasuransiperbulanjsspd/ 100) * $data['hasil']['juaspousepayordeath'])/12);
				}
				...
				if ($data['hasil']['juaspousepayortpd'] != "")
				{
					$biayaasuransiperbulansptpd = $this->ModSimulasi->getBiayaAsuransiPerBulanSPTPD($data['hasil']['nilai'][$i-1]['usianasabah']);
					$biayaasuransiperbulanjssptpd = $biayaasuransiperbulansptpd[$statuskelamin];
					$data['hasil']['nilai'][$i]['biayaasuransiperbulanjssptpd'] = ((($biayaasuransiperbulanjssptpd/ 100) * $data['hasil']['juaspousepayortpd'])/12);
				}
				
				$data['hasil']['nilai'][$i]['totalbiaya'] = $data['hasil']['nilai'][$i]['biayaasuransiperbulanad'] + $data['hasil']['nilai'][$i]['biayaasuransiperbulanjsaddb'] + 
															$data['hasil']['nilai'][$i]['biayaasuransiperbulanjsci53'] + $data['hasil']['nilai'][$i]['biayaasuransiperbulanjshcp'] +
															$data['hasil']['nilai'][$i]['biayaasuransiperbulanjshcpbedah'] + $data['hasil']['nilai'][$i]['biayaasuransiperbulanjstpd'] +
															$data['hasil']['nilai'][$i]['biayaasuransiperbulantl'] + $data['hasil']['nilai'][$i]['biayaasuransiperbulanjspbd'] + 
															$data['hasil']['nilai'][$i]['biayaasuransiperbulanjspbtpd'] + $data['hasil']['nilai'][$i]['biayaasuransiperbulanjsspd'] +
															$data['hasil']['nilai'][$i]['biayaasuransiperbulanjssptpd'] + 27500; 
															
				//MANFAAT INVESTASI RENDAH
								
				$data['hasil']['nilai'][2]['manfaatinvestasirendah'] = 	(((((((((((((((((((((((($data['hasil']['nilai'][1]['manfaatinvestasirendah'] + (50 / 100 * $data['hasil']['nilai'][2]['premiberkala']) + (95 / 100 * $data['hasil']['nilai'][2]['topupberkala']) - ($data['hasil']['nilai'][2]['totalbiaya'] + $data['hasil']['nilai'][3]['totalbiaya'])) * (1+(($data['hasil']['asumsi_inv_min1']/100)/12))) 
																		+ (50 / 100 * $data['hasil']['nilai'][2]['premiberkala']) + (95 / 100 * $data['hasil']['nilai'][2]['topupberkala']) - ($data['hasil']['nilai'][2]['totalbiaya'] + $data['hasil']['nilai'][3]['totalbiaya'])) * (1+(($data['hasil']['asumsi_inv_min1']/100)/12)))
																		+ (50 / 100 * $data['hasil']['nilai'][2]['premiberkala']) + (95 / 100 * $data['hasil']['nilai'][2]['topupberkala']) - ($data['hasil']['nilai'][2]['totalbiaya'] + $data['hasil']['nilai'][3]['totalbiaya'])) * (1+(($data['hasil']['asumsi_inv_min1']/100)/12)))
																		+ (50 / 100 * $data['hasil']['nilai'][2]['premiberkala']) + (95 / 100 * $data['hasil']['nilai'][2]['topupberkala']) - ($data['hasil']['nilai'][2]['totalbiaya'] + $data['hasil']['nilai'][3]['totalbiaya'])) * (1+(($data['hasil']['asumsi_inv_min1']/100)/12)))
																		+ (50 / 100 * $data['hasil']['nilai'][2]['premiberkala']) + (95 / 100 * $data['hasil']['nilai'][2]['topupberkala']) - ($data['hasil']['nilai'][2]['totalbiaya'] + $data['hasil']['nilai'][3]['totalbiaya'])) * (1+(($data['hasil']['asumsi_inv_min1']/100)/12)))
																		+ (50 / 100 * $data['hasil']['nilai'][2]['premiberkala']) + (95 / 100 * $data['hasil']['nilai'][2]['topupberkala']) - ($data['hasil']['nilai'][2]['totalbiaya'] + $data['hasil']['nilai'][3]['totalbiaya'])) * (1+(($data['hasil']['asumsi_inv_min1']/100)/12)))
				...
				//MANFAAT INVESTASI SEDANG
				
				$data['hasil']['nilai'][2]['manfaatinvestasisedang'] = 	(((((((((((((((((((((((($data['hasil']['nilai'][1]['manfaatinvestasisedang'] + (50 / 100 * $data['hasil']['nilai'][2]['premiberkala']) + (95 / 100 * $data['hasil']['nilai'][2]['topupberkala']) - ($data['hasil']['nilai'][2]['totalbiaya'] + $data['hasil']['nilai'][3]['totalbiaya'])) * (1+(($data['hasil']['asumsi_inv_med1']/100)/12))) 
																		+ (50 / 100 * $data['hasil']['nilai'][2]['premiberkala']) + (95 / 100 * $data['hasil']['nilai'][2]['topupberkala']) - ($data['hasil']['nilai'][2]['totalbiaya'] + $data['hasil']['nilai'][3]['totalbiaya'])) * (1+(($data['hasil']['asumsi_inv_med1']/100)/12)))
																		+ (50 / 100 * $data['hasil']['nilai'][2]['premiberkala']) + (95 / 100 * $data['hasil']['nilai'][2]['topupberkala']) - ($data['hasil']['nilai'][2]['totalbiaya'] + $data['hasil']['nilai'][3]['totalbiaya'])) * (1+(($data['hasil']['asumsi_inv_med1']/100)/12)))
																		+ (50 / 100 * $data['hasil']['nilai'][2]['premiberkala']) + (95 / 100 * $data['hasil']['nilai'][2]['topupberkala']) - ($data['hasil']['nilai'][2]['totalbiaya'] + $data['hasil']['nilai'][3]['totalbiaya'])) * (1+(($data['hasil']['asumsi_inv_med1']/100)/12)))
																		+ (50 / 100 * $data['hasil']['nilai'][2]['premiberkala']) + (95 / 100 * $data['hasil']['nilai'][2]['topupberkala']) - ($data['hasil']['nilai'][2]['totalbiaya'] + $data['hasil']['nilai'][3]['totalbiaya'])) * (1+(($data['hasil']['asumsi_inv_med1']/100)/12)))
																		+ (50 / 100 * $data['hasil']['nilai'][2]['premiberkala']) + (95 / 100 * $data['hasil']['nilai'][2]['topupberkala']) - ($data['hasil']['nilai'][2]['totalbiaya'] + $data['hasil']['nilai'][3]['totalbiaya'])) * (1+(($data['hasil']['asumsi_inv_med1']/100)/12)))
				...
				$data['hasil']['nilai'][2]['manfaatinvestasisedang2'] = (((((((((((((((((((((((($data['hasil']['nilai'][1]['manfaatinvestasisedang2'] + (50 / 100 * $data['hasil']['nilai'][2]['premiberkala']) + (95 / 100 * $data['hasil']['nilai'][2]['topupberkala']) - ($data['hasil']['nilai'][2]['totalbiaya'] + $data['hasil']['nilai'][3]['totalbiaya'])) * (1+(($data['hasil']['asumsi_inv_med2']/100)/12))) 
																		+ (50 / 100 * $data['hasil']['nilai'][2]['premiberkala']) + (95 / 100 * $data['hasil']['nilai'][2]['topupberkala']) - ($data['hasil']['nilai'][2]['totalbiaya'] + $data['hasil']['nilai'][3]['totalbiaya'])) * (1+(($data['hasil']['asumsi_inv_med2']/100)/12)))
																		+ (50 / 100 * $data['hasil']['nilai'][2]['premiberkala']) + (95 / 100 * $data['hasil']['nilai'][2]['topupberkala']) - ($data['hasil']['nilai'][2]['totalbiaya'] + $data['hasil']['nilai'][3]['totalbiaya'])) * (1+(($data['hasil']['asumsi_inv_med2']/100)/12)))
																		+ (50 / 100 * $data['hasil']['nilai'][2]['premiberkala']) + (95 / 100 * $data['hasil']['nilai'][2]['topupberkala']) - ($data['hasil']['nilai'][2]['totalbiaya'] + $data['hasil']['nilai'][3]['totalbiaya'])) * (1+(($data['hasil']['asumsi_inv_med2']/100)/12)))
																		+ (50 / 100 * $data['hasil']['nilai'][2]['premiberkala']) + (95 / 100 * $data['hasil']['nilai'][2]['topupberkala']) - ($data['hasil']['nilai'][2]['totalbiaya'] + $data['hasil']['nilai'][3]['totalbiaya'])) * (1+(($data['hasil']['asumsi_inv_med2']/100)/12)))
																		+ (50 / 100 * $data['hasil']['nilai'][2]['premiberkala']) + (95 / 100 * $data['hasil']['nilai'][2]['topupberkala']) - ($data['hasil']['nilai'][2]['totalbiaya'] + $data['hasil']['nilai'][3]['totalbiaya'])) * (1+(($data['hasil']['asumsi_inv_med2']/100)/12)))
				...
				//MANFAAT INVESTASI TINGGI
				
				$data['hasil']['nilai'][2]['manfaatinvestasitinggi'] = 	(((((((((((((((((((((((($data['hasil']['nilai'][1]['manfaatinvestasitinggi'] + (50 / 100 * $data['hasil']['nilai'][2]['premiberkala']) + (95 / 100 * $data['hasil']['nilai'][2]['topupberkala']) - ($data['hasil']['nilai'][2]['totalbiaya'] + $data['hasil']['nilai'][3]['totalbiaya'])) * (1+(($data['hasil']['asumsi_inv_max1']/100)/12))) 
																		+ (50 / 100 * $data['hasil']['nilai'][2]['premiberkala']) + (95 / 100 * $data['hasil']['nilai'][2]['topupberkala']) - ($data['hasil']['nilai'][2]['totalbiaya'] + $data['hasil']['nilai'][3]['totalbiaya'])) * (1+(($data['hasil']['asumsi_inv_max1']/100)/12)))
																		+ (50 / 100 * $data['hasil']['nilai'][2]['premiberkala']) + (95 / 100 * $data['hasil']['nilai'][2]['topupberkala']) - ($data['hasil']['nilai'][2]['totalbiaya'] + $data['hasil']['nilai'][3]['totalbiaya'])) * (1+(($data['hasil']['asumsi_inv_max1']/100)/12)))
																		+ (50 / 100 * $data['hasil']['nilai'][2]['premiberkala']) + (95 / 100 * $data['hasil']['nilai'][2]['topupberkala']) - ($data['hasil']['nilai'][2]['totalbiaya'] + $data['hasil']['nilai'][3]['totalbiaya'])) * (1+(($data['hasil']['asumsi_inv_max1']/100)/12)))
																		+ (50 / 100 * $data['hasil']['nilai'][2]['premiberkala']) + (95 / 100 * $data['hasil']['nilai'][2]['topupberkala']) - ($data['hasil']['nilai'][2]['totalbiaya'] + $data['hasil']['nilai'][3]['totalbiaya'])) * (1+(($data['hasil']['asumsi_inv_max1']/100)/12)))
																		+ (50 / 100 * $data['hasil']['nilai'][2]['premiberkala']) + (95 / 100 * $data['hasil']['nilai'][2]['topupberkala']) - ($data['hasil']['nilai'][2]['totalbiaya'] + $data['hasil']['nilai'][3]['totalbiaya'])) * (1+(($data['hasil']['asumsi_inv_max1']/100)/12)))
				...
				$data['hasil']['nilai'][2]['manfaatinvestasitinggi2'] = (((((((((((((((((((((((($data['hasil']['nilai'][1]['manfaatinvestasitinggi2'] + (50 / 100 * $data['hasil']['nilai'][2]['premiberkala']) + (95 / 100 * $data['hasil']['nilai'][2]['topupberkala']) - ($data['hasil']['nilai'][2]['totalbiaya'] + $data['hasil']['nilai'][3]['totalbiaya'])) * (1+(($data['hasil']['asumsi_inv_max2']/100)/12))) 
																		+ (50 / 100 * $data['hasil']['nilai'][2]['premiberkala']) + (95 / 100 * $data['hasil']['nilai'][2]['topupberkala']) - ($data['hasil']['nilai'][2]['totalbiaya'] + $data['hasil']['nilai'][3]['totalbiaya'])) * (1+(($data['hasil']['asumsi_inv_max2']/100)/12)))
																		+ (50 / 100 * $data['hasil']['nilai'][2]['premiberkala']) + (95 / 100 * $data['hasil']['nilai'][2]['topupberkala']) - ($data['hasil']['nilai'][2]['totalbiaya'] + $data['hasil']['nilai'][3]['totalbiaya'])) * (1+(($data['hasil']['asumsi_inv_max2']/100)/12)))
																		+ (50 / 100 * $data['hasil']['nilai'][2]['premiberkala']) + (95 / 100 * $data['hasil']['nilai'][2]['topupberkala']) - ($data['hasil']['nilai'][2]['totalbiaya'] + $data['hasil']['nilai'][3]['totalbiaya'])) * (1+(($data['hasil']['asumsi_inv_max2']/100)/12)))
																		+ (50 / 100 * $data['hasil']['nilai'][2]['premiberkala']) + (95 / 100 * $data['hasil']['nilai'][2]['topupberkala']) - ($data['hasil']['nilai'][2]['totalbiaya'] + $data['hasil']['nilai'][3]['totalbiaya'])) * (1+(($data['hasil']['asumsi_inv_max2']/100)/12)))
																		+ (50 / 100 * $data['hasil']['nilai'][2]['premiberkala']) + (95 / 100 * $data['hasil']['nilai'][2]['topupberkala']) - ($data['hasil']['nilai'][2]['totalbiaya'] + $data['hasil']['nilai'][3]['totalbiaya'])) * (1+(($data['hasil']['asumsi_inv_max2']/100)/12)))
				...
				//MANFAAT MENINGGAL DUNIA RENDAH
				
				$data['hasil']['nilai'][2]['manfaatmeninggalduniarendah'] = $data['hasil']['uangpertanggungan'] +  $data['hasil']['nilai'][2]['manfaatinvestasirendah'];
				
				$data['hasil']['nilai'][2]['manfaatmeninggalduniarendah2'] = $data['hasil']['uangpertanggungan'] +  $data['hasil']['nilai'][2]['manfaatinvestasirendah2'];
				
				//MANFAAT MENINGGAL DUNIA SEDANG
				
				$data['hasil']['nilai'][2]['manfaatmeninggalduniasedang'] = $data['hasil']['uangpertanggungan'] +  $data['hasil']['nilai'][2]['manfaatinvestasisedang'];
				
				$data['hasil']['nilai'][2]['manfaatmeninggalduniasedang2'] = $data['hasil']['uangpertanggungan'] +  $data['hasil']['nilai'][2]['manfaatinvestasisedang2'];
				
				//MANFAAT MENINGGAL DUNIA TINGGI
				
				$data['hasil']['nilai'][2]['manfaatmeninggalduniatinggi'] = $data['hasil']['uangpertanggungan'] +  $data['hasil']['nilai'][2]['manfaatinvestasitinggi'];
				
				$data['hasil']['nilai'][2]['manfaatmeninggalduniatinggi2'] = $data['hasil']['uangpertanggungan'] +  $data['hasil']['nilai'][2]['manfaatinvestasitinggi2'];
				
				
				if ($data['hasil']['nilai'][2]['manfaatinvestasirendah'] < 0) 
				{
					$data['hasil']['nilai'][2]['manfaatinvestasirendah'] = 0;
					$data['hasil']['nilai'][2]['manfaatmeninggalduniarendah'] = 0;
				}
				if ($data['hasil']['nilai'][2]['manfaatinvestasisedang'] < 0) 
				{
					$data['hasil']['nilai'][2]['manfaatinvestasisedang'] = 0;
					$data['hasil']['nilai'][2]['manfaatmeninggalduniasedang'] = 0;
				}
				if ($data['hasil']['nilai'][2]['manfaatinvestasitinggi'] < 0) 
				{
					$data['hasil']['nilai'][2]['manfaatinvestasitinggi'] = 0;
					$data['hasil']['nilai'][2]['manfaatmeninggalduniatinggi'] = 0;
				}
				if ($data['hasil']['nilai'][2]['manfaatmeninggalduniarendah'] < 0) 
				{
					$data['hasil']['nilai'][2]['manfaatmeninggalduniarendah'] = 0;
				}
				if ($data['hasil']['nilai'][2]['manfaatmeninggalduniasedang'] < 0) 
				{
					$data['hasil']['nilai'][2]['manfaatmeninggalduniasedang'] = 0;
				}
				if ($data['hasil']['nilai'][2]['manfaatmeninggalduniatinggi'] < 0) 
				{
					$data['hasil']['nilai'][2]['manfaatmeninggalduniatinggi'] = 0;
				}
				...
				if ($data['hasil']['nilai'][2]['manfaatinvestasirendah2'] < 0) 
				{
					$data['hasil']['nilai'][2]['manfaatinvestasirendah2'] = 0;
					$data['hasil']['nilai'][2]['manfaatmeninggalduniarendah2'] = 0;
				}
				if ($data['hasil']['nilai'][2]['manfaatinvestasisedang2'] < 0) 
				{
					$data['hasil']['nilai'][2]['manfaatinvestasisedang2'] = 0;
					$data['hasil']['nilai'][2]['manfaatmeninggalduniasedang2'] = 0;
				}
				if ($data['hasil']['nilai'][2]['manfaatinvestasitinggi2'] < 0) 
				{
					$data['hasil']['nilai'][2]['manfaatinvestasitinggi2'] = 0;
					$data['hasil']['nilai'][2]['manfaatmeninggalduniatinggi2'] = 0;
				}
				if ($data['hasil']['nilai'][2]['manfaatmeninggalduniarendah2'] < 0) 
				{
					$data['hasil']['nilai'][2]['manfaatmeninggalduniarendah2'] = 0;
				}
				if ($data['hasil']['nilai'][2]['manfaatmeninggalduniasedang2'] < 0) 
				{
					$data['hasil']['nilai'][2]['manfaatmeninggalduniasedang2'] = 0;
				}
				if ($data['hasil']['nilai'][2]['manfaatmeninggalduniatinggi2'] < 0) 
				{
					$data['hasil']['nilai'][2]['manfaatmeninggalduniatinggi2'] = 0;
				}
				...
				$data['hasil']['nilai'][2]['manfaatinvestasirendahringkasan'] = $data['hasil']['nilai'][2]['manfaatinvestasirendah'] * ($data['hasil']['persentasealokasidana1'] / 100) + $data['hasil']['nilai'][2]['manfaatinvestasirendah2'] * ($data['hasil']['persentasealokasidana2'] / 100);
				
				$data['hasil']['nilai'][2]['manfaatinvestasisedangringkasan'] = $data['hasil']['nilai'][2]['manfaatinvestasisedang'] * ($data['hasil']['persentasealokasidana1'] / 100)  + $data['hasil']['nilai'][2]['manfaatinvestasisedang2'] * ($data['hasil']['persentasealokasidana2'] / 100);
				
				$data['hasil']['nilai'][2]['manfaatinvestasitinggiringkasan'] = $data['hasil']['nilai'][2]['manfaatinvestasitinggi'] * ($data['hasil']['persentasealokasidana1'] / 100)  + $data['hasil']['nilai'][2]['manfaatinvestasitinggi2'] * ($data['hasil']['persentasealokasidana2'] / 100);
				
				//MANFAAT MENINGGAL DUNIA RINGKASAN
				$data['hasil']['nilai'][2]['manfaatmeninggalduniarendahringkasan'] = $data['hasil']['nilai'][2]['manfaatmeninggalduniarendah'] * ($data['hasil']['persentasealokasidana1'] / 100)  + $data['hasil']['nilai'][2]['manfaatmeninggalduniarendah2'] * ($data['hasil']['persentasealokasidana2'] / 100);
				
				$data['hasil']['nilai'][2]['manfaatmeninggalduniasedangringkasan'] = $data['hasil']['nilai'][2]['manfaatmeninggalduniasedang'] * ($data['hasil']['persentasealokasidana1'] / 100)  + $data['hasil']['nilai'][2]['manfaatmeninggalduniasedang2'] * ($data['hasil']['persentasealokasidana2'] / 100);
				
				//KOMPARASI RINGKASAN
				
				if ($data['hasil']['nilai'][2]['manfaatinvestasirendahkomparasiringkasan'] < 0) 
				{
					$data['hasil']['nilai'][2]['manfaatinvestasirendahkomparasiringkasan'] = 0;
					$data['hasil']['nilai'][2]['manfaatmeninggalduniarendahkomparasiringkasan'] = 0;
				}
				if ($data['hasil']['nilai'][2]['manfaatinvestasisedangkomparasiringkasan'] < 0) 
				{
					$data['hasil']['nilai'][2]['manfaatinvestasisedangkomparasiringkasan'] = 0;
					$data['hasil']['nilai'][2]['manfaatmeninggalduniasedangkomparasiringkasan'] = 0;
				}
				if ($data['hasil']['nilai'][2]['manfaatinvestasitinggikomparasiringkasan'] < 0) 
				{
					$data['hasil']['nilai'][2]['manfaatinvestasitinggikomparasiringkasan'] = 0;
					$data['hasil']['nilai'][2]['manfaatmeninggalduniatinggikomparasiringkasan'] = 0;
				}
				if ($data['hasil']['nilai'][2]['manfaatmeninggalduniarendahkomparasiringkasan'] < 0) 
				{
					$data['hasil']['nilai'][2]['manfaatmeninggalduniarendahkomparasiringkasan'] = 0;
				}
				if ($data['hasil']['nilai'][2]['manfaatmeninggalduniasedangkomparasiringkasan'] < 0) 
				{
					$data['hasil']['nilai'][2]['manfaatmeninggalduniasedangkomparasiringkasan'] = 0;
				}
				if ($data['hasil']['nilai'][2]['manfaatmeninggalduniatinggikomparasiringkasan'] < 0) 
				{
					$data['hasil']['nilai'][2]['manfaatmeninggalduniatinggikomparasiringkasan'] = 0;
				}
				...
				if ($data['hasil']['nilai'][2]['manfaatinvestasirendahkomparasiringkasan2'] < 0) 
				{
					$data['hasil']['nilai'][2]['manfaatinvestasirendahkomparasiringkasan2'] = 0;
					$data['hasil']['nilai'][2]['manfaatmeninggalduniarendahkomparasiringkasan2'] = 0;
				}
				if ($data['hasil']['nilai'][2]['manfaatinvestasisedangkomparasiringkasan2'] < 0) 
				{
					$data['hasil']['nilai'][2]['manfaatinvestasisedangkomparasiringkasan2'] = 0;
					$data['hasil']['nilai'][2]['manfaatmeninggalduniasedangkomparasiringkasan2'] = 0;
				}
				if ($data['hasil']['nilai'][2]['manfaatinvestasitinggikomparasiringkasan2'] < 0) 
				{
					$data['hasil']['nilai'][2]['manfaatinvestasitinggikomparasiringkasan2'] = 0;
					$data['hasil']['nilai'][2]['manfaatmeninggalduniatinggikomparasiringkasan2'] = 0;
				}
				if ($data['hasil']['nilai'][2]['manfaatmeninggalduniarendahkomparasiringkasan2'] < 0) 
				{
					$data['hasil']['nilai'][2]['manfaatmeninggalduniarendahkomparasiringkasan2'] = 0;
				}
				if ($data['hasil']['nilai'][2]['manfaatmeninggalduniasedangkomparasiringkasan2'] < 0) 
				{
					$data['hasil']['nilai'][2]['manfaatmeninggalduniasedangkomparasiringkasan2'] = 0;
				}
				if ($data['hasil']['nilai'][2]['manfaatmeninggalduniatinggikomparasiringkasan2'] < 0) 
				{
					$data['hasil']['nilai'][2]['manfaatmeninggalduniatinggikomparasiringkasan2'] = 0;
				}
								
				$data['hasil']['nilai'][2]['manfaatinvestasirendahkomparasiringkasan'] = 	(((((((((((((((((((((((($data['hasil']['nilai'][1]['manfaatinvestasirendahkomparasiringkasan'] + (50 / 100 * $data['hasil']['nilai'][2]['premiberkalakomparasiringkasan']) + (95 / 100 * $data['hasil']['nilai'][2]['topupberkala']) - ($data['hasil']['nilai'][2]['totalbiaya'] + $data['hasil']['nilai'][3]['totalbiaya'])) * (1+(($data['hasil']['asumsi_inv_min1']/100)/12))) 
																		+ (50 / 100 * $data['hasil']['nilai'][2]['premiberkalakomparasiringkasan']) + (95 / 100 * $data['hasil']['nilai'][2]['topupberkala']) - ($data['hasil']['nilai'][2]['totalbiaya'] + $data['hasil']['nilai'][3]['totalbiaya'])) * (1+(($data['hasil']['asumsi_inv_min1']/100)/12)))
																		+ (50 / 100 * $data['hasil']['nilai'][2]['premiberkalakomparasiringkasan']) + (95 / 100 * $data['hasil']['nilai'][2]['topupberkala']) - ($data['hasil']['nilai'][2]['totalbiaya'] + $data['hasil']['nilai'][3]['totalbiaya'])) * (1+(($data['hasil']['asumsi_inv_min1']/100)/12)))
																		+ (50 / 100 * $data['hasil']['nilai'][2]['premiberkalakomparasiringkasan']) + (95 / 100 * $data['hasil']['nilai'][2]['topupberkala']) - ($data['hasil']['nilai'][2]['totalbiaya'] + $data['hasil']['nilai'][3]['totalbiaya'])) * (1+(($data['hasil']['asumsi_inv_min1']/100)/12)))
																		+ (50 / 100 * $data['hasil']['nilai'][2]['premiberkalakomparasiringkasan']) + (95 / 100 * $data['hasil']['nilai'][2]['topupberkala']) - ($data['hasil']['nilai'][2]['totalbiaya'] + $data['hasil']['nilai'][3]['totalbiaya'])) * (1+(($data['hasil']['asumsi_inv_min1']/100)/12)))
																		+ (50 / 100 * $data['hasil']['nilai'][2]['premiberkalakomparasiringkasan']) + (95 / 100 * $data['hasil']['nilai'][2]['topupberkala']) - ($data['hasil']['nilai'][2]['totalbiaya'] + $data['hasil']['nilai'][3]['totalbiaya'])) * (1+(($data['hasil']['asumsi_inv_min1']/100)/12)))
				...
				$data['hasil']['nilai'][2]['manfaatinvestasirendahkomparasiringkasan2'] = (((((((((((((((((((((((($data['hasil']['nilai'][1]['manfaatinvestasirendahkomparasiringkasan2'] + (50 / 100 * $data['hasil']['nilai'][2]['premiberkalakomparasiringkasan']) + (95 / 100 * $data['hasil']['nilai'][2]['topupberkala']) - ($data['hasil']['nilai'][2]['totalbiaya'] + $data['hasil']['nilai'][3]['totalbiaya'])) * (1+(($data['hasil']['asumsi_inv_min2']/100)/12))) 
																		+ (50 / 100 * $data['hasil']['nilai'][2]['premiberkalakomparasiringkasan']) + (95 / 100 * $data['hasil']['nilai'][2]['topupberkala']) - ($data['hasil']['nilai'][2]['totalbiaya'] + $data['hasil']['nilai'][3]['totalbiaya'])) * (1+(($data['hasil']['asumsi_inv_min2']/100)/12)))
																		+ (50 / 100 * $data['hasil']['nilai'][2]['premiberkalakomparasiringkasan']) + (95 / 100 * $data['hasil']['nilai'][2]['topupberkala']) - ($data['hasil']['nilai'][2]['totalbiaya'] + $data['hasil']['nilai'][3]['totalbiaya'])) * (1+(($data['hasil']['asumsi_inv_min2']/100)/12)))
																		+ (50 / 100 * $data['hasil']['nilai'][2]['premiberkalakomparasiringkasan']) + (95 / 100 * $data['hasil']['nilai'][2]['topupberkala']) - ($data['hasil']['nilai'][2]['totalbiaya'] + $data['hasil']['nilai'][3]['totalbiaya'])) * (1+(($data['hasil']['asumsi_inv_min2']/100)/12)))
																		+ (50 / 100 * $data['hasil']['nilai'][2]['premiberkalakomparasiringkasan']) + (95 / 100 * $data['hasil']['nilai'][2]['topupberkala']) - ($data['hasil']['nilai'][2]['totalbiaya'] + $data['hasil']['nilai'][3]['totalbiaya'])) * (1+(($data['hasil']['asumsi_inv_min2']/100)/12)))
																		+ (50 / 100 * $data['hasil']['nilai'][2]['premiberkalakomparasiringkasan']) + (95 / 100 * $data['hasil']['nilai'][2]['topupberkala']) - ($data['hasil']['nilai'][2]['totalbiaya'] + $data['hasil']['nilai'][3]['totalbiaya'])) * (1+(($data['hasil']['asumsi_inv_min2']/100)/12)))
				...
				$data['hasil']['nilai'][2]['manfaatinvestasirendahkr'] = $data['hasil']['nilai'][2]['manfaatinvestasirendahkomparasiringkasan'] * ($data['hasil']['persentasealokasidana1'] / 100) + $data['hasil']['nilai'][2]['manfaatinvestasirendahkomparasiringkasan2'] * ($data['hasil']['persentasealokasidana2'] / 100);
				
				$data['hasil']['nilai'][2]['manfaatinvestasisedangkomparasiringkasan'] = 	(((((((((((((((((((((((($data['hasil']['nilai'][1]['manfaatinvestasisedangkomparasiringkasan'] + (50 / 100 * $data['hasil']['nilai'][2]['premiberkalakomparasiringkasan']) + (95 / 100 * $data['hasil']['nilai'][2]['topupberkala']) - ($data['hasil']['nilai'][2]['totalbiaya'] + $data['hasil']['nilai'][3]['totalbiaya'])) * (1+(($data['hasil']['asumsi_inv_med1']/100)/12))) 
																		+ (50 / 100 * $data['hasil']['nilai'][2]['premiberkalakomparasiringkasan']) + (95 / 100 * $data['hasil']['nilai'][2]['topupberkala']) - ($data['hasil']['nilai'][2]['totalbiaya'] + $data['hasil']['nilai'][3]['totalbiaya'])) * (1+(($data['hasil']['asumsi_inv_med1']/100)/12)))
																		+ (50 / 100 * $data['hasil']['nilai'][2]['premiberkalakomparasiringkasan']) + (95 / 100 * $data['hasil']['nilai'][2]['topupberkala']) - ($data['hasil']['nilai'][2]['totalbiaya'] + $data['hasil']['nilai'][3]['totalbiaya'])) * (1+(($data['hasil']['asumsi_inv_med1']/100)/12)))
																		+ (50 / 100 * $data['hasil']['nilai'][2]['premiberkalakomparasiringkasan']) + (95 / 100 * $data['hasil']['nilai'][2]['topupberkala']) - ($data['hasil']['nilai'][2]['totalbiaya'] + $data['hasil']['nilai'][3]['totalbiaya'])) * (1+(($data['hasil']['asumsi_inv_med1']/100)/12)))
																		+ (50 / 100 * $data['hasil']['nilai'][2]['premiberkalakomparasiringkasan']) + (95 / 100 * $data['hasil']['nilai'][2]['topupberkala']) - ($data['hasil']['nilai'][2]['totalbiaya'] + $data['hasil']['nilai'][3]['totalbiaya'])) * (1+(($data['hasil']['asumsi_inv_med1']/100)/12)))
																		+ (50 / 100 * $data['hasil']['nilai'][2]['premiberkalakomparasiringkasan']) + (95 / 100 * $data['hasil']['nilai'][2]['topupberkala']) - ($data['hasil']['nilai'][2]['totalbiaya'] + $data['hasil']['nilai'][3]['totalbiaya'])) * (1+(($data['hasil']['asumsi_inv_med1']/100)/12)))
				...
				$data['hasil']['nilai'][2]['manfaatinvestasisedangkomparasiringkasan2'] = (((((((((((((((((((((((($data['hasil']['nilai'][1]['manfaatinvestasisedangkomparasiringkasan2'] + (50 / 100 * $data['hasil']['nilai'][2]['premiberkalakomparasiringkasan']) + (95 / 100 * $data['hasil']['nilai'][2]['topupberkala']) - ($data['hasil']['nilai'][2]['totalbiaya'] + $data['hasil']['nilai'][3]['totalbiaya'])) * (1+(($data['hasil']['asumsi_inv_med2']/100)/12))) 
																		+ (50 / 100 * $data['hasil']['nilai'][2]['premiberkalakomparasiringkasan']) + (95 / 100 * $data['hasil']['nilai'][2]['topupberkala']) - ($data['hasil']['nilai'][2]['totalbiaya'] + $data['hasil']['nilai'][3]['totalbiaya'])) * (1+(($data['hasil']['asumsi_inv_med2']/100)/12)))
																		+ (50 / 100 * $data['hasil']['nilai'][2]['premiberkalakomparasiringkasan']) + (95 / 100 * $data['hasil']['nilai'][2]['topupberkala']) - ($data['hasil']['nilai'][2]['totalbiaya'] + $data['hasil']['nilai'][3]['totalbiaya'])) * (1+(($data['hasil']['asumsi_inv_med2']/100)/12)))
																		+ (50 / 100 * $data['hasil']['nilai'][2]['premiberkalakomparasiringkasan']) + (95 / 100 * $data['hasil']['nilai'][2]['topupberkala']) - ($data['hasil']['nilai'][2]['totalbiaya'] + $data['hasil']['nilai'][3]['totalbiaya'])) * (1+(($data['hasil']['asumsi_inv_med2']/100)/12)))
																		+ (50 / 100 * $data['hasil']['nilai'][2]['premiberkalakomparasiringkasan']) + (95 / 100 * $data['hasil']['nilai'][2]['topupberkala']) - ($data['hasil']['nilai'][2]['totalbiaya'] + $data['hasil']['nilai'][3]['totalbiaya'])) * (1+(($data['hasil']['asumsi_inv_med2']/100)/12)))
																		+ (50 / 100 * $data['hasil']['nilai'][2]['premiberkalakomparasiringkasan']) + (95 / 100 * $data['hasil']['nilai'][2]['topupberkala']) - ($data['hasil']['nilai'][2]['totalbiaya'] + $data['hasil']['nilai'][3]['totalbiaya'])) * (1+(($data['hasil']['asumsi_inv_med2']/100)/12)))
				...
				$data['hasil']['nilai'][2]['manfaatinvestasitinggikomparasiringkasan'] = 	(((((((((((((((((((((((($data['hasil']['nilai'][1]['manfaatinvestasitinggikomparasiringkasan'] + (50 / 100 * $data['hasil']['nilai'][2]['premiberkalakomparasiringkasan']) + (95 / 100 * $data['hasil']['nilai'][2]['topupberkala']) - ($data['hasil']['nilai'][2]['totalbiaya'] + $data['hasil']['nilai'][3]['totalbiaya'])) * (1+(($data['hasil']['asumsi_inv_max1']/100)/12))) 
																		+ (50 / 100 * $data['hasil']['nilai'][2]['premiberkalakomparasiringkasan']) + (95 / 100 * $data['hasil']['nilai'][2]['topupberkala']) - ($data['hasil']['nilai'][2]['totalbiaya'] + $data['hasil']['nilai'][3]['totalbiaya'])) * (1+(($data['hasil']['asumsi_inv_max1']/100)/12)))
																		+ (50 / 100 * $data['hasil']['nilai'][2]['premiberkalakomparasiringkasan']) + (95 / 100 * $data['hasil']['nilai'][2]['topupberkala']) - ($data['hasil']['nilai'][2]['totalbiaya'] + $data['hasil']['nilai'][3]['totalbiaya'])) * (1+(($data['hasil']['asumsi_inv_max1']/100)/12)))
																		+ (50 / 100 * $data['hasil']['nilai'][2]['premiberkalakomparasiringkasan']) + (95 / 100 * $data['hasil']['nilai'][2]['topupberkala']) - ($data['hasil']['nilai'][2]['totalbiaya'] + $data['hasil']['nilai'][3]['totalbiaya'])) * (1+(($data['hasil']['asumsi_inv_max1']/100)/12)))
																		+ (50 / 100 * $data['hasil']['nilai'][2]['premiberkalakomparasiringkasan']) + (95 / 100 * $data['hasil']['nilai'][2]['topupberkala']) - ($data['hasil']['nilai'][2]['totalbiaya'] + $data['hasil']['nilai'][3]['totalbiaya'])) * (1+(($data['hasil']['asumsi_inv_max1']/100)/12)))
																		+ (50 / 100 * $data['hasil']['nilai'][2]['premiberkalakomparasiringkasan']) + (95 / 100 * $data['hasil']['nilai'][2]['topupberkala']) - ($data['hasil']['nilai'][2]['totalbiaya'] + $data['hasil']['nilai'][3]['totalbiaya'])) * (1+(($data['hasil']['asumsi_inv_max1']/100)/12)))
				...
				$data['hasil']['nilai'][2]['manfaatinvestasitinggikomparasiringkasan2'] = (((((((((((((((((((((((($data['hasil']['nilai'][1]['manfaatinvestasitinggikomparasiringkasan2'] + (50 / 100 * $data['hasil']['nilai'][2]['premiberkalakomparasiringkasan']) + (95 / 100 * $data['hasil']['nilai'][2]['topupberkala']) - ($data['hasil']['nilai'][2]['totalbiaya'] + $data['hasil']['nilai'][3]['totalbiaya'])) * (1+(($data['hasil']['asumsi_inv_max2']/100)/12))) 
																		+ (50 / 100 * $data['hasil']['nilai'][2]['premiberkalakomparasiringkasan']) + (95 / 100 * $data['hasil']['nilai'][2]['topupberkala']) - ($data['hasil']['nilai'][2]['totalbiaya'] + $data['hasil']['nilai'][3]['totalbiaya'])) * (1+(($data['hasil']['asumsi_inv_max2']/100)/12)))
																		+ (50 / 100 * $data['hasil']['nilai'][2]['premiberkalakomparasiringkasan']) + (95 / 100 * $data['hasil']['nilai'][2]['topupberkala']) - ($data['hasil']['nilai'][2]['totalbiaya'] + $data['hasil']['nilai'][3]['totalbiaya'])) * (1+(($data['hasil']['asumsi_inv_max2']/100)/12)))
																		+ (50 / 100 * $data['hasil']['nilai'][2]['premiberkalakomparasiringkasan']) + (95 / 100 * $data['hasil']['nilai'][2]['topupberkala']) - ($data['hasil']['nilai'][2]['totalbiaya'] + $data['hasil']['nilai'][3]['totalbiaya'])) * (1+(($data['hasil']['asumsi_inv_max2']/100)/12)))
																		+ (50 / 100 * $data['hasil']['nilai'][2]['premiberkalakomparasiringkasan']) + (95 / 100 * $data['hasil']['nilai'][2]['topupberkala']) - ($data['hasil']['nilai'][2]['totalbiaya'] + $data['hasil']['nilai'][3]['totalbiaya'])) * (1+(($data['hasil']['asumsi_inv_max2']/100)/12)))
																		+ (50 / 100 * $data['hasil']['nilai'][2]['premiberkalakomparasiringkasan']) + (95 / 100 * $data['hasil']['nilai'][2]['topupberkala']) - ($data['hasil']['nilai'][2]['totalbiaya'] + $data['hasil']['nilai'][3]['totalbiaya'])) * (1+(($data['hasil']['asumsi_inv_max2']/100)/12)))
				...
				$data['hasil']['nilai'][2]['manfaatinvestasitinggikr'] = $data['hasil']['nilai'][2]['manfaatinvestasitinggikomparasiringkasan'] * ($data['hasil']['persentasealokasidana1'] / 100) + $data['hasil']['nilai'][2]['manfaatinvestasitinggikomparasiringkasan2'] * ($data['hasil']['persentasealokasidana2'] / 100);
				
				// KOMPARASI RINGKASAN MANFAAT MENINGGAL DUNIA
				$data['hasil']['nilai'][2]['manfaatmeninggalduniarendahkomparasiringkasan'] = $data['hasil']['uangpertanggungan'] +  $data['hasil']['nilai'][2]['manfaatinvestasirendahkomparasiringkasan'];
				
				$data['hasil']['nilai'][2]['manfaatmeninggalduniasedangkomparasiringkasan'] = $data['hasil']['uangpertanggungan'] +  $data['hasil']['nilai'][2]['manfaatinvestasisedangkomparasiringkasan'];
				
				$data['hasil']['nilai'][2]['manfaatmeninggalduniatinggikomparasiringkasan'] = $data['hasil']['uangpertanggungan'] +  $data['hasil']['nilai'][2]['manfaatinvestasitinggikomparasiringkasan'];
				
				$data['hasil']['nilai'][2]['manfaatmeninggalduniarendahkomparasiringkasan2'] = $data['hasil']['uangpertanggungan'] +  $data['hasil']['nilai'][2]['manfaatinvestasirendahkomparasiringkasan2'];
				
				$data['hasil']['nilai'][2]['manfaatmeninggalduniasedangkomparasiringkasan2'] = $data['hasil']['uangpertanggungan'] +  $data['hasil']['nilai'][2]['manfaatinvestasisedangkomparasiringkasan2'];
				
				$data['hasil']['nilai'][2]['manfaatmeninggalduniatinggikomparasiringkasan2'] = $data['hasil']['uangpertanggungan'] +  $data['hasil']['nilai'][2]['manfaatinvestasitinggikomparasiringkasan2'];
					
				$data['hasil']['nilai'][2]['manfaatmeninggalduniarendahkr'] = $data['hasil']['nilai'][2]['manfaatmeninggalduniarendahkomparasiringkasan'] * ($data['hasil']['persentasealokasidana1'] / 100) + $data['hasil']['nilai'][2]['manfaatmeninggalduniarendahkomparasiringkasan2'] * ($data['hasil']['persentasealokasidana2'] / 100);
				
				$data['hasil']['nilai'][2]['manfaatmeninggalduniasedangkr'] = $data['hasil']['nilai'][2]['manfaatmeninggalduniasedangkomparasiringkasan'] * ($data['hasil']['persentasealokasidana1'] / 100) + $data['hasil']['nilai'][2]['manfaatmeninggalduniasedangkomparasiringkasan2'] * ($data['hasil']['persentasealokasidana2'] / 100);
				
				$data['hasil']['nilai'][2]['manfaatmeninggalduniatinggikr'] = $data['hasil']['nilai'][2]['manfaatmeninggalduniatinggikomparasiringkasan'] * ($data['hasil']['persentasealokasidana1'] / 100) + $data['hasil']['nilai'][2]['manfaatmeninggalduniatinggikomparasiringkasan2'] * ($data['hasil']['persentasealokasidana2'] / 100);
		...
		$data['hitung'] = array(
			...
			'CARA_BAYAR' => $data['hasil']['carabayar'],
			'JUMLAH_PREMI' => $data['hasil']['premiberkala']
		);
