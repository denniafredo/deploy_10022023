...
class Optima8 extends CI_Controller{	
	...
	function insertNasabah(){
		...
		//return $data;
		$this->load->view('hasil/optima8',$data);
	}
	
	function detail(){
		$data['details'] = $this->ModSimulasi->getDetailProduct('optima8');
	...
	function createPDF($namaFile,$data){
		...
		$this->pdf->ln();
		$this->pdf->Cell(15);
		$this->pdf->Cell(160,10,'JS Plan Optima 8',0,0,'C');
		$this->pdf->ln();
		$this->pdf->ln();
		// Judul Proposal
		// Opening Text
		$this->pdf->SetFont('Arial','',10);
		$this->pdf->Cell(15);
	    $this->pdf->Cell(160,5,'Disajikan untuk '.$data['hasil']['sapaan'].' '.$data['hasil']['nama'].'',0,0,'L');
		$this->pdf->ln();
		$this->pdf->ln();
		...
		$this->pdf->Cell(15);
	    $this->pdf->Cell(160,5,'Sebagai gambaran keunggulan manfaat JS Plan Optima 8, kami sampaikan sebagai berikut :',0,0,'L');
		$this->pdf->ln();
		$this->pdf->ln();
		...
		$this->pdf->ln();
		$this->pdf->Cell(15);
	    $this->pdf->Cell(160,5,'JS Plan Optima 8 Dengan Deposito Bank',0,0,'C');
		$this->pdf->ln();
		$this->pdf->ln();
		...
		$this->pdf->Cell(80,5,'JS Plan Optima 8','BTR',0,'C');
		$this->pdf->Cell(40,5,'Deposito Bank','TR',0,'C');
		$this->pdf->ln();
		$this->pdf->Cell(15);
		$this->pdf->Cell(25,5,'Tahun Ke','LBR',0,'C');
		$this->pdf->Cell(15,5,'Nasabah','BR',0,'C');
		...
		$this->pdf->ln();
		$this->pdf->Cell(15);
	    $this->pdf->Cell(50,3,'Bunga JS Plan Optima 8',0,0,'L');
		$this->pdf->Cell(5,3,':',0,0,'L');
		$this->pdf->Cell(50,3,'8% Per Tahun (Nett) - Compounded / Majemuk',0,0,'L');
		$this->pdf->ln();
		$this->pdf->Cell(15);
