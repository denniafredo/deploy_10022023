...
class Jssmartpromapan extends CI_Controller{
	
	function cgetTarifAll(){
		$this->load->model('Modsmartpromapan');
		$usiasekarang  = $this->input->post("usiacalontertanggung");

		$result = $this->Modsmartpromapan->getTarifUA_all($usiasekarang);
		$hasil = $result;
	...
	function cgetAsumsiDanaInvest(){
		$this->load->model('Modsmartpromapan');
		$usiasekarang  = $this->input->post("usiacalontertanggung");
		$result = $this->Modsmartpromapan->getAsumsiDanaInvest($usiasekarang);
		$hasil = $result;
	...
	function cgetTarifSpousePayor(){
		...
		$result = $this->Modsmartpromapan->getTarifUA_SpousePayor($usiasekarang);
		$hasil = $result;
	...
	function cgetEkstraPremi(){
		...
		$result = $this->Modsmartpromapan->getEkstraPremi($kdjenispekerjaanctt);
		$hasil = $result;
	...
	function cgetResikoAwal(){
		...
		$result = $this->Modsmartpromapan->getResikoAwal($kdnpert);
		$hasil = $result;
	...
	function insertProPempol(){
		...
		$result = $this->Modsmartpromapan->insertProPempolNew($data['pempol']);
	...
	function insertProTertanggung(){
		...
		$result = $this->Modsmartpromapan->insertProTertanggungNew($data['tertanggung']);
	...
	function insertProAsuransiPokok(){
		...
		$result = $this->Modsmartpromapan->insertProAsuransiPokok($data['asuransipokok']);
	...
	function insertProAlokasiDana(){
		...
		$result = $this->Modsmartpromapan->insertProAlokasiDanaNew($data['alokasidana']);
	    echo $result;
	}
	...
	function insertProDataRider(){
		...
		$data['datarider'] = array(
			...
			'IS_HCPCARE' => $this->input->post("is_hcpcare"),
			'HCPCARE' => $this->input->post("hcpcare"),
			'BIAYA_HCPCARE' => $this->input->post("biaya_hcpcare")
		);

		$result = $this->Modsmartpromapan->insertProDataRiderNew($data['datarider']);
		...
		$data['datariderold'] = array(
			...
			/* Fungsi untuk menyimpan benefit RIDER HOSPITAL CARE - (konfirmasi untuk manfaat yang ditampilkan apasaja) 
			'IS_HCPCARE_MURNI' => $this->input->post("is_hcpcare"),
			'PLAFON_HCPCARE_MURNI' => $this->input->post("hcpcare"),
			'HCPCARE_MURNI' => $this->input->post("biaya_hcpcare"),
			'IS_HCPCARE_ICU' => $this->input->post("is_hcpcare"),
			'PLAFON_HCPCARE_ICU' => $this->input->post("hcpcare")*2,
			'HCPCARE_ICU' => $this->input->post("biaya_hcpcare"),
			'IS_HCPCARE_BEDAH' => 0,
			'PLAFON_HCPCARE_BEDAH' => 0,
			'HCPCARE_BEDAH' => 0,
			*/
			
		);
		$result = $this->Modsmartpromapan->insertProDataRiderOld($data['datariderold']);
			...
			$this->Modsmartpromapan->insertProJua($data['dataprojua_dasar']);
			...
			$this->Modsmartpromapan->insertProJua($data['dataprojua_adb']);
			...
			$this->Modsmartpromapan->insertProJua($data['dataprojua_ci53']);
			...
			$this->Modsmartpromapan->insertProJua($data['dataprojua_wpci51']);
			...
			$this->Modsmartpromapan->insertProJua($data['dataprojua_tr']);
			...
			$this->Modsmartpromapan->insertProJua($data['dataprojua_hcp']);
			...
			$this->Modsmartpromapan->insertProJua($data['dataprojua_tpd']);
			...
			$this->Modsmartpromapan->insertProJua($data['dataprojua_wptpd']);
			...
			$this->Modsmartpromapan->insertProJua($data['dataprojua_addb']);
			...
			$this->Modsmartpromapan->insertProJua($data['dataprojua_pbd']);
			...
			$this->Modsmartpromapan->insertProJua($data['dataprojua_pbci']);
			...
			$this->Modsmartpromapan->insertProJua($data['dataprojua_pbtpd']);
			...
			$this->Modsmartpromapan->insertProJua($data['dataprojua_spd']);
			...
			$this->Modsmartpromapan->insertProJua($data['dataprojua_spci']);
			...
			$this->Modsmartpromapan->insertProJua($data['dataprojua_sptpd']);

			$data['dataprojua_hcpcare'] = array(
				'BUILD_ID' => $this->session->userdata('build_id'),
				'JENIS' => 'H_CARE',
				'NILAI' => $this->input->post("hcpcare")
			);
			$this->Modsmartpromapan->insertProJua($data['dataprojua_hcpcare']);	
	}
	...
	function hasil(){
		...
		$this->load->view('hasil/jssmartpromapan');
	}
	...
	function CetakPDF()
	{
		...
		$data['hasilProTertanggung'] = $this->Modsmartpromapan->selectProTertanggungPdf($buildid);
		$data['hasilProPempol'] = $this->Modsmartpromapan->selectProPempolPdf($buildid);
		$data['hasilProAsuransiPokok'] = $this->Modsmartpromapan->selectProAsuransiPokokPdf($buildid);
		$data['hasilProAlokasiDana'] = $this->Modsmartpromapan->selectProAlokasiDanaPdf($buildid);
		$data['hasilProDataRiderNew'] = $this->Modsmartpromapan->selectProDataRiderNewPdf($buildid);
		$data['hasilProKeteranganRider'] = $this->Modsmartpromapan->selectProKeteranganRiderPdf($buildid);
		...
		$data['hasilProTotalInvestasi1'] = $this->Modsmartpromapan->selectProTotalInvestasi1Pdf($buildid);
		...
		$data['hasilProTotalKomparasi'] = $this->Modsmartpromapan->selectProTotalKomparasiPdf($buildid);
		$this->load->view('pdf/jssmartpromapan_create_pdf',$data);
