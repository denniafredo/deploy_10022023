    ...
    <div class="col-md-6">
        ...
        <div class="form-group" style="border: 1px solid #444; padding: 10px;">
            <div class="col-md-12">
                ...
                <div class="form-group">
                    <label class="control-label col-md-4">Pilih Jenis Pekerjaan<span class="required"> * </span></label>
                    <div class="col-md-6">
    ...
    function checkedTertanggungSamaDenganPemegangPolis(input) {
        $("#tertanggungsamadenganpemegangpolis").click(function() {
            ...
            if (document.getElementById('tertanggungsamadenganpemegangpolis').checked) {
                ...
                document.getElementById("kdjnspekerjaancalontertanggung").value = document.getElementById("kdjenispekerjaannasabah").value;
