...
<script>
    jQuery(document).ready(function() {       
	   ...
	   $("#juaci").change(function() {
					...
					$.ajax({
						type	: "POST",
						url		: "<?=base_url('linkequityfund/hitungpremitambahan');?>",
				...
				$("#juapa").change(function() {
					...
					$.ajax({
						type	: "POST",
						url		: "<?=base_url('linkequityfund/hitungpremitambahanPA');?>",
				...
				$("#wp").click(function() {
					...
					$.ajax({
						type	: "POST",
						url		: "<?=base_url('linkequityfund/hitungjuaWP');?>",
						...
						success : function(data) {
							...
							$.ajax({
								type	: "POST",
								url		: "<?=base_url('linkequityfund/hitungpremitambahanWP');?>",
				...
				$("#juactt").change(function() {
					...
					$.ajax({
						type	: "POST",
						url		: "<?=base_url('linkequityfund/hitungpremitambahanCTT');?>",
				...
				$("#dropdowncpm").change(function() {
					...
					$.ajax({
						type	: "POST",
						url		: "<?=base_url('linkequityfund/hitungpremitambahanCPM');?>",
				...
				$("#dropdowncpb").click(function() {
					...
					$.ajax({
						type	: "POST",
						url		: "<?=base_url('linkequityfund/hitungpremitambahanCPB');?>",
				...
				$("#juaterm").change(function() {
					...
					$.ajax({
						type	: "POST",
						url		: "<?=base_url('linkequityfund/hitungpremitambahanTERM');?>",
