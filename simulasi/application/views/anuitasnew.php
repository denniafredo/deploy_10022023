...
<div style="border: 5px solid #444; padding: 20px; margin-left:20px; margin-right:20px" class="row">
    <div class="col-md-12">
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
                <input class="form-control form-control-inline input-small date-picker" id="saatmulaiasuransijsanuitas" name="saatmulaiasuransijsanuitas" size="16" type="text" placeholder="Saat Mulai Program Anuitas" />
        ...
        <div class="form-group">
                                                ...
                                                <option value="IDEAL (SESUAI UU)">IDEAL</option>
            ...
            <table class="table table-striped table-hover">
                <thead>
                    <tr>
                        ...
                        <th name="labelpht" id="labelpht">
                            PHT
                        </th>
                        <th>

                        </th>
                        <th name="labelpjd" id="labelpjd">
                            PJD/PYT
                        </th>
                    </tr>
                </thead>
                ...
                <tbody>
                    <!--
                                                                                            <tr>
                                                                                                    <td>1.</td>
                                                                                                    <td>Anuitas Sejahtera Prima</td>
                                                            <td>Rp.</td>
                                                                                                    <td>
                                                            <input class="form-control" placeholder="" type="" name="aspkawin" id="aspkawin" onChange="" value="0" readonly>
                                                            </td>
                                                            <td>Rp.</td>
                                                                                                    <td>
                                                            <input class="form-control" placeholder="" type="" name="aspbujang" id="aspbujang" onChange="" value="0" readonly>
                                                            </td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                                    <td>2.</td>
                                                                                                    <td>Anuitas Sejahtera Ideal</td>
                                                            <td>Rp.</td>
                                                                                                    <td>
                                                            <input class="form-control" placeholder="" type="" name="asikawin" id="asikawin" onChange="" value="0" readonly>
                                                            </td>
                                                            <td>Rp.</td>
                                                            <td>
                                                            <input class="form-control" placeholder="" type="" name="asibujang" id="asibujang" onChange="" value="0" readonly>
                                                            </td>
                                                                                            </tr>
                    -->
                    <tr>
<!--										<td>3.</td>-->
                        ...
                        <td></td>
                        <td>
                            <input class="form-control" placeholder="" type="" name="aikawin" id="aikawin" value="0" readonly>
                        </td>
                        <td></td>
                        <td>
                            <input class="form-control" placeholder="" type="" name="aibujang" id="aibujang" value="0" readonly>
                        </td>
                    </tr>
                    <!--
                                                         <tr style="">
                                                                                                    <td>4.</td>
                                                                                                    <td>Anuitas Eksekutif Prima</td>
                                                            <td>Rp.</td>
                                                                                                    <td>
                                                            <input class="form-control" placeholder="" type="" name="aepkawin" id="aepkawin" onChange="" value="0" readonly>
                                                            </td>
                                                            <td>Rp.</td>
                                                            <td>
                                                            <input class="form-control" placeholder="" type="" name="aepbujang" id="aepbujang" onChange="" value="0" readonly>
                                                            </td>
                                                                                            </tr>
                    -->
    ...
    jQuery(document).ready(function () {
        ...
        $("#tertanggungsamadenganpemegangpolis").click(function () {
            if (document.getElementById('tertanggungsamadenganpemegangpolis').checked) {
                ...
                } else if (usiasekarang > 80)
                {
                    alert('Usia maksimal 80 tahun!');
                    document.getElementById("tanggallahircalontertangggung").value = '';
                } else
                {
        ...
        $("#statuskawin").change(function () {
            ...
            $.ajax({
                type: "POST",
                url: "<?= base_url('anuitasnew/hitungpremisekaligusanijsanuitas'); ?>",
                data: "premisekaligusjsanuitas=" + premisekaligusjsanuitas + "&saatmulaiasuransijsanuitas=" + saatmulaiasuransijsanuitas + "&usiasekarang=" + usiasekarang + "&statuskawin=" + statuskawin + "&tgllahir=" + tgllahir,
        ...
        $("#saatmulaiasuransijsanuitas").change(function () {
            ...
            if (premisekaligusjsanuitas < 50000000)
            {
                alert('Minimal premi 50000000!')
                document.getElementById("premisekaligusjsanuitas").value = 50000000;
            } else if (premisekaligusjsanuitas > 25000000000)
            {
                alert('Maksimal premi 25000000000!')
                document.getElementById("premisekaligusjsanuitas").value = 25000000000;
            }
