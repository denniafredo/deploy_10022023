<!-- BEGIN PAGE CONTENT-->
	<div class="row invoice-logo">
		...
		<div class="col-xs-6" align="justify">
			<h3>
				 Proposal JS Replacement Income Assurance
			</h3>
		</div>
	</div>
	<hr/>
		...
		<div class="col-xs-12">
			...
			<div class="portlet box blue">
				<div align="justify" class="portlet-body util-btn-margin-bottom-5">
						...
						<p align="justify"><strong>b.  Meninggal Dunia Asumsi Meninggal di akhir tahun ke- <?= $hasil['masaasuransijsgajiterusan'] - 3;?></strong></p>
