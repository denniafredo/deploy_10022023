<?php
	...
	$sql4 = "SELECT a.build_id, b.fundalocname nama_alokasi1, a.alokasi1, c.fundalocname nama_alokasi2, a.alokasi2,
			 ...
			 LEFT OUTER JOIN pro_alokasi_fund b ON a.nama_alokasi1 = b.fundalocid
			 LEFT OUTER JOIN pro_alokasi_fund c ON a.nama_alokasi2 = c.fundalocid
			 WHERE build_id = '$buildid'";
				...
				while($usia <= 99) {
					...
					for ($y = 1; $y <= 12; $y++) {
						...
						if($tahun_ke == 1){
							...
							//$biaya_pbd_		= $ua_pbd*$tarifriderjspbd/12/100*(1+($nilaiekstrapremilife_cpp/1000));
							$biaya_pbci		= 0;
							...
							//$biaya_spd_		= $ua_spd*$tarifriderjsspd/12/100*(1+($nilaiekstrapremilife_cpp/1000));
							$biaya_spci		= 0;
							...
							//$biaya_pbd		= ($ua_pbd*$tarifriderjspbd/12/100*(1+($nilaiekstrapremilife_cpp/1000))) + $biaya_pbd_;
							...
							//$biaya_spd		= ($ua_spd*$tarifriderjsspd/12/100*(1+($nilaiekstrapremilife_cpp/1000))) + $biaya_spd_;
						...
						if($carabayar ==1){
							...
							if($tahun_ke == 1 && $y==1){
								...
								$investasi_rendah01 = $alokasi_total * (1+($bunga_rendah/12)) * $alokasi1;
								$investasi_sedang01 = $alokasi_total * (1+($bunga_sedang/12)) * $alokasi1;
								$investasi_tinggi01 = $alokasi_total * (1+($bunga_tinggi/12)) * $alokasi1;
								$investasi_rendah02 = $alokasi_total * (1+($bunga_rendah2/12)) * $alokasi2;
								$investasi_sedang02 = $alokasi_total * (1+($bunga_sedang2/12)) * $alokasi2;
								$investasi_tinggi02 = $alokasi_total * (1+($bunga_tinggi2/12)) * $alokasi2;
