    ...
    <div class="row" align="center">
		<div class="col-xs-12">
			<div class="well" style="font-weight:bold;font-size:16px">
				ILUSTRASI JS PLAN ANNUITY ASSURANCE
			</div>
		</div>
     </div>
	<hr/>
								...
								<tbody>
                                     <tr>
										...
										<td>JS Plan Annuity Assurance</td>
                                      	<td>Rp.</td>
										<td>
                                        <input class="form-control" placeholder="" type="" name="aepkawin" id="aepkawin" onChange="" value="<?= number_format($hasil['aepkawin'],0,'.',',');?>" readonly>
                                        </td>
                                        <td>Rp.</td>
                                        <td>
                                        <input class="form-control" placeholder="" type="" name="aepbujang" id="aepbujang" onChange="" value="<?= number_format($hasil['aepbujang'],0,'.',',');?>" readonly>
                                        </td>
									</tr>
