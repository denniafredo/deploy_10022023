				...
				<table class="table table-striped table-hover" width="100%">			
					<tbody>
						...
						<tr>
							...
							<td align="center" style="font-size:18px">:</td>
							<td align="left" style="font-size:18px"><?=number_format($pos['TOPUPSEKALIGUS'],0,',','.');?></td>						
						</tr>
						<tr>
							<td align="justify" style="font-size:18px">Total Premi yang dibayar</td>
							<td align="center" style="font-size:18px">:</td>
							<td align="left" style="font-size:18px"><?=number_format($pos['PREMI']+$pos['TOPUPSEKALIGUS'],0,',','.');?></td>						
						</tr>
						<tr>
							<td align="justify" style="font-size:18px">Medical</td>
							<td align="center" style="font-size:18px">:</td>
							<td align="left" style="font-size:18px"><?=$pos['KDSTATUSMEDICAL']=='M'?'Ya':'Tidak';?></td>						
						</tr>
					<tbody>
				</table>
			</div>					
	...
	<div class="row">
		<div class="col-xs-12">
			...
			<div class="table-responsive">
				<table class="table table-striped table-hover" width="100%">			
					<tbody>
						<?php foreach ($pos['OPSIFUND'] as $i => $v) { ?>
						<tr>
							<td align="justify" style="font-size:18px" width="20%"><?=$v['NAMAFUND']?></td>
							<td align="center" style="font-size:18px" width="10px">:</td>
							<td align="left" style="font-size:18px"><?=$v['PORSI'];?>%</td>						
						</tr>
						<?php } ?>
					</tbody>
				</table>
	...
	<div class="row">
		<div class="col-xs-12">
			...
			<div class="table-responsive">
				<table class="table table-striped table-hover" width="100%">			
					<tbody>
						<?php foreach ($pos['RIDER'] as $i => $v) { ?>
						<tr>
							<td align="justify" style="font-size:18px" width="20%">Nama Asuransi</td>
							<td align="center" style="font-size:18px" width="10px">:</td>
							<td align="left" style="font-size:18px"><?=ucwords(strtolower($v['NAMABENEFIT']))?></td>						
						</tr>
						<tr>
							<td align="justify" style="font-size:18px" width="20%">Sampai Usia Tertanggung</td>
							<td align="center" style="font-size:18px" width="10px">:</td>
							<td align="left" style="font-size:18px">99 Tahun</td>						
						</tr>
						<tr>
							<td align="justify" style="font-size:18px" width="20%">Uang Asuransi</td>
							<td align="center" style="font-size:18px" width="10px">:</td>
							<td align="left" style="font-size:18px"><?=number_format($v['MANFAAT'],0,',','.');?></td>						
						</tr>
						<tr>
							<td align="justify" style="font-size:18px" width="20%">Biaya Asuransi per bulan</td>
							<td align="center" style="font-size:18px" width="10px">:</td>
							<td align="left" style="font-size:18px"><?=number_format($v['BIAYA'],0,',','.');?></td>						
						</tr>
						<tr>
							<td align="justify" style="font-size:18px" width="20%">Pengakuan Resiko Awal</td>
							<td align="center" style="font-size:18px" width="10px">:</td>
							<td align="left" style="font-size:18px">100%</td>						
						</tr>
						<tr>
							<td align="justify" style="font-size:18px" width="20%">Resiko Awal</td>
							<td align="center" style="font-size:18px" width="10px">:</td>
							<td align="left" style="font-size:18px"><?=number_format($pos['RESIKOAWAL'],0,',','.');?></td>						
						</tr>
						<?php } ?>
					</tbody>
				</table>
				...
				<table class="table table-striped table-hover" width="100%">			
					<tbody>
						...
						<tr style="vertical-align:top;">
							<td align="justify" style="font-size:18px" width="20%"><?=ucwords(strtolower($v['NAMABENEFIT']))?></td>
							<td align="center" style="font-size:18px" width="10px">:</td>
							<td align="left" style="font-size:18px"><?=$v['DESKRIPSI']?></td>						
						</tr>
						<?php } ?>
					</tbody>
				</table>
