...
<div class="form-group">
	...
	<div class="col-md-4">
		<div class="input-group">
			...
			<input class="form-control" placeholder="Premi Sekaligus" type="text" name="premisekaligus9" id="premisekaligus" onchange="">
...
<script>
    ...
    function calculate_sale_price(input)
	{
	   ...
	   // alokasi.value = proteksi.toFixed(2);
		...
		var asuransi = (val !=='' && val >= 100000000) ? (val * 130)/100:'(empty)';
