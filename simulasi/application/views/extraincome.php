...
<div class="form-group">
	...
	<div class="col-md-4">
		<div class="input-group">
			...
			<input class="form-control" placeholder="Premi Sekaligus" type="text" name="premisekaligusextraincome" id="premisekaligus" onchange="calculate_sale_price(this);">
...
<div class="col-md-3">
		<input class="form-control form-control-inline input-small date-picker" name="mulas" id="mulas" size="16" type="text" value="" onchange="hitungtahun(this);"/>
...
<hr></hr>
<h3>Perbandingan Dengan Deposito &amp; Tabungan Bank</h3>
<div class="form-group">
	<label class="control-label col-md-3">Bunga Deposito
	</label>
	<div class="col-md-4">
		<div class="input-group">
			
			<input class="form-control" placeholder="Pajak" type="text" name="bunganett" id="bunganett" value="6.5">
			<span class="input-group-addon">
				<i>%</i>
			</span>
			<!--input class="form-control" placeholder="" type="hidden" name="minpremi" value="<?= $details->min_premi; ?>"-->
...
<div class="form-group">
	<label class="control-label col-md-3">Bunga Tabungan
	</label>
	<div class="col-md-4">
		<div class="input-group">
			
			<input class="form-control" placeholder="Pajak" type="text" name="bungatabungan" id="bungatabungan" value="6">
			<span class="input-group-addon">
				<i>%</i>
			</span>
			<!--input class="form-control" placeholder="" type="hidden" name="minpremi" value="<?= $details->min_premi; ?>"-->
...
<script>
    ...
    function calculate_sale_price(input)
	{
	    ...
	    var jua = (premi.value != '' && premi.value>=5000000) ? (premi.value * 130)/100: 0;
	...
	{
	    mulas = document.getElementById('mulas');
