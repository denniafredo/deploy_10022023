								...
								<tr role="row" class="filter">
									...
									<td>
										  ...
										  <select class="form-control select2me" name="alokasidana1" id="alokasidana1" onChange="">
                                                ...
                                                <option value="JS GUARDIAN 75">JS GUARDIAN 75</option>
                                                <option value="JS GUARDIAN 85">JS GUARDIAN 85</option>
											</select>
										</div>
		</div>
                                                <div class="form-group">
    ...
    jQuery(document).ready(function() {       
	   ...
	   $("#tanggallahircalontertangggung").change(function() {
		...
		$("#alokasidana1").change(function() {
			var alokasidana1 = $("#alokasidana1").val();
			
			if (alokasidana1 == 'JS GUARDIAN 75')
			{
				...
				$('#alokasidana2').attr('readonly',true);
				$('#persentasealokasidana2').attr('readonly',true);
				$('#persentasealokasidana1').attr('readonly',true);	
			}
			...
			{
				$('#alokasidana2').attr('readonly',false);
				$('#persentasealokasidana2').attr('readonly',false);
				$('#persentasealokasidana1').attr('readonly',false);		
			}
		});
		
		$("#alokasidana2").change(function() {
			var alokasidana2 = $("#alokasidana2").val();
			
			if (alokasidana2 == 'JS GUARDIAN 75')
			{
				...
				$('#persentasealokasidana2').trigger('change');
				$('#alokasidana1').attr('readonly',true);
				$('#persentasealokasidana1').attr('readonly',true);	
				$('#persentasealokasidana2').attr('readonly',true);	
			}
			...
			{
				$('#alokasidana1').attr('readonly',false);
				$('#persentasealokasidana1').attr('readonly',false);
				$('#persentasealokasidana2').attr('readonly',false);			
			}
		});
