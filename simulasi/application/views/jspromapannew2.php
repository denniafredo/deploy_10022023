				...
				<div class="table-scrollable">
					<table class="table table-striped table-hover xxxtab">
						...
						<tbody>
							...
							<tr id="trjspyrci" style="display: none">
								
								<td width="30%">JS Payor CI</td>
								<td width="20%">
								<select class="form-control " name="jspcijspromapannew" id="jspcijspromapannew" disabled >
									<option value="0">0</option>
									<option value="1">1</option>
								</select>
								</td>
								<td style="display: none">
								<input class="form-control" placeholder="" type="" name="premijspcijspromapannew" id="premijspcijspromapannew"  value="0" readonly>
								</td>
								<td>
								<input class="form-control" placeholder="" type="" name="uangasuransijspcijspromapannew" id="uangasuransijspcijspromapannew"  value="0" disabled>
								</td>
							</tr>
							...
							<tr id="trjsspci" style="display: none">
								
								<td width="30%">JS Spouse CI</td>
								<td width="20%">
								<select class="form-control" name="jsspcijspromapannew" id="jsspcijspromapannew" disabled>
									<option value="0">0</option>
									<option value="1">1</option>
								</select>
								</td>
								<td style="display: none">
								<input class="form-control" placeholder="" type="" name="premijsspcijspromapannew" id="premijsspcijspromapannew"  value="0" readonly>
								</td>
								<td>
								<input class="form-control" placeholder="" type="" name="uangasuransijsspcijspromapannew" id="uangasuransijsspcijspromapannew"  value="0" disabled>
								</td>
							</tr>
						...
						<tbody>			
							...
							<tr>			
								...
								<select class="form-control" name="pilihriderlainnya" id="pilihriderlainnya" >
									...
									<option value="JS Payor Death" id="choice_pyd">JS Payor Death</option>
									<option value="JS Spouse Death" id="choice_sppd">JS Spouse Death</option>
								</select>
								</td>
							...
							<!-- add by salman 20/08/2019-->
							<tr style="display: none" id="riderpayordeathbenefit" name="riderpayordeathbenefit">							
								<td width="38%">JS Payor Death</td>
								<td width="20%">
								<select class="form-control " name="jspayordeathjspromapannew" id="jspayordeathjspromapannew" disabled readonly >
									<option value="0">0</option>
									<option value="1">1</option>
								</select>
								</td>
								<td style="display: none">
								<input class="form-control" placeholder="" type="" name="premijspayordeathjspromapannew" id="premijspayordeathjspromapannew"  value="0" readonly>
								</td>
								<td>
								<input class="form-control" placeholder="" type="" name="uangasuransijspayordeathjspromapannew" id="uangasuransijspayordeathjspromapannew"  value="0" disabled>
								</td>
							</tr>
							<tr style="display: none" id="riderspousepdb" name="riderspousepdb">							
								<td width="38%">JS Spouse Death</td>
								<td width="20%">
								<select class="form-control " name="jsspousedeathjspromapannew" id="jsspousedeathjspromapannew" disabled readonly >
									<option value="0">0</option>
									<option value="1">1</option>
								</select>
								</td>
								<td style="display: none">
								<input class="form-control" placeholder="" type="" name="premijsspousedeathjspromapannew" id="premijsspousedeathjspromapannew"  value="0" readonly>
								</td>
								<td>
								<input class="form-control" placeholder="" type="" name="uangasuransijsspousedeathjspromapannew" id="uangasuransijsspousedeathjspromapannew"  value="0" disabled>
								</td>
							</tr>
							<!-- end by salman 20/08/2019-->
...
//	   PEMPOL
		...
		if (document.getElementById('tertanggungsamadenganpemegangpolis').checked) {
			$.ajax({
				type	: "POST",
				url		: "<?=base_url('jspromapannew2/insertProTertanggung');?>",
...
//					alert(msg);
			...
			$.ajax({
				type	: "POST",
				url		: "<?=base_url('jspromapannew2/insertProPempol');?>",
...
//		}
	...
	//alert("Cara Bayar : " + carabayarjspromapannew);
	    ...
	    $.ajax({
			type	: "POST",
			url		: "<?=base_url('jspromapannew2/insertProAlokasiDana');?>",
...
a.USIA
	...
	// Hide it after 3 seconds
		setTimeout(function(){
				...
				$.ajax({    
				type: "GET",
				url: "<?=base_url('jspromapannew2/getTarifUA_nonRokok');?>",      
				dataType: "text",             
				...
				//alert('set16 '+set[16]);
				  ...
				  if(set[14] == 1)
				  {			
					 document.getElementById("uangasuransijspcijspromapannew").value = set[16];
					 $('#jspcijspromapannew option[value=1]').attr('selected','selected');
					 $('#jspcijspromapannew').prop('disabled', true);
					 $('#trjspyrci').show();
					 $('#coice_sppd').hide();
				  ...
				  if(set[15] == 1)
				  {			
					 document.getElementById("uangasuransijsspcijspromapannew").value = set[17];
					 $('#jsspcijspromapannew option[value=1]').attr('selected','selected');
					 $('#jsspcijspromapannew').prop('disabled', true);
					 $('#trjsspci').show();
					 $('#coice_pyd').hide();
        ...
        type: "GET",
        url: "<?=base_url('jspromapannew2/getDataProRiderAll');?>",      
  ...
  // initiate layout and plugins
	...
	$('#pilihriderlainnya').change(function(){
		...
		setTimeout(function(){
				...
				$.ajax({
				type	: "POST",	
				url		: "<?=base_url('jspromapannew2/recalcUAByRiderv2');?>", 			
						 ...
						 // alert('dsadsada ' + set[5]);
						  ...
						  document.getElementById("uangasuransijswpcijspromapannew").value = set[3];
							...
							{						 
								...
								document.getElementById("uangasuransijspayordeathjspromapannew").value = 0;									
								document.getElementById("uangasuransijsspousedeathjspromapannew").value = 0;									
							...
							else if(pilihriderlainnya == "JS Payor Death")
							{						
								$('#jspayordeathjspromapannew option[value=1]').attr('selected','selected');
								document.getElementById("uangasuransijspayordeathjspromapannew").value = set1[1];
							...
							else if(pilihriderlainnya == "JS Spouse Death")
							{						
								$('#jsspousedeathjspromapannew option[value=1]').attr('selected','selected');
								document.getElementById("uangasuransijsspousedeathjspromapannew").value = set1[1];
...
//		
	...
	$("#pilihriderlainnya").change(function() {
		...
		if (pilihriderlainnya == 'JS Critical Ilness')
		{
			...
			document.getElementById("riderpayordeathbenefit").style.display = "none";	
//			document.getElementById("riderpayortpd").style.display = "";
			document.getElementById("riderspousepdb").style.display = "none";	
...
//			document.getElementById("riderpayortpd").style.display = "";
//			document.getElementById("riderspousepdb").style.display = "";	
			document.getElementById("riderspousepayortpd").style.display = "none";
			document.getElementById("rideraddb").style.display = "none";	
			document.getElementById("ridertpd").style.display = "none";
			document.getElementById("riderlainnya2").style.display = "none";	
		}
...
//		}
	...
	$("#totalpremi").change(function() {
		...
		$.ajax({
			type	: "POST",
			url		: "<?=base_url('jspromapannew2/hitungsaranua');?>",
...
//				$('#totalpremi').trigger('change');
		...
		if(topupsekaligus < 1000000){
			alert('Topup sekaligus tidak boleh kurang dari satu juta');
...
//			$('#topupberkala').trigger('change');
	...
	$("#uangasuransihcpjspromapannew").change(function() {
		...
		$.ajax({
			type	: "POST",
			url		: "<?=base_url('jspromapannew2/hitungjshcppromapannew');?>",
...
//		}
	...
	$("#uangasuransihcpbjspromapannew").change(function() {
		...
		$.ajax({
			type	: "POST",
			url		: "<?=base_url('jspromapannew2/hitungjshcpbpromapannew');?>",
	...
	$("#wpjspromapannew").change(function() {
		...
		if (wpjspromapannew == '1')
		{
			...
			$.ajax({
				type	: "POST",
				url		: "<?=base_url('jspromapannew2/hitungjswppromapannew');?>",
...
//			document.getElementById("uangasuransijswptpdjspromapannew").disabled = true;	
	...
	$("#jsspdjspromapannew").change(function() {
		...
		if (jsspdjspromapannew == '1')
		{
			...
			$.ajax({
						type	: "POST",
						url		: "<?=base_url('jspromapannew2/hitungjsspdpromapannew');?>",
	...
	$("#jssptpdjspromapannew").change(function() {
		...
		if (jssptpdjspromapannew == '1')
		{
			...
			$.ajax({
						type	: "POST",
						url		: "<?=base_url('jspromapannew2/hitungjssptpdpromapannew');?>",
						data	: "usiasekarang="+usiasekarang+"&masaasuransi="+masaasuransi+"&jeniskelamincalontertanggung="+jeniskelamincalontertanggung+"&carabayarjspromapannew="+carabayarjspromapannew,
						success : function(data) {
	...
	$("#uangasuransijstpdjspromapannew").change(function() {
		...
		$.ajax({
					type	: "POST",
					url		: "<?=base_url('jspromapannew2/hitungjstpdpromapannew');?>",
	...
	$("#uangasuransici53jspromapannew").change(function() {
		...
		$.ajax({
					type	: "POST",
					url		: "<?=base_url('jspromapannew2/hitungjsci53promapannew');?>",
	...
	$("#uangasuransijsaddbjspromapannew").change(function() {
		...
		$.ajax({
					type	: "POST",
					url		: "<?=base_url('jspromapannew2/hitungjsaddbpromapannew');?>",
	...
	$("#uangasuransitermjspromapannew").change(function() {
		...
		$.ajax({
			type	: "POST",
			url		: "<?=base_url('jspromapannew2/hitungjstermpromapannew');?>",
...
//		
	...
	$("#submitBtn").click(function() {
		...
		// sementara skip dulu spouse death
		var jsspdjspromapannew = document.getElementById("jsspdjspromapannew").value;
...
//		var id_produk = document.getElementById("id_produk").value;
		...
		//alert('BERHASIL!15');
		var totalpremi = document.getElementById("totalpremi").value;
							   //parseInt(document.getElementById("premijsspdjspromapannew").value)
		var jspcijspromapannew = parseInt(document.getElementById("jspcijspromapannew").value);
		var uangasuransijspcijspromapannew = parseInt(document.getElementById("uangasuransijspcijspromapannew").value);
		var jsspcijspromapannew = parseInt(document.getElementById("jsspcijspromapannew").value);
		var uangasuransijsspcijspromapannew = parseInt(document.getElementById("uangasuransijsspcijspromapannew").value);
		
		/*
		"&uangasuransijspcijspromapannew="+uangasuransijspcijspromapannew+
		"&jspcijspromapannew="+jspcijspromapannew+
		"&uangasuransijsspcijspromapannew="+uangasuransijsspcijspromapannew+
		"&jsspcijspromapannew="+jsspcijspromapannew
		
		alert('BERHASIL!16 '+jspcijspromapannew);
		alert('BERHASIL!16 '+uangasuransijspcijspromapannew);
		alert('BERHASIL!16 '+jsspcijspromapannew);
		alert('BERHASIL!16 '+uangasuransijsspcijspromapannew);
		*/
		$.LoadingOverlay("show");
		...
		$.ajax({
			type	: "POST",
			url		: "<?=base_url('jspromapannew2/insertDataPDF');?>",
		...
		$.ajax({
			...
			success : function(msg) {
				...
				setTimeout(function(){		
					...
					/*window.location.href= "<?=base_url('jspromapannew2/hasil')?>?buildid="+msg+'&filepdf='+filepdf+'&kodeprospek='+kodeprospek; */
					window.location.href= "<?=base_url('jspromapannew2/hasil')?>?buildid="+<?=$this->session->userdata('build_id');?>+'&filepdf='+filepdf+'&kodeprospek='+kodeprospek; 
