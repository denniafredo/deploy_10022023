			...
			function getAllTarif(){
			 ...
			 $('#test').on('click', function() {
			 	var arrayAcord = [
						...
						console.log(arrayAcord);
						console.log(arrayAcord);
			 	//console.log(kdprodukrider);	
			 	$.ajax({
			 		type	: "POST",
			 		url		: "http://osbadmin.jiwasraya.co.id:8001/api/osb/Jiwasraya_ProdukBenefit_Services/getKetentuanProduk",
					beforeSend : function (xhrObj) {
				xhrObj.setRequestHeader("Content-Type", "application/json");
				xhrObj.setRequestHeader("Accept", "application/json");
			},
			 		data	: '{  "kdProduk" : "JL4BLN",  "jenisBenefit" : "R",  "show" : "Y",  "induk" : "",  "dataSPAJVOCollection" : '+JSON.stringify(arrayAcord)+'}',
