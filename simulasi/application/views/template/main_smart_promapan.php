...
<div class="page-container">
									          	...
									          	<div class="row">
									            	...
									            	<div class="col-md-5">
											            ...
											            <div class="form-group">
															...
															<div class="col-md-4">
																<input readonly type="text" class="form-control" name="rumussisabiayacoicor" id="rumussisabiayacoicor" value="15" />
															</div>
											            </div>
									            	</div>
									        ...
									        <div class="box-body">
									          	<div class="row">
									            	...
									            	<div class="col-md-5">
														...
														<!-- TAMBAHAN UNTUK MEMILIH PERHITUNGAN UA DENGAN FA DAN NON MEDICAL -->
														<div class="form-group" hidden>
															<label class="control-label col-md-4"><i>Financial Underwriting </i></label>
															<div class="col-md-4">
															<select class="form-control " name="pil_fa" id="pil_fa" >
																<option value="T" selected>Tidak</option>
																<option value="Y">Ya</option>
															</select>
															</div>
														...
														<div class="form-group" hidden>
															<label class="control-label col-md-4"><i>Pilihan Non Medical </i></label>
															<div class="col-md-4">
															<select class="form-control " name="pil_nonmed" id="pil_nonmed" >
																<option value="T" selected>Tidak</option>
																<option value="Y">Ya</option>
															</select>
															</div>
										            ...
										            <div class="col-md-5">										              	
														...
														<div class="form-group">
															...
															<div class="col-md-4">
																<div class="input-group">
																	<input class="form-control" placeholder="Premi Berkala" type="number" name="premiberkala" id="premiberkala" value="0" onchange="getAllTarif()">
														...
														<!-- FUNGSI untuk menampilkan UANG ASURANSI dg memperhatikan FINANCIAL UNDERWRITING-->
														<div class="form-group" hidden>
															<label class="control-label col-md-4"><b><i>UA dg Financial UW</i></b></label>
															<div class="col-md-4">
																<div class="input-group">
																	<input class="form-control" type="text" name="uangasuransi_fu" id="uangasuransi_fu" readonly>
																</div>
															</div>	
														</div>
														<!-- FUNGSI untuk menampilkan UANG ASURANSI dg memperhatikan status NON MEDICAL-->
														<div class="form-group" hidden>
															<label class="control-label col-md-4"><b><i>UA Non Medical</i></b></label>
															<div class="col-md-4">
																<div class="input-group">
																	<input class="form-control" type="text" name="uangasuransi_nm" id="uangasuransi_nm" readonly>
																</div>
															</div>	
														</div>
														<!-- END -->

														<!-- FUNGSI untuk menampilkan UANG ASURANSI AKHIR -->
														<div class="form-group" hidden>
															<label class="control-label col-md-4"><b><i>UA Akhir</i></b></label>
															<div class="col-md-4">
																<div class="input-group">
																	<input class="form-control" type="text" name="uangasuransi_akhir" id="uangasuransi_akhir" readonly>
																</div>
															</div>	
														</div>
														<!-- END -->
																			...
																			<div class="form-group">
																				<div class="col-md-12">
																					<select class="form-control " name="alokasidana2" id="alokasidana2" >
																						<option value="">Pilih Alokasi Dana</option>
																						<option value="1" selected>JS LINK PASAR UANG</option>
																						<option value="2">JS LINK PENDAPATAN TETAP</option>
									            		...
									            		<div style="padding: 20px; margin-left:20px; margin-right:20px" class="row">
															<table class="table table-striped table-hover xxxtab">
																...
																<tbody>
																	...
																	<tr id="barisjswpci51">
																		<!-- <td>4</td> -->
																		<td><i class="fa fa-fw fa-arrow-circle-right"></i>&nbsp&nbsp JS Waiver of Premium Critical Illness 51 (JS WP CI 51)</td>
																		<td align="center">
																	...
																	<tr id="barisjswptpd">
																		<!-- <td>8</td> -->
																		<td><i class="fa fa-fw fa-arrow-circle-right"></i>&nbsp&nbsp JS Waiver of Premium Total Permanent Dissability (JS WP-TPD)</td>
																		<td align="center">
																	...
																	<tr>
																		<!-- <td>2</td> -->
																		<td><i class="fa fa-fw fa-arrow-circle-right"></i>&nbsp&nbsp JS Accident Death Benefit (JS ADB)</td>
																		<td align="center">
																	...
																	<tr id="barisjsci53">
																		<!-- <td>3</td> -->
																		<td><i class="fa fa-fw fa-arrow-circle-right"></i>&nbsp&nbsp JS Critical Illness 53 (JS CI 53)</td>
																		<td align="center">
																	...
																	<!-- Biaya Asuransi : JS Term Rider (JS TR) -->
																	<tr id="barisjstr">
																		<!-- <td>5</td> -->
																		<td><i class="fa fa-fw fa-arrow-circle-right"></i>&nbsp&nbsp JS Term Rider (JS TR)</td>
																		<td align="center">
																			<label class="el-checkbox el-checkbox-lg">
																	...
																	<tr id="barisjshcp">
																		<!-- <td>6</td> -->
																		<td><i class="fa fa-fw fa-arrow-circle-right"></i>&nbsp&nbsp JS Hospital Cash Plan (JS HCP)</td>
																		<td>
																	...
																	<!-- Biaya Asuransi : JS Hospital Care (JS HC ) -->
																	<tr id="barisjshcp" hidden>
																		<td><i class="fa fa-fw fa-arrow-circle-right"></i>&nbsp&nbsp JS Hospital Care</td>
																		<td>
																			<select class="form-control" name="jshcpcare" id="jshcpcare" onchange="getAllTarif()">
																				<option value="0">0</option>
																		...
																		<td>
																			<input class="form-control" type="text" value="69" readonly>
																		</td>
																		<td>
																			<input class="form-control" type="text" name="uangasuransijshcpcare" id="uangasuransijshcpcare" value="0" readonly>
																		</td>
																		<td>
																			<input class="form-control" type="text" name="biayauangasuransijshcpcare" id="biayauangasuransijshcpcare"  value="0" readonly>
																		</td>
																			<input class="form-control" type="hidden" name="tarifuangasuransijshcpcare" id="tarifuangasuransijshcpcare"  placeholder="0" readonly>
																		
																			<input class="form-control" type="hidden" name="resikoawaluangasuransijshcpcare" id="resikoawaluangasuransijshcpcare"  value="0" readonly>
																	</tr>
																	<!-- Biaya Asuransi : JS Total Permanent Disability (JS TPD) -->
																	<tr id="barisjstpd">
																		<!-- <td>7</td> -->
																		<td><i class="fa fa-fw fa-arrow-circle-right"></i>&nbsp&nbsp JS Total Permanent Dissability (JS TPD)</td>
																		<td align="center">																			
																			<label class="el-checkbox el-checkbox-lg">
																	...
																	<tr id="barisjsaddb">
																		<!-- <td>9</td> -->
																		<td><i class="fa fa-fw fa-arrow-circle-right"></i>&nbsp&nbsp JS Accidental Death Dissmemberment Benefit (ADDB)</td>
																		<td align="center">
																	...
																	<tr id="barisjspbd">
																		<!-- <td>10</td> -->
																		<td><i class="fa fa-fw fa-arrow-circle-right"></i>&nbsp&nbsp JS Payor Death Benefit (JS PB-D)</td>
																		<td align="center">
																	...
																	<tr id="barisjspbci">
																		<!-- <td>11</td> -->
																		<td><i class="fa fa-fw fa-arrow-circle-right"></i>&nbsp&nbsp JS Payor Benefit Critical Illness (JS PB-CI)</td>
																		<td align="center">
																	...
																	<tr id="barisjspbtpd">
																		<!-- <td>12</td> -->
																		<td><i class="fa fa-fw fa-arrow-circle-right"></i>&nbsp&nbsp JS Payor Benefit Total Permanent Dissability (JS PB-TPD)</td>
																		<td align="center">
																	...
																	<tr id="barisjsspd">
																		<!-- <td>13</td> -->
																		<td><i class="fa fa-fw fa-arrow-circle-right"></i>&nbsp&nbsp JS Spouse Payor Death Benefit (JS SP-D)</td>
																		<td align="center">
																	...
																	<tr id="barisjsspci">
																		<!-- <td>14</td> -->
																		<td><i class="fa fa-fw fa-arrow-circle-right"></i>&nbsp&nbsp JS Spouse Payor Critical Illness (JS SP-CI)</td>
																		<td align="center">
																	...
																	<tr id="barisjssptpd">
																		<!-- <td>15</td> -->
																		<td><i class="fa fa-fw fa-arrow-circle-right"></i>&nbsp&nbsp JS Spouse Payor Total Permanent Dissability  (JS SP-TPD)</td>
																		<td align="center">
	...
	<!-- END CONTENT -->
		...
		<script>
			...
			/*Fungsi tambahan untuk mencegah perbedaan karena agen back saat sudah submit - Teguh 06/11/2019*/
			...
			if(usiasekarangctt == ''){
				...
				$.ajax({
					type	: "POST",					
					url		: "<?=base_url('jssmartpromapan/cgetAsumsiDanaInvest');?>",
			...
			$('#tanggallahircalontertanggung').on('change', function() {
				...
				var hari = Math.floor((hariini-birthday_ctt)/(24 * 60 * 60 * 1000));
				if(hari < 15 || age > 69){
					alert("Calon Tertanggung Minimal berusia 15 hari dan Maksimal berusia 69 tahun");
			...
			window.onload=function(){
				...
				$.ajax({
					type	: "POST",
					url		: "<?=base_url('jssmartpromapan/cgetTarifSpousePayor');?>",
			...
			function cekCPPsamadenganCTT() {
				...
				if (checkBox.checked == true){
					...
					$.ajax({
						type	: "POST",
						url		: "<?=base_url('jssmartpromapan/cgetEkstraPremi');?>",
					...
					$.ajax({
						type	: "POST",
						url		: "<?=base_url('jssmartpromapan/cgetResikoAwal');?>",
			...
			function getAllTarif(){
				...
				var premi = document.getElementById("premiberkala").value;
				...
				if( kdjenispekerjaanctt=="" ||  hubungandenganpempol=="" || jeniskelaminctt=="" || perokokcalontertanggung =="" || premi==0 || penghasilan=="")
				{
					...
					document.getElementById("premiberkala").value ="";
					exit();
				}				

				$.ajax({
					type	: "POST",
					url		: "<?=base_url('jssmartpromapan/cgetTarifAll');?>",
					data	: "usiacalontertanggung="+usiasekarangctt,
					success : function(msg) {
						...
						//Untuk Menentukan Tarif HOSPITAL CARE berdasarkan jenis kelamin dan tipe yang diambil
						var pilihanhcpcare = document.getElementById("jshcpcare").value;
						if(pilihanhcpcare == 'A' && jeniskelaminctt == 'M'){
							var tarifriderjshcpcare = a.HC_L_A;
							var uangasuransijshcpcare = 300000;
						}else if(pilihanhcpcare == 'B' && jeniskelaminctt == 'M'){
							var tarifriderjshcpcare = a.HC_L_B;
							var uangasuransijshcpcare = 500000;
						}else if(pilihanhcpcare == 'C' && jeniskelaminctt == 'M'){
							var tarifriderjshcpcare = a.HC_L_C;
							var uangasuransijshcpcare = 750000;
						}else if(pilihanhcpcare == 'D' && jeniskelaminctt == 'M'){
							var tarifriderjshcpcare = a.HC_L_D;
							var uangasuransijshcpcare = 1000000;
						}else if(pilihanhcpcare == 'E' && jeniskelaminctt == 'M'){
							var tarifriderjshcpcare = a.HC_L_E;
							var uangasuransijshcpcare = 1500000;
						}else if(pilihanhcpcare == 'A' && jeniskelaminctt == 'F'){
							var tarifriderjshcpcare = a.HC_P_A;
							var uangasuransijshcpcare = 300000;
						}else if(pilihanhcpcare == 'B' && jeniskelaminctt == 'F'){
							var tarifriderjshcpcare = a.HC_P_B;
							var uangasuransijshcpcare = 500000;
						}else if(pilihanhcpcare == 'C' && jeniskelaminctt == 'F'){
							var tarifriderjshcpcare = a.HC_P_C;
							var uangasuransijshcpcare = 750000;
						}else if(pilihanhcpcare == 'D' && jeniskelaminctt == 'F'){
							var tarifriderjshcpcare = a.HC_P_D;
							var uangasuransijshcpcare = 1000000;
						}else if(pilihanhcpcare == 'E' && jeniskelaminctt == 'F'){
							var tarifriderjshcpcare = a.HC_P_E;
							var uangasuransijshcpcare = 1500000;
						}else if(pilihanhcpcare == 0){
							var tarifriderjshcpcare = "0,0";
							var uangasuransijshcpcare = 0;
						}
						...
						if (checkBox_jsadb.checked == true){
							if(nilaiekstrapremipa_ctt == 'REFER'){
								...
								var pilihanjsadb = 1;
								var tarifriderjsadb_ = (1 + (nilaiekstrapremipa_ctt / 100)) * tarifriderjsadb.replace(",", ".") / 12;
							}
						}else{
							var pilihanjsadb = 0;
							var tarifriderjsadb_ = 0;
						...
						if (checkBox_jsaddb.checked == true){
							if(nilaiekstrapremipa_ctt == 'REFER'){
								...
								var pilihanjsaddb = 1;
								var tarifriderjsaddb_ = (1 + (nilaiekstrapremipa_ctt / 100)) * tarifriderjsaddb.replace(",", ".") / 12;
							}
						}else{
							var pilihanjsaddb = 0;
							var tarifriderjsaddb_ = 0;
						...
						//PILIHAN RIDER JS HCP dan HOSPITAL CARE
						var tarifriderjshcp_ = tarifriderjshcp.replace(",", ".");
						var tarifriderjshcpcare_ = tarifriderjshcpcare.replace(",", ".");
						//console.log("TARIF HOSPITAL CARE : "+tarifriderjshcpcare);
						//console.log("TARIF HOSPITAL CARE 1 : "+tarifriderjshcpcare_);
						...
						$('#tarifuangasuransijshcpcare').val(tarifriderjshcpcare_);
						...
						//Menghitung Biaya Asuransi Rider JS HOSPITAL CARE per Bulan
						var biayaasuransijshcpcare = tarifriderjshcpcare_ / 12 * 1.12;
						$('#uangasuransijshcpcare').val(Math.round(uangasuransijshcpcare));
						$('#biayauangasuransijshcpcare').val(Math.round(biayaasuransijshcpcare));

						
						//Memanggil nilai-nilai untuk perhitungan JUA						
						var carabayarpremi = document.getElementById("carabayarjspromapannew").value;
						if (carabayarpremi == 1){	//Cara Bayar Bulanan
							...
							var totalpremitahunan = document.getElementById("premiberkala").value;
							var premiberkala = totalpremitahunan / 3;
							var topupberkalatahunan = document.getElementById("topupberkala").value;
							var topupberkala = topupberkalatahunan / 3;
							...
							var totalpremitahunan = document.getElementById("premiberkala").value;
							var premiberkala = totalpremitahunan / 6;
							var topupberkalatahunan = document.getElementById("topupberkala").value;
							var topupberkala = topupberkalatahunan / 6;
							var totalpremitahunan = document.getElementById("totalpremi").value;
							var totalpremi = totalpremitahunan / 6;
						}else{ //Cara Bayar Tahunan
							var totalpremitahunan = document.getElementById("premiberkala").value;
							var premiberkala = totalpremitahunan / 12;
							var topupberkalatahunan = document.getElementById("topupberkala").value;
							var topupberkala = topupberkalatahunan / 12;
							var totalpremitahunan = document.getElementById("totalpremi").value;
						...
						var hitungrumuscoa = 27500/premiberkala*100;
						...
						var kdjenispekerjaanctt = document.getElementById("kdjnspekerjaancalontertanggung").value;
						// var RAjswpci51 = premiberkala * 12 * tarifresikoawaldanspouse / 1000;
						// var RAjswptpd = premiberkala * 12 * tarifresikoawaldanspouse / 1000;

						var RAjswpci51 = totalpremi * 12 * tarifresikoawaldanspouse / 1000; //Testing
						...
						if(kdjenispekerjaanctt ==169 || kdjenispekerjaanctt ==306 || kdjenispekerjaanctt ==351 ){
							if (ra_wp > 200000000){
								...
								var uangasuransijswpci51 = pilihanwpci51 * totalpremi * 12; //Testing
								...
								var uangasuransijswptpd = pilihanwptpd * totalpremi * 12; //Testing
						...
						var RAjspb = premiberkala * 12 * tarifresikoawalpayor / 1000;
						var RAjssp = premiberkala * 12 * tarifresikoawaldanspouse / 1000;
						var ra_pbsp = (Math.max(RAjspb, RAjssp));
						if(kdjenispekerjaancpp ==169 || kdjenispekerjaancpp ==306 || kdjenispekerjaancpp ==351){
						...
						var jumlahnilaibiaya = biayaasuransijshcp + biayaasuransijshcpcare + biayaasuransijswpci51 + biayaasuransijswptpd + biayaasuransijspbd + biayaasuransijspbci + biayaasuransijspbtpd + biayaasuransijsspd + biayaasuransijsspci + biayaasuransijssptpd;
						var ceknilairiderbenefitpasti = (1 - (hasilhitungsisabiayacoicor / 100)) * (premiberkala * hasilhitungsisadanacoicor / 100);
						...
						var nilaib =(hasilhitungsisabiayacoicor/100) / (1 - (jumlahnilaibiaya / (premiberkala * hasilhitungsisadanacoicor / 100)));
						...
						if (jumlahnilaibiaya > ceknilairiderbenefitpasti){
							...
							var ua_normal = Math.floor((((hasilhitungsisadanacoicor / 100 * premiberkala) - (jumlahnilaibiaya))  * 1000 / jumlahnilaitarif) / 1000000);
							...
							document.getElementById("jshcpcare").value=0;
							document.getElementById("uangasuransijshcpcare").value=0;
							document.getElementById("biayauangasuransijshcpcare").value=0;
							...
							if(nilaia < nilaib){
								...
								var ua_down = Math.floor((((hasilhitungsisadanacoicor / 100 * premiberkala) - (jumlahnilaibiaya))  * 1000 / jumlahnilaitarif) / 1000000);
								...
								/**** FUNGSI untuk menghitung UA dengan memperhatikan FINANCIAL UNDERWRITING ****/
								var hitung_ua_fu = (activeincome - a) / bb;
								if(hitung_ua_fu > 1500000000){
									var ua_fu = Math.floor(((activeincome - a) - (parseInt(pilihanjsci53)/2*1500000000) - (parseInt(pilihanjstr * 1500000000)) - (parseInt(pilihanjstpd)/2*1500000000))/1000000)*1000000;
								}else{
									var ua_fu = Math.floor(hitung_ua_fu / 1000000) * 1000000;
								}
								$('#uangasuransi_fu').val(Math.round(ua_fu));
								//console.log("UA dg Financial Underwriting :"+ua_fu);
								/**** END ****/

								/**** FUNGSI untuk menghitung UA dengan memperhatikan NON MEDICAL ****/
								if(usiasekarangctt <= 17){
									var maks_ua = 1500000000;				
								}else if(usiasekarangctt >= 18 && usiasekarangctt <= 45){
									var maks_ua = 2000000000;
								}else if(usiasekarangctt >= 46 && usiasekarangctt <= 50){
									var maks_ua = 1000000000;
								}else if(usiasekarangctt >= 51 && usiasekarangctt <= 55){
									var maks_ua = 800000000;
								}else{
									var maks_ua = 650000000;
								}
								var ua_nonmdc = Math.floor(((maks_ua - a) / bb)/1000000) * 1000000;
								$('#uangasuransi_nm').val(Math.round(ua_nonmdc));
								//console.log("UA Non Medical :"+ua_nonmdc);
								/**** END ****/
								...
								if(totalresikoawalctt_new > 10000000000){
									...
									if(kdjenispekerjaanctt ==169 || kdjenispekerjaanctt ==306 || kdjenispekerjaancpp ==351){
								...
								/*** Membatasi JUA adalah minilam 5 kali premi (berkala) tahunan ***/
								var minjua = premiberkala * 12 * 5;
								console.log("MIN JUA : "+minjua);
								if(Math.round(hasilhitungjua) < minjua){
									alert('Minimal nilai JUA adalah lima kali premi berkala tahunan!');
									var hasilhitungjua = 0;
								}else{
								...
								var pil_fa = document.getElementById("pil_fa").value;
								var pil_nonmed = document.getElementById("pil_nonmed").value;
								//console.log("Pilihan FA : "+pil_fa);
								//console.log("Pilihan NM : "+pil_nonmed);

								if(pil_fa == 'Y' && pil_nonmed == 'Y'){
									var uangasuransi_akhir = Math.min(hasilhitungjua, ua_fu, ua_nonmdc);
								}else if(pil_fa == 'Y' && pil_nonmed == 'T'){
									var uangasuransi_akhir = Math.min(hasilhitungjua, ua_fu);
								}else if(pil_fa == 'T' && pil_nonmed == 'Y'){
									var uangasuransi_akhir = Math.min(hasilhitungjua, ua_nonmdc);
								}else{
									var uangasuransi_akhir = hasilhitungjua;
								}
								$('#uangasuransi_akhir').val(Math.round(uangasuransi_akhir));
							}
						}
			...
			$('#premiberkala').on('change', function() {
				var carabayarpremi = document.getElementById("carabayarjspromapannew").value;
				var premiberkala = document.getElementById("premiberkala").value;
				var topupberkala = document.getElementById("topupberkala").value;
				...
				if (carabayarpremi == 1){	//Cara bayar Bulanan				
					if(premiberkala<350000){
						...
						document.getElementById("premiberkala").value ="";
						document.getElementById("topupberkala").value ="";
					}else{
						var totalpremi = (premiberkala*1)+(topupberkala*1);
					}
				}else if (carabayarpremi == 3){ //Cara bayar Kuartalan
					if(premiberkala<1050000){
						alert("Minimal Premi Kuartalan sebesar Rp 1.050.000,-");
						document.getElementById("premiberkala").value ="";
						document.getElementById("topupberkala").value ="";
					}else{
						var totalpremi = (premiberkala*1)+(topupberkala*1);
					...
					if(premiberkala<2100000){
						alert("Minimal Premi Semesteran sebesar Rp 2.100.000,-");
						document.getElementById("premiberkala").value ="";
						document.getElementById("topupberkala").value ="";
					}else{
						var totalpremi = (premiberkala*1)+(topupberkala*1);
					...
					if(premiberkala<4200000){	//Cara bayar Tahunan
						alert("Minimal Premi Tahunan sebesar Rp 4.200.000,-");
						document.getElementById("premiberkala").value ="";
						document.getElementById("topupberkala").value ="";
					}else{
						var totalpremi = (premiberkala*1)+(topupberkala*1);
			...
			$('#topupberkala').on('change', function() {
				var carabayarpremi = document.getElementById("carabayarjspromapannew").value;
				var premiberkala = document.getElementById("premiberkala").value;
				var topupberkala = document.getElementById("topupberkala").value;
				if(topupberkala < 100000){
					alert("Minimal Topup Berkala adalah seratus ribu (Rp 100.000,-)");
					document.getElementById("topupberkala").value = "";
				}else{
					if (carabayarpremi == 1){	//Cara bayar Bulanan				
						if(premiberkala<350000){
			...
			$('#penghasilansatutahun').on('change', function() {
				var penghasilan 	= document.getElementById("penghasilansatutahun").value;
				var usiasekarangctt	= document.getElementById("usiacalontertanggung").value;
				var usiaproduktif 	= document.getElementById("usiaproduktif").value;
				var activeincome 	= (usiaproduktif - usiasekarangctt) * penghasilan;
			...
			$('#submitProposal').on('click', function() {
				...
				$.ajax({
					type	: "POST",
					url		: "<?=base_url('jssmartpromapan/insertProPempol');?>",
				...
				$.ajax({
					type	: "POST",
					url		: "<?=base_url('jssmartpromapan/insertProTertanggung');?>",
				...
				$.ajax({
					type	: "POST",
					url		: "<?=base_url('jssmartpromapan/insertProAsuransiPokok');?>",
				...
				$.ajax({
					type	: "POST",
					url		: "<?=base_url('jssmartpromapan/insertProAlokasiDana');?>",
				...
				var is_hcpcare= document.getElementById("jshcpcare").value;
				var hcpcare= document.getElementById("uangasuransijshcpcare").value;
				var biaya_hcpcare= document.getElementById("biayauangasuransijshcpcare").value;
				...
				$.ajax({
					...
					success : function(msg) {				
						...
						window.location.href= "<?=base_url('jssmartpromapan/hasil')?>?buildid="+<?=$this->session->userdata('build_id');?>+'&filepdf='+filepdf+'&kodeprospek='+kodeprospek; 
						$.LoadingOverlay("hide");
				...
				$.ajax({
					type	: "POST",
					url		: "<?=base_url('jssmartpromapan/insertDataPDF');?>",
