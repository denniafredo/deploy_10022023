...
<script>
    jQuery(document).ready(function() {       
	   ...
	   $("#juaci").change(function() {
					...
					$.ajax({
						type	: "POST",
						url		: "<?=base_url('linkfixedincome/hitungpremitambahan');?>",
				...
				$("#juapa").change(function() {
					...
					$.ajax({
						type	: "POST",
						url		: "<?=base_url('linkfixedincome/hitungpremitambahanPA');?>",
				...
				$("#wp").click(function() {
					...
					$.ajax({
						type	: "POST",
						url		: "<?=base_url('linkfixedincome/hitungjuaWP');?>",
						...
						success : function(data) {
							...
							$.ajax({
								type	: "POST",
								url		: "<?=base_url('linkfixedincome/hitungpremitambahanWP');?>",
				...
				$("#juactt").change(function() {
					...
					$.ajax({
						type	: "POST",
						url		: "<?=base_url('linkfixedincome/hitungpremitambahanCTT');?>",
				...
				$("#dropdowncpm").change(function() {
					...
					$.ajax({
						type	: "POST",
						url		: "<?=base_url('linkfixedincome/hitungpremitambahanCPM');?>",
				...
				$("#dropdowncpb").click(function() {
					...
					$.ajax({
						type	: "POST",
						url		: "<?=base_url('linkfixedincome/hitungpremitambahanCPB');?>",
				...
				$("#juaterm").change(function() {
					...
					$.ajax({
						type	: "POST",
						url		: "<?=base_url('linkfixedincome/hitungpremitambahanTERM');?>",
