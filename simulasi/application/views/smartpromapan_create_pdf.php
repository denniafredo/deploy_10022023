<?php
	...
	header("Connection: close");
		...
		$this->pdf->Cell(190,4,'JS SMART PROMAPAN (Jiwasraya Smart Proteksi Masa Depan)','B',0,'L');
		$this->pdf->ln(7);
		...
		foreach($hasilProAlokasiDana as $data) {
			...
			// if($alokasi1 == 'JS LINK PASAR UANG'){
			// 	$prosalokasilow1	= 3;
			// 	$prosalokasimed1	= 5;
			// 	$prosalokasihigh1	= 8;
			// }else if($alokasi1 == 'JS LINK PENDAPATAN TETAP'){
			// 	$prosalokasilow1	= 4;
			// 	$prosalokasimed1	= 7;
			// 	$prosalokasihigh1	= 12;
			// }else if($alokasi1 == 'JS LINK BERIMBANG'){
			// 	$prosalokasilow1	= 4;
			// 	$prosalokasimed1	= 8;
			// 	$prosalokasihigh1	= 13;
			// }else if($alokasi1 == 'JS LINK EKUITAS'){
			// 	$prosalokasilow1	= 5;
			// 	$prosalokasimed1	= 10;
			// 	$prosalokasihigh1	= 16;
			// }else{
		...
		foreach($hasilProDataRiderNew as $data) {
			...
			if($data->IS_CI53 != 0){
				$this->pdf->Cell(47.5,3,'JS Critical Illness 53 (JS CI 53)','L',0,'L');
			...
			if($data->IS_ADDB != 0){
				$this->pdf->Cell(47.5,3,'JS Accidental Death Dissmemberment','L',0,'L');
			...
			if($data->IS_ADB != 0){
				foreach($hasilProTertanggung as $datas) {
					if ($datas->EKSTRAPA_CTT != 0){
						$this->pdf->Cell(47.5,3,'JS Accident Death Benefit (JS ADB) *','L',0,'L');
					}else{
						$this->pdf->Cell(47.5,3,'JS Accident Death Benefit (JS ADB)','L',0,'L');
					}
				}
			...
			if($data->IS_HCP != 0){
				$this->pdf->Cell(47.5,3,'JS Hospital Cash Plan (JS HCP)','L',0,'L');
				$this->pdf->Cell(47.5,3,'65','L',0,'C');
			...
			/*Tambahan Untuk Rider JS Hospital Care*/
			if($data->IS_HCPCARE != '0'){
				$this->pdf->Cell(47.5,3,'JS Hospital Care Plan '.$data->IS_HCPCARE.' ','L',0,'L');
				$this->pdf->Cell(47.5,3,'70','L',0,'C');
				$this->pdf->Cell(47.5,3,number_format(ROUND($data->HCPCARE),0,',','.'),'L',0,'R');
				$this->pdf->Cell(47.5,3,number_format(ROUND($data->BIAYA_HCPCARE),0,',','.'),'LR',0,'R');
				$this->pdf->ln();
			}
			...
			if($data->IS_TPD != 0){
				foreach($hasilProTertanggung as $datas) {
					if ($datas->EKSTRATPD_CTT != 0){
						$this->pdf->Cell(47.5,3,'JS Total Permanent Dissability (JS TPD) *','L',0,'L');
					}else{
						$this->pdf->Cell(47.5,3,'JS Total Permanent Dissability (JS TPD)','L',0,'L');
					}
				}
			...
			if($data->IS_TR != 0){
				foreach($hasilProTertanggung as $datas) {
					if ($datas->EKSTRALIFE_CTT != 0){
						$this->pdf->Cell(47.5,3,'JS Term Rider (JS TR) *','L',0,'L');
					}else{
						$this->pdf->Cell(47.5,3,'JS Term Rider (JS TR)','L',0,'L');
					}
				}
			...
			if($data->IS_PBD != 0){
				foreach($hasilProPempol as $datas) {
					if ($datas->EKSTRALIFE_CPP != 0){
						$this->pdf->Cell(47.5,3,'JS Payor Death Benefit (JS PB-D) *','L',0,'L');
					}else{
						$this->pdf->Cell(47.5,3,'JS Payor Death Benefit (JS PB-D)','L',0,'L');
					}
				}
			...
			if($data->IS_PBCI != 0){
				$this->pdf->Cell(47.5,3,'JS Payor Benefit Critical Illness (JS PB-CI)','L',0,'L');
				$this->pdf->Cell(47.5,3,$maxasuransipayor,'L',0,'C');
			...
			if($data->IS_PBTPD != 0){
				$this->pdf->Cell(47.5,3,'JS Payor Total Permanent Dissability','L',0,'L');
				...
				foreach($hasilProPempol as $datas) {
					if ($datas->EKSTRATPD_CPP != 0){
						$this->pdf->Cell(47.5,3,'(JS PB-TPD) *','L',0,'L');
					}else{
						$this->pdf->Cell(47.5,3,'(JS PB-TPD)','L',0,'L');
					}
				}
			...
			if($data->IS_SPD != 0){
				foreach($hasilProPempol as $datas) {
					if ($datas->EKSTRALIFE_CPP != 0){
						$this->pdf->Cell(47.5,3,'JS Spouse payor Death Benefit (JS SP-D) *','L',0,'L');
					}else{
						$this->pdf->Cell(47.5,3,'JS Spouse payor Death Benefit (JS SP-D)','L',0,'L');
					}
				}
			...
			if($data->IS_SPCI != 0){
				$this->pdf->Cell(47.5,3,'JS Spouse Payor Critical Illness','L',0,'L');
				...
				$this->pdf->Cell(0,3,'','L');
				$this->pdf->ln();
				$this->pdf->Cell(47.5,3,'(JS SP-CI)','L',0,'L');
				$this->pdf->ln();
			}
			if($data->IS_SPTPD != 0){
				$this->pdf->Cell(47.5,3,'JS Spouse Payor Total Permanent','L',0,'L');
				$this->pdf->Cell(47.5,6,$maxasuransispousepayor,'L',0,'C');
				...
				foreach($hasilProPempol as $datas) {
					if ($datas->EKSTRATPD_CPP != 0){
						$this->pdf->Cell(47.5,3,'Dissability (JS SP-TPD) *','L',0,'L');
					}else{
						$this->pdf->Cell(47.5,3,'Dissability (JS SP-TPD)','L',0,'L');
					}
				}
			...
			if($data->IS_WPCI51 != 0){
				$this->pdf->Cell(47.5,3,'JS Waiver of Premium Critical Illness 51','L',0,'L');
				$this->pdf->Cell(47.5,6,'65','L',0,'C');
				...
				$this->pdf->Cell(0,3,'','L');		
				$this->pdf->ln();
				$this->pdf->Cell(47.5,3,'(JS WP CI 51)','L',0,'L');
				$this->pdf->ln();
			}
			if($data->IS_WPTPD != 0){
				$this->pdf->Cell(47.5,3,'JS Waiver of Premium Total Permanent','L',0,'L');
				$this->pdf->Cell(47.5,6,'65','L',0,'C');
				...
				foreach($hasilProTertanggung as $datas) {
					if ($datas->EKSTRATPD_CTT != 0){
						$this->pdf->Cell(47.5,3,'Dissability (JS WP-TPD) *','L',0,'L');
					}else{
						$this->pdf->Cell(47.5,3,'Dissability (JS WP-TPD)','L',0,'L');
					}
				}
		...
		$this->pdf->Cell(100,3,'*   Biaya sudah termasuk extra premi karena resiko pekerjaan.','',0,'L');
		$this->pdf->ln();
		...
		foreach($hasilProDataRiderNew as $data) {
			...
			if($data->IS_CI53 != 0){
				$this->pdf->Cell(50,3,'JS Critical Illness 53 (JS CI 53)',0,0,'L');
				$this->pdf->MultiCell(140,3,'Memberikan manfaat Uang Asuransi JS Critical Illness apabila Tertanggung didiagnosa pertama kali menderita salah satu dari 53 jenis Critical Illness sampai dengan ulang tahun Polis diusia Tertanggung 65 Tahun.',0);
				$this->pdf->ln(1);
				$x = $this->pdf->GetX();
				$y = $this->pdf->GetY();
				$this->pdf->ln(2);
			...
			if($data->IS_ADDB != 0){
				$this->pdf->Cell(50,3,'JS Accidental Death Dissmemberment',0,0,'L');
				$this->pdf->Cell(140,3,'Memberikan manfaat prosentase Uang Asuransi JS Accidental Death Dissmemberment apabila Tetanggung Meninggal Dunia',0);
				$this->pdf->ln(3);
			...
			if($data->IS_ADB != 0){
				$this->pdf->Cell(50,3,'JS Accident Death Benefit (JS ADB)',0,0,'L');
				$this->pdf->MultiCell(140,3,'Memberikan manfaat Uang Asuransi JS Accident Death Benefit apabila Tertanggung Meninggal Dunia karena kecelakaan sampai dengan ulang tahun Polis diusia Tertanggung 65 Tahun.',0);
				$this->pdf->ln(1);
				$x = $this->pdf->GetX();
				$y = $this->pdf->GetY();
				$this->pdf->ln(2);
			...
			if($data->IS_HCP != 0){
				$this->pdf->Cell(50,3,'JS Hospital Cash Plan (JS HCP)',0,0,'L');
				$this->pdf->MultiCell(140,3,'Memberikan santunan Rawat Inap, Rawat ICU, dan atau Rawat Bedah di Rumah Sakit. Manfaat JS Hospital Cash Plan + Bedah akan dibayarkan setelah pertanggungan berjalan 90 hari dan sampai dengan ulang tahun Polis diusia Tertanggung 65 Tahun.',0);
				$this->pdf->ln(1);
				$x = $this->pdf->GetX();
				$y = $this->pdf->GetY();
				$this->pdf->ln(2);
			...
			if($data->IS_HCPCARE != '0'){
				$this->pdf->Cell(50,3,'JS Hospital Care',0,0,'L');
				$this->pdf->MultiCell(140,3,'Memberikan santunan Rawat Inap, Rawat ICU, dan atau Rawat Bedah di Rumah Sakit.',0);
				$this->pdf->ln(1);
				$x = $this->pdf->GetX();
				$y = $this->pdf->GetY();
				$this->pdf->ln(2);
			...
			if($data->IS_TPD != 0){
				$this->pdf->Cell(50,3,'JS Total Permanent Dissability (JS TPD)',0,0,'L');
				$this->pdf->MultiCell(140,3,'Memberikan manfaat Uang Asuransi JS Total Permanent Dissability apabila Tertanggung menderita Total Permanent Dissability sampai dengan ulang tahun Polis diusia Tertanggung 65 Tahun',0);
				$this->pdf->ln(1);
				$x = $this->pdf->GetX();
				$y = $this->pdf->GetY();
				$this->pdf->ln(2);
			...
			if($data->IS_TR != 0){
				$this->pdf->Cell(50,3,'JS Term Rider (JS TR)',0,0,'L');
				$this->pdf->MultiCell(140,3,'Memberikan manfaat Uang Asuransi JS Term Life Insurance apabila Tertanggung Meninggal Dunia sampai dengan ulang tahun Polis diusia Tertanggung 65 Tahun',0);
				$this->pdf->ln(1);
				$x = $this->pdf->GetX();
				$y = $this->pdf->GetY();
				$this->pdf->ln(2);
			...
			if($data->IS_PBD != 0){
				$this->pdf->Cell(50,3,'JS Payor Death Benefit (JS PB-D)',0,0,'L');
			...
			if($data->IS_PBCI != 0){
				$this->pdf->Cell(50,3,'JS Payor Benefit Critical Illness (JS PB-CI)',0,0,'L');
			...
			if($data->IS_PBTPD != 0){
				$this->pdf->Cell(50,3,'JS Payor Total Permanent Dissability',0,0,'L');
				$this->pdf->Cell(140,3,'Apabila Pemegang Polis menderita Total Permanent Dissability sebelum berusia 65 tahun, maka diberikan manfaat pembebasan',0);
				$this->pdf->ln(3);
				$this->pdf->Cell(50,3,'(JS PB-TPD)',0,0,'L');
			...
			if($data->IS_SPD != 0){
				$this->pdf->Cell(50,3,'JS Spouse payor Death Benefit (JS SP-D)',0,0,'L');
			...
			if($data->IS_SPCI != 0){
				$this->pdf->Cell(50,3,'JS Spouse Payor Critical Illness (JS SP-CI)',0,0,'L');
			...
			if($data->IS_SPTPD != 0){
				$this->pdf->Cell(50,3,'JS Spouse Payor Total Permanent',0,0,'L');
				$this->pdf->Cell(140,3,'Apabila Pemegang Polis menderita Total Permanent Dissability sebelum berusia 65 tahun, maka diberikan manfaat pembebasan',0);
				$this->pdf->ln(3);
				$this->pdf->Cell(50,3,'Dissability (JS SP-TPD)',0,0,'L');
			...
			if($data->IS_WPCI51 != 0){
				$this->pdf->Cell(50,3,'JS Waiver of Premium Critical Illness 51',0,0,'L');
				...
				$this->pdf->ln(3);
				$this->pdf->Cell(50,3,'(JS WP CI 51)',0,0,'L');
			...
			if($data->IS_WPTPD != 0){
				$this->pdf->Cell(50,3,'JS Waiver of Premium Total Permanent',0,0,'L');
				$this->pdf->Cell(140,3,'Apabila Tertanggung menderita Total Permanent Dissability karena sakit atau karena kecelakaan, maka Pemegang Polis akan',0);
				$this->pdf->ln(3);
				$this->pdf->Cell(50,3,'Dissability (JS WP-TPD)',0,0,'L');
				$this->pdf->Cell(140,3,'dibebaskan dari kewajiban membayar premi sampai dengan ulang tahun Polis diusia Tertanggung 65 Tahun.',0);
				$this->pdf->ln(4);
				$x = $this->pdf->GetX();
				$y = $this->pdf->GetY();
		...
		$this->pdf->ln(7);
		$this->pdf->SetFont('Arial','B',12);
		$this->pdf->Cell(190,5,'JS SMART PROMAPAN (Jiwasraya Smart Proteksi Masa Depan)','B',0,'L');
		$this->pdf->ln(7);
		...
		$this->pdf->ln();
		$this->pdf->Cell(20,3,'',0,0,'L');
		$this->pdf->Cell(170,3,'Manfaat Polis dapat terus berlanjut, maka Anda diminta untuk melakukan top up sekaligus.',0,0,'L');
		$this->pdf->ln();
...
//		$this->pdf->ln();
		...
		$this->pdf->SetFont('Arial','B',6);
		$this->pdf->Cell(2);
		$this->pdf->Cell(0,5,'JS SMART PROMAPAN.',0,0,'L');
		$this->pdf->ln();
		$this->pdf->SetFont('Arial','',6);
		$this->pdf->Cell(1);
		...
		$this->pdf->ln();
		$this->pdf->Cell(1);
		$this->pdf->Cell(190,5,'9. Jumlah minimum Top Up Berkala adalah Rp. 100.000,-',0,0,'L');
		$this->pdf->ln();
		$this->pdf->SetFont('Arial','',6);
		
		$this->pdf->Cell(190,5,'10. Minimum penarikan dana (Redemptions) adalah Rp. 1.000.000,- dan menyisakan dana minimum Rp. 2.000.000,-',0,0,'L');
		$this->pdf->ln();
		$this->pdf->SetFont('Arial','',6);
		$this->pdf->Cell(190,5,'11. Produk JS SMART PROMAPAN tidak dikenakan biaya penarikan.',0,0,'L');
...
//		$this->pdf->Cell(12,5,'dikenakan biaya sebesar 2% dari total dana penarikan.',0,0,'L');
		...
		$this->pdf->ln();*/
		$this->pdf->SetFont('Arial','',6);
		$this->pdf->Cell(190,5,'12. Penilaian harga unit dilakukan pada setiap hari kerja, Senin sampai dengan Jum`at dengan menggunakan metode harga pasar yang berlaku bagi instrumen investasi yang mendasari masing-',0,0,'L');
		$this->pdf->ln();
		$this->pdf->SetFont('Arial','',6);
		$this->pdf->Cell(4);
		...
		$this->pdf->ln();
		$this->pdf->SetFont('Arial','',6);
		$this->pdf->Cell(190,5,'13. Besarnya Nilai Tunai yang terbentuk pada polis ini (dapat lebih besar atau lebih kecil dari dana yang diinvestasikan oleh Pemegang Polis), akan dipengaruhi oleh fluktuasi dari harga unit atau faktor ',0,0,'L');
		$this->pdf->ln();
		$this->pdf->SetFont('Arial','',6);
		$this->pdf->Cell(4);
		...
		$this->pdf->ln();
		$this->pdf->SetFont('Arial','',6);
		$this->pdf->Cell(190,5,'14. Perpanjangan masa pertanggungan asuransi tambahan setelah berakhirnya masa asuransi akan dilakukan underwriting/seleksi risiko ulang sehingga perpanjangan dapat diterima dengan rate ',0,0,'L');
		$this->pdf->ln();
		$this->pdf->Cell(4);
		$this->pdf->Cell(12,5,'standar atau bahkan ditolak.',0,0,'L');
		$this->pdf->ln();
		$this->pdf->SetFont('Arial','',6);
		$this->pdf->Cell(190,5,'15. Harga unit yang digunakan pada Premi Pertama akan terbentuk setelah diterimanya SPAJ dan teridentifikasinya seluruh pembayaran Premi Pertama di Kantor Pusat oleh Jiwasraya. Tanggal',0,0,'L');
		$this->pdf->SetFont('Arial','',6);
		$this->pdf->ln();
		$this->pdf->Cell(4);
		...
		$this->pdf->ln();
		$this->pdf->SetFont('Arial','',6);
		$this->pdf->Cell(190,5,'16. Memiliki Polis Asuransi Jiwa merupakan komitmen jangka panjang. JS SMART PROMAPAN adalah suatu produk asuransi jiwa yang dikaitkan dengan investasi. Untuk dapat menikmati manfaat polis ini,',0,0,'L');
		$this->pdf->ln();
		$this->pdf->SetFont('Arial','',6);
		$this->pdf->Cell(4);
		...
		*/
		...
		foreach($hasilProDataRiderNew as $data) {
			...
			if ($data->IS_ADB != 0)
			{
				...
				$this->pdf->Cell(1);
				$this->pdf->SetFont('Arial','',8);
				$this->pdf->Cell(140,5,'JS Accident Death Benefit (JS ADB): Memberikan manfaat Uang Asuransi JS Accident Death Benefit apabila ','LTR',0,'L');
				$this->pdf->SetFont('Arial','',8);
			...
			if ($data->IS_CI53 != 0)
			{
				...
				$this->pdf->Cell(1);
				$this->pdf->SetFont('Arial','',8);
				$this->pdf->Cell(140,5,'JS Critical Illness 53 (JS CI 53): Memberikan manfaat Uang Asuransi JS Critical Illness apabila Tertanggung','LTR',0,'L');
				$this->pdf->SetFont('Arial','',8);
			...
			if ($data->IS_WPCI51 != 0)
			{
				...
				$this->pdf->Cell(1);
				$this->pdf->SetFont('Arial','',8);
				$this->pdf->Cell(140,5,'JS Waiver of Premium Critical Illness 51 (JS WP CI 51): Apabila Tertanggung didiagnosa pertama kali ','LTR',0,'L');
				$this->pdf->SetFont('Arial','',8);
			...
			if ($data->IS_TR != 0)
			{
				...
				$this->pdf->Cell(1);
				$this->pdf->SetFont('Arial','',8);
				$this->pdf->Cell(140,5,'JS Term Rider (JS TR): Memberikan manfaat Uang Asuransi JS Term Life Insurance apabila Tertanggung ','LTR',0,'L');
				$this->pdf->SetFont('Arial','',8);
			...
			if ($data->IS_HCP != 0)
			{
				...
				$this->pdf->Cell(1);
				$this->pdf->SetFont('Arial','',8);
				$this->pdf->Cell(140,5,'JS Hospital Cash Plan (JS HCP): Memberikan santunan Rawat Inap, Rawat ICU, dan atau Rawat Bedah ','LTR',0,'L');
				$this->pdf->SetFont('Arial','',8);
				...
				$this->pdf->Cell(1);
				$this->pdf->SetFont('Arial','',8);
				$this->pdf->Cell(140,5,'di Rumah Sakit. Manfaat JS Hospital Cash Plan + Bedah akan dibayarkan setelah pertanggungan berjalan ','LR',0,'L');
				$this->pdf->SetFont('Arial','',8);
			...
			if ($data->IS_TPD != 0)
			{
				...
				$this->pdf->Cell(1);
				$this->pdf->SetFont('Arial','',8);
				$this->pdf->Cell(140,5,'JS Total Permanent Dissability (JS TPD) : Memberikan manfaat Uang Asuransi JS Total Permanent ','LTR',0,'L');
				$this->pdf->SetFont('Arial','',8);
				$this->pdf->Cell(50,5,number_format($data->TPD,0,'.',','),'LTR',0,'R');
				$this->pdf->ln(3);
				$this->pdf->Cell(1);
				$this->pdf->SetFont('Arial','',8);
				$this->pdf->Cell(140,5,'Dissability apabila Tertanggung menderita Total Permanent Dissability sampai dengan ulang tahun Polis','LR',0,'L');
				$this->pdf->SetFont('Arial','',8);
				$this->pdf->Cell(50,5,'','LR',0,'L');
				$this->pdf->ln(3);
				$this->pdf->Cell(1);
			...
			if ($data->IS_WPTPD != 0)
			{
				...
				$this->pdf->Cell(1);
				$this->pdf->SetFont('Arial','',8);
				$this->pdf->Cell(140,5,'JS Waiver of Premium Total Permanent Dissability (JS WP-TPD): Apabila Tertanggung menderita Total ','LTR',0,'L');
				$this->pdf->SetFont('Arial','',8);
				$this->pdf->Cell(50,5,number_format($data->WPTPD,0,'.',','),'LTR',0,'R');
				$this->pdf->ln(3);
				$this->pdf->Cell(1);
				$this->pdf->SetFont('Arial','',8);
				$this->pdf->Cell(140,5,'Permanent Dissability karena sakit atau karena kecelakaan, maka Pemegang Polis akan dibebaskan dari ','LR',0,'L');
				$this->pdf->SetFont('Arial','',8);
				$this->pdf->Cell(50,5,'','LR',0,'L');
				$this->pdf->ln(3);
				$this->pdf->Cell(1);
			...
			if ($data->IS_ADDB != 0)
			{
				...
				$this->pdf->Cell(1);
				$this->pdf->SetFont('Arial','',8);
				$this->pdf->Cell(140,5,'JS Accidental Death Dissmemberment Benefit (ADDB): Memberikan manfaat prosentase Uang Asuransi ','LTR',0,'L');
				$this->pdf->SetFont('Arial','',8);
				$this->pdf->Cell(50,5,number_format($data->ADDB,0,'.',','),'LTR',0,'R');
				$this->pdf->ln(3);
				$this->pdf->Cell(1);
				$this->pdf->SetFont('Arial','',8);
				$this->pdf->Cell(140,5,'JS Accidental Death Dissmemberment apabila Tetanggung Meninggal Dunia atau menderita cacat karena ','LR',0,'L');
				$this->pdf->SetFont('Arial','',8);
				$this->pdf->Cell(50,5,'','LR',0,'L');
				$this->pdf->ln(3);
				$this->pdf->Cell(1);
			...
			if ($data->IS_PBD != 0)
			{
				...
				$this->pdf->Cell(1);
				$this->pdf->SetFont('Arial','',8);
				$this->pdf->Cell(140,5,'JS Payor Death Benefit (JS PB-D): Apabila Pemegang Polis Meninggal Dunia, maka diberikan manfaat ','LTR',0,'L');
				$this->pdf->SetFont('Arial','',8);
			...
			if ($data->IS_PBCI != 0)
			{
				...
				$this->pdf->Cell(1);
				$this->pdf->SetFont('Arial','',8);
				$this->pdf->Cell(140,5,'JS Payor Benefit Critical Illness (JS PB-CI): Apabila Pemegang Polis didiagnosa pertama kali menderita salah','LTR',0,'L');
				$this->pdf->SetFont('Arial','',8);
			...
			if ($data->IS_PBTPD != 0)
			{
				...
				$this->pdf->Cell(1);
				$this->pdf->SetFont('Arial','',8);
				$this->pdf->Cell(140,5,'JS Payor Total Permanent Dissability (JS PB-TPD): Apabila Pemegang Polis menderita Total Permanent ','LTR',0,'L');
				$this->pdf->SetFont('Arial','',8);
				$this->pdf->Cell(50,5,number_format($data->PBTPD,0,'.',','),'LTR',0,'R');
				$this->pdf->ln(3);
				$this->pdf->Cell(1);
				$this->pdf->SetFont('Arial','',8);
				$this->pdf->Cell(140,5,'Dissability sebelum berusia 65 tahun, maka diberikan manfaat pembebasan pembayaran Premi terhadap Polis ','LR',0,'L');
				$this->pdf->SetFont('Arial','',8);
				$this->pdf->Cell(50,5,'','LR',0,'L');
				$this->pdf->ln(3);
				$this->pdf->Cell(1);
			...
			if ($data->IS_SPD != 0)
			{
				...
				$this->pdf->Cell(1);
				$this->pdf->SetFont('Arial','',8);
				$this->pdf->Cell(140,5,'JS Spouse payor Death Benefit (JS SP-D): Apabila Pemegang Polis Meninggal Dunia, maka diberikan manfaat','LTR',0,'L');
				$this->pdf->SetFont('Arial','',8);
			...
			if ($data->IS_SPCI != 0)
			{
				...
				$this->pdf->Cell(1);
				$this->pdf->SetFont('Arial','',8);
				$this->pdf->Cell(140,5,'JS Spouse Payor Critical Illness (JS SP-CI): Apabila Pemegang Polis didiagnosa pertama kali menderita salah','LTR',0,'L');
				$this->pdf->SetFont('Arial','',8);
			...
			if ($data->IS_SPTPD != 0)
			{
				...
				$this->pdf->Cell(1);
				$this->pdf->SetFont('Arial','',8);
				$this->pdf->Cell(140,5,'JS Spouse Payor Total Permanent Dissability (JS SP-TPD): Apabila Pemegang Polis menderita Total ','LTR',0,'L');
				$this->pdf->SetFont('Arial','',8);
				$this->pdf->Cell(50,5,number_format($data->SPTPD,0,'.',','),'LTR',0,'R');
				$this->pdf->ln(3);
				$this->pdf->Cell(1);
				$this->pdf->SetFont('Arial','',8);
				$this->pdf->Cell(140,5,'Permanent Dissability sebelum berusia 65 tahun, maka diberikan manfaat pembebasan pembayaran Premi ','LR',0,'L');
				$this->pdf->SetFont('Arial','',8);
				$this->pdf->Cell(50,5,'','LR',0,'L');
				$this->pdf->ln(3);
				$this->pdf->Cell(1);
		...
		$this->pdf->ln(10);
		$this->pdf->SetFont('Arial','',10);
		$this->pdf->Cell(190,5,'Pertanggungan asuransi JS SMART PROMAPAN tidak berlaku apabila Tertanggung meninggal dalam keadaan sebagai berikut:',0,0,'L');
		$this->pdf->ln(5);
		$this->pdf->SetFont('Arial','',10);
