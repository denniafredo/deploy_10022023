...
<h4 class="block">Calon Tertanggung</h4>
        ...
        <div class="form-group">
          ...
          <div class="col-md-6">
														<input type="text" class="form-control" name="namalengkapcalontertanggung" id="namalengkapcalontertanggung" placeholder="Nama Lengkap" readonly/>
                                                ...
                                                <div class="form-group">
                                                  ...
                                                  <div class="col-md-3">
										  <select class="form-control select2me" name="jeniskelamincalontertanggung" id="jeniskelamincalontertanggung" onChange="" disabled>
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="col-md-6">
													  <input class="form-control form-control-inline input-xs date-picker" id="tanggallahircalontertangggung" name="tanggallahircalontertangggung" size="16" type="text" value="" placeholder="Tanggal Lahir" onChange="" readonly/>
														<span class="help-block">
...
<div class="form-group">
		...
		<div class="input-group" style="display: none">
		  <input class="form-control" placeholder="" name="premi5tahunpertama" id="premi5tahunpertama" onchange="" readonly>
        ...
        <div class="input-group">
		  <input type="" class="form-control" placeholder="" name="premitahunke6danseterusnya" id="premitahunke6danseterusnya" onchange="" readonly>
<!--
          <span class="help-block" style="font-weight:bold;font-style:italic">
			...
			var premitahunke6danseterusnya = $("#premitahunke6danseterusnya").val();
				...
				$.ajax({
					...
					success : function(data) {
						if (data < 200000)
						{
							alert('Premi Minimal 200000!');
							document.getElementById('gaji').value = '';
							document.getElementById('jumlahrisikoawaljsgajiterusanplatinum').value = '';
							document.getElementById('premitahunke6danseterusnya').value = '';
						}
						else
						{
