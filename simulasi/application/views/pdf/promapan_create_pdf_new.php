...
//		JS CI53
		...
		$this->pdf->MultiCell(180,5,'Biaya pengelolaan investasi maksimal 2% per tahun tergantung jenis reksadana yang dipilih.',0,'J');
//		$this->pdf->Cell(4);
//		$this->pdf->Cell(190,5,'d. Biaya pembelian unit adalah sebesar 5% dari dana investasi.',0,0,'L');
//		$this->pdf->ln();
		$this->pdf->SetFont('Monserrat','',6);
		$this->pdf->Cell(5,5,'3.',0,0,'R');
		$this->pdf->MultiCell(185,5,'Jika unit yang terbentuk pada tahun 1 tidak mencukupi untuk membayar Biaya Asuransi, dan Biaya Administrasi, maka biaya-biaya tersebut dinyatakan sebagai biaya-biaya terhutang yang akan dipotong dari unit yang terbentuk pada bulan ke 13.',0,'J');
		...
		$this->pdf->MultiCell(180,5,'Besarnya Nilai Tunai yang dibayarkan (bisa lebih besar atau lebih kecil dari yang diilustrasikan) akan bergantung pada perkembangan dari dana investasi IFG LIFE PRIME PROTECTION.',0,'J');
		...
		$this->pdf->MultiCell(180,5,'Produk IFG LIFE PRIME PROTECTION tidak dikenakan biaya penarikan.',0,'J');
		...
		$this->pdf->MultiCell(180,5,'Memiliki Polis Asuransi Jiwa merupakan komitmen jangka panjang. IFG LIFE PRIME PROTECTION adalah suatu produk asuransi jiwa yang dikaitkan dengan investasi. Untuk dapat menikmati manfaat polis ini',0,'J');
		...
		$this->pdf->ln(5);
		$this->pdf->SetFont('Monserrat','',10);
		$this->pdf->MultiCell(190,5,'Pertanggungan asuransi IFG LIFE PRIME PROTECTION tidak berlaku apabila Tertanggung meninggal dalam keadaan sebagai berikut:',0,'J');
		$this->pdf->SetFont('Monserrat','',10);
