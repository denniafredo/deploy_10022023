...
class Modsmartpromapan extends CI_Model {
	...
	function getTarifUA_all($yearscalontertanggung){
		...
		$sql = "select * from JAIM_300_TARIF_SMART_PROMAPAN where USIA = '$yearscalontertanggung' ";
		$query = $this->db->query($sql);
	...
	function getTarifUA_SpousePayor($yearscalonpemegangpolis){
		...
		$sql = "select * from JAIM_300_TARIF_SMART_PROMAPAN where USIA = '$yearscalonpemegangpolis' ";
		$query = $this->db->query($sql);
