...
.state('aplikasiSPAJOnline.skkTertanggungMain', {
	url: '/skkTertanggungMain',
	views: {
		'tab11': {
			templateUrl: 'templates/SKKTertanggungMain.html?seed='+Math.floor(1000 + Math.random() * 9000).toString(),
			controller: 'skkTertanggungMainCtrl'
		}
	}
})
