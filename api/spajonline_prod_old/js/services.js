angular.module('app.services', []).factory('simpleFormValidatorByType', [
	...
	function () {
		...
		var tipedokumens = [{
			'id': '0',			'id_sae': '0',			'label': '--Pilih--'
		}, {
			'id': '1',			'id_sae': 'LAIN LAIN',			'label': 'LAIN-LAIN'
		}, {
			'id': '30',			'id_sae': 'KTP',			'label': 'KTP'
		}, {
			'id': '9',			'id_sae': 'KK',			'label': 'KARTU KELUARGA'
		}, {
			'id': '2',			'id_sae': 'AKTE LAHIR ANAK',			'label': 'AKTE KEL. ANAK'
		}, {
			'id': '3',			'id_sae': 'BUKTI ENTRY PREMI I',			'label': 'BATCH'
		}, {
			'id': '4',			'id_sae': 'BK',			'label': 'BERITA KEPUTUSAN'
		}, {
			'id': '5',			'id_sae': 'BP3',			'label': 'BP3/ BPPS DAN ID'
		}, {
			'id': '6',			'id_sae': 'BUKTI TRANSFER',			'label': 'BUKTI TRANSFER'
		}, {
			'id': '7',			'id_sae': 'CP',			'label': 'CASHPLAN'
		}, {
			'id': '8',			'id_sae': 'HASIL LABORATORIUM',			'label': 'HASIL PERIKSA LAB  MED'
		}, {
			'id': '10',			'id_sae': 'KMS',			'label': 'KMS ANAK'
		}, {
			'id': '11',			'id_sae': 'POLIS DUPLIKAT',			'label': 'KUMP DOC DUPLIKAT POLIS'
		}, {
			'id': '12',			'id_sae': 'EXPIRASI',			'label': 'KUMP DOC EXPIRASI (JATUH TEMPO)'
		}, {
			'id': '13',			'id_sae': 'BS BERKALA',			'label': 'KUMP DOC PEMB BS, ANUITAS BERKALA'
		}, {
			'id': '14',			'id_sae': 'PEMULIHAN POLIS',			'label': 'KUMP DOC PEMULIHAN POLIS'
		}, {
			'id': '15',			'id_sae': 'PERUBAHAN AHLI WARIS',			'label': 'KUMP DOC UBAH AHLI WARIS'
		}, {
			'id': '16',			'id_sae': 'PERUBAHAN ALAMAT',			'label': 'KUMP. DOC UBAH  ALAMAT'
		}, {
			'id': '17',			'id_sae': 'TEBUS',			'label': 'KUMPULAN DOC TEBUS'
		}, {
			'id': '18',			'id_sae': 'KONVERSI',			'label': 'KUMPULAN DOC. KONVERSI'
		}, {
			'id': '19',			'id_sae': 'TAHAPAN',			'label': 'KUMPULAN DOC. TAHAPAN'
		}, {
			'id': '20',			'id_sae': 'GADAI',			'label': 'KUMPULAN DOKUMEN GADAI POLIS'
		}, {
			'id': '21',			'id_sae': 'KLAIM',			'label': 'KUMPULAN DOKUMEN KLAIM MENINGGAL'
		}, {
			'id': '22',			'id_sae': 'LAMPIRAN POLIS',			'label': 'LAMPIRAN POLIS'
		}, {
			'id': '23',			'id_sae': 'LPK',			'label': 'LAP. PERIKSA KESEHATAN MEDICAL'
		}, {
			'id': '24',			'id_sae': 'DESISI',			'label': 'NOTA DESISI  SPAJ  HO'
		}, {
			'id': '25',			'id_sae': 'PROPOSAL SPAJ',			'label': 'PROPOSAL'
		}, {
			'id': '26',			'id_sae': 'SKK ANAK',			'label': 'SKK ANAK KHUSUS JS  PRESTASI/SMART'
		}, {
			'id': '27',			'id_sae': 'SPAJ',			'label': 'SPAJ/SKK'
		}, {
			'id': '28',			'id_sae': 'SURAT KUASA',			'label': 'SURAT KUASA'
		}, {
			'id': '29',			'id_sae': 'TANDA TERIMA POLIS',			'label': 'TANDA TERIMA POLIS'
		}, ];
		...
		var jeniasuransis = [{
			...
			"id": "JL4BLN",			"label": "JS PROMAPAN 2019",			"gruprider": "0",			"ctrl_pdf": "jspromapannew"
		}, {
			"id": "JL4XN",			"label": "JS PRO IDAMAN",			"gruprider": "0",			"ctrl_pdf": "jsproidaman"
		}, {
			"id": "JSPNNN",			"label": "JS PRESTASI",			"gruprider": "0",			"ctrl_pdf": "prestasi"
		}, {
			"id": "JSSPOA",			"label": "JS OPTIMA ASSURANCE",			"gruprider": "0",			"ctrl_pdf": "optima7"
		}, {
			"id": "JSDMPPN",			"label": "JS DMP",			"gruprider": "0",			"ctrl_pdf": "jsdmpplus"
		}, {
			"id": "JL4BLN_",			"label": "-",			"gruprider": "0",			"ctrl_pdf": "jspromapannew"
		}, ];
