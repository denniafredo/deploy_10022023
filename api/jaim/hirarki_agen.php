...
$sqlktr = "";
if($p3 != 'all'){
  $sqlktr = "AND m.KDKANTOR = '$p3'";	
}
$sql =" SELECT * FROM (SELECT 	m.noagen,
				m.kdkantor,
           	   	m.kdjabatanagen,
           	   	namajabatanagen,
	   ...
	   FROM tabel_400_agen m, TABEL_413_JABATAN_AGEN n, tabel_100_klien o
	        WHERE m.kdjabatanagen = n.kdjabatanagen 
	        	  ...
	        	  AND m.KDJABATANAGEN IN ('24','25','26','27')
	        	  AND m.noagen = '$p6'
	        	  AND m.noagen NOT IN (SELECT NOAGEN FROM tabel_400_agen
	        	  						 WHERE kdstatusagen not in ('02','04') 
								        	  ".$sqlktr."
								      	START WITH noagen = '$p6'
