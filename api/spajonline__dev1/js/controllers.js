	...
	function ($state, $scope, $stateParams, spajProvider, dataFactory, $store, $ionicPopup) {
		...
		$scope.init_data = function () {
			$scope.data = {
				...
				'masaBayarPremi': (prospek.kd_produk == 'JL4BLN' || prospek.kd_produk == 'JL4BLN_' || prospek.kd_produk == 'JL4XN') ? "99" : "5",
				'premi': prospek.jumlah_premi,
				'uangAsuransi': prospek.jua,
				'jangkaWaktuAsuransi': (prospek.kd_produk == 'JL4BLN' || prospek.kd_produk == 'JL4BLN_' || prospek.kd_produk == 'JL4XN') ? "99" : "5", //data.jenisAsuransi == 'JL4BLN' || data.jenisAsuransi == 'JL4BLN_' || data.jenisAsuransi == 'JL4XN'
				'nomorRekening': '',
...
.controller('daftarSPAJOnlineCtrl', ['$scope', '$state', '$stateParams', 'spajProvider', 'dataFactory', '$ionicPopup', '$http', '$ionicLoading', '$location', '$store', '$ionicScrollDelegate',
	function ($scope, $state, $stateParams, spajProvider, dataFactory, $ionicPopup, $http, $ionicLoading, $location, $store, $ionicScrollDelegate) {
		...
		$scope.retrySubmit = function(guid){
			alert(guid);
		}
...
/* 		$scope.scrollTo = function (target) {
		...
		$http({
			...
			spajProvider.setProspekListData($scope.idagen,$scope.dataProspek);
