angular.module('starter', ['ionic'])
    ...
    .controller('LoginCtrl', function($scope, $state,$http,$ionicPopup,$ionicLoading) {
        ...
        $scope.login = function() {
			try{
				let url =  "http://jaim.jiwasraya.co.id/mobileapi/spaj_bridge/get.php?act=login_espaj&idagen="+this.user.username+"&password="+this.user.password;
				var send = "idagen="+this.user.username+"&password="+this.user.password
