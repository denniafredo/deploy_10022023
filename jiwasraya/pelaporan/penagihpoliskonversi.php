<? 
  ...
  echo "<a class=verdana10blk><b>INFORMASI POLIS AKTIF KANTOR $kantor PER PENAGIH</b></a>";	
	//echo "<hr size=1>";
	?>
...
*/
 ...
 $i++;
  ...
  ?>
					 ...
					 echo "</div>";
?>
 <a href="penagihpoliskonversi_all.php"><font color="#ffffff">Rekap Autodebet</font></a> 
<?					 
	echo "<hr size=1>";
