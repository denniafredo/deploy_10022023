	...
	case 'tebus':
	 switch ($status) {
	  ...
	  case '1':
  	 ...
  	 //$cetaksip = "<a href=\"#\" onclick=\"window.location.replace('../polis/pengajuantebus2_ptg.php?prefix=$prefix&noper=$noper&kdbayar=G01GADAI')\">Cetak Surat Penyataan, Akta, Ijin Gadai</a>";
		 $cetaksip = '';
		 break;
		case '2':
