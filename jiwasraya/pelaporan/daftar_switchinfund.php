...
<?
  if(isset($_GET['tglcari'])){
	...
	if($_POST['dtgl']=="all" || substr($_GET['tglcari'],0,3)=="all"){
	  $filtercari = "and to_char(a.tglpengajuan,'MM/YYYY')='".substr($tglcari,-7)."' ";
		$titletglcari = "BULAN ".substr($tglcari,-7);
	} else {
	  $filtercari = "and to_char(a.tglpengajuan,'DD/MM/YYYY')='$tglcari' ";
		$titletglcari = "TANGGAL ".$tglcari;
	}
	 
?>
<b>DAFTAR SWITCHING FUND<BR /> 
MUTASI <?=$titletglcari;?> </b>
<?

if ($HTTP_POST_VARS['check'] || $_POST['check'] == 'Update') {
...
<table border="0" cellpadding="2" cellspacing="1" style="border-collapse: collapse" bordercolor="#CCCCCC" width="100%" id="AutoNumber1">
  <tr>
    ...
    <td bgcolor="#89acd8" align="center">Produk Baru</td>
	...
	<td bgcolor="#89acd8" align="center">Check</td>
  </tr>
  <? 
	$sql = "select ".
              "c.kdrayonpenagih,a.prefixpertanggungan,a.nopertanggungan,a.kdproduk,d.namaproduk,".
							"kdproduknew, ".
              "to_char(a.tglupdated,'DD/MM/YYYY') tglmutasi,a.userupdated, ".
              "to_char(a.tglpengajuan,'DD/MM/YYYY') tgltransfer, ".
          ...
          "from  ".
              ...
              "$DBUser.TABEL_223_TRANSAKSI_SWITCHFUND a, ".
    ...
    <td style="border-left-width: 1; border-right-width: 1; border-top: 1px solid #D8E1FA; border-bottom: 1px solid #D8E1FA"><?=$arr["TERTANGGUNG"];?></td>
		...
		<td style="border-left-width: 1; border-right-width: 1; border-top: 1px solid #D8E1FA; border-bottom: 1px solid #D8E1FA" align="center"><?=$arr["KDPRODUKNEW"];?></td>
	...
	?>
	<tr bgcolor="#f5d79c">
	 <td align="center" colspan="5"><b>JUMLAH <?=$cabas;?></b></td>
	 <td align="right"><?=number_format($jmltotal,2,",",".");?></td>
	 
	 <td align="right" colspan="6"><? if ($jabatan=="LINK" || $jabatan=="ADMINISTRATOR"){
