	...
	echo "<div align=center>";
				  ...
				  $sql = "select a.prefixpertanggungan,a.nopertanggungan,a.kdproduk,".
	               ...
	               "from $DBUser.tabel_200_pertanggungan a ".
			           "where a.nopenagih='$nopenagih' and a.kdpertanggungan='2' ".
		          ...
		          case "12": $bln = "Desember"; break;
					 ...
					 echo "<a class=verdana10blk><b>Daftar Polis Periode $bln $vthn</b></a><br><br>";
					    ...
					    echo("<td align=center><b>Produk</b></td>");
							echo("<td align=center><b>No.BP3</b></td>");
              ...
              echo("<td class=verdana8blk>".$i."</td>");
		          ...
		          echo("<td class=verdana8blk>".$PER->namatertanggung."</td>");
							...
							echo("<td class=verdana8blk align=center>".$arr["NOBP3"]."</td>");
