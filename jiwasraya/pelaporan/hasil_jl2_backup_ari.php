...
-->
    ...
    <td style="border-left-width: 1; border-right-width: 1; border-top: 1px solid #D8E1FA; border-bottom: 1px solid #D8E1FA" align="right"><?=number_format($arr["JMLPREMI"]/100,2,",",".");?></td>
...
//	$jmltotaldebet += $arr["PREMITAGIHAN"]+$arr["MATERE"]-$discount;
  $jmltotaldebet += $arr["JMLPREMI"]; // dirubah untuk sementara oleh dedi 28/12/2012
	...
	<tr bgcolor="#f5d79c">
	 ...
	 <td align="right"><?=number_format($jmltotaldebet/100,2,",",".");?></td>
	 <td></td>
