...
?></td>
 ...
 <td colspan="2"><input type="submit" name="submit" value="Cari"></input> &nbsp;<a href="./daftar_point_nonton.php">VIEW DETAIL</a></td>
...
if ($kantornya=='KP') {
	...
	$filterktr=" AND a.PREFIXPERTANGGUNGAN IN 
		...
		$sql = "SELECT KANTOR, NOPOL, PEMPOL, MULAS,CARA,sum(PREMI1) PREMI1,PRODUK,MAX(LUNAS)LUNAS, SUM(POINTNYA) POINTNYA FROM (SELECT   a.prefixpertanggungan kantor,a.prefixpertanggungan||a.nopertanggungan nopol,
         (SELECT   namaklien1
 ...
 WHERE       a.prefixpertanggungan = b.prefixpertanggungan
         ...
         AND PREMI1 >= 500000
		   ".$filterktr."
order by   a.prefixpertanggungan, premi1) GROUP BY KANTOR, NOPOL, PEMPOL, MULAS,CARA,PRODUK";
  $kantorcetak=$kantor1;
