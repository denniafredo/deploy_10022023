...
//		echo $sq1;
    ...
    // Periode Tgl Awal s/d Tgl Sampai
	// UNTUK UNIT LINK C.4 AMBIL DATA DARI RUGI LABA BUKAN ARUS KAS 
	if (/*$nourut=='C.3.'||*/$nourut=='C.4.1'||$nourut=='C.4.2'||$nourut=='C.5.'/*||$nourut=='C.6.'*/||$nourut=='C.7.'){
	...
	elseif ($nourut=='C.5.2.'||$nourut=='C.3.1.'||$nourut=='C.3.2.'){
		$sq2 = "select sum(debet) AS DEBET, sum(kredit) AS KREDIT, abs(sum(debet)-sum(kredit)) JML ".
			   "from $DBUser.tabel_802_trvouc ".
    ...
    // Periode Tgl Dari s/d Tgl Sampai
	// UNTUK UNIT LINK C.4 AMBIL DATA DARI RUGI LABA BUKAN ARUS KAS 
	if ($nourut=='C.3.'||$nourut=='C.4.'||$nourut=='C.4.1'||$nourut=='C.4.2'||$nourut=='C.5.'/*||$nourut=='C.6.'*/||$nourut=='C.7.'){
...
//		echo "$kdktr=".$kdktr."&dthn=".$dthn."&tglDariCari=".$tglAwalCari."&tglSampaiCari=".$tglSampaiCari."&akun=".$akun;
		...
		if ($nourut=='C.1.' || $nourut=='C.2.1.'|| $nourut=='C.2.2'|| $nourut=='C.4.1'|| $nourut=='C.4.2'||/*$nourut=='C.4.3'||$nourut=='C.4.4'||*/$nourut=='C.5.1.'||$nourut=='C.5.2.'||$nourut=='C.5.3.'||$nourut=='C.6'){
...
<?
		if ($dthn<='2008'){
			...
			"'123332800',".
			"'123332900',".
			"'123131304',". //rek extra income
			"'123131701',". //rek optima 7
			"'123333000',".
			"'123120000','123131700','123120900','123121000')"; //rek saving plan dan optima
		}
...
?>
 ...
 <tr>
 	<td></td>
  <td><p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;C.3.1. Premi Unit Link Berkala </p></td>
<?
		if ($dthn<='2008'){
			$kdrekening="('0')";
		}else{
			...
			echo nilaiRekening('C.3.1',$DBA,$wherektr1,$kdktr,$whereposted,$dthn,$kdrekening,$tglAwalCari,$tglDariCari,$tglSampaiCari);

?>
 </tr>
 <tr>
 	<td></td>
  <td><p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;C.3.2. Premi Unit Link Sekaligus </p></td>
<?
		if ($dthn<='2008'){
			$kdrekening="('0')";
		}else{
			...
			echo nilaiRekening('C.3.2',$DBA,$wherektr1,$kdktr,$whereposted,$dthn,$kdrekening,$tglAwalCari,$tglDariCari,$tglSampaiCari);
...
?>
 ...
 <tr>
 <td></td>
  <!--<td><p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;C.5.2. Saving Plan Bancassurance</p></td>-->
  <td><b><p>&nbsp;&nbsp;&nbsp;C.4. Bancassurance </p></b></td>
	<?
	if ($dthn<='2008'){
			$kdrekening="('0')";
		}else{
			...
			//echo nilaiRekening('C.5.3.',$DBA,$wherektr1,'KP',$whereposted,$dthn,$kdrekening,$tglAwalCari,$tglDariCari,$tglSampaiCari);
 ...
 <tr>
 	<td></td>
  <td><b><p>&nbsp;&nbsp;&nbsp;C.5. Premi Autodebet </p></b></td>
<?
		if ($dthn<='2008'){
			$kdrekening="('0')";
		}else{
...
?>
 ...
 <tr>
	...
	<tr bgcolor="#a9d8e7">
		...
		<td align="right"><?=number_format($jmlpreminbpp1+$jmlpremisub1+$jmlpremitop1+$berkala2+$sekaligus2+$topupskg2+$topupbk2+$arsp["PREMI"],2,",","."); $prmnbpp=$jmlpreminbpp1+$jmlpremisub1+$jmlpremitop1+$berkala2+$sekaligus2+$topupskg2+$topupbk2+$arsp["PREMI"];?></td>
<?
...
?>
 ...
 <tr>
 	<td></td>
  <td><p>&nbsp;&nbsp;&nbsp;D.1. Saving Plan PK</p></td>
<?
		if ($dthn<='2008'){
      $kdrekening="('0')";
		}else{
  		$kdrekening="('123237800','123238200','123237700','123238100')";
		}
...
<tr>
 	<td></td>
  <td><p>&nbsp;&nbsp;&nbsp;D.2. NB PK Berkala</p></td>-->
<?
		if ($dthn<='2008'){
      $kdrekening="('0')";
		}else{
  		$kdrekening="('123220100',
					'123220200',
					'123220300',
					'123220400',
					'123220500',
...
<tr>
 	<td></td>
  <td><p>&nbsp;&nbsp;&nbsp;D.3. NB PK Sekaligus</p></td>
<?
		if ($dthn<='2008'){
      $kdrekening="('0')";
		}else{
  		$kdrekening="('123230100',
					'123230200',
					'123230300',
					'123230400',
					'123230500',
			...
			echo nilaiRekening('D.3.',$DBA,$wherektr1,$kdktr,$whereposted,$dthn,$kdrekening,$tglAwalCari,$tglDariCari,$tglSampaiCari);
?>
</tr>
...
?>
 ...
 <tr>
  ...
  <td><p>&nbsp;&nbsp;&nbsp;F.1. Pertanggungan Perorangan (C+E.1)</p></td>
		...
		<td align="right"><?=number_format($prmnbpp+$jmlpreminbobpp1,2,",",".");//number_format($jmlpreminbpp1+$jmlpreminbobpp1,2,",",".");?></td>
<?
...
?>
 ...
 <tr bgcolor="#ffffcc">
 	<td><b>II</b></td>
  <td colspan="5"><b>Rekening Perantara Unit Link</b></td>
 </tr>
 <tr>
 	<td></td>
  <td>- Rekening Perantara Unit Link Berkala</td>
<?
		if ($dthn<='2008'){
      $kdrekening="('0')";
    }else{
		  $kdrekening=
			...
			//$kdktr=$ktr;
			//echo '$wherektr'.$wherektr;
			//echo '$wherektr1'.$wherektr1;
			//echo '$kdktr'.$kdktr;
			echo nilaiRekening('X.1',$DBA,$wherektr1,$kdktr,$whereposted,$dthn,$kdrekening,$tglAwalCari,$tglDariCari,$tglSampaiCari);
?>
 </tr>
 <tr>
 	<td></td>
  <td>- Rekening Perantara Unit Link Sekaligus</td>
<?
		if ($dthn<='2008'){
      $kdrekening="('0')";
    }else{
...
//      $kdrekening="('500000','500001','500002','500003','500004','500005','500006','500007','500008','500010','500011','500020','500021','500100','500101','500102','500103','500111','500121','500131','500200','500201','500202','500203','500211','500212','500300','501000','501001','501002','501003','501004','501005','502000','502001','503000','503001','503002','504000','505000','507000','508000','508001','509000','509001','509003','509004','510000','511000','512000','512001','513000','514000','515000','516000','517000','518000','519000','520000','525000','526000','527000','528000','529000','540000','541000','542000','544000','545000','549000','543000','502002','525001','500015','500009','507002','525002')";
		  ...
		  /*"(select AKUN from TABEL_802_RUGILABA_DETAIL ".
			...
			'564000000','565000000','512111001','512111002','511140004','512109000',
			'512109100',
			'512109200',
			'512109300',
			'512201000',
			...
			//echo '$wherektr1'.$wherektr1;
			//echo '$kdktr'.$kdktr;
			echo nilaiRekening('X.2',$DBA,$wherektr1,$kdktr,$whereposted,$dthn,$kdrekening,$tglAwalCari,$tglDariCari,$tglSampaiCari);
?>
 </tr>
