...
<!--  	 <td>272007</td>-->
  	 ...
  	 <td align="right"><?=number_format(($jmlpremi+$jmlpremi_di+$jmlpremi_va)-($jmlmatre+$jmlmatre_di+$jmlmatre_va)+($jmldiskon+$jmldiskon_di+$jmldiskon_va),2,",",".");?></td><? //echo $jmlpremi+$jmlpremi_di+$jmlpremi_va;?>
  	 <td align="right"></td>
  	</tr>
<!--
		<tr>
