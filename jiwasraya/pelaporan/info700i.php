<?
  ...
  if($update_pending=1){
    ...
    /* Tambahan untuk mencatat historis pulih - Teguh 24/03/2020 */
    $sqlip = "INSERT INTO $DBUser.TABEL_716_HISTORIS_MUTASI_PUL (prefixpertanggungan, nopertanggungan, status, keterangan, tglrekam, userrekam)
              VALUES ('$prefixpertanggungannew', '$nopertanggungannew', 'Lanjut',  '-', sysdate, '$userid')";
    $DBU->parse($sqlip);
    $DBU->execute();
   /* End Tambahan insert Historis Pulih*/
  }
?>
