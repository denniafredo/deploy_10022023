...
//		echo $sq1;
    ...
    // Periode Tgl Dari s/d Tgl Sampai
	// UNTUK UNIT LINK C.4 AMBIL DATA DARI RUGI LABA BUKAN ARUS KAS ||$nourut=='C.4.1'||$nourut=='C.4.2'
...
?>
 <tr>
 	<td></td>		
  <td><p>&nbsp;&nbsp;&nbsp;A.1. Pertanggungan Perorangan
  <? echo "(<a href=\"#\" onclick=\"NewWindow('nilaixbobot_jlindo_anp.php?wherektr=".$kdktr."&tglDariCari=".$tglDariCari."&tglSampaiCari=".$tglSampaiCari."','popuppage','1000','300','yes')\">";?>ANP)</a></td>
...
<!-- 
 tidak diperlukan lagi udah ngambil dari R/L	
	 <tr>
 	<td></td>
...
//======================================
 ...
 <tr>
 <td></td>
  <td><p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;C.5.1. Saving Plan/Optima</p></td>
	<!--<td align="right"><?//=number_format(0,2,",",".");?></td>
	...
	if ($dthn<='2008'){
			...
			$kdrekening="('123120000','123131700','123120900','123121000','123131701','241170000','241171000')"; //tambah optima
		}
 ...
 <td></td>
  ...
  <td><b><p>&nbsp;&nbsp;&nbsp;C.6. Bancassurance </p></b></td>
	<?
	if ($dthn<='2008'){
			$kdrekening="('0')";
		}else{
 ...
 <tr>
 	<td></td>
  <td><b><p>&nbsp;&nbsp;&nbsp;C.7. Premi Autodebet </p></b></td>
<?
		if ($dthn<='2008'){
			$kdrekening="('0')";
		}else{
