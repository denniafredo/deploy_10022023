...
<a class="verdana10blk"><b>PENERIMAAN PREMI OB PER KANTOR CABANG</b></a>
<hr size="1">
    <table>
...
if($vtgl=="" && $vbln=="" && $vthn=="") {
   ...
   $sql = "select ".
	...
	echo "<a class=verdana10blk><b>Penerimaan Premi OB RO ".$tglheader."</b></a><br>".
