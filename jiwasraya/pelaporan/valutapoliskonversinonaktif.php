<? 
  ...
  echo "<a class=verdana10blk><b>INFORMASI POLIS NON AKTIF KANTOR $kantor PER VALUTA</b></a>";	
	echo "<hr size=1>";
	?>
...
<?
  ...
  $DB->parse($qry);
	...
	echo "<div align=center>";
	           ...
	           $jmlproposal = ($jmlpol=="") ? '-' : "<a href=\"#\" onclick=\"NewWindow('portopoliokantorvalutanonaktif.php?valuta=$kdval','popuppage','1000','400','yes')\"><b>$jmlpol</b></a>";
