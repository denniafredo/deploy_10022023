...
<html>
<head>
<title>Hasil Citibank 1Bill/BNI Credit Card</title>
<style type="text/css">
<!-- 
body { 
 font-size: 12px;
...
<form name="getpremi" action="<?=$PHP_SELF;?>" action="post">
  ...
  <?  ShowFromDate(10,"Past"); ?>
   ...
   <? if ($kdbank=='CTB') {$banknya='CITIBANK';} else {$banknya='BNI';};?>
</form>
<br />
	...
	$sql = "select ".
			  ...
			  "where ".
				...
				"b.nopenagih=c.nopenagih and a.void='0' and b.kdvaluta='1' and ".
							"to_char(a.entry_time,'YYYYMM') ='$bulancari' ".
...
if($kdbank=="BMRI" || $kdbank=="BBRI") {
	$sql = "select ".
			  ...
			  "where ".
				...
				//X"b.nopertanggungan=d.nopertanggungan and a.tglbooked=d.tglbooked and ".
				"b.nopenagih=c.nopenagih and a.void='0' and b.kdvaluta='1' and ".
							"to_char(a.entry_time,'YYYYMM') ='$bulancari' and ".
							//"to_char(a.tglupdated,'YYYYMMDD') between '$tglawal' and  '$tglakhir' and ".
							"c.kdrayonpenagih='$kantor' and ".
							"b.kdproduk=e.kdproduk and a.company_code='".$kdbank."' ";} else {
		$sql = "select ".
					"distinct e.kdcabas as cabas ".
				  "from ".
				   //X "$DBUser.tabel_300_historis_premi d,".
  ...
  foreach ($arr as $foo => $row ) {
    ...
    if($kdbank=="BMRI" || $kdbank=="BBRI") {
		   ...
		   WHERE       b.prefixpertanggungan = SUBSTR (a.no_polis, 1, 2)
				   ...
				   AND a.void = '0'
				   AND b.kdvaluta = '1'
				   AND TO_CHAR (a.entry_time, 'YYYYMM') = '$bulancari'
...
$sql = "select ".
          ...
          "where ".
            ...
            "b.nopenagih=c.nopenagih and a.statuspembayaran='2' and b.kdvaluta='0' and ".
						"to_char(a.tglrekam,'YYYYMM') between '$tglawal' and  '$tglakhir' and ".
						//"to_char(a.tglupdated,'YYYYMMDD') between '$tglawal' and  '$tglakhir' and ".
						"c.kdrayonpenagih='$kantor' and ".
            "b.kdproduk=e.kdproduk and a.kdbank='".$kdbank."' ";}
	$DB->parse($sql);
...
//
          ...
          "where ".
            ...
            "b.nopenagih=c.nopenagih and ".
						"a.statuspembayaran='2' and ".
						"b.kdvaluta='0' and ".
						"to_char(a.tglrekam,'YYYYMM') between '$bulancari' and ".
            //"to_char(a.tglupdated,'YYYYMMDD') between '$tglawal' and  '$tglakhir' and ".
            "c.kdrayonpenagih='$kantor' and ".
						"b.kdproduk=e.kdproduk and e.kdcabas='$cabas' and a.kdbank='".$kdbank."' ".
...
if ($mode!='print'){
?> 
 		<a href="rekap_1bill.php"><font color="#ffffff">Rekap 1bill</font></a>
<? 
		echo "<hr size=1>";
		echo "<a class=verdana10blk href=\"index.php\">Menu Pelaporan</a>";
		echo("<font face=Verdana size=1>&nbsp;&nbsp;|&nbsp;&nbsp;</font>");
		echo("<font face=Verdana size=1><a href=\"#\" onclick=\"window.open('hasil_1bill.php?nmbank=".$nmbank."&banknya=".$banknya."&month=".$month."&year=".$year."&kdbank=".$kdbank."&mode=print','','width=1000,height=600,top=100,left=100,scrollbars=yes');\"><img src=../img/cetak.gif align=absmiddle border=0> Cetak Laporan</a></font>");
}
?>
</body>
</html>
