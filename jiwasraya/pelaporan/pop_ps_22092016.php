  	...
  	?>
		  ...
		  <tr>            
            <td align="left"><table width="200" border="1" cellpadding="2" cellspacing="1" style="border-collapse: collapse">
              <tr>
                <td><div align="center">NOMOR POLIS ANDA</div></td><td><div align="center">RAYON</div></td><td><div align="center">PERIODE</div></td>
                </tr>
              <tr>
                <td><div align="center"><?=$arr["NOPOLLAMA"];?></div></td><td><div align="center"><?=$arr["KDRAYONPENAGIH"];?></div></td><td><div align="center"><?=$arr["TGLBOKEES"];?></div></td>
                </tr>
            </table></td>
			<td>&nbsp;</td>
            <td>&nbsp;</td>
          ...
          <tr>
            ...
            <table border="1" cellpadding="2" cellspacing="1" style="border-collapse: collapse" bordercolor="#CCCCCC" width="100%">
					...
					if($kdkantor== 'all'){
						$sqlx= "SELECT  to_char(sysdate,'DD/MM/YYYY') cetak,b.prefixpertanggungan||b.nopertanggungan as nopol, b.nopol as nopollama,
						 ...
						 decode(b.kdvaluta,'1',d.premitagihan,'0',
						  ...
						  decode(to_char(a.tglbooked,'MM/YYYY'),to_char(a.tglrekam,'MM/YYYY'),DECODE(SUBSTR(b.KDPRODUK,1,3),'JL2',0,'JL3',0,'JL4',0,1)*
						   decode(b.kdvaluta,'1',d.premitagihan,'0',
              ...
              <tr>
                ...
                <td align="right"><?=number_format($arx["MATERAI"],2,',','.');?></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td align="center"><?=$arx["TGLPENDEBETAN"];?></td>
