<?
  ...
  $DB=new Database($userid, $passwd, $DBName);
	$KT=new Klien($userid,$passwd,$nopenagih);
  
echo "<body>";
echo "<link href=\"../jws.css\" rel=\"stylesheet\" type=\"text/css\">";
echo "<font face=\"verdana\" size=\"2\"><b>Nama Penagihan : ".$KT->nama." (".$nopenagih.")</b></font><br>";
...
if ($cek==NULL) {
  ...
  if($vbln==""){
	  $periode="to_char(c.tglbooked,'YYYY')='$vth' and a.kdstatusfile='1' and (c.status is null or c.status!='4')";
	} else {
	  $periode="to_char(c.tglbooked,'MMYYYY')='$vbln$vth' and a.kdstatusfile='1' and (c.status is null or c.status!='4')";
	}
	...
	$qry ="select c.prefixpertanggungan,c.nopertanggungan,(select b.namaklien1 from ".
			 ...
			 "d.notasi,c.premitagihan,a.juamainproduk ".
			 "from $DBUser.tabel_200_pertanggungan a,$DBUser.tabel_300_historis_premi c,".
			 "$DBUser.tabel_304_valuta d,$DBUser.tabel_305_cara_bayar e,$DBUser.tabel_500_penagih f ".
			 "where a.kdpertanggungan='2' and a.nopenagih=f.nopenagih and ".
			 "f.nopenagih='$nopenagih' and c.prefixpertanggungan=a.prefixpertanggungan and ".
			 "c.nopertanggungan=a.nopertanggungan and c.tglseatled is null and ".
			 "a.kdvaluta=d.kdvaluta and a.kdcarabayar=e.kdcarabayar and ".
			 "$periode $sambung ".
...
echo "<hr size=\"1\">";
echo "<font face=\"verdana\" size=\"2\"><a href=\"premitagihanpenagih.php?nopenagih=$nopenagih&vbln=$vbln&vthn=$vth\">Back</a></font>";
echo "</body>";
?>
