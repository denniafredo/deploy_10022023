...
<font face="Verdana" size="2"><b>PEMBERITAHUAN PROPOSAL MELALUI EMAIL DAN TRACKING PROPOSAL</b><br>
Kantor : <?echo $kantor; ?>
<hr size="1">
<a class="verdana8blu">
...
<li>Untuk kasus terjadi kesalahan entry atau pengiriman, sejauh belum dilakukan Approval oleh Divisi OBR, jika ingin dikoreksi, harus sepengetahuan Bagian Underwriting Divisi OBR.</li>
<li><b>Perhatikan Syarat agar portofolio bisa dikirim emailnya antara lain:<br></b>
Penagih TIDAK KOSONG, Data Keterangan Kesehatan Sudah Lengkap
...
//	echo "Ari ".$nilairp." - ".$PERT->premi1." - ".$TR->Kurs($PERT->valuta,$tglbp3);
  ...
  <tr>
    ...
    <td bgcolor="#FFFFFF" align="center"><font face="Verdana" size="1"><? echo "<a href=\"#\" onclick=\"NewWindow('../polis/polis.php?j=1&prefix=".$arr["PREFIXPERTANGGUNGAN"]."&noper=".$arr["NOPERTANGGUNGAN"]."','',800,500,1)\">"./*$arr["PREFIXPERTANGGUNGAN"]."-".$arr["NOPERTANGGUNGAN"]*/$arr['NOPOLBARU']."</a></font></td>";?>
...
//-------------------------------------------------- start medical --------------------------------
	$sql  = "select ".
      				  "a.prefixpertanggungan,a.nopertanggungan,a.nopolbaru,".
  ...
  <tr>
    ...
    <td width="10%" bgcolor="#FFFFFF" align="center"><font face="Verdana" size="1"><? echo "<a href=\"#\" onclick=\"NewWindow('../polis/polis.php?j=1&prefix=".$arr["PREFIXPERTANGGUNGAN"]."&noper=".$arr["NOPERTANGGUNGAN"]."','',800,500,1)\">"./*$arr["PREFIXPERTANGGUNGAN"]."-".$arr["NOPERTANGGUNGAN"]*/$arr['NOPOLBARU']."</a></font></td>";?>
...
<table border="0" width="100%" cellspacing="1" cellpadding="2">
  <tr>
	  <td class="verdana10blk"><font color="red"></font> </td>
    <td align="right">
