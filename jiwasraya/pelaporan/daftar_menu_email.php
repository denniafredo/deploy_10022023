...
if ($kirim) { // di edit oleh fendy sesuai permintaan atar tanggal 10 februari 2016 /* XXXXXX */
  $sql = "SELECT   TO_CHAR(TGLBOOKED,'MMYYYY') BOOKED,NOPOLIS,
		 ...
		 'Nasabah Yth, terimakasih pembayaran polis anda no. '||NOPOLIS||'/'||TO_CHAR(TGLBOOKED,'MMYYYY')||' sebesar Rp '||(JUMLAHTAGIHAN / 100)|| ' telah kami terima tgl $tglcari. Untuk info hub.1500151' SMS
