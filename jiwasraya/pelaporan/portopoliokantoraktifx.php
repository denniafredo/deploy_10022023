...
<script language="javascript">
  ...
  var halcari=document.clntmtc.carihal.value;
	var xxx = parseInt(document.clntmtc.carihal.value);
	  nextpg = xxx + 10;
		if((xxx < 11)||(halcari =='')) {
		  window.location.replace('portopoliokantoraktif.php?action=list&maju=ok&lastpg=11&get='+halcari+'');
    }else {
		  window.location.replace('portopoliokantoraktif.php?action=list&maju=ok&lastpg='+nextpg+'&get='+halcari+'');
		}
	}
</script>
<table>
...
#------------------------------ END NAVIGASI ---------------------------------
                  ...
                  "a.notertanggung=b.noklien and ".
								  ...
								  "a.nopenagih=c.nopenagih and a.kdstatusfile='1' ".
									"order by a.prefixpertanggungan,a.nopertanggungan) s,".
