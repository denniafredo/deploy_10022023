...
<a class="verdana10blk"><b>HASIL PREMI BP3 PER PRODUK</b></a>
<hr size="1">
    <table>
...
if(!$kdkantor){
   $judul="Kantor $kantor";
	 $officex=$kantor;
   $getkantor="d.kdrayonpenagih='$kantor'";
} elseif($kdkantor=="ALL") {
	 $judul="Semua Kantor";
	 $officex="ALL";
   $getkantor="d.kdrayonpenagih like '%%'";
}	else {
	 $judul="Kantor $kdkantor";
	 $officex=$kdkantor;
   $getkantor="d.kdrayonpenagih='$kdkantor'";
}
*/
if(!$kdkantor){
   $judul="Kantor $kantor";
   ...
   $getkantor="='$kdkantor'";
	...
	echo "<a class=verdana10blk><b>Akseptasi ".$tglheader." ".$judul."</b></a>";
  ...
  <tr bgcolor="#78bdd8">
	...
	while ($ark=$DB->nextrow()) {
	   ...
	   echo "<td class=verdana7blk>".$ark["KDPRODUK"]."</td>"; 
		 echo "<td class=verdana7blk><a href=\"#\" onclick=\"NewWindow('popperproduk.php?tglsearch=$tglsearch&kdproduk=".$ark["KDPRODUK"]."&kdkantor=$officex','popuppage','850','300','yes')\">".$ark["NAMAPRODUK"]."</a></td>"; 
