...
<br />
<div align="center">
<b>REKAPITULASI HASIL PREMI CITIBANK 1BILL <br /> 
PERIODE BULAN <?=$namabulan." ".$year;?><br />SECARA NASIONAL</b><br><br>
</div>
...
//						"b.kdvaluta='1' and ". 
						...
						"b.kdproduk=e.kdproduk and a.kdbank='CTB' order by c.kdrayonpenagih";
		//echo $sql;
		$DB->parse($sql);
	  $DB->execute();
  	$arr = $DB->result();	
  ...
  $total=0;
	foreach ($arr as $foo => $row ) {
  	...
  	$sql = "select ".
              ...
              "sum(a.jumlahtagihan) as jmlpremi ".
...
//              "b.kdvaluta='1' and ".
              ...
              "c.kdrayonpenagih='$kdrayonpenagih' and ".
							"b.kdproduk=e.kdproduk and a.kdbank='CTB' ".
