...
<form name="agen" action="<?PHP_SELF?>"> 
<font face="Verdana" size="2"><b>INFORMASI PREMI TAGIHAN PER PENAGIH</b></font>
<hr size="1">
<table border="0" cellpadding="2" cellspacing="2">
  <tr>
    <td><font face="Verdana" size="2">Masukkan Nomor Penagih</font></td>
    <td><input type="text" name="nopenagih" size="12" maxlength="10" onblur="javascript:validasi10(this.form.nopenagih);">
						<a href="#" onclick="NewWindow('popcaripenagih.php','popuppage','420','300','yes')"><img src="../img/jswindow.gif" border="0" alt="cari daftar penagih"></a>		
		</td>
...
$sqla = "select prefixpenagih,nopenagih,kdrayonpenagih ".
			  "from $DBUser.tabel_500_penagih where nopenagih='$nopenagih'";
				 $DB->parse($sqla);
				 $DB->execute();
				 $arr=$DB->nextrow();
         $rayon=$arr["KDRAYONPENAGIH"];
if(!$nopenagih)
{
}
else if($rayon!=$kantor){
 echo "<font color=red>Penagih nomor <b>$nopenagih</b> bukan penagih kantor $kantor</font>";
} else {				 
...
$sqly ="select c.prefixpertanggungan,c.nopertanggungan, ".
			...
			"where a.kdpertanggungan='2' and a.nopenagih=b.nopenagih and b.nopenagih='$nopenagih' and ".
			"b.kdrayonpenagih='$kantor' and c.prefixpertanggungan=a.prefixpertanggungan and c.nopertanggungan=a.nopertanggungan and ".
...
if ($total==0) { 
	if ($on!=1){
		...
		echo "<font face=\"Verdana\" size=\"2\" color=\"#ff0000\"><b>Tidak Ada Premi Jatuh Tempo Periode $bulan $vthn Penagih Nomor $nopenagih $KL->nama</b></font><br>";
	}
} elseif ($total>0) {

	echo "<font face=\"Verdana\" size=\"2\">Premi Jatuh Tempo Periode <b>$bulan $vthn Penagih Nomor $nopenagih $KL->nama</b></font><br><br>";
...
//-------------------------------- 1. Valuta Rupiah Tanpa Indeks Rp kdvaluta='1' --------------------------------------
  $qry ="select sum(c.premitagihan) jmlrpbln from $DBUser.tabel_200_pertanggungan a,$DBUser.tabel_300_historis_premi c, ".
			 ...
			 "where a.kdpertanggungan='2' and a.nopenagih=f.nopenagih and f.nopenagih='$nopenagih' and ". 
  ...
  $DB->execute();
	...
	echo "</tr>";
	echo "<tr>";
	echo "<td class=\"verdana8blk\" align=\"left\"><a href=\"premitagihanpenagih2.php?nopenagih=$nopenagih&carabayar=RPBULAN&cek=$jmlrpbln&vbln=$bln&vth=$vthn\">Bulanan</a></td>";
	echo "<td class=\"verdana8blk\" align=\"right\">Rp</td>";
	echo "<td class=\"verdana8blk\" align=\"right\"><a href=\"premitagihanpenagih2.php?nopenagih=$nopenagih&carabayar=RPBULAN&cek=$jmlrpbln&vbln=$bln&vth=$vthn\">".number_format($jmlrpbln,2)."</s></td>";
	echo "</tr>";
	echo "<tr>";
	echo "<td class=\"verdana8blk\" align=\"left\" bgcolor=#e0e0e4><a href=\"premitagihanpenagih2.php?nopenagih=$nopenagih&carabayar=RPKUARTAL&cek=$jmlrpkwt&vbln=$bln&vth=$vthn\">Kwartalan</a></td>";
	echo "<td class=\"verdana8blk\" align=\"right\" bgcolor=#e0e0e4>Rp</td>";
	echo "<td class=\"verdana8blk\" align=\"right\" bgcolor=#e0e0e4><a href=\"premitagihanpenagih2.php?nopenagih=$nopenagih&carabayar=RPKUARTAL&cek=$jmlrpkwt&vbln=$bln&vth=$vthn\">".number_format($jmlrpkwt,2)."</a></td>";
	echo "</tr>";
	echo "<tr>";
	echo "<td class=\"verdana8blk\" align=\"left\"><a href=\"premitagihanpenagih2.php?nopenagih=$nopenagih&carabayar=RPSEMESTER&cek=$jmlrpsmt&vbln=$bln&vth=$vthn\">Semesteran</a></td>";
	echo "<td class=\"verdana8blk\" align=\"right\">Rp</td>";
	echo "<td class=\"verdana8blk\" align=\"right\"><a href=\"premitagihanpenagih2.php?nopenagih=$nopenagih&carabayar=RPSEMESTER&cek=$jmlrpsmt&vbln=$bln&vth=$vthn\">".number_format($jmlrpsmt,2)."</a></td>";
	echo "</tr>";
	echo "<tr>";
	echo "<td class=\"verdana8blk\" align=\"left\" bgcolor=#e0e0e4><a href=\"premitagihanpenagih2.php?nopenagih=$nopenagih&carabayar=RPTAHUN&cek=$jmlrpthn&vbln=$bln&vth=$vthn\">Tahunan</a></td>";
	echo "<td class=\"verdana8blk\" align=\"right\" bgcolor=#e0e0e4>Rp</td>";
	echo "<td class=\"verdana8blk\" align=\"right\" bgcolor=#e0e0e4><a href=\"premitagihanpenagih2.php?nopenagih=$nopenagih&carabayar=RPTAHUN&cek=$jmlrpthn&vbln=$bln&vth=$vthn\">".number_format($jmlrpthn,2)."</a></td>";
	echo "</tr>";
	echo "<tr>";
...
//--------------------------------- 2. Valuta Rupiah Dengan Indeks Rp kdvaluta='0' ------------------------------------
  ...
  $DB->execute();
	...
	echo "</tr>";
	echo "<tr>";
	echo "<td class=\"verdana8blk\" align=\"left\"><a href=\"premitagihanpenagih2.php?nopenagih=$nopenagih&carabayar=RPIBULAN&cek=$jmlrpibln&vbln=$bln&vth=$vthn\">Bulanan</a></td>";
	echo "<td class=\"verdana8blk\" align=\"right\">Rp</td>";
	echo "<td class=\"verdana8blk\" align=\"right\"><a href=\"premitagihanpenagih2.php?nopenagih=$nopenagih&carabayar=RPIBULAN&cek=$jmlrpibln&vbln=$bln&vth=$vthn\">".number_format($jmlrpibln,2)."</a></td>";
	echo "</tr>";
	echo "<tr>";
	echo "<td class=\"verdana8blk\" align=\"left\" bgcolor=#e0e0e4><a href=\"premitagihanpenagih2.php?nopenagih=$nopenagih&carabayar=RPIKUARTAL&cek=$jmlrpikwt&vbln=$bln&vth=$vthn\">Kwartalan</a></td>";
	echo "<td class=\"verdana8blk\" align=\"right\" bgcolor=#e0e0e4>Rp</td>";
	echo "<td class=\"verdana8blk\" align=\"right\" bgcolor=#e0e0e4><a href=\"premitagihanpenagih2.php?nopenagih=$nopenagih&carabayar=RPIKUARTAL&cek=$jmlrpikwt&vbln=$bln&vth=$vthn\">".number_format($jmlrpikwt,2)."</a></td>";
	echo "</tr>";
	echo "<tr>";
	echo "<td class=\"verdana8blk\" align=\"left\"><a href=\"premitagihanpenagih2.php?nopenagih=$nopenagih&carabayar=RPISEMESTER&cek=$jmlrpismt&vbln=$bln&vth=$vthn\">Semesteran</a></td>";
	echo "<td class=\"verdana8blk\" align=\"right\">Rp</td>";
	echo "<td class=\"verdana8blk\" align=\"right\"><a href=\"premitagihanpenagih2.php?nopenagih=$nopenagih&carabayar=RPISEMESTER&cek=$jmlrpismt&vbln=$bln&vth=$vthn\">".number_format($jmlrpismt,2)."</a></td>";
	echo "</tr>";
	echo "<tr>";
	echo "<td class=\"verdana8blk\" align=\"left\" bgcolor=#e0e0e4><a href=\"premitagihanpenagih2.php?nopenagih=$nopenagih&carabayar=RPITAHUN&cek=$jmlrpithn&vbln=$bln&vth=$vthn\">Tahunan</a></td>";
	echo "<td class=\"verdana8blk\" align=\"right\" bgcolor=#e0e0e4>Rp</td>";
	echo "<td class=\"verdana8blk\" align=\"right\" bgcolor=#e0e0e4><a href=\"premitagihanpenagih2.php?nopenagih=$nopenagih&carabayar=RPITAHUN&cek=$jmlrpithn&vbln=$bln&vth=$vthn\">".number_format($jmlrpithn,2)."</a></td>";
	echo "</tr>";
	echo "<tr>";
	echo "<td class=\"verdana8blk\" align=\"right\" bgcolor=#D8E2FC>Total</td>";
	echo "<td class=\"verdana8blk\" align=\"right\" bgcolor=#D8E2FC>Rp</td>";
...
//------------------------------------- 3. Valuta Dollar US$ kdvaluta='3' -------------------------------------
  ...
  $DB->execute();
	...
	echo "</tr>";
	echo "<tr>";
	echo "<td class=\"verdana8blk\" align=\"left\"><a href=\"premitagihanpenagih2.php?nopenagih=$nopenagih&carabayar=DOLLARBULAN&cek=$jmldollarbln&vbln=$bln&vth=$vthn\">Bulanan</a></td>";
	echo "<td class=\"verdana8blk\" align=\"right\">US$</td>";
	echo "<td class=\"verdana8blk\" align=\"right\"><a href=\"premitagihanpenagih2.php?nopenagih=$nopenagih&carabayar=DOLLARBULAN&cek=$jmldollarbln&vbln=$bln&vth=$vthn\">".number_format($jmldollarbln,2)."</a></td>";
	echo "</tr>";
	echo "<tr>";
	echo "<td class=\"verdana8blk\" align=\"left\" bgcolor=#e0e0e4><a href=\"premitagihanpenagih2.php?nopenagih=$nopenagih&carabayar=DOLLARKUARTAL&cek=$jmldollarkwt&vbln=$bln&vth=$vthn\">Kwartalan</a></td>";
	echo "<td class=\"verdana8blk\" align=\"right\" bgcolor=#e0e0e4>US$</td>";
	echo "<td class=\"verdana8blk\" align=\"right\" bgcolor=#e0e0e4><a href=\"premitagihanpenagih2.php?nopenagih=$nopenagih&carabayar=DOLLARKUARTAL&cek=$jmldollarkwt&vbln=$bln&vth=$vthn\">".number_format($jmldollarkwt,2)."</a></td>";
	echo "</tr>";
	echo "<tr>";
	echo "<td class=\"verdana8blk\" align=\"left\"><a href=\"premitagihanpenagih2.php?nopenagih=$nopenagih&carabayar=DOLLARSEMESTER&cek=$jmldollarsmt&vbln=$bln&vth=$vthn\">Semesteran</a></td>";
	echo "<td class=\"verdana8blk\" align=\"right\">US$</td>";
	echo "<td class=\"verdana8blk\" align=\"right\"><a href=\"premitagihanpenagih2.php?nopenagih=$nopenagih&carabayar=DOLLARSEMESTER&cek=$jmldollarsmt&vbln=$bln&vth=$vthn\">".number_format($jmldollarsmt,2)."</a></td>";
	echo "</tr>";
	echo "<tr>";
	echo "<td class=\"verdana8blk\" align=\"left\" bgcolor=#e0e0e4><a href=\"premitagihanpenagih2.php?nopenagih=$nopenagih&carabayar=DOLLARTAHUN&cek=$jmldollarthn&vbln=$bln&vth=$vthn\">Tahunan</a></td>";
	echo "<td class=\"verdana8blk\" align=\"right\" bgcolor=#e0e0e4>US$</td>";
	echo "<td class=\"verdana8blk\" align=\"right\" bgcolor=#e0e0e4><a href=\"premitagihanpenagih2.php?nopenagih=$nopenagih&carabayar=DOLLARTAHUN&cek=$jmldollarthn&vbln=$bln&vth=$vthn\">".number_format($jmldollarthn,2)."</a></td>";
	echo "</tr>";
	echo "<tr>";
	echo "<td class=\"verdana8blk\" align=\"right\" bgcolor=#D8E2FC>Total</td>";
