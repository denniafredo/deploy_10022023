    ...
    ?>
        ...
        <?php
          ...
          while ($arrd=$DBD->nextrow()) {
            ...
            $bulan = $arrd['BULAN'];
            $tahun = $arrd['TAHUN'];
            $id_audience = $arrd['ID_AUDIENCE'];
            $id_blast = $arrd['ID_BLAST'];
          }
        ?>
        ...
        ?>
            <td>
              <!-- <a href="email/pdf_bpo/<?=$tahun?>/<?=$bulan.$tahun;?>_SURAT_PEMBERITAHUAN_BPO_<?=$arr["PREFIXPERTANGGUNGAN"];?><?=$arr["NOPERTANGGUNGAN"];?>.pdf" target="_blank"> -->
              ...
              <!-- <a href="#" onClick="window.open('cetak_surat_bpo.php?id_blast=<?=$id_blast;?>&id_audience=<?=$id_audience;?>','','width=1000,height=1000,top=100,left=100,scrollbars=yes');"> -->
              CETAK</a>
            </td>        
        <?php
          }
