...
<?
	  ...
	  $sql="select yy.satu
					|| LTRIM(REPLACE (
					TO_CHAR ( (yy.premitot+decode(kdproduk,'JL4B',0,   /*REQ ARIEF YUSUF TGL 02/05/2014*/
														   'JL4X',0,
                               'JL4BLN',0,
														   'JL4BL',0,
                               'JL4BF',0,z.nilaimeterai)),
					'099999999999999.00'),
					'.',
					''
					))||yy.siji||
					 yy.semua semua from $DBUser.tabel_999_batas_materai z,(
			SELECT      satu,
					  LPAD (ROWNUM, 5, '0') siji
					 ,premitot,
					  dua
					 || LPAD (ROWNUM, 5, '0')
					 || tiga
