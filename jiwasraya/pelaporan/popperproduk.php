...
if($dijit==4){
		 $searchbydate="to_char(a.tglkonversi,'YYYY')='".$tglsearch."' ";
		 $tgltitle="Tahun ".$tglsearch;
} elseif($dijit==6){
     $bln=substr($tglsearch,0,2);
		 $tahun=substr($tglsearch,-4);
     $searchbydate="to_char(a.tglkonversi,'MMYYYY')='".$tglsearch."' ";
		 $tgltitle="Bulan ".$bln." ".$tahun;
} else {
     $tgl=substr($tglsearch,0,2);
		 $bln=substr($tglsearch,2,2);
		 $tahun=substr($tglsearch,-4);
     $searchbydate="to_char(a.tglkonversi,'DDMMYYYY')='".$tglsearch."' ";
...
echo "<b><a class=verdana10blk>Akseptasi Polis Produk ".$kdproduk." ".$tgl." ".$vbulan." ".$tahun." Kantor $kdkantor</a></b><br><br>";
