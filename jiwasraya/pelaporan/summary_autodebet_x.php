...
<? 
  	$sql = "select ".
           ...
           "from ".
              ...
              //"e.rekening2=d.kdrekeninglawan ".
							"b.kdproduk=e.kdproduk and a.kdbank='MDR' ".
           "group by d.kdrekeninglawan,e.kdcabas,a.tglrekam,b.indexawal ";
  ...
  <!---------- summary  -------->
	  <?
		$sql = "select (select nama from $DBUser.tabel_802_kodeakun where akun='272007') namaakunperantara,".
              "(select nama from $DBUser.tabel_802_kodeakun where akun='553000') namaakunpotongan,".
              "(select nama from $DBUser.tabel_802_kodeakun where akun='604000') namaakunmatre,".
