<? 
  ...
  if ($medical == "") {
				 echo " <font face=\"Verdana\" size=\"2\">Proposal Medical Tidak ada</font>";
	} else {				
		       ...
		       $nopert = $data["NOPERTANGGUNGAN"];
					 ...
					 $query = "update $DBUser.tabel_200_pertanggungan set ".
	                  "kdstatusemail='1',tglsendemail=sysdate where nopertanggungan='$nopert' and ".
							      "kdpertanggungan='1' and kdstatusemail is null and kdstatusmedical='M'";
           $DB->parse($query);
           $DB->execute();
					 $DB->commit();
					 $count++;
		       ...
		       $nopertn = $data["NOPERTANGGUNGAN"];
					 ...
					 $query = "update $DBUser.tabel_200_pertanggungan set ".
	                  "kdstatusemail='1',tglsendemail=sysdate where nopertanggungan='$nopertn' and ".
							      "kdpertanggungan='1' and kdstatusemail is null and kdstatusmedical='N'";
           $DB->parse($query);
           $DB->execute();
					 $DB->commit();
					 $hit++;
