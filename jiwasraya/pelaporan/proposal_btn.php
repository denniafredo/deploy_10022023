...
if ($cariproposalkantor){	
	 ...
	 elseif ($produk=="ALL"){
	 		$kategoriproduk=" and a.kdproduk like '%BTN'";	 				
			$nmproduk="SELURUH PRODUK BTN";
	 }
	 else{
...
//					break;
           ...
           echo("</table>");
					 ...
					 echo "<hr size=1>";
					 echo "<a class=verdana10blk href=\"../submenu.php?mnuinduk=A01\">ADMIN BANCASSURANCE</a>";
?>