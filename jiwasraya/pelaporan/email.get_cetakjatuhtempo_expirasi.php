...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="782" id="AutoNumber1">
  <tr>    
    ...
    <p align="justify">Terlampir kami sampaikan pemberitahuan <strong>jatuh tempo polis nomor <?php echo $row["PREFIXPERTANGGUNGAN"].'-'.$row["NOPERTANGGUNGAN"].' / '.$row["NOPOL"];?></strong> dan <strong>Formulir pengajuan jatuh tempo</strong> polis Anda</p>
