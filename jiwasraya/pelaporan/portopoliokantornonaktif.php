<?  
  ...
  if(parseInt(navigator.appVersion) >= 4){win.window.focus();}
	...
	echo "<a class=\"verdana10blk\"><b>INFORMASI POLIS KONVERSI NON AKTIF KANTOR $kantor </b></a>";
  echo "<hr size=1>";
	//echo "<a class=verdana8blk href=\"updatenonaktif.php?lihat=$lihat&start=1&end=200&page=1\">Klik disini untuk update data per halaman</a>";
...
<script language="javascript">
  ...
  var halcari=document.clntmtc.carihal.value;
	var xxx = parseInt(document.clntmtc.carihal.value);
	  nextpg = xxx + 10;
		if((xxx < 11)||(halcari =='')) {
		  window.location.replace('portopoliokantornonaktif.php?action=list&maju=ok&lastpg=11&get='+halcari+'');
    }else {
		  window.location.replace('portopoliokantornonaktif.php?action=list&maju=ok&lastpg='+nextpg+'&get='+halcari+'');
		}
	}
</script>
<table>
