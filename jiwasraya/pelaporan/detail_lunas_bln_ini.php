...
$sql="select *
		...
		(SELECT rownum rn,PREFIXPERTANGGUNGAN,NOPERTANGGUNGAN,NAMA,NOAGEN,NAMA_AGEN,KDRAYONPENAGIH,TGLBOOKED,
			  ...
			  AND TO_CHAR(TGLSEATLED, 'MM/YYYY') = '$tglbooked'
...
echo "</table><table>";	
	...
	echo '<tr>';	
		for ($x = 1; $x <= $jmlpage; $x++) {
			...
			$batasatas = $x * 50;
			echo "<td>
					<a href='detail_lunas_bln_ini.php?jenis=$jenis&kd_kuitansi=$kdkuitansi&kd_carabayar=$carabayar&kd_wilayah=$kdwilayah&bln=$tglbooked&batasbawah=$batasbawah&batasatas=$batasatas'>$x</a>		
				  </td>";
		} 
	echo '</tr>';	
	?>
