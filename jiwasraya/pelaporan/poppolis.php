...
<?	
	...
	echo "<font color=\"003399\"><b>DAFTAR POLIS</b></font><br>";
	echo "<font face=Verdana size=1><b>Kode Kantor : ".$prefixpertanggungan."</b></font>";
	echo "<br><br>";
	printf("<font face=Verdana size=2><a href=poppolis.php?id=all>All</a></font>&nbsp;");
	$aray=array();
	for($i=0;$i<26;$i++) {
	$aray[]=chr(65+$i);
	printf("<font face=Verdana size=2><a href=poppolis.php?id=".$aray[$i].">".$aray[$i]."</a></font>&nbsp;");
	}
	printf("<font face=Verdana size=2><a href=poppolis.php?id=all>All</a></font>&nbsp;");
	echo "<br><br>";
  ...
  echo "<table>";
					 ...
					 print( "<td class=arial10blk align=center>No.</td>\n" );
  				 print( "<td class=arial10blk align=center>Nomor</td>\n" );
					 print( "<td class=arial10blk align=center>Tertanggung</td>\n" );
					 print( "<td class=arial10blk align=center>Produk</td>\n" );
					 print( "<td class=arial10blk align=center>Valuta</td>\n" );
					 print( "<td class=arial10blk align=center>JUA</td>\n" );
					 print( "<td class=arial10blk align=center>Premi1</td>\n" );
					 print( "<td class=arial10blk align=center>Medical</td>\n" );
					 print( "<td class=arial10blk align=center>Carabayar</td>\n" );
  				 print( "</tr>" );
			if ($id=='all'){
				...
				print( "<tr bgcolor=#e0e0e4>" );
				  ...
				  $DA=new Database($userid, $passwd, $DBName);
				   ...
				   $ars=$DA->nextrow();	
						  ...
						  printf("<td><font face=Verdana size=1>".$prefixpertanggungan."-<a href=\"#\" onclick=\"javascript:window.opener.document.propmtc01.nopertanggungan.value='%s';window.close();\">%s</a></font></td>",$arr["NOPERTANGGUNGAN"],$arr["NOPERTANGGUNGAN"]);//,$arr["NAMAKLIEN1"],$arr["TGLLAHIR"]);
