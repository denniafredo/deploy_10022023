...
if($masa=="pilih"){
  ...
  echo "</div>";
	...
	if($a=="0"){
			$valutatitle = "<td class=verdana8blk align=center bgcolor=#96cbcb></td><td class=verdana8blk align=center colspan=3 bgcolor=#b4d7e0><b>".$namavaluta[$a]."</b></td>";
	    $produktitle = "<td class=verdana8blk width=250 align=center bgcolor=#96cbcb><B>PRODUK</B></td><td class=verdana8blk align=center bgcolor=#82d7ff><b>POLIS</b></td><td class=verdana8blk align=center bgcolor=#9ce29a><b>JUA</b></td><td class=verdana8blk align=center bgcolor=#fee498><b>PREMI</b></td>";
  } else {
	 		$valutatitle = "<td class=verdana8blk align=center colspan=3 bgcolor=#b4d7e0><b>".$namavaluta[$a]."</b></td>";
	    $produktitle = "<td class=verdana8blk align=center bgcolor=#82d7ff><b>POLIS</b></td><td class=verdana8blk align=center bgcolor=#9ce29a><b>JUA</b></td><td class=verdana8blk align=center bgcolor=#fee498><b>PREMI</b></td>";
	}
  ...
  echo "<tr>";
	...
	while($ars=$DB->nextrow()){
	 ...
	 echo "<tr>";
	    echo $kolomproduk."<td class=verdana8blk align=right bgcolor=#e1f5ff>".$polis[$a]."</td><td class=verdana8blk align=right bgcolor=#defdd9>".number_format($jua[$a],2,",",".")."</td><td class=verdana8blk align=right bgcolor=#fff5d7>".number_format($premi[$a],2,",",".")."</td>";
	 echo "</tr>";
	...
	if($a=="0"){
			$jmlproduk = "<td class=verdana8blk width=250 align=center bgcolor=#96cbcb><B>JUMLAH</B></td><td class=verdana8blk align=right bgcolor=#82d7ff><b>".$jmlpolis[$a]."</b></td><td class=verdana8blk align=right bgcolor=#9ce29a><b>".number_format($jmljua[$a],2,",",".")."</b></td><td class=verdana8blk align=right bgcolor=#fee498><b>".number_format($jmlpremi[$a],2,",",".")."</b></td>";
	} else {
      $jmlproduk = "<td class=verdana8blk align=right bgcolor=#82d7ff><b>".$jmlpolis[$a]."</b></td><td class=verdana8blk align=right bgcolor=#9ce29a><b>".number_format($jmljua[$a],2,",",".")."</b></td><td class=verdana8blk align=right bgcolor=#fee498><b>".number_format($jmlpremi[$a],2,",",".")."</b></td>";
	}	
	echo "<tr>";
	    echo $jmlproduk;
	echo "</tr>";
