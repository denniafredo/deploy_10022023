  ...
  echo "<hr size=1>";
	echo "<div align=center>";
		...
		//Rekap Untuk Saldo Awal			
					$qrysaldo = "select 'TOTAL',valuta,kdcabas,sum(knb)-sum(lknb) as knb,sum(nnb)-sum(lnnb) as nnb,sum(kob)-sum(lkob) as kob,
				 ...
				 echo "<td class=verdana8blk align=left rowspan=39><b>SALDO AWAL</b></td>";
  				 ...
  				 echo "</tr>";
					...
					//Valuta Rupiah Dengan Indeks
					 $qrysaldo2 = "select 'TOTAL',valuta,kdcabas,sum(knb)-sum(lknb) as knb,sum(nnb)-sum(lnnb) as nnb,sum(kob)-sum(lkob) as kob,
sum(nob)-sum(lnob) as nob,sum(jmlkuitansi)-sum(ljmlkuitansi) as jmlkuitansi,sum(jmlpremi)-sum(ljmlpremi) as jmlpremi
from
(SELECT 'NOTA TAGIHAN PREMI BERKALA LANJUTAN' GRUP,           
           'VRTI' valuta,
    ...
    FROM      $DBUser.tabel_300_lipp_pelunasan a
		...
		//die;
				...
				//Valuta Rupiah Tanpa Indeks	
					$qrysaldo3 = "select 'TOTAL',valuta,kdcabas,sum(knb)-sum(lknb) as knb,sum(nnb)-sum(lnnb) as nnb,sum(kob)-sum(lkob) as kob,
sum(nob)-sum(lnob) as nob,sum(jmlkuitansi)-sum(ljmlkuitansi) as jmlkuitansi,sum(jmlpremi)-sum(ljmlpremi) as jmlpremi
from
(SELECT 'NOTA TAGIHAN PREMI BERKALA LANJUTAN' GRUP,           
           'VRTI' valuta,
				...
				ocifetch($querytotal);
				 ...
				 echo "<td class=verdana8blk align=left rowspan=39><b>TOTAL </b></td>";
  				 ...
  				 echo "</tr>";
					...
					//Valuta Rupiah Dengan Indeks
					 $qrytotal2 = "select 'TOTAL',valuta,kdcabas,sum(knb)-sum(lknb) as knb,sum(nnb)-sum(lnnb) as nnb,sum(kob)-sum(lkob) as kob,
sum(nob)-sum(lnob) as nob,sum(jmlkuitansi)-sum(ljmlkuitansi) as jmlkuitansi,sum(jmlpremi)-sum(ljmlpremi) as jmlpremi
from
(SELECT 'NOTA TAGIHAN PREMI BERKALA LANJUTAN' GRUP, 	          
           'VRDI' valuta,
		...
		//die;
				...
				while(ocifetch($querytotal2))
  				 ...
  				 echo "</tr>";
					 $i++;}			
				//Valuta Rupiah Tanpa Indeks	
					$qrytotal3 = "select 'TOTAL',valuta,kdcabas,sum(knb)-sum(lknb) as knb,sum(nnb)-sum(lnnb) as nnb,sum(kob)-sum(lkob) as kob,
sum(nob)-sum(lnob) as nob,sum(jmlkuitansi)-sum(ljmlkuitansi) as jmlkuitansi,sum(jmlpremi)-sum(ljmlpremi) as jmlpremi
from
(SELECT 'NOTA TAGIHAN PREMI BERKALA LANJUTAN' GRUP,           
           'VRTI' valuta,
