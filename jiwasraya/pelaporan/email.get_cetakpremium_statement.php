...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="782" id="AutoNumber1">
  <tr>    
    ...
    <p align="justify">Bersama ini kami sampaikan Premium Statement polis <?=$row["ANDA"];?></p>
	<table border="0" cellspacing="1" style="border-collapse: collapse" width="100%" id="table1" cellpadding="4" bordercolor="#B3CFFF">
		  <tr>
    ...
    <p align="justify"><strong><u>Info Penting</u></strong> <br>
      <ol>
		<li>PT Asuransi Jiwa IFG tidak menerima pembayaran premi melalui petugas yang mendatangi pemegang polis dan menerima pembayaran secara tunai, di luar tata cara bayar yang resmi PT Asuransi Jiwa IFG tidak bertanggung jawab apabila terjadi hal yang tidak diinginkan
		</li>
		<li>Apabila membutuhkan informasi lebih lanjut berkaitan dengan surat pemberitahuan ini atau alamat korespondensi/email/nomor handphone Anda berubah silahkan hubungi Call Center PT Asuransi Jiwa IFG <strong>021-1500151</strong> atau e-mail customer_service@ifg-life.co.id
		</li>		
	  </ol>
    </p>       
  </tr>
