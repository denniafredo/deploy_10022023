...
<table border="0" cellspacing="1" style="border-collapse: collapse" width="100%" id="table1" cellpadding="4" bordercolor="#B3CFFF">
	...
	?>
        ...
        <td><?=$row["ALAMAT"];?></td>
        <td><?=$row["KOTA"];?></td>
        <td><?="<a href=\"javascript:NewWindow('../pelaporan/cetakjatuhtempo.php?prefixpertanggungan=".$row["PREFIXPERTANGGUNGAN"]."&nopertanggungan=".$row["NOPERTANGGUNGAN"]."&tglexp=".$row["TGLEXP"]."','polisinfo',815,600,'yes');\">cetak</a>";?> | 
			<?="<a href=\"javascript:NewWindow('../pelaporan/cetak_pdf_jatuh_tempo_premi.php?prefixpertanggungan=".$row["PREFIXPERTANGGUNGAN"]."&nopertanggungan=".$row["NOPERTANGGUNGAN"]."&kdkantor=".$kdkantor."','polisinfo',815,600,'yes');\">CETAK BARU</a>";?>
		</td>
