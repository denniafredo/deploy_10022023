<? 
  ...
  $DBA=new database($userid, $passwd, $DBName);
	...
	function ShowFromDate1($year_interval,$YearIntervalType) {
  GLOBAL $day,$month,$year;

  //DAY 1
  echo "<select name=hari1>"	;
  ...
  //YEAR 1
	...
	function ShowFromDate2($year_interval,$YearIntervalType) {
  GLOBAL $day,$month,$year;

  //DAY 1
  echo "<select name=hari2>"	;
	  for($currentDay = 1; $currentDay<= 31;$currentDay++) 
			  { 
				  print("<option value=\"$currentDay\""); 
							if($selected==$currentDay) 
  ...
  //YEAR 1
	...
	/*echo ' ini hari1 '.$hari1.' ini hari2 '.$hari2;
	echo ' ini month1 '.$month1.' ini month2 '.$month2;
	echo ' ini year1 '.$year1.' ini year2 '.$year2;*/
	
	$parm1 = $year1.$month1.$hari1;
	$parm2 = $year2.$month2.$hari2;
...
?>
  ...
  <a class="verdana10blk">Dari <?  ShowFromDate1(10,"Past"); ?> Sampai <?  ShowFromDate2(10,"Past"); ?></a>  
...
$sql = "select ".
          ...
          "where ".
            ...
            "b.nopenagih=c.nopenagih and a.statuspembayaran='2' and b.kdvaluta='1' and ".
						"to_char(a.tglrekam,'YYYYMMDD') between '$parm1' and  '$parm2' and ".
