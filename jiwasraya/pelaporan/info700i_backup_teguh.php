  ...
  <tr>
    ...
    if (($box_count)<1) {
        ...
        foreach ($box as $dear) {
			...
			//echo $createsip;
                    ...
                    $DB->execute();
			//echo $createsip."<br / >";					
			$sqa = "update $DBUser.tabel_700_tebus set statusbayar='1',status='2' where  prefixpertanggungan='".$ket[0]."' ".
				   " and nopertanggungan='".$ket[1]."' and to_char(tglhitung,'dd/mm/yyyy')='".$ket[2]."'";
                    $DB->parse($sqa);
                    $DB->execute();
            //echo $sqa."<br />";
    ...
    <td class="tblisi" align="center">
		  <table  width="100%" border="0" cellspacing="0" cellpadding="0">
			 <tr class="hijao">
			  ...
			  <td align="center">Status <br>Terakhir</td>
                ...
                <td align="center"><input type="checkbox" name="xxx" onClick="Cekbok(this.form.xxx.checked);" /></td>
			 </tr>
      <?
      ...
      $sql = "select a.nomorsip,a.prefixpertanggungan,a.nopertanggungan,a.userrekam,b.namastatus,a.status, ".
      		   ...
      		   "to_char(a.tglsip,'DD/MM/YYYY') tglsip, $nilaibenefit nilaibenefit ".
      			 "from ".
     ...
     // echo $sql;
	  ...
	  if($kantor=="KP"){?>		  
		<tr><td class=verdana8blu  colspan="13"><strong><div align="left">Untuk Proses Pembayaran Hari Ini Silahkan Proses Sebelum Pukul 12.00 WIB</div></strong><div align="right"><input type="submit" name="bayar"  value="Proses Bayar" /></div></td></tr>	</table>
    </td>
	  </tr><? } ?>
</table>
