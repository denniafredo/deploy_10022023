...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="782" id="AutoNumber1">
  <tr>
    <td width="100%" style="border-left-color: #111111; border-left-width: 1; border-right-color: #111111; border-right-width: 1"><table width="100%" border="0" cellspacing="0" cellpadding="3">
      <tr>
        <td height="27" class="style5"><div align="left" class="style8"><b><span class="style10">PT ASURANSI JIWASRAYA (PERSERO)</br>
          <?=$KTR->namakantor.'</b></br>'.$KTR->alamat01.'</br>'.$KTR->alamat02.'</br>'.$KTR->phone01;?>
          </br>
          <b>www.jiwasraya.co.id</b> </span></div></td>
    ...
    <p align="justify" class="style5">Terima kasih atas kepercayaan <?=$row["ANDA"];?> kepada PT Asuransi Jiwasraya (Persero) dalam memberikan perlindungan asuransi bagi <?=$row["ANDA"];?> dan keluarga.</p>
	...
	<ol class="style5">
  	...
  	<li align="justify">Dalam hal pembayaran Premi telah dilakukan oleh Bapak/Ibu dan atau data Polis di atas tidak sesuai serta jika ada informasi lain yang ingin Bapak/Ibu ketahui, mohon untuk dapat menghubungi Kantor PT Asuransi Jiwasraya (Persero) terdekat atau Call Center Jiwasraya : (021) 1500151 atau email: customer_service@jiwasraya.co.id, dengan melampirkan bukti pelunasan premi yang sah.</li>
    <li align="justify"><b>PT Asuransi Jiwasraya (Persero) tidak menerima pembayaran premi melalui Agen / Marketing</b>, untuk informasi lebih lanjut tentang cara bayar premi melalui Host to host/Auto debet/Virtual Account, Pelayanan klaim, Produk Asuransi JS-Link dan Produk Asuransi lainnya dapat menghubungi Call Center Jiwasraya di nomor (021) 1500151 atau email : customer_service@jiwasraya.co.id.
</li>
	</ol>
	...
	<p align="justify" class="style5">Hormat kami <br>
      PT ASURANSI JIWASRAYA (PERSERO)<br><br><br><br>
    </p>
