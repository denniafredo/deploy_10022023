 ...
 $sql1 = "  SELECT   SD.kdrayonpenagih,
    ...
    FROM   (  SELECT   kdrayonpenagih,
                ...
                FROM   (  SELECT   kdrayonpenagih,
                                   ...
                                   SUM (LUNAS) lunas,
                                   KDKUITANSI
                            FROM   $DBUser.tagihan_vs_pelunasan_new a
...
$sql1 = "SELECT   SD.NAMACARABAYAR,
    ...
    FROM   (  SELECT   NAMACARABAYAR,
                ...
                FROM   (  SELECT   (SELECT   NAMACARABAYAR
                                   ...
                                   KDKUITANSI
                            FROM   $DBUser.tagihan_vs_pelunasan_new a
                           WHERE   KDRAYONPENAGIH IN (".$filterkantor.")
                                   AND kdstatusfile = '1'
								   AND TO_CHAR (TGLBOOKED, 'MM/YYYY') = '".$tglcari."'  
								   /*AND TGLGENERATE = (TO_DATE ('".$newfilter."', 'DD/MM/YYYY')) */
								    AND to_char(TGLGENERATE,'dd/mm/yyyy') = '".$newfilter."'
...
//echo $sql;
	...
	?>
        ...
        <td align="right"><strong><a href="#" onclick="popitup('detail_tagihan_bln_ini22.php?jenis=TM_TAG&kd_kuitansi=BP&kd_carabayar=<?=$row["NAMACARABAYAR"];?>&kd_wilayah=<?=$wilayah;?>&bln=<?=$newfilter;?>&blnx=<?=$tglcari;?>&pilih=<?=$pilih;?>')"><?=number_format($row["TM_TAG_BP"],2,",",".");?></a></strong></td>
        <td align="right"><strong><a href="#" onclick="popitup('detail_tagihan_bln_ini22.php?jenis=TM_TAG&kd_kuitansi=NB&kd_carabayar=<?=$row["NAMACARABAYAR"];?>&kd_wilayah=<?=$wilayah;?>&bln=<?=$newfilter;?>&blnx=<?=$tglcari;?>&pilih=<?=$pilih;?>')"><?=number_format($row["TM_TAG_NB"],2,",",".");?></a></strong></td>
        <td align="right"><strong><a href="#" onclick="popitup('detail_tagihan_bln_ini22.php?jenis=TM_TAG&kd_kuitansi=OB&kd_carabayar=<?=$row["NAMACARABAYAR"];?>&kd_wilayah=<?=$wilayah;?>&bln=<?=$newfilter;?>&blnx=<?=$tglcari;?>&pilih=<?=$pilih;?>')"><?=number_format($row["TM_TAG_OB"],2,",",".");?></a></strong></td>        
		<!--td align="right"><strong><?=number_format($row["SD_TAG_NB"],2,",",".");?></strong></td-->        
		<td align="right"><strong><a href="#" onclick="popitup('detail_tagihan_sd_bln_ini22.php?jenis=SD_TAG&kd_kuitansi=BP&kd_carabayar=<?=$row["NAMACARABAYAR"];?>&kd_wilayah=<?=$wilayah;?>&bln=<?=$newfilter;?>&blnx=<?=$tglcari;?>&pilih=<?=$pilih;?>')"><?=number_format($row["SD_TAG_BP"],2,",",".");?></a></strong></td>        
		<td align="right"><strong><a href="#" onclick="popitup('detail_tagihan_sd_bln_ini22.php?jenis=SD_TAG&kd_kuitansi=NB&kd_carabayar=<?=$row["NAMACARABAYAR"];?>&kd_wilayah=<?=$wilayah;?>&bln=<?=$newfilter;?>&blnx=<?=$tglcari;?>&pilih=<?=$pilih;?>')"><?=number_format($row["SD_TAG_NB"],2,",",".");?></a></strong></td>        
        <!--td align="right"><strong><?=number_format($row["SD_TAG_OB"],2,",",".");?></strong></td-->        
        <td align="right"><strong><a href="#" onclick="popitup('detail_tagihan_sd_bln_ini22.php?jenis=SD_TAG&kd_kuitansi=OB&kd_carabayar=<?=$row["NAMACARABAYAR"];?>&kd_wilayah=<?=$wilayah;?>&bln=<?=$newfilter;?>&blnx=<?=$tglcari;?>&pilih=<?=$pilih;?>')"><?=number_format($row["SD_TAG_OB"],2,",",".");?></a></strong></td>        
        <td align="right"><strong><a href="#" onclick="popitup('detail_lunas_bln_ini22.php?jenis=TM_LNS&kd_kuitansi=BP&kd_carabayar=<?=$row["NAMACARABAYAR"];?>&kd_wilayah=<?=$wilayah;?>&bln=<?=$newfilter;?>&blnx=<?=$tglcari;?>&pilih=<?=$pilih;?>')"><?=number_format($row["TM_LNS_BP"],2,",",".");?></a></strong></td>        
        <td align="right"><strong><a href="#" onclick="popitup('detail_lunas_bln_ini22.php?jenis=TM_LNS&kd_kuitansi=NB&kd_carabayar=<?=$row["NAMACARABAYAR"];?>&kd_wilayah=<?=$wilayah;?>&bln=<?=$newfilter;?>&blnx=<?=$tglcari;?>&pilih=<?=$pilih;?>')"><?=number_format($row["TM_LNS_NB"],2,",",".");?></a></strong></td>        
        <td align="right"><strong><a href="#" onclick="popitup('detail_lunas_bln_ini22.php?jenis=TM_LNS&kd_kuitansi=OB&kd_carabayar=<?=$row["NAMACARABAYAR"];?>&kd_wilayah=<?=$wilayah;?>&bln=<?=$newfilter;?>&blnx=<?=$tglcari;?>&pilih=<?=$pilih;?>')"><?=number_format($row["TM_LNS_OB"],2,",",".");?></a></strong></td>        
		<!--td align="right"><strong><?=number_format($row["SD_LNS_NB"],2,",",".");?></strong></td-->        
		<td align="right"><strong><a href="#" onclick="popitup('detail_lunas_sd_bln_ini22.php?jenis=SD_LNS&kd_kuitansi=BP&kd_carabayar=<?=$row["NAMACARABAYAR"];?>&kd_wilayah=<?=$wilayah;?>&bln=<?=$newfilter;?>&blnx=<?=$tglcari;?>&pilih=<?=$pilih;?>')"><?=number_format($row["SD_LNS_BP"],2,",",".");?></a></strong></td>        
		<td align="right"><strong><a href="#" onclick="popitup('detail_lunas_sd_bln_ini22.php?jenis=SD_LNS&kd_kuitansi=NB&kd_carabayar=<?=$row["NAMACARABAYAR"];?>&kd_wilayah=<?=$wilayah;?>&bln=<?=$newfilter;?>&blnx=<?=$tglcari;?>&pilih=<?=$pilih;?>')"><?=number_format($row["SD_LNS_NB"],2,",",".");?></a></strong></td>        
        <!--td align="right"><strong><?=number_format($row["SD_LNS_OB"],2,",",".");?></strong></td-->        
        <td align="right"><strong><a href="#" onclick="popitup('detail_lunas_sd_bln_ini22.php?jenis=SD_LNS&kd_kuitansi=OB&kd_carabayar=<?=$row["NAMACARABAYAR"];?>&kd_wilayah=<?=$wilayah;?>&bln=<?=$newfilter;?>&blnx=<?=$tglcari;?>&pilih=<?=$pilih;?>')"><?=number_format($row["SD_LNS_OB"],2,",",".");?></a></strong></td>        

        <td align="right"><strong><a href="#" onclick="popitup('sisa_tagihan_sd_bln_ini22.php?jenis=SD_LNS&kd_kuitansi=BP&kd_carabayar=<?=$row["NAMACARABAYAR"];?>&kd_wilayah=<?=$wilayah;?>&bln=<?=$newfilter;?>&blnx=<?=$tglcari;?>&pilih=<?=$pilih;?>')"><?=number_format(($row["SD_TAG_BP"])-($row["SD_LNS_BP"]),2,",",".");?></a></strong></td>        
        <td align="right"><strong><a href="#" onclick="popitup('sisa_tagihan_sd_bln_ini22.php?jenis=SD_LNS&kd_kuitansi=NB&kd_carabayar=<?=$row["NAMACARABAYAR"];?>&kd_wilayah=<?=$wilayah;?>&bln=<?=$newfilter;?>&blnx=<?=$tglcari;?>&pilih=<?=$pilih;?>')"><?=number_format(($row["SD_TAG_NB"])-($row["SD_LNS_NB"]),2,",",".");?></a></strong></td>        
        <!--td align="right"><strong><?=number_format(($row["SD_TAG_NB"])-($row["SD_LNS_NB"]),2,",",".");?></strong></td-->
        <td align="right"><strong><a href="#" onclick="popitup('sisa_tagihan_sd_bln_ini22.php?jenis=SD_LNS&kd_kuitansi=OB&kd_carabayar=<?=$row["NAMACARABAYAR"];?>&kd_wilayah=<?=$wilayah;?>&bln=<?=$newfilter;?>&blnx=<?=$tglcari;?>&pilih=<?=$pilih;?>')"><?=number_format(($row["SD_TAG_OB"])-($row["SD_LNS_OB"]),2,",",".");?></a></strong></td>                
