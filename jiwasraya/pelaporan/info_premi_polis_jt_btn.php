<?  
  ...
  include "../../includes/session.php";  
	...
	<a class="verdana10blk\"><b>DAFTAR POLIS KANTOR <?echo $kantor;?></b></a>
	<hr size=1>
	<table>
	<form name="cariproposal" method="post" action="<? $PHP_SELF ?>">
	<tr>  
	<td class="verdana10blk">Periode (Jatuh Tempo)</td>
  ...
  echo "<hr size=1>";
	echo "<div align=center>";
		...
		/*		  $sql = "select a.prefixpertanggungan,a.nopertanggungan,a.kdproduk,".
           ...
           "TO_CHAR (a.mulas, 'DD/MM/YYYY') mulas, ".
		   "TO_CHAR (C.TGLBOOKED, 'DD/MM/YYYY') BOOKED, ".
		   "TO_CHAR (C.TGLSEATLED, 'DD/MM/YYYY') SEATLED, ".
    ...
    "FROM   $DBUser.tabel_100_klien b, ".
           "$DBUser.tabel_200_pertanggungan a, $DBUser.tabel_300_historis_premi c            ".
   "WHERE       a.notertanggung = b.noklien(+)            ".
           ...
           "AND notertanggung IS NOT NULL and $periode ".								 
					...
					$DB->execute();
					 ...
					 echo "<table width=100% class=tblisi cellpadding=0 cellspacing=0>";
					    echo("<tr class=hijao>");
							...
							echo("<td align=center>Tgl.Booked</td>");
							echo("<td align=center>Tgl.Settled</td>");
              ...
              echo("<td><font face=\"Verdana\" size=\"1\">".$i."</font></td>");
		          ...
		          echo("<td><font face=\"Verdana\" size=\"1\">".$arr["BOOKED"]."</font></td>");
				  echo("<td><font face=\"Verdana\" size=\"1\">".$arr["SEATLED"]."</font></td>");
