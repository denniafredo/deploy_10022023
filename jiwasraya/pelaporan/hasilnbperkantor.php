...
<a class="verdana10blk"><b>PENERIMAAN PREMI NB PER KANTOR PERWAKILAN</b></a>
...
if($vtgl=="" && $vbln=="" && $vthn=="") {
			...
			$sql = "select ".
                 ...
                 "(select ".
                   ...
                   "where ".
                    	...
                    	"h.kdkuitansi like 'NB%' and to_char(h.tglbayar,".$summary." ".
	...
	echo "<a class=verdana10blk><b>Penerimaan Premi NB ".$tglheader."</b></a><br>".
