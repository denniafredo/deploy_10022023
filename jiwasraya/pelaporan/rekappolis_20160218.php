...
// End of Tambahan oleh Ari 04/02/2008
	...
	if($a=="0"){
			$valutatitle = "<td class=verdana8blk align=center bgcolor=#96cbcb></td><td class=verdana8blk align=center colspan=6 bgcolor=#b4d7e0><b>".$namavaluta[$a]."</b></td>";
	    $produktitle = "<td class=verdana8blk width=250 align=center bgcolor=#96cbcb><B>PRODUK</B></td><td class=verdana8blk align=center bgcolor=#82d7ff><b>POLIS</b><td class=verdana8blk align=center bgcolor=#82d7ff><b>PEMPOL</b></td><td class=verdana8blk align=center bgcolor=#9ce29a><b>JUA</b></td><td class=verdana8blk align=center bgcolor=#fee498><b>PREMI</b></td><td class=verdana8blk align=center bgcolor=#ccccff><b>KOMISI BP3</b></td><td class=verdana8blk align=center bgcolor=#ccccff><b>KOMISI PENUTUPAN I</b></td>";
  } else {
	 		$valutatitle = "<td class=verdana8blk align=center colspan=6 bgcolor=#b4d7e0><b>".$namavaluta[$a]."</b></td>";
	    $produktitle = "<td class=verdana8blk align=center bgcolor=#82d7ff><b>POLIS</b></td><td class=verdana8blk align=center bgcolor=#82d7ff><b>PEMPOL</b></td><td class=verdana8blk align=center bgcolor=#9ce29a><b>JUA</b></td><td class=verdana8blk align=center bgcolor=#fee498><b>PREMI</b></td><td class=verdana8blk align=center bgcolor=#ccccff><b>KOMISI BP3</b></td><td class=verdana8blk align=center bgcolor=#ccccff><b>KOMISI PENUTUPAN I</b></td>";
	}
  ...
  echo "<tr>";
	...
	while($ars=$DB->nextrow()){
	 ...
	 if($a=="0"){
	    $kdproduk = $ars["NAMAPRODUK"];
			$kolomproduk="<td class=verdana8blk  width=250 bgcolor=#d0e8e8>".$kdproduk."</td>";
	 } else {
	    $kdproduk="0";
			$kolomproduk="";
	 }
	...
	if($a=="0"){
	  $jmlproduk = "<td class=verdana8blk width=250 align=center bgcolor=#96cbcb><B>JUMLAH</B></td><td class=verdana8blk align=right bgcolor=#82d7ff><b>".$jmlpolis[$a]."</b></td><td class=verdana8blk align=right bgcolor=#82d7ff><b>".$jmlpempol[$a]."</b></td><td class=verdana8blk align=right bgcolor=#9ce29a><b>".number_format($jmljua[$a],2,",",".")."</b></td><td class=verdana8blk align=right bgcolor=#fee498><b>".number_format($jmlpremi[$a],2,",",".")."</b></td><td class=verdana8blk align=right bgcolor=#ccccff><b>".number_format($jmlkomisibp3[$a],2,",",".")."</b></td><td class=verdana8blk align=right bgcolor=#ccccff><b>".number_format($jmlkomisi1[$a],2,",",".")."</b></td>";
	} else {
      $jmlproduk = "<td class=verdana8blk align=right bgcolor=#82d7ff><b>".$jmlpolis[$a]."</b></td><td class=verdana8blk align=right bgcolor=#82d7ff><b>".$jmlpempol[$a]."</b></td><td class=verdana8blk align=right bgcolor=#9ce29a><b>".number_format($jmljua[$a],2,",",".")."</b></td><td class=verdana8blk align=right bgcolor=#fee498><b>".number_format($jmlpremi[$a],2,",",".")."</b></td><td class=verdana8blk align=right bgcolor=#ccccff><b>".number_format($jmlkomisibp3[$a],2,",",".")."</b></td><td class=verdana8blk align=right bgcolor=#ccccff><b>".number_format($jmlkomisi1[$a],2,",",".")."</b></td>";
	}
	echo "<tr>";
	    echo $jmlproduk;
	echo "</tr>";
