...
<a class="verdana10blk"><b>PENERIMAAN PREMI NB PER KANTOR CABANG</b></a>
<hr size="1">
    <table>
...
if($vtgl=="" && $vbln=="" && $vthn=="") {
   ...
   $sql = "select ".
          ...
          "from ".
              ...
              "(select ".
                	"k.kdkantorinduk,".
                	"sum(p.premi1) as premirp,".
									"sum(h.nilairp) as premirpn,".
              ...
              "where ".
                	...
                	"j.nopenagih=p.nopenagih and ".
                	"k.kdkantor=j.kdrayonpenagih and ".
                 	"h.nilairp is not null and ".
                	"h.kdkuitansi like 'NB%' and ".
                	"to_char(h.tglbayar,".$summary." ".
              "group by k.kdkantorinduk) x,".
          
              "(select ".
                	"k.kdkantorinduk,".
                	"sum(p.premi1) as premirpi,".
									"sum(h.nilairp) as premirpin,".
                	"count(p.nopertanggungan) as jmlpolrpi  ".
              "from ".
                	"$DBUser.tabel_200_pertanggungan p,".
                	"$DBUser.tabel_300_historis_premi h,".
                	"$DBUser.tabel_001_kantor k,".
              ...
              "where ".
                	...
                	"h.kdkuitansi like 'NB%' and ".
                	"to_char(h.tglbayar,".$summary." ".
              "group by k.kdkantorinduk) y,".
          
              "(select ".
                	"k.kdkantorinduk,".
                	"sum(p.premi1) as premiusd,".
									"sum(h.nilairp) as premiusdn,".
                	"count(p.nopertanggungan) as jmlpolusd ".
              "from ".
                	"$DBUser.tabel_200_pertanggungan p,".
                	"$DBUser.tabel_300_historis_premi h,".
                	"$DBUser.tabel_001_kantor k,".
              ...
              "where ".
                	...
                	"h.kdkuitansi like 'NB%' and ".
                	"to_char(h.tglbayar,".$summary." ".
              "group by k.kdkantorinduk) z ".
          
          "where ".
              "r.kdkantor=x.kdkantorinduk(+) and ".
              "r.kdkantor=y.kdkantorinduk(+) and ".
              "r.kdkantor=z.kdkantorinduk(+) and ".
	...
	echo "<a class=verdana10blk><b>Penerimaan Premi NB RO ".$tglheader."</b></a><br>".
  ...
  <tr bgcolor="#78bdd8">
	...
	while ($ark=$DB->nextrow()) {
		 ...
		 $prerpn=$ark["PREMIRPN"];
		 $preusdn=$ark["PREMIUSDN"];
		 $prerpin=$ark["PREMIRPIN"];

		 $jmlrp=$ark["JMLPOLRP"];
		 $jmlusd=$ark["JMLPOLUSD"];
		 $jmlrpi=$ark["JMLPOLRPI"];
		 
		 $pol=$jmlrp+$jmlusd+$jmlrpi;
		 $premi=$prerpn+$prerpin+$preusdn;
		 
	   include "../../includes/belang.php";	
		 echo "<td class=verdana7blk>".$i."</td>"; 
	   echo "<td class=verdana7blk>".$ark["KDKANTOR"]."</td>"; 
		 echo "<td class=verdana7blk>".$ark["NAMAKANTOR"]."</td>"; 
		 echo "<td class=verdana7blk align=right>".($jmlrp=='' ? 0 : $jmlrp)."</td>"; 
		 echo "<td class=verdana7blk align=right>".number_format($prerp,2)."</td>";
		 echo "<td class=verdana7blk align=right>".($jmlrpi=='' ? 0 : $jmlrpi)."</td>"; 
		 echo "<td class=verdana7blk align=right>".number_format($prerpi,2)."</td>";
		 echo "<td class=verdana7blk align=right>".($jmlusd=='' ? 0 : $jmlusd)."</td>"; 
		 echo "<td class=verdana7blk align=right>".number_format($preusd,2)."</td>";
		 echo "<td class=verdana7blk align=right>".($pol=='' ? 0 : $pol)."</td>";
...
<br><br>
<?php
 //echo "<a href=\"#\" class=verdana10blk onclick=\"NewWindow('graph_premiro.php?tglsearch=$tglsearch','popuppage','600','400','yes');\">Tampilan Grafik</a>";
  ?>
</div>
<hr size="1">
