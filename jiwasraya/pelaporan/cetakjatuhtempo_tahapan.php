...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="782" id="AutoNumber1">
  <tr>
    <td width="100%" style="border-left-color: #111111; border-left-width: 1; border-right-color: #111111; border-right-width: 1"><table width="100%" border="0" cellspacing="0" cellpadding="3">
      ...
      <tr>
        ...
        <td class="style5"><div align="right" class="style8"><b><span class="style10">PT ASURANSI JIWA IFG</br>
              <?=$KTR->namakantor.'</b></br>'.$KTR->alamat01.'</br>'.$KTR->alamat02.' '.$KTR->kodepos.'</br>Telp. : '.$KTR->phone01.'</br>Fax. : '.$KTR->phone02.'</br>Email. : '.$KTR->email;?>
              </br>
    ...
    <div align="justify" class="style5">      
        ...
        <p>Berdasarkan catatan yang ada pada kami, jatuh tempo pembayaran benefit <?php echo substr($row["NAMABENEFIT"],10,strlen($row["NAMABENEFIT"])-10); ?> untuk polis nomor <?php echo $row["PREFIXPERTANGGUNGAN"];?>-<?php echo $row["NOPERTANGGUNGAN"];?> / <?php echo $row["NOPOL"];?> atas nama 
          <?php echo $row["PEMPOL"];?> 
akan jatuh tempo pada tanggal <?php echo $tglexp; ?>.</p>
    ...
    <table border="0" cellspacing="1" style="border-collapse: collapse" width="100%" id="table1" cellpadding="4" bordercolor="#B3CFFF">
	  ...
	  <td class="style5">Copy Buku Rekening Bank</td>
	  <td class="style5">&nbsp;</td>
	  <td class="style5">&nbsp;</td>
    ...
    <p align="justify" class="style5">Hormat kami <br>
      PT ASURANSI JIWA IFG <br><?php echo $KTR->namakantor; ?><br><br><br><br><?php //echo $KTR->kepala;?><br /><?php //echo $KTR->jabatan;?>
  </p>
    <p align="justify" class="style2">Dokumen ini tidak memerlukan tanda tangan karena dicetak secara komputerisasi.</p>    </td>
  </tr>
  <tr>
    <td style="border-left-color: #111111; border-left-width: 1; border-right-color: #111111; border-right-width: 1; font-size: 13px;">&nbsp;
        <br><br>
        <b><i>*Diharapkan menyertakan fotocopy halaman depan buku rekening untuk transfer manfaat asuransi (1 lembar)</b><br>
            [No Rekening hanya diperkenankan atas nama Pemegang Polis / tertanggung / nama-nama yang tercantum dalam daftar penerima manfaat]</i>
    </td>
  </tr>
</table>
<br/><br/>
