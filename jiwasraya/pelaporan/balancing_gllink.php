...
<script language="JavaScript" type="text/javascript" src="../../includes/window.js" ></script>
	...
	echo "<a class=verdana10blu><b>BALANCING TRANSAKSI DAN REKAPITULASI GL-LINK</b></a>";
	echo "<hr size=1>";
#---------------------------------------------- start navigasi -----------------
...
echo "    </tr>";
echo "    <tr>";
echo "      <td class=\"verdana9blk\">Kantor Pelaporan</td>";
...
if($cari){
      ...
      echo "BALANCING TRANSAKSI DAN REKAPITULASI GL-LINK<br>";
      echo $namakantor."<br>";					
      echo "PERIODE LAPORAN ".$tglDari."<br><br>";					

?>

 <table border="1" style="border-collapse: collapse" id="table1" cellpadding="5">
 <tr>
  <td bgcolor="#3300ff" align="center" rowspan="2"><font color="#FFFFFF">No</font></td>
  <td bgcolor="#3300ff" align="center" rowspan="2"><font color="#FFFFFF">Kode Akun</font></td>
  <td bgcolor="#3300ff" align="center" colspan="3"><font color="#FFFFFF">Transaksi (TRVOUC)</font></td>
  <td bgcolor="#3300ff" align="center" colspan="3"><font color="#FFFFFF">Rekapitulasi (MASTER)</font></td>
  <td bgcolor="#3300ff" align="center" colspan="3"><font color="#FFFFFF">Selisih</font></td>
 </tr>
 <tr>
  <td bgcolor="#3300ff" align="center"><font color="#FFFFFF">Debet</font></td>
  <td bgcolor="#3300ff" align="center"><font color="#FFFFFF">Kredit</font></td>
  <td bgcolor="#3300ff" align="center"><font color="#FFFFFF">(D-K)</font></td>
  <td bgcolor="#3300ff" align="center"><font color="#FFFFFF">Debet</font></td>
  <td bgcolor="#3300ff" align="center"><font color="#FFFFFF">Kredit</font></td>
  <td bgcolor="#3300ff" align="center"><font color="#FFFFFF">(D-K)</font></td>
  <td bgcolor="#3300ff" align="center"><font color="#FFFFFF">Debet</font></td>
