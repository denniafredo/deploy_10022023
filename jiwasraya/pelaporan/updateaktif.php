...
?>
  ...
  if(parseInt(navigator.appVersion) >= 4){win.window.focus();}
	...
	<?
	echo "<a class=\"verdana10blk\"><b>UPDATE POLIS KONVERSI AKTIF KANTOR $kantor </b></a>";
  echo "<hr size=1>";
...
?>
&nbsp;&nbsp;&nbsp;<a class="verdana10blk" href="portopoliokantoraktif.php?lihat=$lihat&start=1&end=200&page=1">Halaman Data Konversi</a>
