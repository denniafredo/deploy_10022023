...
<b>HASIL <?=$namabank;?> <br />BULAN <?=$tglcari;?></b>
  ...
  $sql = "select (select DECODE(counT(tglseatled),1,'SUDAH LUNAS PADA '||MAX(TO_CHAR(tglseatled,'DDMMYYYY')),'') from $DBUser.tabel_300_historis_premi
where prefixpertanggungan=SUBSTR (a.peserta_text, 76, 2)
and nopertanggungan=SUBSTR (a.peserta_text, 78, 9)
and to_char(tglbooked,'mmyyyy')=SUBSTR (a.peserta_text, 128, 6)
and tglseatled is not null)lunas, a.* from $DBUser.TABEL_315_UPLD_AUTODEBET a where to_char(tglproses,'dd/mm/yyyy')='$tglcari' and kdbank='$kdbank' and status='0'";
  $kantorcetak=$kantor1;
	...
	<td bgcolor="#89acd8" align="center">DATA</td>
    <td bgcolor="#89acd8" align="center">BANK</td>
	<td bgcolor="#89acd8" align="center">PROSES</td>
	...
	<?=$i;?></td>
	<td style="border-left-width: 1; border-right-width: 1; border-top: 1px solid #D8E1FA; border-bottom: 1px solid #D8E1FA"><?=$arr["PESERTA_TEXT"];?></td>
		...
		<td align="center" style="border-left-width: 1; border-right-width: 1; border-top: 1px solid #D8E1FA; border-bottom: 1px solid #D8E1FA"><?=$tglcari;?></td>
        <td style="border-left-width: 1; border-right-width: 1; border-top: 1px solid #D8E1FA; border-bottom: 1px solid #D8E1FA"><?=$arr["LUNAS"];?></td>		
  </tr>
  <?
	$i++;	}
	?>
