...
//echo 'masuk ddn'; die;
	...
	//while ($rowxx = oci_fetch_array($dbxx->get_statement())) {
		...
		echo 'Kirim email ke '.$prefixpertanggungan.$nopertanggungan.$kdkantor.'<br>';
			...
			$mail->Subject  = " <Ujicoba kirim dari Server JLINDO> Pemberitahuan Jatuh Tempo Ekspirasi Polis ".$rowx["PREFIXPERTANGGUNGAN"].'-'.$rowx["NOPERTANGGUNGAN"]. " atas nama tertanggung ".$rowx["TERTANGGUNG"];
