...
<table>
<tr>
<td>Tanggal Proses : <?=DateSelector("d");?> <td colspan="2"> </td><td>Kategori Produk :</td><td>
<select name="kategori"><option value="link">Link</option><option value="nonlink">Non Link</option></select><input type="submit" name="submit" value="Cari"></td>
</tr>
</table>
</form>
...
to_char(a.tglbayar,'dd/mm/yyyy') tglbayar,to_char(a.tglseatledtitipan,'dd/mm/yyyy') tglseatled,a.norekva,
    ...
    and a.prefixpertanggungan=b.prefixpertanggungan and b.nopenagih=c.nopenagih ".$kategoriprod." and to_char(tglseatledtitipan,'mm/yyyy')='".substr($tglcari,1,7)."'";
  $kantorcetak=$kantor1;
