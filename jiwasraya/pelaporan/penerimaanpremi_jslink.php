...
<br />
<div align="center">
<b>HASIL AUTO DEBET BANK MANDIRI <br />BULAN <?=$namabulan." ".$year;?> PERIODE <?=$periode=="" ? "1" : $periode;?><br /><?=$KTR->namakantor;?> </b>
</div>
...
//
          ...
          "where ".
            ...
            //"to_char(a.tglupdated,'YYYYMMDD') between '$tglawal' and  '$tglakhir' and ".
            "c.kdrayonpenagih='$kantor' and ".
						"b.kdproduk=e.kdproduk and e.kdcabas='$cabas' and a.kdbank='MDR' ".
...
//		 $PNG=new Klien($userid,$passwd,$arr["NOPENAGIHLAMA"]);
      	$sql=	"select substr(keteranganmutasi,20,10) as nopenagihlama from $DBUser.tabel_600_historis_mutasi_pert ".
      						...
      						"and nopertanggungan='".$arr["NOPERTANGGUNGAN"]."' and substr(keteranganmutasi,length(keteranganmutasi)-15,16) like '%MANDIRI%' ".
...
//		 $PNG=new Klien($userid,$passwd,$arr["NOPENAGIHLAMA"]);
      	$sql=	"select substr(keteranganmutasi,20,10) as nopenagihlama from $DBUser.tabel_600_historis_mutasi_pert ".
      						"where kdmutasi='12' and prefixpertanggungan='".$arr["PREFIXPERTANGGUNGAN"]."' ".
      						"and nopertanggungan='".$arr["PREFIXPERTANGGUNGAN"]."' and substr(keteranganmutasi,length(keteranganmutasi)-15,16) like '%MANDIRI%' ".
      						"group by substr(keteranganmutasi,20,10)";
        $DBA->parse($sql);
        $DBA->execute();
				$arrA=$DBA->nextrow();
