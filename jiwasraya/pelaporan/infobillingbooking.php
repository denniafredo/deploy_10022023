...
<body>
<a class="verdana10blk"><b>INFO BILLING BOOKING</b></a>
<hr size="1">
<? 
 if(!$nopenagih){
    $nomorpenagih="";
...
<table border="0" cellpadding="1" cellspacing="1" width="100%" class="tblisi1">
  ...
  $namacarabayar=array(0=>'BULANAN','KWARTALAN','SEMESTERAN','TAHUNAN');
	...
	*/
	$kdcarabayar=array(0=>'1','2','3','4');
  $namacarabayar=array(0=>'BULANAN','KWARTALAN','SEMESTERAN','TAHUNAN');
	$kdkuitansi=array(0=>'BLN','KWA','SEM','THN');
	$kdvaluta = array(0=>'0','1','3');
	
	$sqlk ="select kdkantor from $DBUser.tabel_001_kantor";
	$DB->parse($sqlk);
	$DB->execute();
/*
	while($kn=$DB->nextrow()){
	...
	*/
	...
	// $penagih = $noklien;			
	  ...
	  for ($b=0; $b<count($kdkuitansi); $b++) {
	   print( " <td align=center>".$kdkuitansi[$b]."</td>\n" );
    }
		print( "</tr>\n" );
        ...
        /*	
                      ...
                      "where ".
                      	...
                      	"to_char(tglbooked,'MMYYYY')='042004' ".
                      "group by ".
                      	"b.kdvaluta,".
                      	"b.kdcarabayar,".
                      	"c.kdrayonpenagih";
        			  ...
        			  $sql ="select sum(premitagihan) res ".
        		   	 ...
        		   	 //echo $sql;
        				 ...
        				 $jml = ($res["JMLPOLIS"]==0) ? "0" : "<a href=\"#\" onclick=\"NewWindow('detilinfotagihan.php?np=$nopenagih&kwt=$kdkuitansi[$b]&val=$kdvaluta[$d]&cb=$kdcarabayar[$c]&tglproses=$blnproses&bln=$bln&thn=$thn&namapenagih=$namaklien1&kdkantor=$kdkantor','detiltagihan',800,400,1)\">".number_format($res["RES"],2)."</a>";
