...
<body topmargin="10">
      ...
      $filtertgl = "and to_char(a.tglproses,'YYYYMMDD')='".$tglprocess."' ";
  			...
  			else
  			{
  			  $filtergrp = "and nvl(b.tagihan,0)='$kdgroup' ";
  				//$filtergrp = "and b.tagihan='$kdgroup' ";
  			}
      ...
      ?>				
			...
			<hr size="1">
      <?="<a href=# onclick=\"NewWindow('tagihan_penagih_cetak.php?tglprocess=".$tglprocess."&nopenagih=".$nopenagih."&kdgroup=".$kdgroup."','',900,500,1)\"><img src=../img/cetak.gif align=absmiddle border=0> Cetak</a>";?>
			 | 
