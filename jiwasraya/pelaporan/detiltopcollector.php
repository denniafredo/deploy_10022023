<?  
  ...
  include "../../includes/session.php";  
	...
	?>
	<title>Info Polis Collectors</title>
...
<?
	$qry = "select a.prefixpenagih,a.nopenagih,".
	       ...
	       "b.namaklien1,c.namapangkatpenagih,d.namakelaspenagih,e.namajenjangpenagih,".
				 ...
				 "a.nopenagih='$noklien'";// and a.kdrayonpenagih='$kantor'";
  ...
  if(!$namapenagih){
	 echo "<hr size=1>";
	 echo "<font color=red>Penagih nomor $noklien bukan penagih kantor $kantor</font>";
	} else {
	echo "<hr size=1>";
  ?>
  ...
  <tr>
	...
	if($gettop=="Year"){
	  ...
	  $thisperiode="$vbln$vthn";
		$periode="to_char(a.mulas,'MMYYYY')='$thisperiode'";
		$judul="$bln $vthn";
  } else {
		$thisperiode="$vtgl$vbln$vthn";
	...
	echo "<div align=center>";
				  ...
				  $sql = "select a.prefixpertanggungan,a.nopertanggungan,a.kdproduk,".
	               ...
	               "from $DBUser.tabel_200_pertanggungan a ".
			           "where a.nopenagih='$noklien' and a.kdpertanggungan='2' ".
	            ...
	            case "03": $bln = "Maret"; break;
		          ...
		          case "12": $bln = "Desember"; break;
					 ...
					 echo "<a class=verdana10blk><b>Daftar Polis Periode $judul</b></a><br><br>";
					 		echo "<table>";
					    echo("<tr class=\"hijao\">");
