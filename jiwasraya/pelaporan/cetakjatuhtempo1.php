...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="782" id="AutoNumber1">
  <tr>
    <td width="100%" style="border-left-color: #111111; border-left-width: 1; border-right-color: #111111; border-right-width: 1"><table width="100%" border="0" cellspacing="0" cellpadding="3">
      ...
      <tr>
        <td height="27" class="style5"><img src="./LogoJS.png" width="220" height="100"\></td>
    ...
    <p align="justify" class="style5">Mohon untuk dapat melakukan pembayaran premi tersebut diatas sebelum  jatuh tempo premi premi pertama, hal ini untuk menjaga kesinambungan manfaat. Keterlambatan pembayaran premi ataupun hal-hal lainnya yang menyebabkan premi tidak terbayarkan dan melewati masa leluasa pembayaran, akan menyebabkan  polis menjadi <em><strong>Batal.</strong></em></p>
