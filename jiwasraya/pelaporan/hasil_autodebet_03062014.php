...
<? 
		...
		echo("<font face=Verdana size=1><a href=\"#\" onclick=\"window.open('hasil_autodebet.php?kdbank=".$kdbank."&periode=".$periode."&month=".$month."&year=".$year."&mode=print','','width=1000,height=600,top=100,left=100,scrollbars=yes');\"><img src=../img/cetak.gif align=absmiddle border=0> Cetak Laporan</a></font>");
}
?>
</body>
</html>
