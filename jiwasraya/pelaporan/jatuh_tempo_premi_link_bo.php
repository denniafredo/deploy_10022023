...
<table border="0" cellspacing="1" style="border-collapse: collapse" width="100%" id="table1" cellpadding="4" bordercolor="#B3CFFF">
	...
	?>
        ...
        <td><?=$row["ALAMAT"];?></td>
        <td><?=$row["KOTA"];?></td>        
        <!--td><?="<a href=\"javascript:NewWindow('../pelaporan/cetakjatuhtempo.php?prefixpertanggungan=".$row["PREFIXPERTANGGUNGAN"]."&nopertanggungan=".$row["NOPERTANGGUNGAN"]."&tglexp=".$row["TGLEXP"]."&link=Y','polisinfo',815,600,'yes');\">cetak</a>";?></td-->
