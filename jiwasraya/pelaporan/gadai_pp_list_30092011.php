...
<table border="1" cellpadding="2" style="border-collapse: collapse" width="100%" bordercolor="#09b0ce">
	<tr>
        ...
        <td rowspan="2" bgcolor="#7dc2d9" align="center">NILAI TUNAI <? echo $month."/".$year;?></td>
...
//-- Tambahan dari Ari 22/12/2010 - Sum Angsuran Pokok dan Bunga untuk tiap periode Booked					   
				...
				$DBUser.polis.nilaitebus(a.prefixpertanggungan, a.nopertanggungan, '$month$year')*(decode(b.kdvaluta,1,1,(select kurs from $DBUser.tabel_999_kurs where TO_CHAR (tglkursberlaku, 'YYYYMM') = '$year$month' and kdvaluta=b.kdvaluta)))/(decode(b.kdvaluta,0,b.indexawal ,1))nilaitebus
...
-->
        ...
        <td valign="top" align="right"><?=idNumberFormat($arr["NILAITEBUS"]);?></td>
