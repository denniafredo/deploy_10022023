...
/*				 
	The following code commented by Udi at Apr, 04th, 2008
	and change with optimized one, hope that will improve performance
	
				 $sql = "SELECT   x.kdkantor, (SELECT namakantor
                        FROM $DBUser.tabel_001_kantor
                       WHERE kdkantor = x.kdkantor) namakantor, y.premitarget,
                   x.premirealisasi,
                  ...
                  group by z.kdrayonpenagih
                  order by z.kdrayonpenagih) x,
                       (SELECT   kdkantor, $fieldtarget AS premitarget
