...
<table bgcolor="#e5e5e5" border="1" width="780" align="center" cellpadding="2" style="border-collapse: collapse" bordercolor="#a4a4a4" id="AutoNumber1" cellspacing="0">
  <tr>
    <td width="100%" height="25" bgcolor="#fac67e" align="center"><b>Regen PDF</b></td>
  </tr>
  <tr>
    <td width="100%">
    <table border="0" cellpadding="2" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber2">
      <tr>
        ...
        <td>: 
  				...
  				/*switch($kdklaim)
  				{
  				  ...
  				  echo "<option value='".$_GET['jenis_blast']."'>".$_GET['jenis_blast']."</option>";
	  ...
	  <tr>
        <td>Periode</td>
        <td colspan="3">: 
        <input type="text" value="<?=$_GET['periode'];?>" name="periode" size="16"> (MM/YYYY)</td>
      </tr>		
    </table>
    </td>
  </tr>
  <tr>
    <td width="100%" height="25" bgcolor="#fac67e" align="center"><input type="submit" name="billing" value="re create" /></td>
  </tr>
	</form>
</table>
