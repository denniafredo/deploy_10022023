...
$sql1 = '';
if($jenis=='VALID'){
	$sql1=" AND URL <> 'invalid'  ";
}elseif($jenis=='INVALID'){
	$sql1 =" URL = 'invalid'  ";
}elseif($jenis=='TERKIRIM'){
	$sql1 =" AND TGL_KIRIM_SMS IS NOT NULL ";
}elseif($jenis=='BLM_TERKIRIM'){
	$sql1 =" AND TGL_KIRIM_SMS IS NULL  ";
}
...
$sql=" select PREFIXPERTANGGUNGAN,NOPERTANGGUNGAN,RAYONPENAGIHAN,
       TGLBOOKED,TGLSEATLED,NO_HP,URL,TGL_KIRIM_SMS       
