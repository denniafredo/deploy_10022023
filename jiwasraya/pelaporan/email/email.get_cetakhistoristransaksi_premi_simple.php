...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="782" id="AutoNumber1">
  <tr>    
    <div align="justify"> 
		  ...
		  <tr>
			<td width="50" valign="top" class="style5">Kepada Yth. Bapak/Ibu <?=$row["PEMPOL"];?></td>			
		  </tr>
		  <tr>
			<td width="50" valign="top" class="style5">Terima kasih atas kepercayaan Anda menjadi nasabah PT Asuransi Jiwa IFG.</td>			
		  </tr>		  
		  <tr>
			<td width="50" valign="top" class="style5">Berikut Kami sampaikan Historis Transaksi Polis <?=$row["PREFIXPERTANGGUNGAN"].$row["NOPERTANGGUNGAN"];?></td>			
		  </tr>
		  <tr>
			<td width="50" valign="top" class="style5">Informasi lebih lanjut dapat menghubungi 1500151.</td>			
		  </tr>	
		  <tr>
