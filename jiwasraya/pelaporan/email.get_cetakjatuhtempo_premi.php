...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="782" id="AutoNumber1">
  <tr>    
    ...
    <p align="justify">Bersama ini kami sampaikan e-Billing premi polis <?=$row["ANDA"];?>, dengan rincian sebagai berikut :</p>
	<table border="0" cellspacing="1" style="border-collapse: collapse" width="100%" id="table1" cellpadding="4" bordercolor="#B3CFFF">
      <tr>
    ...
    <p align="justify"><strong><u>Info Penting</u></strong> <br>
      <ol>
		...
		<li>Informasi tata cara pembayaran premi, silahkan <a href="http://www.jiwasraya.co.id/sites/default/files/dokumen-nasabah/Tata%20Cara%20Pembayaran%20Premi.pdf">klik disini</a> 
		</li>
	  </ol>
    </p>       
  </tr>
