  ...
  <tr>
    <td width="100%" bgcolor="#FFFFFF">
      <table border="0" width="100%" cellspacing="3">
        ...
        <tr>
          <td></td>
          <td><input type="submit" value="Submit" name="submit"><!--<input type="submit" value="Lihat FAQ" name="lihat">--></td>
        </tr>
      </table>
    </td>
  </tr>
...
<hr size="1">
<? 
echo "<a href=\"admin_faqs.php?start=1&end=5\" class=\"verdana10blk\">Back to Admin FAQs XL-iNdO</a>";
}
 ?>
