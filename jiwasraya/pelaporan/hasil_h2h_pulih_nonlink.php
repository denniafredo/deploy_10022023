...
<html>
<head>
<title>Info Pelunasan Pemulihan Non Unit Link</title>
<style type="text/css">
<!-- 
body{
  ...
  <td>Pemb.</td>
	<td>
	  ...
	  <select name="metodebayar">
		...
		<option value="PAMP" <?=$sj;?>>H2H Pampasy</option>
	</select></td>
...
<b>DAFTAR TRANSAKSI NON LINK  <?=$titletrans;?><br /> </b>
