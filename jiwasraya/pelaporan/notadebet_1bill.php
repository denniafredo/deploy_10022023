...
<table border="0" width="60%" cellpadding="4" cellspacing="1" style="border-collapse: collapse" bordercolor="#CCCCCC" id="AutoNumber1">
	<tr>
		...
		TAGIHAN PREMI CITIBANK 1BILL <br />BULAN <?=$namabulan." ".$year;?><br /><?=$KTR->namakantor;?> </b>
		<br /><br /></font>
		</td>
	</tr>	
...
?> 
| 
 <?="<a href=# onclick=NewWindow('print_notadebet.php?year=".$year."&month=".$month."&day=".$day."','',900,400,1)><img src=../img/cetak.gif border=0 align=absmiddle> Cetak Laporan</a>";?>
