                ...
                FROM   (  SELECT   kdrayonpenagih,                                   
                           ...
                           WHERE   KDRAYONPENAGIH IN
                                         (select kdkantor
										  ...
										  connect by prior kdkantor = kdkantorINDUK)
                                   AND kdstatusfile = '1'
								   AND (TO_CHAR (TGLBOOKED, 'MM/YYYY') = '".$tglcari."' and to_char(tglrekam, 'MM/YYYY')='".$tglcari."')
           ...
           (  SELECT   kdrayonpenagih,                       
                ...
                FROM   (  SELECT   kdrayonpenagih,
                           ...
                           WHERE   KDRAYONPENAGIH IN
                                   ...
                                   AND kdstatusfile = '1'
								   AND (TGLBOOKED <=
                                         LAST_DAY (TO_DATE ('".$tglcari."', 'MM/YYYY')) and to_char(tglrekam, 'MM/YYYY')='".$tglcari."')
                        GROUP BY   kdrayonpenagih,
                                   KDCARABAYAR,
                                   KDKUITANSI)
...
ORDER BY   SD.NAMACARABAYAR";
	...
	?>
        ...
        <td align="right"><strong><a href="#" onclick="popitup('detail_tagihan_bln_ini.php?jenis=TM_TAG&kd_kuitansi=BP&kd_carabayar=<?=$row["NAMACARABAYAR"];?>&kd_wilayah=<?=$wilayah;?>&bln=<?=$tglcari;?>')"><?=number_format($row["TM_TAG_BP"],2,",",".");?></a></strong></td>
		...
		<td align="right"><strong><a href="#" onclick="popitup('detail_tagihan_sd_bln_ini.php?jenis=SD_TAG&kd_kuitansi=BP&kd_carabayar=<?=$row["NAMACARABAYAR"];?>&kd_wilayah=<?=$wilayah;?>&bln=<?=$tglcari;?>')"><?=number_format($row["SD_TAG_BP"],2,",",".");?></a></strong></td>        
        ...
        <td align="right"><strong><a href="#" onclick="popitup('detail_lunas_bln_ini.php?jenis=TM_LNS&kd_kuitansi=BP&kd_carabayar=<?=$row["NAMACARABAYAR"];?>&kd_wilayah=<?=$wilayah;?>&bln=<?=$tglcari;?>')"><?=number_format($row["TM_LNS_BP"],2,",",".");?></a></strong></td>        
		...
		<td align="right"><strong><a href="#" onclick="popitup('detail_lunas_sd_bln_ini.php?jenis=SD_LNS&kd_kuitansi=BP&kd_carabayar=<?=$row["NAMACARABAYAR"];?>&kd_wilayah=<?=$wilayah;?>&bln=<?=$tglcari;?>')"><?=number_format($row["SD_LNS_BP"],2,",",".");?></a></strong></td>        
        ...
        <td align="right"><strong><a href="#" onclick="popitup('sisa_tagihan_sd_bln_ini.php?jenis=SD_LNS&kd_kuitansi=BP&kd_carabayar=<?=$row["NAMACARABAYAR"];?>&kd_wilayah=<?=$wilayah;?>&bln=<?=$tglcari;?>')"><?=number_format(($row["SD_TAG_BP"])-($row["SD_LNS_BP"]),2,",",".");?></a></strong></td>        
