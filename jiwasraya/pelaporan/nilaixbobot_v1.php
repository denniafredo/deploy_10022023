...
//		echo "$kdktr=".$kdktr."&dthn=".$dthn."&tglDariCari=".$tglAwalCari."&tglSampaiCari=".$tglSampaiCari."&akun=".$akun;
		...
		if ($nourut=='C.1.'||$nourut=='C.2.'||$nourut=='C.3.'||$nourut=='C.4.1'||$nourut=='C.4.2'||$nourut=='C.5'){
...
<?
		if ($dthn<='2008'){
			...
			"'148090000',".//auto debet MDR
			"'148340000','148440000','148390000')"; //tambahan rekening R/K
		}
...
<?
		if ($dthn<='2008'){
			...
			"'148290000','148310000','148320000','148330000','148350000','148400000')"; //tambahan rekening R/K
		}
...
//======================================
  ...
  <td><p>&nbsp;&nbsp;&nbsp;<b>C.5. Saving Plan</b></p></td>
	...
	if ($dthn<='2008'){
			...
			$kdrekening="('123120000','148450000')";
		}
			echo nilaiRekening('C.5',$DBA,$wherektr1,$kdktr,$whereposted,$dthn,$kdrekening,$tglAwalCari,$tglDariCari,$tglSampaiCari);
	?>
 </tr>
 ...
 <tr>
	...
	<tr bgcolor="#a9d8e7">
		<td></td>
		<td><b>Jumlah Penerimaan Premi NB PP (C.1+C.2+C.3.1+C.3.2+C.4.1+C.4.2+C.5)</b></td>
