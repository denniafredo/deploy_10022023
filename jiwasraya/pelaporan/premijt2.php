...
echo "<font face=\"verdana\" size=\"2\"><b>Rayon Penagihan : ".$kdkantor."</b></font><br>";
...
$arr=$DB->nextrow();
if ($cek==NULL) {
	echo "<br><font face=\"Verdana\" size=\"2\" color=\"#ff0000\"><b>Tidak Ada Premi Jatuh Tempo Bulan $bulan $vth</b></font><br>";
	...
	$qry ="select c.prefixpertanggungan,c.nopertanggungan,(select b.namaklien1 from ".
			 ...
			 "f.kdrayonpenagih='$kantor' and c.prefixpertanggungan=a.prefixpertanggungan and ".
			 "c.nopertanggungan=a.nopertanggungan and ".
//			 "c.tglseatled is NULL and ".
			 "a.kdvaluta=d.kdvaluta and a.kdcarabayar=e.kdcarabayar and ".
			 "to_char(c.tglbooked,'MMYYYY')='$vbln$vth' $sambung ".
			 "order by a.nopenagih,a.prefixpertanggungan,a.nopertanggungan";
	//echo $qry."<br>";
	$DB->parse($qry);
	$DB->execute();
	echo "<font face=\"Verdana\" size=\"2\">Premi Jatuh Tempo Bulan <b>$bulan $vth</b></font><br>";
...
echo "<hr size=\"1\">";
echo "<font face=\"verdana\" size=\"2\"><a href=\"premijt1.php?vbln=$vbln&vth=$vth\"><< Back</a></font>";
echo "</body>";
?>
