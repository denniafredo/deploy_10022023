...
echo "</table><table>";	
	...
	echo '<tr>';	
		for ($x = 1; $x <= $jmlpage; $x++) {
			$batasbawah = 1 + ($x * 50) - 50;
			$batasatas = $x * 50;
			echo "<td>
					<a href='detail_lunas_sd_bln_ini.php?jenis=$jenis&kd_kuitansi=$kdkuitansi&kd_carabayar=$carabayar&kd_wilayah=$kdwilayah&bln=$tglbooked&batasbawah=$batasbawah&batasatas=$batasatas'>$x</a>		
				  </td>";
		} 
	echo '</tr>';	
	?>
