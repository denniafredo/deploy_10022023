...
?>
<b>DAFTAR JATUH TEMPO SAVING PLAN<BR /> 
...
<table border="0" cellpadding="2" cellspacing="1" style="border-collapse: collapse" bordercolor="#CCCCCC" width="100%" id="AutoNumber1">
  ...
  <? 
	$sql = "select ".
              ...
              "b.kdcarabayar,b.nopolswitch, a.nilaitunai  ".
          "from  ".
              //"$DBUser.tabel_223_transaksi_produk a, ".
              "$DBUser.TABEL_223_TRANSAKSI_savingplan a, ".
	...
	<td style="border-left-width: 1; border-right-width: 1; border-top: 1px solid #D8E1FA; border-bottom: 1px solid #D8E1FA" align="center"><?=$arr["EXPIRASI"];?></td>
		<td style="border-left-width: 1; border-right-width: 1; border-top: 1px solid #D8E1FA; border-bottom: 1px solid #D8E1FA" align="center"><?=number_format($arr["NILAITUNAI"],2,",",".");?></td>
  </tr>
	<? 
	$i++;
	$jmltotal += $arr["PREMI"];
