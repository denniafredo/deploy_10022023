...
<table>
    ...
    <td>
	Tanggal Download<?=DateSelector("d");?> &nbsp;<input type="submit" name="applyx" value="SUBMIT" class="but">&nbsp;
    <input type="submit" name="upjur" value="UPLOAD JURNAL" class="but">
  </td>
    </tr>
		<!--<tr><td></td><td><input type="submit" name="applyx" value="SUBMIT" class="but"></td>
        <td colspan="2">
        <fieldset>
...
if($upjur)
{
   ...
   $tglupload = str_replace("/", "", $tglcari);
	$sql="insert into $DBUser.TABEL_802_TRVOUC@GLABC select * from $DBUser.TABEL_802_TRVOUC_TEMP where kdtrans='$tglcari'";
   //$sql="BEGIN $DBUser.JURNAL_UTILITY.GEN_JURNAL_AUTODEBET('$tglupload', '$kdbank'); END;";
   //echo $sql;
   //die;
	//$DB->parse($sql);
    //$DB->execute();
...
<b>HASIL <?=$namabank;?> <br />BULAN <?=$tglcari;?></b>
  ...
  $sql = "select * from $DBUser.TABEL_802_TRVOUC_TEMP where kdtrans='$tglcari'";
  $kantorcetak=$kantor1;
    ...
    <td bgcolor="#89acd8" align="center">KDTRANS</td>
	<td bgcolor="#89acd8" align="center">NOTRANS</td>
    <td bgcolor="#89acd8" align="center">AKUN</td>
	...
	<?=$i;?></td>
	<td style="border-left-width: 1; border-right-width: 1; border-top: 1px solid #D8E1FA; border-bottom: 1px solid #D8E1FA"><?=$arr["KDKANTOR"];?></td>
        ...
        <td align="center" style="border-left-width: 1; border-right-width: 1; border-top: 1px solid #D8E1FA; border-bottom: 1px solid #D8E1FA"><?=$arr["DEBET"];?></td>	
        <td align="center" style="border-left-width: 1; border-right-width: 1; border-top: 1px solid #D8E1FA; border-bottom: 1px solid #D8E1FA"><?=$arr["KREDIT"];?></td>	
        <td align="center" style="border-left-width: 1; border-right-width: 1; border-top: 1px solid #D8E1FA; border-bottom: 1px solid #D8E1FA"><?=$arr["KET"];?></td>
  </tr>
  <?
	$i++;	}
	?>
