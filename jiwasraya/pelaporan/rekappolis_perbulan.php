...
echo "Bulan ".ShowFromDate(10,"Past");

echo "  <table border=1>";
echo "  <form name=produksi method=post action=$PHP_SELF>";
echo "    <tr bgcolor=#b0cbe6>";
echo "      <td class=\"verdana9blk\">Bulan </td>";
echo "      <td class=\"verdana9blk\">".ShowFromDate(10,"Past")."</td>";
...
if($masa=="pilih"){
  ...
  echo "</div>";
	...
	if($a=="0"){
	    ...
	    $produktitle = "<td class=verdana8blk width=250 align=center bgcolor=#96cbcb><B>PRODUK</B></td><td class=verdana8blk align=center bgcolor=#82d7ff><b>POLIS</b><td class=verdana8blk align=center bgcolor=#82d7ff><b>PEMPOL</b></td><td class=verdana8blk align=center bgcolor=#9ce29a><b>JUA</b></td><td class=verdana8blk align=center bgcolor=#fee498><b>PREMI</b></td>";
  } else {
