		...
		$sql = "select ".
          ...
          "where ".
            ...
            "b.nopenagih=c.nopenagih ".
						...
						"and substr(b.kdproduk,1,3)='JL2'";//and a.kdbank='".$metodebayar."'";
	}
	//echo "<br />".$sql."<br />";
	$DB->parse($sql);
  $DB->execute();				
...
<table border="0" cellpadding="2" cellspacing="1" style="border-collapse: collapse" bordercolor="#CCCCCC" width="100%" id="AutoNumber1">
  ...
  foreach ($arr as $foo => $row ) {
	...
	$sql = "select ".
          ...
          "where ".
            ...
            //"c.kdrayonpenagih='$kantor' and ".
						"b.kdproduk=e.kdproduk ".
						"and substr(b.kdproduk,1,3)='JL2' ".
						"and e.kdcabas='$cabas' and a.kdbank='".$metodebayar."' ".
    ...
    <td style="border-left-width: 1; border-right-width: 1; border-top: 1px solid #D8E1FA; border-bottom: 1px solid #D8E1FA" align="right"><?=number_format(($arr["PREMITAGIHAN"]),2,",",".");?></td>
    <!--<td style="border-left-width: 1; border-right-width: 1; border-top: 1px solid #D8E1FA; border-bottom: 1px solid #D8E1FA" align="right"><?=number_format(($arr["JMLPREMI"]-$discount),2,",",".");?></td>-->
    <? 
	...
	<tr bgcolor="#f5d79c">
	 ...
	 <td align="right"><?=number_format(${"jmltotaldebetob".$cabas}-${"jmldiscountob".$cabas}+${"jmlmatreob".$cabas},2,",",".");?></td>
	...
	<tr bgcolor="#f5d79c">
	 ...
	 <td align="right"><?=number_format(${"jmltotaldebetnb".$cabas} - ${"jmldiscountnb".$cabas}+${"jmlmatrenb".$cabas},2,",",".");?></td>
	 <td></td>
	 <td></td>
	 <td></td>
	 <td></td>
