...
if ($submit) {
	...
	// mencari no ijin gadai
            ...
            $nourut = $maxurut + 1;
					...
					$noizincp = $noizinbaru."/Cash Plan/".$kantor.substr($tglpengajuan,2,8);
					//echo $noizincp;
	...
	{ 
		...
		$sql = 	"insert into $DBUser.tabel_901_pengajuan_klaim ".
						"(prefixpertanggungan,nopertanggungan,kdklaim,tglpengajuan,".
						"userrekam,tglrekam,nilaibenefit,status,namadokter,alamatdokter,tglbooked,pemohon, noizin, kdkantorproses) ".
				"values ".
						"('$prefix','$noper','$jnsklaim',to_date('$tglpengajuan','DD/MM/YYYY'), ".
						"user,sysdate,NULL,'0','$namadokter','$alamatdokter',$booked,'$pemohon','$noizincp', '$kantor')";
	...
	if ($DB->execute()) 
	{
		// masukkan data klaim kecelakaan
			 ...
			 print( "   <tr>\n" );
			 print( "    <td width=\"20%\" align=\"left\"><a href=\"#\" onclick=\"window.location.replace('hitungklaim_cashplan.php?prefix=$prefix&noper=$noper&kdklaim=$jnsklaim&tglpengajuan=$tglpengajuan')\"><font face=Arial size=2>Lanjut</font></a></td>\n" );
...
function OpenWin(prefix,noper) {
	...
	window.frame_aajaxan.location.href='loadpengajuan_cashplan.php?prefix='+prefix+'&noper='+noper+'';
}
...
<table bgcolor="#e5e5e5" border="1" width="95%" align="center" cellpadding="2" style="border-collapse: collapse" bordercolor="#a4a4a4" id="AutoNumber1" cellspacing="0">
  <tr>
    <td width="100%" height="25" bgcolor="#fac67e" align="center"><b>PENGAJUAN KLAIM RIDER CASH PLAN NEW UNIT LINK</b></td>
  </tr>
  <tr>
    <td width="100%">
