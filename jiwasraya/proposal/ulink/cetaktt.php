...
<font face="Verdana" size="2"><b>DAFTAR CETAK TANDA TERIMA POLIS</b><br>
Kantor : <?echo $kantor; ?>
...
<? }?>
<br /><a href="./cetakpolis.php" >MENU CETAK POLIS</a>
	...
	$sql= "select ".
    	      ...
    	      "a.nopertanggungan,a.kdproduk,to_char(a.mulas,'DD/MM/YYYY') mulas,".
				...
				"where ".
                 ...
                 "and nopertanggungan=a.nopertanggungan and tglcetaktterima is null) ".
    				"ORDER BY a.mulas";
		//echo $sql;		
	$DB->parse($sql);
	$DB->execute();
...
/*ga jadi karena berat loading nya : 23 jul 2013/ iie*/
	 ...
	 */
	 ...
	 $artt=$DC->nextrow();
	 if($artt["TT"]=='OK') {
	 	$tandaterima="<font face=\"Verdana\" size=\"1\"><a href=# onclick=\"NewWindow('../../polis/tanda_terima_pro.php?prefixpertanggungan=".$arr["PREFIXPERTANGGUNGAN"]."&nopertanggungan=".$arr["NOPERTANGGUNGAN"]."','',800,500,1)\">CETAK T.TERIMA</a></font>";
	 } else{ $tandaterima="";}
		...
		echo "<td bgcolor=\"#FFFFFF\" align=\"center\">".$tandaterima."</td>"; 
		?>
</tr>
	<? 
	$count++;
...
<a href="./cetakpolis.php" >MENU CETAK POLIS</a>
