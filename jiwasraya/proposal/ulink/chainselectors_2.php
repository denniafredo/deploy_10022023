        ...
        */ 
        ...
        { 
            ...
            */ 
			...
			if((int)$this->maxTargetChoices == 0){
				$this->maxTargetChoices = 5;
			}
            print("\tfor(index=0; index < 5; index++)\n"); 
            print("\t{\n"); 
            ...
            */ 
			...
			if(is_array($this->uniqueChoices) && count($this->uniqueChoices) > 0){
				...
				print("}\n\n"); 
						    ...
						    //   "&nbsp;<a href=\"popupprod.php\" onclick=\"NewWindow(this.href,'name','260','200','yes');return false\">".
		            //   "<img src=\"../img/jswindow.gif\" border=\"0\" alt=\"lihat produk\"></a>".

        //print the two selectors 
        function printSelectors() 
        { 
            $selected=TRUE; 
            printf ("<tr><td width=\"115\" ><font face=\"Arial\" size=\"2\">Kode Produk</font></td>");
    				echo	 "<td width=\"1\" ><font size=\"2\"><b>:</b></font></td>";
    				echo	 "<td width=\"413\" colspan=\"4\" >";
						print("<select name=\"" . $this->names[CS_FIRST_SELECTOR] . "\" class=\"c\" onfocus=\"highlight(event)\" title=\"Produk Asuransi\" " . 
                  "onChange=\"update".$this->names[CS_SECOND_SELECTOR]."();\" onblur=\"TanggalMulasDefault()\">\n"); 
            ...
            */ 
            ...
            printf ("<tr><td width=\"115\"><font face=\"Arial\" size=\"2\">Cara Bayar</font></td>".
    							 "<td width=\"1\" ><font size=\"2\"><b>:</b></font></td>".
    							 "<td width=\"413\" colspan=\"4\" >");
            print("<select name=\"".$this->names[CS_SECOND_SELECTOR]."\" class=\"c\" onfocus=\"highlight(event)\" onblur=\"ProdukValuta(this.form)\" >\n"); 
            for($i=0; $i < 5; $i++) 
            { 
