...
<tr>
<td class=verdana8><font size="2">Nama Fund</font></td><td class=verdana8><font size="2">Porsi (%)</font></td><td class=verdana8 align="center"><font size="2">Cek <!--(Pilih 2)--></font></td>
</tr>
<?
...
echo "<input type=hidden name=uaminnya value=$uamin><input type=hidden name=uamaxnya value=$uamax>UA Minimal = ".number_format($uamin,2,",",".")." <br><input type=text name=jua onBlur=\"javascript:uaOK()\"><br> UA Maximal = ".number_format($uamax,2,",",".");
...
<tr>
  <td class="arial10"><a href="benefit.php?state=0&premijua=<?echo $premijua;?>&noproposal=<?echo $noproposal;?>&nopertanggungan=<?echo $nopertanggungan;?>&prefixpertanggungan=<?echo $prefixpertanggungan;?>&kdper=<?echo $kdper;?>&vara=<?echo $vara;?>&kdproduk=<?echo $kdproduk;?>">Back</a></td>
    ...
    <input type="submit" name="propmtc14lanjut" disabled value="Lanjut"  onclick="javascript:SubmitOK();">
	</td>
</tr>
</table>
<?
