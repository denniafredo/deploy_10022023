...
<table border="0" cellpadding="1" cellspacing="1" width="700" class="tblborder">
  ...
  <tr>
   	 ...
   	 <td width="2%" class="arial10">:</td>
   	 <td width="25%" class="arial10"><input type="text" name="mulas" size="10" maxlength="10" onBlur="javascript:convert_date(mulas);HitungUsia(document.ntryprop);CekAwalMulas(document.ntryprop);" class="c" onFocus="highlight(event)" value="<? echo date("d/m/Y"); ?>"></td>
	...
	<tr class="tblisi">
	 ...
	 No. Rekening
      ...
      ?>
		 ...
		 Jumlah Transfer <input type="text" name="jmltransfer" size="15" maxlength="15" class="c" disabled onBlur="cektransfer();javascript:convert_date(document.ntryprop.akhirpremi);javascript:convert_date(document.ntryprop.expirasi);">
		 </font>
		 </td>
	</td>
