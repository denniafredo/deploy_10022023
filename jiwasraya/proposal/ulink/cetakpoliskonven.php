...
//Dihilangkan agar tidak bisa ilakukan pencetakan dokumen ulang
/*if (isset($ulang)) {
...
AND (select sum(nilaipembayaran) from $DBUser.tabel_800_pembayaran h ".
    						 ...
    						 "AND a.nopertanggungan = h.nopertang	gungan ".
	...
	$sql= "select ".
    	      ...
    	      "a.nopertanggungan,a.kdproduk,to_char(a.mulas,'DD/MM/YYYY') mulas,".
				...
				"where ".
					...
					//	"AND a.prefixpertanggungan like 'LB%' ".
...
/*ga jadi karena berat loading nya : 23 jul 2013/ iie*/
	 ...
	 */
	 ...
	 if($artt["TT"]=='OK') {
		...
		$nextpage="test.cetak.polis_.php?prefix=".$arr["PREFIXPERTANGGUNGAN"]."&nopertanggungan=".$arr["NOPERTANGGUNGAN"]."";
