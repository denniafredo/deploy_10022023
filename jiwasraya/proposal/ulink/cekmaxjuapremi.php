	...
	if($juapremi=="jua"){
      ...
      $arr=$DB->nextrow();
    	$minpremi=$arr["PREMIMINIMAL"];
			...
			$minjuapremi = $minpremi!="" ? $arr["PREMIMINIMAL"] : 100000;
...
//				if($premitemp > $maxallow)
			...
			else if($kdproduk=="JSSP" || $kdproduk=="JSSPA" || $kdproduk=="JSSK")
			{
...
//			if(substr($kdproduk,0,5)=="JSSPO" && $juapremi=="premi")
			if((substr($kdproduk,0,4)=="JSSP"||substr($kdproduk,0,4)=="JSSK") && $juapremi=="premi")
			{			 
			  $batas = 100000;
