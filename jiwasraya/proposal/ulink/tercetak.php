...
<table border="0" width="100%" bgcolor="#DFDFBF" cellspacing="1" cellpadding="2">
  ...
  <tr>
    ...
    <td bgcolor="#C2CAED" rowspan="2" align="center"><font face="Verdana" size="1"><b>MED</b></font></td>
		...
		<td bgcolor="#C2CAED" rowspan="2" align="center"><font face="Verdana" size="1"><b>TGL. CETAK</b></font></td>
   </tr>
  <tr>
...
*/
	...
	$sql= "select ".
    	      ...
    	      "a.nopertanggungan,a.kdproduk,to_char(a.mulas,'DD/MM/YYYY') mulas,to_char(a.tglcetak,'DD/MM/YYYY') tglcetak,".
...
//	echo "Ari ".$nilairp." - ".$PERT->premi1." - ".$TR->Kurs($PERT->valuta,$tglbp3);
  ...
  <tr>
    ...
    <td bgcolor="#FFFFFF" align="center"><font face="Verdana" size="1"><? echo $arr["TGLCETAK"]; ?></font></td>
