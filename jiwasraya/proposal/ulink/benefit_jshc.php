        ...
        // New Cash Plan Murni dan Bedah per 18/08/2009
      	...
      	} else 
      	{
            ...
            //		   		 "values ('$prefixpertanggungan','$nopertanggungan','$kdproduk','$kdbenefit',$periodebayar,$periodebenefit,'R')";	 	
						...
						$btsumur=65;
						if(($vbenefit>$maxuarider) && ($kdbenefit=="ADDB" || $kdbenefit=="TI" || $kdbenefit=="TPD" || $kdbenefit=="PBTPD" || $kdbenefit=="SPTPD" || $kdbenefit=="PBD" || $kdbenefit=="SPBD" || $kdbenefit=="CI53")){
						echo "<br>UA Rider Lebih Besar dari pada UA Maximal Rider, UA Max= ".$maxuarider;
						}else{
							if($kdbenefit=="PBTPD" || $kdbenefit=="SPTPD" || $kdbenefit=="PBD" || $kdbenefit=="SPBD"){
							if($kdbenefit=="PBTPD"){
							$kdbenefitnya="PTPD";
							}else{
							$kdbenefitnya=$kdbenefit;
							}
							if($kdbenefit=="PBD" || $kdbenefit=="PBTPD" || $kdbenefit=="PTPD"){
							...
							$cekkls="SELECT   noklien,to_char(b.tgllahir,'dd/mm/yyyy') tgllahir,floor(months_between(mulas,b.tgllahir)/12) usia_th,b.merokok,((".$vbenefit." / 1000) * tarif) / $faktorcb as premirider FROM   $DBUser.tabel_200_temp a,".
										...
										"$DBUser.tabel_100_klien b,$DBUser.tabel_205_tarip_premi d WHERE ".
										...
										"AND d.usia = floor(months_between(mulas,b.tgllahir)/12) AND kdtarif='$kdbenefitnya'";
							}else{
						   ...
						   "to_date('$tglmulas','DD/MM/YYYY'),add_months(to_date('$tgllahir','DD/MM/YYYY'),(($btsumur)*12)),'".$arrcekkls["PREMIRIDER"]."')";
							//echo $sql;
...
<tr class="tblisi1">
 <td>
 	<table border=0 width="100%" class=tblisi>
    <tr class=hijao align=center>
    <td colspan="3">Data Tertanggung JS Hospital Care</td>
    </tr>
	<tr class=hijao align=center>
	 <td>No</td>
