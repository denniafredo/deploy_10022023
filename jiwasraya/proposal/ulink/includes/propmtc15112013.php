...
if ($nopertanggungan<>''){	
	$sql = "select prefixpertanggungan,nopertanggungan,notertanggung,nosp,kdpertanggungan, ".
				 ...
				 "premi2,nopenagih,kdstatusfile,noagen,kdstatusmedical,nopemegangpolis,nopembayarpremi,notertanggung2, ".
...
/*  add 12 Nov */
    ...
    $selectorNames = array( 
	  ...
	  $Query= "select  kdproduk, namaproduk ,usia_lpp,variabel,lama_min,lama_max ".
	          "from  $DBUser.tabel_202_produk where nvl(status,0)!='X'";
...
/* $sqltertt="select namaklien1 as namatertanggung2 from $DBUser.tabel_100_klien wher noklien='$nottg2'";
$DB1->parse($sqltertt);
$DB1->execute();
$arrtert2=$DB->nextrow();
$namatertanggung2=$arrtert2["NAMAKLIEN1"];*/
...
/**************************************************************************/
  ...
  //print( "document.ntryprop.notertanggung2.value = '".$nottg2."';\n" );
 /* if($nopp==$nottg){
		  print( "document.ntryprop.cariTertT.disabled = true;\n" );
	  }else{
		  print( "document.ntryprop.cariTertT.disabled = false;\n" );
	  }*/
  ...
  print( "document.ntryprop.tgltransfer.value ='".$mulas."';\n" );
...
/*	print( "autodeb ='".$autodebet."';\n" );
  ...
  print( "document.ntryprop.nilai.value ='".$p1."';\n" );
	//print( "document.ntryprop.premi1.value ='".$p1."';\n" );
  print( "document.ntryprop.juamainproduk.value ='".$jua."';\n" );
  ...
  /*
iie:22072013  if($nottg2==""){
	  print( "document.ntryprop.submit.disabled=true;\n" );
  }else{
	  print( "document.ntryprop.submit.disabled=false;\n" );
  }
  */
...
<script language="JavaScript" type="text/javascript" src="includes/entrypropmtc.js"></script>
