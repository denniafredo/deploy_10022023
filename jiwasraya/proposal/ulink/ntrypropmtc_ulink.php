...
//	  $DB=new Database($userid,$passwd,"JSDEPLOY");
		$ary ="select prefixpertanggungan,nopertanggungan,nopolbaru,kdstatusemail,kdbank, keterangan from $DBUser.tabel_200_pertanggungan where ".
...
<style type="text/css">.c { COLOR: #000000; } </style>
...
<table border="0" cellpadding="1" cellspacing="1" width="700" class="tblhead">
  <tr>
	 <td class="tblhead" align="center" width="100%">EDIT PROPOSAL No : <?echo $arr['NOPOLBARU'];  ?></td>
  </tr>
...
?>
  ...
  <tr>
   	 ...
   	 <td class="arial10">
		 ...
		 <input type="button" value="Cari Klien" name="cari" class="buton" onClick="Cari(this.form)"></td>
		 <td class="arial10" align="right" valign="top">Proposal No</td>
   	 <td class="arial10"  valign="top">:</td>
   	 <td class="arial10"><b><? echo $kantor."-".$nopertanggungan ?><br>
    
     </td>
 		 <td class="arial10"></td>
	</tr>
    <!--<tr>
   	 <td class="arial10" colspan="7">No Tert. Tambahan :   	 
		 <input type="text" readonly name="notertanggung2" size="10" maxlength="10"  onblur="javascript:validasi10(this.form.notertanggung);" class="a">
		  <input type="hidden" name="namatertanggung2"><input type="button" value="Tert. Tambahan" name="cariTertT" class="buton" onClick="CariTT(this.form)"></td>
  ...
  <tr>
   	 ...
   	 <td width="2%" class="arial10">:</td>
   	 <td width="25%" class="arial10"><input type="hidden" name="tgltransfer"><input type="text" name="mulas" size="10" maxlength="10" onBlur="convert_date(mulas); return usai(ntryprop);"  onchange="javascript:convert_date(mulas);usai(ntryprop);" class="c" onFocus="highlight(event)"></td>
  ...
  <tr>
   	 ...
   	 <td width="2%" class="arial10">:</td>
   	 <td width="25%" class="ver8ungu"><input type="text" name="lamapembpremi_th" size="2" maxlength="2"  onfocus="highlight(event)" class="c" readonly onBlur="return cek_masapremi()">tahun
   	 ...
   	 <td width="2%" class="arial10">:</td>
   	 <td width="20%" class="arial10"><input type="text" name="akhirpremi" size="10" maxlength="10" class="a" readonly onBlur="javascript:convert_date(akhirpremi);" readonly></td>
		 <td width="16%" class="arial10"></td>
	</tr>
