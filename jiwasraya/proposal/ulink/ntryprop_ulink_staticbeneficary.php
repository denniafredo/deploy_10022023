<? 
  ...
  include "../../../includes/database.php";
	...
	function is_IE(){
		...
		return preg_match('/mozilla/i', $brw);
	}
...
<table border="0" cellpadding="1" cellspacing="1" width="900" class="tblborder">
  ...
  <tr>
   	 ...
   	 <td width="2%" class="arial10">:</td>
   	 <td width="25%" class="ver8ungu"><input type="text" name="lamapembpremi_th" size="2" maxlength="2"  onfocus="highlight(event)" class="c" onBlur="return cek_masapremi()"  value="<? echo $lprth; ?>" readonly>tahun
         ...
         <table border="0" cellpadding="1" cellspacing="1" width="90%"  class="tblisi">
             <tr>
			  ...
			  for($i;$i<=10;$i++){?>
				<tr> 
					<td width="3%">
					<input class="buton" type="button" value="<?=$i?>" onclick="NewWindow('./insurable.php?n=<?=$i?>&c=<?=$notertanggung?>','popuppage',600,400,1)"></td>
					<td ><input type="text" name="no<?=$i?>" maxlength="1" size="1" readonly class="a"></td>
					<td ><input type="text" name="nama<?=$i?>" size="40" readonly class="a"></td>
					<td ><input type="text" name="klienno<?=$i?>" maxlength="10" size="10" readonly class="a"></td>
					<td ><input type="text" name="hubungan<?=$i?>" size="30" readonly class="a"></td>
				</tr>
			<?php }?>
