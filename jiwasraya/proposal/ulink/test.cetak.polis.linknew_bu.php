<?php
	...
	class CetakPolis extends FPDF {
		...
		public function Init() {
			...
			$sql = "SELECT MIN (nilaibenefit) nilaibenefit,
					...
					FROM (
						...
						FROM (
							SELECT nilaibenefit,
								--(SELECT NVL (KDBENEFIT, KDASALBENEFIT)
		...
		public function DataPolis() {
			...
			//
			if(substr($arr["KDPRODUK"], 0, 4) == "JL4B" || substr($arr["KDPRODUK"], 0, 4) == "JL4S") {
				$this->SetFont('Arial','B',9);
				$this->Cell($this->num_space, $height, NULL, 0, 0, 'C');
			...
			if(substr($kd_produk,0,4)=="JL4B")
				$this->MultiCell(($this->pg_w-($this->num_space*2))*3/25, $h, "SUP PRO-M\nKK PRO-M", 0, 'C');
			else if ($kd_produk=="JL4XG")
                $this->MultiCell(($this->pg_w-($this->num_space*2))*3/25, $h, "SUP JS GA\nKK JS GA", 0, 'C');
            else if ($kd_produk=="JL4SMR") /*Tambahan untuk produk Smart Pro Mapan (JL4SMR) - TEGUH 17/01/2019*/
                $this->MultiCell(($this->pg_w-($this->num_space*2))*3/25, $h, "SUP S-PRO-M\nKK S-PRO-M", 0, 'C');
			else
			...
			$this->Cell(($this->pg_w-($this->num_space*2))*4/25, 4, number_format($arr["JUAMAINPRODUK"], 2, ",", "."), 0, 0, 'R');
		...
		public function LampiranPolis() {
            ...
            // JS SMART Promapan
            if(substr($arr["KDPRODUK"], 0, 4) == "JL4S") {
                $this->font_body('B');
                $this->Cell($this->num_space, $height, NULL, 0, 0, 'C');
                $this->Cell($this->pg_w-($this->num_space*2), $height, "Pilihan Jenis Dana Investasi Awal :", 0, 1, 'L');
                ...
                $this->Cell($this->num_space, $height, NULL, 0, 0, 'C');
                $this->Cell(($this->pg_w-($this->num_space*2))*3/27, $height, "1", 'LR', 0, 'C');
                $this->Cell(($this->pg_w-($this->num_space*2))*6/27, $height, "35%", 'LR', 0, 'C');
                $this->Cell(($this->pg_w-($this->num_space*2))*6/27, $height, "95%", 'LR', 0, 'C');
                $this->Cell(($this->pg_w-($this->num_space*2))*6/27, $height, "65%", 'LR', 0, 'C');
                $this->Cell(($this->pg_w-($this->num_space*2))*6/27, $height, "5%", 'LR', 1, 'C');
                ...
                $this->Cell($this->num_space, $height, NULL, 0, 0, 'C');
                $this->Cell(($this->pg_w-($this->num_space*2))*3/27, $height, "3", 'LR', 0, 'C');
                $this->Cell(($this->pg_w-($this->num_space*2))*6/27, $height, "80%", 'LR', 0, 'C');
                $this->Cell(($this->pg_w-($this->num_space*2))*6/27, $height, "95%", 'LR', 0, 'C');
                $this->Cell(($this->pg_w-($this->num_space*2))*6/27, $height, "20%", 'LR', 0, 'C');
                $this->Cell(($this->pg_w-($this->num_space*2))*6/27, $height, "5%", 'LR', 1, 'C');
