...
function CekSetuju(theForm) {
 if ( theForm.pempre.checked || theForm.tert.checked) {
...
<form name="klien" action="updclntmain_link2.php" method="POST" onSubmit="return OnSumbit(document.klien)">
  <tr>
    <td width="100%">
    <table width="100%" border="0" cellpadding="4" cellspacing="0" class="tblisi1">
      <tr>
        ...
        <td colspan="2"><font color="yellow"><? echo $namaklien; ?></td>
				<td align="left"><b><font color="red"><? $a = ($noklien) ? 'EDIT': 'ENTRY BARU'; echo "ENTRY PEMBAYAR PREMI ATAU TERTANGGUNG"; ?></td>
      </tr>
      <tr>
  ...
  <tr>
    ...
    <table width="100%" border="0" cellpadding="2"  class="tblisi" cellspacing="4">
      ...
      <tr>
        ...
        <td class="verdana10blk"><input type="text" class="c"  onFocus="highlight(event)" name="idexpired" size="20" maxlength="20" value="" onBlur="convert_date(idexpired)"><font color="#ff3333"> (DD/MM/YYYY)</font></td>
      </tr>
      <tr>
...
$sbrLain=array(0=> "1/Bonus","2/Komisi","3/Penjualan Aset","4/Hasil Investasi","5/Hibah","6/Warisan","7/Lainnya","8/Tidak ada Penghasilan");
  ...
  $sql="select kdhubungan,namahubungan from $DBUser.tabel_218_kode_hubungan";
    ...
    <input type="checkbox" name="pempre" value="pempre" onClick="CekSetuju(document.klien)"> Pembayar Premi  <br />
    <input type="checkbox" name="tert" value="tert" onClick="CekSetuju(document.klien)"> Tertanggung <div align="left">
