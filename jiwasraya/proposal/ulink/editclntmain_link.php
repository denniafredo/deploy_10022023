...
$sbrDana=array(0=> "1/Gaji","2/Hasil Usaha","3/Orang Tua","4/Hasil Investasi","5/Penghasilan Suami Istri","6/Lainnya");
	...
	$sql= "select KDKLIEN, NOKLIEN, NAMAKLIEN1, NAMAKLIEN2, KDAGAMA, GELAR, JENISKELAMIN, MERITALSTATUS, TEMPATLAHIR, to_char(TGLLAHIR,'DD/MM/YYYY') TGLLAHIR, KDID, TINGGIBADAN,". 	
		  "KDPEKERJAAN, BERATBADAN, KDHOBBY, NOID, PENDAPATAN, ALAMATTETAP01, KDKOTAMADYATETAP, ALAMATTETAP02, KODEPOSTETAP, PHONETETAP01, KDPROPINSITETAP, PHONETETAP02,".
		  "EMAILTETAP, ALAMATTAGIH01, KDKOTAMADYATAGIH, ALAMATTAGIH02, KODEPOSTAGIH, KDSTATUSREC, KDPROPINSITAGIH, PHONETAGIH01, PHONETAGIH02,".
		  "EMAILTAGIH,to_char(TGLKAWIN,'DD/MM/YYYY') , KDPEKERJAANLAMA, KDGANTIPEKERJAAN, ALAMATKERJA, STATUS, NPWP, WARGANEGARA, DIK_AKHIR,".
		  "to_char(TGLEXPIRED_ID,'DD/MM/YYYY') TGLEXPIRED_ID, NAMAIBUKAND, STATUS_TINGGAL, FAX_RMH, NO_PONSEL2, PANGKAT, NAMA_PERS, ALAMAT_PERS, TELPON_PERS, FAX_PERS, KET_USAHA,".
		  "BID_USAHA, NAMA_USAHA, ALAMAT_USAHA, BESAR_PENDAPATAN, SUMBER_DANA, SUMBER_PENGHASILAN, NAMA_PASANGAN, NAMA_KTR_PASANGAN, ALAMAT_KTR_PASANGAN,".
		  " to_char(TGLNIKAH,'DD/MM/YYYY') TGLNIKAH, ALMT_SURAT, TUJ_EMAIL, NO_PONSEL, ALAMATTINGGALKP2, KDPROPINSIKP, KDKOTAMADYAKP, KDPOSKP, ALAMATTINGGALKTP, ALAMATTINGGALKTP2,".
		  " KDPROPINSIKTP, KDKOTAMADYAKTP, KDPOSKTP, ALAMATTINGGALKP, BID_PERS, MEROKOK ".
...
//echo $sql;
	...
	$idexpired = (!$idexpired) ? $arc["TGLEXPIRED_ID"] : $idexpired;
	$ibuKand = (!$ibuKand) ? $arc["NAMAIBUKAND"] : $ibuKand;
	$npwp = (!$npwp) ? $arc["NPWP"] : $npwp;
	$tglMenikah = (!$tglMenikah) ? $arc["TGLNIKAH"] : $tglMenikah;
	$alamatTinggal = (!$alamatTinggal) ? $arc["ALAMATTETAP01"] : $alamatTinggal;
	$alamatTinggal2 = (!$alamatTinggal2) ? $arc["ALAMATTETAP02"] : $alamatTinggal2;
	$kdpos = (!$kdpos) ? $arc["KODEPOSTETAP"] : $kdpos;
	$alamatTinggalKTP = (!$alamatTinggalKTP) ? $arc["ALAMATTINGGALKTP"] : $alamatTinggalKTP;
	$alamatTinggalKTP2 = (!$alamatTinggalKTP2) ? $arc["ALAMATTINGGALKTP2"] : $alamatTinggalKTP2;
	$kdposKTP = (!$kdposKTP) ? $arc["KDPOSKTP"] : $kdposKTP;
	$alamatTinggalKP = (!$alamatTinggalKP) ? $arc["ALAMATTINGGALKP"] : $alamatTinggalKP;
	$alamatTinggalKP2 = (!$alamatTinggalKP2) ? $arc["ALAMATTINGGALKP2"] : $alamatTinggalKP2;
	$kdposKP = (!$kdposKP) ? $arc["KDPOSKP"] : $kdposKP;
	$phonetetap = (!$phonetetap) ? $arc["PHONETETAP01"] : $phonetetap;
	$faxRumah = (!$faxRumah) ? $arc["FAX_RMH"] : $faxRumah;
	$no_ponsel = (!$no_ponsel) ? $arc["NO_PONSEL"] : $no_ponsel;
	$no_ponsel2 = (!$no_ponsel2) ? $arc["NO_PONSEL2"] : $no_ponsel2;
	$emailtetap = (!$emailtetap) ? $arc["EMAILTETAP"] : $emailtetap;
	$namaPers = (!$namaPers) ? $arc["NAMA_PERS"] : $namaPers;
	$almtPers = (!$almtPers) ? $arc["ALAMAT_PERS"] : $almtPers;
	$bidangkerja = (!$bidangkerja) ? $arc["KDPOSKP"] : $bidangkerja;
	$telpPers = (!$telpPers) ? $arc["TELPON_PERS"] : $telpPers;
	$faxPers = (!$faxPers) ? $arc["FAX_PERS"] : $faxPers;
	$jabatan = (!$jabatan) ? $arc["KDPOSKP"] : $jabatan;
	$ketUsaha = (!$ketUsaha) ? $arc["KET_USAHA"] : $ketUsaha;
	$bidUsaha = (!$bidUsaha) ? $arc["BID_USAHA"] : $bidUsaha;
	$namaUsaha = (!$namaUsaha) ? $arc["NAMA_USAHA"] : $namaUsaha;
	$almtUsaha = (!$almtUsaha) ? $arc["ALAMAT_USAHA"] : $almtUsaha;
	$suamiIstri = (!$suamiIstri) ? $arc["NAMA_PASANGAN"] : $suamiIstri;
	$ktrSuamiIstri = (!$ktrSuamiIstri) ? $arc["NAMA_KTR_PASANGAN"] : $ktrSuamiIstri;
	$almKtrSuamiIstri = (!$almKtrSuamiIstri) ? $arc["ALAMAT_KTR_PASANGAN"] : $almKtrSuamiIstri;
	$gajiPerbulan = (!$gajiPerbulan) ? $arc["BESAR_PENDAPATAN"] : $gajiPerbulan;
	$merokok = (!$merokok) ? $arc["MEROKOK"] : $merokok;
	$tujuanEmail = (!$tujuanEmail) ? $arc["TUJ_EMAIL"] : $tujuanEmail;
	
	//echo "KAMPRET".$gajiPerbulan;
...
function CekAlamat(theForm) {
 if (theForm.alamatsesuai.checked) {
  var alamat=theForm.alamatTinggalKTP.value;
  var alamat2=theForm.alamatTinggalKTP2.value;
  var kdkotamadya=theForm.kdkotamadyaKTP.value;
  var kdprovinsi=theForm.kdpropinsiKTP.value;
  var kdpos=theForm.kdposKTP.value;
  theForm.alamatTinggal.value=alamat;
  theForm.alamatTinggal2.value=alamat2;
  theForm.kdkotamadya.value=kdkotamadya;
  theForm.kdpropinsi.value=kdprovinsi;
  theForm.kdpos.value=kdpos;
  theForm.alamatTinggalKP.value=alamat;
  theForm.alamatTinggalKP2.value=alamat2;
  theForm.kdkotamadyaKP.value=kdkotamadya;
  theForm.kdpropinsiKP.value=kdprovinsi;
  theForm.kdposKP.value=kdpos;
  }
}
    ...
    <form name="klien" action="updclntmain_link.php" method="POST" onSubmit="return OnSumbit(document.klien)">
      ...
      <tr>
        <td width="100%"><table width="100%" border="0" cellpadding="2"  class="tblisi" cellspacing="4">
          <tr>
            ...
            <td class="verdana10blk"><input type="text" class="c"  onfocus="highlight(event)" size="5" maxlength="20" name="gelar" value="<? echo $gelar; ?>"></td>
          </tr>
          <tr>
            ...
            <td class="verdana10blk"><input type="text" class="c"  onFocus="highlight(event)" name="idexpired" size="20" maxlength="20" value="<? echo $idexpired; ?>" onBlur="convert_date(idexpired)"></td>
          </tr>
          <tr>
        ...
        $query = "select kdagama,namaagama from $DBUser.tabel_102_agama";
          ...
          <tr>
            ...
            <td class="verdana10blk"><input type="text" class="c"  onFocus="highlight(event)" name="ibuKand" size="35" value="<? echo $ibuKand;?>" maxlength="33"></td>
          </tr>
          <tr>
            <td class="verdana10blk">Pendidikan Terakhir</td>
            <td class="verdana10blk"><?
		$pendidikan=array(0=> "BELUM SEKOLAH","SD","SMP","SMA","D1/D2","D3","S1","S2","S3");
		?>
	 ...
	 echo $pddk;
		  ...
		  ?>
            ...
            <td class="verdana10blk"><input type="text" class="c"  onFocus="highlight(event)" name="npwp" size="20" maxlength="20" value="<? echo $npwp;?>"></td>
          </tr>
          <tr>
        ...
        $query = "select meritalstatus,namameritalstatus from $DBUser.tabel_103_status_pernikahan";
	      ...
	      ?>
            ...
            <td class="verdana10blk"><input type="text" class="c"  onFocus="highlight(event)" name="tglMenikah" size="20" maxlength="20" value="<? echo $tglMenikah;?>"  onBlur="convert_date(tglMenikah)">
              <font color="#ff3333">(DD/MM/YYYY)</font></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="verdana10blk"><input name="alamatTinggalKTP" type="text" class="c" id="alamatTinggalKTP"  onFocus="highlight(event)" value="<? echo $alamatTinggalKTP; ?>" size="40" maxlength="30"></td>
            ...
            <td class="verdana10blk"><select name="kdkotamadyaKTP" size="1" class="c" id="kdkotamadyaKTP" onFocus="highlight(event)">
              <option></option>
              <?  
        $query = "select kdkotamadya,namakotamadya from $DBUser.tabel_109_KOTAMADYA order by namakotamadya";
		    $DB->parse($query);
		    $DB->execute();
    	  while($arr=$DB->nextrow()) {
		     if ($arr["KDKOTAMADYA"]==$arc["KDKOTAMADYAKTP"]) {
          ...
          <tr>
            <td class="verdana10blk"></td>
            <td class="verdana10blk"><input name="alamatTinggalKTP2" type="text" class="c" id="alamatTinggalKTP2"  onFocus="highlight(event)" value="<? echo $alamatTinggalKTP; ?>" size="40" maxlength="30">
              </textarea></td>
            <td class="verdana10blk"></td>
            <td class="verdana10blk"></td>
          </tr>
          <tr>
            ...
            <td class="verdana10blk"><select name="kdpropinsiKTP" size="1" class="c" id="kdpropinsiKTP" onFocus="highlight(event)">
              <option></option>
              <?  
        $query = "select kdpropinsi,namapropinsi from $DBUser.tabel_108_propinsi";
		    ...
		    $DB->execute();
    	  while($arr=$DB->nextrow()) {
		     if ($arr["KDPROPINSI"]==$arc["KDPROPINSIKTP"]) {
	      ...
	      ?>
            ...
            <td class="verdana10blk"><input type="text" class="c"  onFocus="highlight(event)" name="kdposKTP" size="20" maxlength="5" value="<? echo $kdposKTP;?>"></td>
          </tr>
          <tr>
            <td colspan="3" class="verdana10blk"><input type="checkbox" name="alamatsesuai" onClick="CekAlamat(document.klien)">
              Alamat KTP Sesuai dengan Alamat Saat Ini dan Korespondensi Sesuai</td>
            <td class="verdana10blk">&nbsp;</td>
          </tr>
          <tr>
            <td colspan="4" class="verdana10blk"><hr></td>
          ...
          <tr>
            ...
            <td class="verdana10blk"><input name="alamatTinggal" type="text" class="c" id="alamatTinggal"  onFocus="highlight(event)" value="<? echo $alamatTinggal;?>" size="40" maxlength="30"></td>
            <td class="verdana10blk">Kota/Kabupaten</td>
        ...
        $query = "select kdkotamadya,namakotamadya from $DBUser.tabel_109_KOTAMADYA";
		    ...
		    $DB->execute();
    	  while($arr=$DB->nextrow()) {
		     if ($arr["KDKOTAMADYA"]==$arc["KDKOTAMADYATETAP"]) {
		       echo "<option value=".$arr["KDKOTAMADYA"]." selected>".$arr["NAMAKOTAMADYA"]."</option>";
		     } else {
		       echo "<option value=".$arr["KDKOTAMADYA"].">".$arr["NAMAKOTAMADYA"]."</option>";
			   }
          ...
          <tr>
            <td class="verdana10blk"></td>
            <td class="verdana10blk"><input name="alamatTinggal2" type="text" class="c" id="alamatTinggal2"  onFocus="highlight(event)" value="<? echo $alamatTinggal2;?>" size="40" maxlength="30">
              </textarea></td>
            <td class="verdana10blk"></td>
            <td class="verdana10blk"></td>
          </tr>
        ...
        $query = "select kdpropinsi,namapropinsi from $DBUser.tabel_108_propinsi";
		    ...
		    $DB->execute();
    	  while($arr=$DB->nextrow()) {
		     if ($arr["KDPROPINSI"]==$arc["KDPROPINSITETAP"]) {
		       echo "<option value=".$arr["KDPROPINSI"]." selected>".$arr["NAMAPROPINSI"]."</option>";
		     } else {
		       echo "<option value=".$arr["KDPROPINSI"].">".$arr["NAMAPROPINSI"]."</option>";
			   }
	      ...
	      ?>
            ...
            <td class="verdana10blk">Kode Pos</td>
            <td class="verdana10blk"><input type="text" class="c"  onFocus="highlight(event)" name="kdpos" size="20" maxlength="5" value="<? echo $kdpos;?>"></td>
          </tr>
          <tr>
            <td class="verdana10blk">No. Telp. Rumah</td>
            <td class="verdana10blk"><input type="text" class="c"  onFocus="highlight(event)" name="phonetetap" size="20" maxlength="20" value="<? echo $phonetetap;?>"></td>
            <td class="verdana10blk">No. Fax. Rumah</td>
            <td class="verdana10blk"><input type="text" class="c"  onFocus="highlight(event)" name="faxRumah" size="20" maxlength="20" value="<? echo $faxRumah;?>"></td>
          </tr>
          <tr>
            <td class="verdana10blk">No. Ponsel 1</td>
            <td class="verdana10blk"><input type="text" class="c"  onFocus="highlight(event)" name="no_ponsel" size="20" maxlength="20" value="<? echo $no_ponsel;?>"></td>
            <td class="verdana10blk">No. Ponsel 2</td>
            <td class="verdana10blk"><input type="text" class="c"  onFocus="highlight(event)" name="no_ponsel2" size="20" maxlength="20" value="<? echo $no_ponsel2;?>"></td>
          </tr>
          <tr>
            <td class="verdana10blk">Email</td>
            <td class="verdana10blk"><input type="text" class="c"  onFocus="highlight(event)" name="emailtetap" size="20" value="<? echo $emailtetap;?>"></td>
            <td class="verdana10blk">&nbsp;</td>
            <td class="verdana10blk">&nbsp;</td>
          </tr>
          <tr>
            <td colspan="4" class="verdana10blk">Apakah khusus korespondensi rutin bersedia disampaikan hanya dalam bentuk Email
              <input type="radio" name="tujuanEmail" id="tujuanEmail" value="Yes" <? if($tujuanEmail=="Yes") echo "checked";?>>
              Ya&nbsp;&nbsp;&nbsp;&nbsp;
              <input type="radio" name="tujuanEmail" id="tujuanEmail" value="No" <? if($tujuanEmail=="No") echo "checked";?>>
              Tidak </td>
          </tr>
          <tr>
            <td colspan="4" class="verdana10blk"><hr></td>
          ...
          <tr>
            ...
            <td class="verdana10blk"><input name="alamatTinggalKP" type="text" class="c" id="alamatTinggalKP"  onFocus="highlight(event)" value="<? echo $alamatTinggalKP;?>" size="40" maxlength="30"></td>
            <td class="verdana10blk">Kota/Kabupaten</td>
        ...
        $query = "select kdkotamadya,namakotamadya from $DBUser.tabel_109_KOTAMADYA";
		    ...
		    $DB->execute();
    	  while($arr=$DB->nextrow()) {
		     if ($arr["KDKOTAMADYA"]==$arc["KDKOTAMADYAKP"]) {
		       echo "<option value=".$arr["KDKOTAMADYA"]." selected>".$arr["NAMAKOTAMADYA"]."</option>";
		     } else {
		       echo "<option value=".$arr["KDKOTAMADYA"].">".$arr["NAMAKOTAMADYA"]."</option>";
			   }
          ...
          <tr>
            <td class="verdana10blk"></td>
            <td class="verdana10blk"><input name="alamatTinggalKP2" type="text" class="c" id="alamatTinggalKP2"  onFocus="highlight(event)" value="<? echo $alamatTinggalKP2;?>" size="40" maxlength="30">
              </textarea></td>
            <td class="verdana10blk"></td>
            <td class="verdana10blk"></td>
          </tr>
        ...
        $query = "select kdpropinsi,namapropinsi from $DBUser.tabel_108_propinsi";
		    ...
		    $DB->execute();
    	  while($arr=$DB->nextrow()) {
		     if ($arr["KDPROPINSI"]==$arc["KDPROPINSIKP"]) {
		       echo "<option value=".$arr["KDPROPINSI"]." selected>".$arr["NAMAPROPINSI"]."</option>";
		     } else {
		       echo "<option value=".$arr["KDPROPINSI"].">".$arr["NAMAPROPINSI"]."</option>";
			   }
	      ...
	      ?>
            ...
            <td class="verdana10blk">Kode Pos</td>
            <td class="verdana10blk"><input type="text" class="c"  onFocus="highlight(event)" name="kdposKP" size="20" maxlength="20" value="<? echo $kdposKP;?>"></td>
          </tr>
          <tr>
            <td colspan="4" class="verdana10blk"><hr></td>
          </tr>
          ...
          <tr>
            ...
            <td class="verdana10blk"><input type="text" class="c"  onFocus="highlight(event)" name="namaPers" size="30" value="<? echo $namaPers;?>"></td>
            <td class="verdana10blk">Alamat Perusahaan</td>
            <td class="verdana10blk"><input type="text" class="c"  onFocus="highlight(event)" name="almtPers" size="40" value="<? echo $almtPers;?>"></td>
          </tr>
          <tr valign="top">
            <td class="verdana10blk">Bidang Pekerjaan</td>
            <td class="verdana10blk"><input name="bidangkerja" type="text" class="c" id="bidangkerja"  onFocus="highlight(event)" value="<? echo $bidangkerja;?>" size="30"></td>
            <td class="verdana10blk">&nbsp;</td>
            <td class="verdana10blk">&nbsp;</td>
          </tr>
          <tr valign="top">
            <td class="verdana10blk">No. Telp. Kantor</td>
            <td class="verdana10blk"><input type="text" class="c"  onFocus="highlight(event)" name="telpPers" size="20" maxlength="20" value="<? echo $telpPers;?>"></td>
            <td class="verdana10blk">No. Fax. Perusahaan</td>
            <td class="verdana10blk"><input type="text" class="c"  onFocus="highlight(event)" name="faxPers" size="20" maxlength="20" value="<? echo $faxPers;?>"></td>
          </tr>
          <tr>
            <td class="verdana10blk">Jabatan/Pangkat/Golongan</td>
            <td class="verdana10blk"><input type="text" class="c"  onFocus="highlight(event)" name="jabatan" size="20" maxlength="20" value="<? echo $jabatan;?>"></td>
        ...
        while($arr=$DB->nextrow()) {
          ...
          <tr>
            ...
            <td class="verdana10blk"><input type="text" class="c"  onFocus="highlight(event)" name="ketUsaha" size="20" maxlength="20" value="<? echo $ketUsaha;?>"></td>
            <td class="verdana10blk">Bidang Usaha</td>
            <td class="verdana10blk"><input type="text" class="c"  onFocus="highlight(event)" name="bidUsaha" size="20" maxlength="20" value="<? echo $bidUsaha;?>"></td>
          </tr>
          <tr>
            <td class="verdana10blk">Nama Usaha </td>
            <td class="verdana10blk"><input type="text" class="c"  onFocus="highlight(event)" name="namaUsaha" size="20" maxlength="20" value="<? echo $namaUsaha;?>"></td>
            <td class="verdana10blk">Alamat Usaha</td>
            <td class="verdana10blk"><input type="text" class="c"  onFocus="highlight(event)" name="almtUsaha" size="20" maxlength="20" value="<? echo $almtUsaha;?>"></td>
          </tr>
          <tr>
            <td colspan="4" class="verdana10blk"><hr></td>
          </tr>
     ...
     ?>
          ...
          <tr>
            <td class="verdana10blk"><input type="radio" name="gajiPerbulan" value="<5000000" id="gajiPerbulan" <? if($gajiPerbulan=="<5000000") echo "checked";?>>
              0 s/d 5.000.000</td>
            <td class="verdana10blk"><input type="radio" name="gajiPerbulan" value="5000001-15000000" id="gajiPerbulan" <? if($gajiPerbulan=="5000001-15000000") echo "checked";?>>
              5.000.001 s/d 15.000.001</td>
            <td class="verdana10blk"><input type="radio" name="gajiPerbulan" value="15000001-25000000" id="gajiPerbulan" <? if($gajiPerbulan=="15000001-25000000") echo "checked";?>>
              15.000.001 s/d 25.000.000</td>
            <td class="verdana10blk"><input type="radio" name="gajiPerbulan" value="25000001-50000000" id="gajiPerbulan" <? if($gajiPerbulan=="25000001-50000000") echo "checked";?>>
              25.000.001 s/d 50000000</td>
          </tr>
          <tr>
            <td class="verdana10blk"><input type="radio" name="gajiPerbulan" value="50000001-100000000" id="gajiPerbulan" <? if($gajiPerbulan=="50000001-100000000") echo "checked";?>>
              50.000.001 s/d 100.000.000</td>
            <td class="verdana10blk"><input type="radio" name="gajiPerbulan" value="100000001-250000000" id="gajiPerbulan" <? if($gajiPerbulan=="100000001-250000000") echo "checked";?>>
              100.000.001 s/d 250.000.000</td>
            <td class="verdana10blk"><input type="radio" name="gajiPerbulan" value=">250000000" id="gajiPerbulan" <? if($gajiPerbulan==">250000000") echo "checked";?>>
              >250.000.000</td>
            <td class="verdana10blk">&nbsp;</td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="verdana10blk"><input type="text" class="c"  onFocus="highlight(event)" name="suamiIstri" size="20" maxlength="20" value="<? echo $suamiIstri;?>"></td>
            <td class="verdana10blk">&nbsp;</td>
            <td class="verdana10blk">&nbsp;</td>
          </tr>
          <tr>
            ...
            <td class="verdana10blk" valign="top"><textarea name="ktrSuamiIstri" id="ktrSuamiIstri" cols="35" rows="3"><? echo $ktrSuamiIstri;?></textarea></td>
            <td class="verdana10blk" valign="top">Alamat Kantor atau Tempat<br />
              Bekerja Istri / Suami</td>
            <td class="verdana10blk" valign="top"><textarea name="almKtrSuamiIstri" id="almKtrSuamiIstri" cols="35" rows="3"><? echo $almKtrSuamiIstri;?></textarea></td>
          </tr>
          <tr>
            <td colspan="4" class="verdana10blk"><hr></td>
          </tr>
          ...
          <tr>
            ...
            <td class="verdana10blk"><label>
              <input type="radio" name="merokok" value="1" id="merokok" <? if($merokok==1) echo "checked";?>>
              Ya</label>
              &nbsp;&nbsp;&nbsp;
              <label>
                <input type="radio" name="merokok" value="0" id="merokok" <? if($merokok==0) echo "checked";?>>
                Tidak</label></td>
          </tr>
          <tr>
            <td class="verdana10blk">&nbsp;</td>
