<?php
	...
	$sql = "SELECT DISTINCT a.nospaj, c.namaklien1, d.prefixagen, d.noagen, e.namaklien1 namaagen, 
				TO_CHAR(a.tanggalrekam, 'dd/mm/yyyy hh24:mi:ss') tglrekam, a.tanggalrekam
			FROM tabel_spaj_online@spajol a
			INNER JOIN tabel_relasi@spajol b ON a.nospaj = b.nospaj
				AND b.statusklien IN (2,3)
			INNER JOIN tabel_klien_spaj_online@spajol c ON b.noklien = c.noklien 
			...
			WHERE d.kdkantor = '$kantor'
				AND LOWER(c.namaklien1) LIKE LOWER('%$nama%')
...
<body>
	...
	<table border="0" width="100%" cellpadding="2" cellspacing="1">
		<tr bgcolor="#f89aa4">
			...
			<td align="center"><b>Tgl Entry</b></td>
		</tr>
