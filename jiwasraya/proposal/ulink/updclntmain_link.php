...
ob_start();
  ...
  $meritalstatus = (strlen($meritalstatus)==0) ? "NULL" :  "'".$meritalstatus."'";
    ...
    $sql =  "update $DBUser.tabel_100_klien set namaklien1='$namaklien1',".
			"gelar=$gelar,jeniskelamin='$jeniskelamin',tempatlahir=$tplhr,tgllahir=to_date('$tgllahir','DD/MM/YYYY'),".
			"kdagama=$kdagama,meritalstatus=$meritalstatus,tinggibadan='$tinggibadan',beratbadan='$beratbadan',kdid=$kdid,noid=$noid,".
			"kdpekerjaan=$kdpekerjaan,npwp='$npwp',warganegara='$staWN',dik_akhir='$pendAkhir',".
			"tglexpired_id=to_date('$idexpired','dd/MM/YYYY'),namaibukand='$ibuKand',alamattetap01='$alamatTinggal',alamattetap02='$alamatTinggal2',".
			"status_tinggal='$staTptTinggal',kdpropinsitetap='$kdpropinsi',KDKOTAMADYATETAP='$kdkotamadya',phonetetap01='$phonetetap',".
			"fax_rmh='$faxRumah',emailtetap='$emailtetap',kodepostetap='$kdpos',no_ponsel2='$no_ponsel2',pangkat='$jabatan',nama_pers='$namaPers',".
			"alamat_pers='$almtPers',telpon_pers='$telpPers',fax_pers='$faxPers',ket_usaha='$ketUsaha',bid_usaha='$bidUsaha',nama_usaha='$namaUsaha',".
			"alamat_usaha='$almtUsaha',besar_pendapatan='$gajiPerbulan',sumber_dana='$sumberDana',sumber_penghasilan='$sumberDanaLain',".
			"nama_pasangan='$suamiIstri',nama_ktr_pasangan='$ktrSuamiIstri',alamat_ktr_pasangan='$almKtrSuamiIstri',tglnikah=to_date('$tglMenikah','DD/MM/YYYY'),".
			"tuj_email='$tujuanEmail',NO_PONSEL='$no_ponsel',ALAMATTINGGALKTP='$alamatTinggalKTP',ALAMATTINGGALKTP2='$alamatTinggalKTP2',".
			"KDKOTAMADYAKTP='$kdkotamadyaKTP',KDPROPINSIKTP='$kdpropinsiKTP',KDPOSKTP='$kdposKTP',ALAMATTINGGALKP='$alamatTinggalKP',".
			"ALAMATTINGGALKP2='$alamatTinggalKP2',KDPROPINSIKP='$kdpropinsiKP',KDKOTAMADYAKP='$kdkotamadyaKP',KDPOSKP='$kdposKP',MEROKOK='$merokok' ".
   ...
   //echo $sql;
	 ...
	 $DB->commit();
	   header("location:http://$HTTP_HOST/$KAMP/proposal/ulink/entryklien_ul.php");
		//  header("location:http://$HTTP_HOST/$KAMP/proposal/ulink/spaj_temp.php?noklien=$noklien");
