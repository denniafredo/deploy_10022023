        ...
        <tr>
          ...
          <table width="100%" cellpadding="0" cellspacing="1" border="0">
            ...
            $kdfund = $row1["KDFUND"];
						...
						$msquery = "select * from $DBUser.TABEL_UL_PENGAJUAN_REDEMPTION where prefixpertanggungan = '$prefix' AND nopertanggungan = '$noper' AND kdfund = '$kdfund' order by tgl_pengajuan";
...
<?php } ?>
 ...
 <br>
            ...
            <a href="mutasiredemp.php"><u>Close</u></a>
          </div>
