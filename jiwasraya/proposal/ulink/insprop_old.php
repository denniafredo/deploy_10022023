  ...
  include "./includes/database.php"; 
	...
	if($notertanggung2=="" && $namatertanggung2==""){
		$sql = "update $DBUser.tabel_200_temp set premiumholiday='$premiumholiday',nopolswitch='$prefix$noper',taltup='$taltup',".
			 	 				 "tgltransfer=to_date('$tgltransfer','DD/MM/YYYY'), jmltransfer='$jmltransfer',kdbank='$kdbank',norekeningdebet='$norekening',notertanggung2='$notertanggung2' ".
  		 	 "where prefixpertanggungan='$prefixpertanggungan' and nopertanggungan='$nopertanggungan'";			 
	}else{
	$sql = "update $DBUser.tabel_200_pertanggungan set notertanggung2='$notertanggung2' where prefixpertanggungan='$prefixpertanggungan' and nopertanggungan='$nopertanggungan'";	
	}
  //echo $sql;
//  die;
  $DB->parse($sql);
