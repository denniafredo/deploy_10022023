...
<![endif]-->
<script language="JavaScript" type="text/javascript" src="./includes/entryprop_fix_chrome.js"></script>
			...
			success : function (data) {
				...
				$.ajax({
					...
					success : function (data) {
						...
						$("select[name='kdproduk']").val(a[1]);
						updatekdcarabayar();
						$("select[name='kdcarabayar']").val(a[2]);
						$("input[name='mulas']").val("<?=date('d/m/Y')?>");
...
<table border="0" cellpadding="1" cellspacing="1" width="700" class="tblborder">
  ...
  <tr>
		...
		<input type="button" value="No.SPAJ"  onclick="NewWindow('spajlist.php','popuppage',600,400,1);" class="buton">
         ...
         <table border="0" cellpadding="1" cellspacing="1" width="90%"  class="tblisi" >
             <tr>
              ...
              <tr class="tblhead1">
      				 ...
      				 <td width="" align="center" id=""> DEL </td>
					 
              </tr>
			  <tbody id="tblbeneficaryisi">
