...
if (!$prefixpertanggungan==$kantor || $kdper=='2') {
 ...
 echo ( "<a  href=\"http://$HTTP_HOST/$KAMP/submenu.php?mnuinduk=150\"><img name=\"a\" border=\"0\" src=\"../img/xlindo.gif\" border=\"0\"></a><br><br>" );
 echo ("<a href=\"http://$HTTP_HOST/$KAMP/submenu.php?mnuinduk=150\">Kembali</a></font>" );
}
?>
</div>
<hr size="1">
