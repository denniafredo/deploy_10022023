...
<div align="center">
  <table border="0" cellspacing="1" cellpadding="0" class="tblborder">
    <form name="klien" action="updclntmain_link1.php" method="POST" onSubmit="return OnSumbit(document.klien)">
      <tr>
      ...
      <tr>
        <td width="100%"><table width="100%" border="0" cellpadding="2"  class="tblisi" cellspacing="4">
          ...
          <tr>
            ...
            <td class="verdana10blk"><input type="text" class="c"  onFocus="highlight(event)" name="idexpired" size="20" maxlength="20" value="" onBlur="convert_date(idexpired)">
	 ...
	 echo $pddk;
        ...
        $query = "select meritalstatus,namameritalstatus from $DBUser.tabel_103_status_pernikahan";
          ...
          <tr>
            ...
            <td class="verdana10blk"><input name="alamatTinggalKTP" type="text" class="c" id="alamatTinggalKTP"  onFocus="highlight(event)" value="" size="40" maxlength="30"></td>
        ...
        $DB->parse($query);
          ...
          <tr>
            <td class="verdana10blk"></td>
            <td class="verdana10blk"><input name="alamatTinggalKTP2" type="text" class="c" id="alamatTinggalKTP2"  onFocus="highlight(event)" value="" size="40" maxlength="30">
              </textarea></td>
            <td class="verdana10blk"></td>
            <td class="verdana10blk"></td>
          </tr>
          <tr>
            ...
            <td class="verdana10blk"><select name="kdpropinsiKTP" size="1" class="c" id="kdpropinsiKTP" onFocus="highlight(event)">
              <option></option>
              <?  
        $query = "select kdpropinsi,namapropinsi from $DBUser.tabel_108_propinsi order by namapropinsi";
		    $DB->parse($query);
		    $DB->execute();
    	  while($arr=$DB->nextrow()) {
          ...
          <tr>
            ...
            <td class="verdana10blk"><input name="alamatTinggal" type="text" class="c" id="alamatTinggal"  onFocus="highlight(event)" value="" size="40" maxlength="30"></td>
            <td class="verdana10blk">Kota/Kabupaten</td>
        ...
        $query = "select kdkotamadya,namakotamadya from $DBUser.tabel_109_KOTAMADYA order by namakotamadya";
          ...
          <tr>
            <td class="verdana10blk"></td>
            <td class="verdana10blk"><input name="alamatTinggal2" type="text" class="c" id="alamatTinggal2"  onFocus="highlight(event)" value="" size="40" maxlength="30">
              </textarea></td>
            <td class="verdana10blk"></td>
            <td class="verdana10blk"></td>
          </tr>
        ...
        $query = "select kdpropinsi,namapropinsi from $DBUser.tabel_108_propinsi order by namapropinsi";
          ...
          <tr>
            <td class="verdana10blk">Nomor Rekening Bank</td>
            <td class="verdana10blk"><input name="NoRekBank" type="text" class="c" id="NoRekBank"  onFocus="highlight(event)" value="" size="40" maxlength="75"></td>
            <td class="verdana10blk">Nama Bank</td>
            <td class="verdana10blk"><input name="NamaBank" type="text" class="c" id="NoRekBank2"  onFocus="highlight(event)" value="" size="40" maxlength="75"></td>
          </tr>
          <tr>
            <td class="verdana10blk">Unit / Cabang</td>
            <td class="verdana10blk"><input name="CabangBank" type="text" class="c" id="CabangBank"  onFocus="highlight(event)" value="" size="40" maxlength="75"></td>
            <td class="verdana10blk"> </td>
            <td class="verdana10blk"> </td>
          </tr> 
          <tr>
            <td class="verdana10blk">Atas Nama</td>
            <td class="verdana10blk"><input name="AtasNamaBank" type="text" class="c" id="AtasNamaBank"  onFocus="highlight(event)" value="" size="40" maxlength="75"></td>
            <td class="verdana10blk"> </td>
            <td class="verdana10blk"> </td>
          </tr> 
          <tr>
          ...
          <tr>
            ...
            <td class="verdana10blk"><input name="alamatTinggalKP" type="text" class="c" id="alamatTinggalKP"  onFocus="highlight(event)" value="" size="40" maxlength="30"></td>
            <td class="verdana10blk">Kota/Kabupaten</td>
        ...
        $query = "select kdkotamadya,namakotamadya from $DBUser.tabel_109_KOTAMADYA order by namakotamadya";
          ...
          <tr>
            <td class="verdana10blk"></td>
            <td class="verdana10blk"><input name="alamatTinggalKP2" type="text" class="c" id="alamatTinggalKP2"  onFocus="highlight(event)" value="" size="40" maxlength="30">
              </textarea></td>
            <td class="verdana10blk"></td>
            <td class="verdana10blk"></td>
          </tr>
        ...
        $query = "select kdpropinsi,namapropinsi from $DBUser.tabel_108_propinsi order by namapropinsi";
          ...
          <tr>
            ...
            <td class="verdana10blk"><select class="c" onFocus="highlight(event)" size="1" name="kdpekerjaan">
              <option></option>
              <?  
        $query = "select kdpekerjaan,namapekerjaan from $DBUser.tabel_105_pekerjaan order by namapekerjaan";
		    $DB->parse($query);
		    $DB->execute();
        while($arr=$DB->nextrow()) {
          ...
          <tr>
            ...
            <td class="verdana10blk"><!--<input type="text" class="c"  onFocus="highlight(event)" name="ketUsaha" size="20" maxlength="20" value="">-->
            <select class="c" onFocus="highlight(event)" size="1" name="ketUsaha">
     ...
     ?>
          ...
          <option>Lainnya</option>
            ...
            <td class="verdana10blk"><select name="sumberDanaLain2">
              ...
              <? 
	 $sbrLain=array(0=> "1/Bonus","2/Komisi","3/Penjualan Aset","4/Hasil Investasi","5/Hibah","6/Warisan","7/Lainnya","8/Tidak ada Penghasilan");
	 for ($kdlain=0; $kdlain<8; $kdlain++)
     {
   ...
   /* if($_GET['mode']=="tertpempol"){
	...
	?>
            <div align="left" style="color : black;">
              <input type="hidden" name="pempol" value="pempol">
              <input type="checkbox" name="pempol1" value="pempol1" onClick="CekSetuju(document.klien)" checked disabled>
              Pemegang Polis <br/ >
              <input type="checkbox" name="pempre" value="pempre" onClick="CekSetuju(document.klien)">
              Pembayar Premi <br/ >
              <input type="checkbox" name="tert" value="tert" onClick="CekSetuju(document.klien)">
              Tertanggung
              <div align="left"> Hubungan Dengan Tertanggung :
                <select class="a" size="1" name="kdhubungan" onFocus="highlight(event)">
                  <?php
