...
<tr><td align="right"><font face="Verdana" size="1" color="#0033CC">F1431</font></td></tr>
	...
	<font face="Verdana" size="2"><b>Komisi Agen Penutup <?echo ($noproposal==$nopertanggungan) ? "Proposal Nomor ".$prefixpertanggungan."-".$nopertanggungan : '';?></b> </font>
  <hr size=1>
	<table cellspacing="0" cellpadding="1" width="100%" class="tblisi">
	<tr>
	  <td class="verdana8blk"><? if ($show) { echo "No. Pertanggungan"; }?></td>
	  <td class="verdana8blk"><? if ($show) { echo ":"; }?></td>
	  <td class="verdana8blk"><? if ($show) { echo $prefix." - ".$noper; }?></td>
