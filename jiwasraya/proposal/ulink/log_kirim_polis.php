...
if (isset($_POST['kirim'])) {
      	...
      	if (($box_count)<1)
				...
				else
				{
    				foreach ($box as $dear) {
						$nomorpolis = $dear;
						$sql1="update $DBUser.tabel_ul_log_kirim_polis set tglkirim=sysdate where nomor_polis='$nomorpolis',userkirim=user and tglkirim is null";
						//echo $sql1."<br>";					
						$DB->parse($sql1);
						$DB->execute();
					}								
...
<font face="Verdana" size="2"><b>LOG KIRIM POLIS</b><br>
<!--Kantor : <? echo $kantor; ?>-->
<br />
...
<form name="getpolis" action="<?=$PHP_SELF;?>" method="post">
  ...
  <table border="0" width="100%" bgcolor="#DFDFBF" cellspacing="1" cellpadding="2">
    ...
    <td bgcolor="#C2CAED" rowspan="2" align="center"><font face="Verdana" size="1"><b>USER KIRIM</b></font></td>
...
$i=1;
  ...
  <tr>
    ...
    <td bgcolor="#FFFFFF" align="right"><font face="Verdana" size="1"><? echo $arr["USERKIRIM"]; ?></font></td>
...
?>
 <tr>
    ...
    <input name="kirim" type="submit" value="Kirim" /></font></td>
</tr>
</table>
</form>
