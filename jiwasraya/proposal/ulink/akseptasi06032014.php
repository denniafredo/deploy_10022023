...
<form name="xxx" method="POST" action="<?=$_SERVER['PHP_SELF']?>">
  <tr>
    ...
    <td bgcolor="#C2CAED" rowspan="2" align="center"><font face="Verdana" size="1"><b>UA PDB</b></font></td>
    <td bgcolor="#C2CAED" rowspan="2" align="center"><font face="Verdana" size="1"><b>UA SDB</b></font></td>
    	      ...
    	      "a.nopertanggungan,a.kdproduk,to_char(a.mulas,'DD/MM/YYYY') mulas,usia_th,".
    				...
    				"NVL((select sum(nilaipembayaran) from $DBUser.tabel_800_pembayaran g ".
					 ...
					 nopertanggungan=a.nopertanggungan and kdbenefit='PBD') PBD, ".
					  "(SELECT NILAIBENEFIT FROM $DBUser.TABEL_223_TRANSAKSI_PRODUK WHERE prefixpertanggungan=a.prefixpertanggungan and
					 nopertanggungan=a.nopertanggungan and kdbenefit='SPBD') spd, ".
	 ...
	 */
	 ?><!--</font></td> -->
		<? 
				...
				$cebox = "<input type=\"checkbox\" name=\"cheklist[]\" value=".$arr['PREFIXPERTANGGUNGAN'].$arr['NOPERTANGGUNGAN'].">".$arr["PREFIXPERTANGGUNGAN"]."-".$arr["NOPERTANGGUNGAN"]; 
...
//-------------------------------------------------- start medical --------------------------------
	$sql  = "select ".
          ...
          "where ".
                ...
                "and a.kdstatusfile = '1' ".
				"AND substr(a.kdproduk,1,3) in ('JL4') ".
      					"and a.kdstatusmedical='M' and not exists (select 'x' from $DBUser.TABEL_214_ACCEPTANCE_DOKUMEN
						where prefixpertanggungan=a.prefixpertanggungan ".
  ...
  <tr>
    ...
    <td width="10%" bgcolor="#FFFFFF" align="center"><font face="Verdana" size="1"><? echo $arr["USIA_TH"]; ?></font></td>
