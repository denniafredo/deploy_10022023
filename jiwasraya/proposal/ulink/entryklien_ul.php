...
<a class="verdana10blk"><b>KLIEN BARU</b></a>
	<?php 
	echo "<li><a class=verdana10blk href=http://$HTTP_HOST/$KAMP/proposal/ulink/editclntmain_link1.php>Entry Klien & Proposal</a></li>";
...
<?php 
	echo "<li><a class=verdana10blk href=http://$HTTP_HOST/$KAMP/proposal/ulink/entrykeymtc_link.php?mode=tertpempol>Pelihara Klien.</a></li>";	
	?>
<hr size="1">
