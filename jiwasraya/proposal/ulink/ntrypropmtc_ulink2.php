...
?>
  ...
  <tr>
    ...
    <tr>
   	 <td class="arial10" colspan="7">No Tertanggung Tambahan :   	 
		 <input type="text" readonly name="notertanggung2" size="10" maxlength="10"  onblur="javascript:validasi10(this.form.notertanggung);" class="a">
		  <input type="hidden" value="<?php echo $kantor.$nopertanggungan; ?>" name="nomorprp"><input type="button" value="Tert. Tambahan" name="cariTertT" class="buton" onClick="CariTT(this.form)"></td>
  ...
  <tr>
   	 ...
   	 <td width="25%" class="arial10"><input type="text" readonly name="nosp" size="11" maxlength="11" class="c" title="Nomor SPAJ" onFocus="highlight(event)"></td>
