...
$pdf->SetFont('Arial','B',9);
$pdf->Text('10'+$numindent,'95'+$numspace, "DENGAN DITERBITKANNYA  POLIS DUPLIKAT INI,");
$pdf->Text('10'+$numindent,'100'+$numspace, "MAKA POLIS  DENGAN  NOMOR   :  ".$prefix."-".$nopertanggungan);
$pdf->Text('10'+$numindent,'105'+$numspace, "YANG DITERBITKAN SEBELUMNYA DINYATAKAN");
$pdf->Text('10'+$numindent,'110'+$numspace, "TIDAK BERLAKU.");
...
$pdf->Output();
	...
	$sqlxx = "INSERT INTO $DBUser.TABEL_600_HISTORIS_MUTASI_PERT VALUES(SYSDATE, '$prefix','$nopertanggungan','28','CETAK POLIS DUPLIKAT','$userid',NULL,NULL)";
	$DB->parse($sqlxx);
	$DB->execute();
