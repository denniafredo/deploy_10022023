<?
 	...
 	include "../../includes/pertanggungan_tes.php";
...
// Tambahan oleh Ari per 04/12/2007 untuk Produk JS-LiNk (JL0/JL1) / Astha Plus (ATP) / Dwiguna Idaman (DGI) 
		...
		<? if($userid=="DEDI")
			$polisbaru_smart="$prefixpertanggungan-$nopertanggungan"; printf("<input type=\"button\" name=\"docpolis\" value=\"DOK. KLAIM HO\" onclick=\"NewWindow('popupdok.php?prefixpertanggungan=$prefixpertanggungan&nopertanggungan=$nopertanggungan','popupkomisi','700','400','yes');return false\" style=\"font-size: 8pt\">"); ?>
