...
if(isset($_POST['sendemail']))
{
	...
	{
		$NoPolis = $cheklist[$i];
		$sqlUpd = "UPDATE $DBUser.TABEL_200_PERTANGGUNGAN SET KDPERTANGGUNGAN='2', TGLKONVERSI=SYSDATE,
		           USERKONVERSI='$userid' WHERE 
				   PREFIXPERTANGGUNGAN='".substr(".$NoPolis.",1,2)."' AND
				   NOPERTANGGUNGAN ='".substr(".$NoPolis.",3,9)."'";
		$DB->parse($sqlUpd);
		$DB->execute();
		//echo $DB->error;
		//echo $sqlUpd;
  ...
  //ociexecute($sql);
		...
		//	 " akan kami sampaikan melalui agen penutup max 10 hari kerja. Utk info hub 021-500151";			 
...
<font face="Verdana" size="2"><b>DAFTAR KONVERSI POLIS</b><br>
Kantor : <?echo $kantor; ?>
...
*/
	...
	$sql= "select ".
    	      ...
    	      "a.nopertanggungan,a.kdproduk,to_char(a.mulas,'DD/MM/YYYY') mulas,".
				...
				"where ".
    				//"a.kdstatusemail='1' ".
					" substr(a.kdproduk,1,3) not in ('JL3x','JL4') ".
...
<table border="0" width="100%" cellspacing="1" cellpadding="2">
  <tr>
    ...
    <td align="right">
	  ...
	  <input type="submit" value="Konversi" name="sendemail">
		<!--
...
//}
 ?>
<tr>
<td><font face="verdana" size="2"><a href="../submenu.php?mnuinduk=A01">Menu Pertanggungan Baru</a></font></td>
