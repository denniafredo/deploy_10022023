...
<table border="0" cellpadding="1" cellspacing="1" width="700" class="tblborder">
  ...
  <tr>
   	 ...
   	 <td width="25%" class="arial10"><input type="text" readonly name="nosp" size="11" maxlength="11" class="c" title="Nomor SPAJ" onFocus="highlight(event)" value="<? echo $nosp; ?>">&nbsp;<input type="button" value="No.SPAJ"  onclick="NewWindow('ulink/spajlist.php','popuppage',800,600,1);" class="buton"></td>
