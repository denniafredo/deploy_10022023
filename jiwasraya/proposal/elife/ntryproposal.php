...
<head>
    ...
    <script language="JavaScript" type="text/javascript" src="entryprop.js"></script>
    <script language="JavaScript" type="text/javascript" src="../../includes/highlight.js"></script>
    <script language="JavaScript" type="text/javascript" src="../../includes/jquery.min.js" ></script>
    <script language="JavaScript" type="text/javascript">
        function cekbentukdataklien(nospajkodebooking) {
            $("#pesan").text('');
            $.ajax({
                type : 'post',
                url : "ajaxbentukdataspajklien.php",
                data : "nospaj="+nospajkodebooking+"&noagen="+$("input[name='noagen']").val(),
                ...
                success : function(data) {
                    ...
                    $.ajax({
                        ...
                        data : "nospaj="+nospajkodebooking,
                        beforeSend: function() {
                            $('#loaderttg').show();
                        },
                        success : function (data) {
                            $('#loaderttg').hide();
                            $("input[name='notertanggung']").val(data);
                        }
                    });
                }
            });
...
<div align="center">
    <br>
    <table border="" cellpadding="1" cellspacing="1" width="900" class="tblborder">
        <tr>
        ...
        <tr>
            ...
            <td width="100%"> <!-- tempat tabel -->
                ...
                <form name="ntryprop" method="post" action="insprop.php?<? echo $SID; ?>" onSubmit="return OnSumbit(document.ntryprop);disableForm(this);">
                    ...
                    <input type="hidden" name="pariabel" placeholder="pariabel">
                    <input type="hidden" name="usia_lpp" placeholder="usia_lpp">
                    ...
                    <table border="0" width="100%" cellspacing="0" cellpadding="1" class="tblisi">
                        ...
                        <tr>
                            ...
                            <td width="25%" class="arial10">
                                <input type="text" readonly name="nosp" size="11" maxlength="11" class="a" title="Nomor SPAJ" onFocus="highlight(event)" value="<? echo $nosp; ?>">&nbsp;
                                <input type="button" value="Kode Booking"  onclick="openWin('popup_elife.php');" class="buton">
                        ...
                        <tr>
                            ...
                            <td class="arial10">
                                ...
                                <input type="button" value="Cari Klien" name="cari" class="buton" onClick="Cari(this.form);" onBlur="javascript:TanggalMulas()" >
...
-->
    ...
    <table width="900">
        <tr>
            <td width="50%" class="arial10"><a href="#" onclick="javascript:history.go(-1)">Back</a></td>
            <td width="50%" class="arial10" align="right"><a href="../../mnuptgbaru.php">Menu Pertanggungan Baru</a></td>
        </tr>
    </table>
</body>
</html>