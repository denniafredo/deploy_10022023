  ...
  $tglbp3 = ($tglbp3=='NULL') ? 'NULL' : "to_date('".$tglbp3."','DD/MM/YYYY')";
	...
	$sql="insert into $DBUser.tabel_200_temp(prefixpertanggungan,kdpertanggungan,tglakhirpremi,gadaiotomatis,".
       ...
       "kdvaluta,juamainproduk,premi1,kdcarabayar,indexawal,premi2,nopenagih,kdstatusfile,".
			 "noagen,tglrekam,userrekam,tglupdated,userupdated,kdstatusmedical,nopemegangpolis,nopembayarpremi,risk) ".
       ...
       "'$kdvaluta',$juamainproduk,$premi1,'$kdcarabayar',$indexawal,$premi2,$nopenagih,'1',".
			 "$noagen,sysdate,user,sysdate,user,'$kdstatusmedical','$nopemegangpolis','$nopembayarpremi',$risk)";
	//echo $sql;
	$DB->parse($sql);
	$DB->execute();
...
<form action="simulasi_benefit.php?<?echo $SID; ?>" method="post" name="hpj">
<p>
