...
<?
  if (!$nama) {
   ...
   $dannama = "and b.namaklien1 like '".strtoupper($nama)."%' "; 
	...
	if($modeshow=="all") {
		...
		else
		{
			if (substr($prd,0,3)=='JL2' || substr($prd,0,3)=='JL3') {
				...
				$pngautodb = "and (b.namaklien1 LIKE 'PENAGIH%') and not(b.namaklien1 LIKE 'PENAGIH KHUSUS%') ";
			}
		}
	}
	...
	if (substr($prd,-3)=='BTN') {
				$pngautodb="and b.namaklien1 LIKE 'PENAGIH AUTODEBET BTN%' ";
				$pskg = "and nvl(a.penagihskg,'0')='0' ";
	}
...
<?
	...
	/*if ($kantor=="AC") { 
		echo "<td class=arial10ungu align=center>".
				 "<a href=\"#\" onclick=\"javascript:".
				 "window.opener.document.".$formname.".".$fieldname.".value='0000050143';".
				 "window.close();\" >0000050143</a></td>".
    		 "<td  class=arial10ungu>PENAGIH TERMINAL KP</td>".
    		 "<td  class=arial10ungu align=center>KP</td>".
    		 "<td  class=arial10ungu align=center>KP</td>".
    		 "</tr>";}*/
?>
</table>
