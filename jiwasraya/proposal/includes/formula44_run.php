  ...
  var $jua;
	...
	function Formula($userid="",$passwd="",$prefix="",$nopert="") {
	  $this->prefix=$prefix;
		...
		$sql="select a.juamainproduk, a.usia_th, a.usia_bl, a.kdproduk, a.kdstatusmedical, a.kdvaluta,".
				 ...
				 "d.namacarabayar, d.kdjeniscb ".
		     "from  $DBUser.tabel_100_klien b,$DBUser.tabel_200_temp a,$DBUser.tabel_246_produk_basis c,$DBUser.tabel_305_cara_bayar d ".
				 "where a.prefixpertanggungan='$prefix' and a.nopertanggungan='$nopert' ".
