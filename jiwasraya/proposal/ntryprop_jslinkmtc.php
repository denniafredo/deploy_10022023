<? 
  ...
  include "../../includes/database.php";
	include "../../includes/propmtc_switching.php";
...
<!--<body OnLoad="Awal();CallBenef();document.ntryprop.premijua.value='premi'; JuaPremi(); document.ntryprop.submit.disabled=true;document.ntryprop.kdbank.disabled=true;document.ntryprop.norekening.disabled=true;" topmargin="0">
-->
<body OnLoad="Awal();CallBenef();JuaPremi(); document.ntryprop.submit.disabled=true;document.ntryprop.kdbank.disabled=true;document.ntryprop.norekening.disabled=true;" topmargin="0">
<?
...
<table border="0" cellpadding="1" cellspacing="1" width="90%" class="tblframe">
	<tr>
		<td class="tblhead" align="center" width="100%"><b>EDIT PROPOSAL JS.LINK (SWITCHING) NO : <?echo $nopertanggungan;  ?></b></td>
  </tr>
	<tr>
