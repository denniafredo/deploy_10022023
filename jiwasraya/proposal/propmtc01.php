...
<form name="propmtc01" action="propmtc10.php" onSubmit="return submitForms()">
<tr class="arial10">
  <td>Mode Operasi</td>
  <td>:</td>
...
<tr class="arial10">
  <td>Nomor Proposal</td>
	<td>:</td>
	<td><input name="nopertanggungan" class="c" type="text" size="9" maxlength="9" onFocus="highlight(event)" onBlur="javascript:validasi(this.form.nopertanggungan);">
	 <? 
