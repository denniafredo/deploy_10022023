<?
  ...
  //echo $FM->kdbasispremi;
	...
	/*----------------------- start top up -------------------*/
	/*
	function TopUp($DBX,$prefix,$noper,$noagen,$kdproduk,$premitopup,$minpremitopup,$actionbutton){
  ...
  $DB->execute();
	...
	$sql="select kdproduk from $DBUser.tabel_200_temp where ".
