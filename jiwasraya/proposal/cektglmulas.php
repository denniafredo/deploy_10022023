...
{
  if($kdproduk=="AEP" || $kdproduk=="AEP1" || $kdproduk=="AEP2" || $kdproduk=="AEP3" || $kdproduk=="AI0" || $kdproduk=="AIP" || $kdproduk=="ASI" || $kdproduk=="ASP"  || $kdproduk=="PAA"  || $kdproduk=="PAB" || substr($kdproduk,0,3)=="JL2")
	{
   ...
   echo "<body onload=\"javascript:window.opener.document.ntryprop.lamapembpremi_th.value='5';window.close();\">";
  } // Akhir Oleh Dedi 8/7/2011
   elseif(substr($kdproduk,0,6)=="JSPEI5") //Oleh Dedi 8/7/2011
	{
   echo "<body onload=\"javascript:window.opener.document.ntryprop.mulas.value='$mulas';window.close();\">";
  } 
  else
