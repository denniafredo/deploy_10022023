...
//	  $DB=new database($userid, $passwd, $DBName);
		$ary ="select prefixpertanggungan,nopertanggungan,kdstatusemail,kdbank, keterangan from $DBUser.tabel_200_pertanggungan where ".
...
//Untuk update dapat dilakukan ketika sudah send email dan keterangan pending tidak kosong - Teguh 11/11/2019
