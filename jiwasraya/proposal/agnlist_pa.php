...
?>	
  ...
  <table width="100%" cellpadding="4" cellspacing="0" >
	...
	?>
	<b>Daftar Agen Kantor <?=$kdkantor;?></b><br>
	<?
...
<?
	//$a="<td align=center><a href=\"#\" onclick=\"javascript:window.opener.document.".$formname.".".$fieldname.".value='".$arr["NOAGEN"]."';window.close();\" >".$arr["PREFIXAGEN"]."-".$arr["NOAGEN"]."</a>
	$i=0;
	while($arr=$DB->nextrow()) {
	  //include "../../includes/belang.php";
		echo "<tr bgcolor=".($i%2 ? "#d3d3d3" : "#97c8e1").">";
		
		$a="<td align=center><a href=\"#\" onclick=\"javascript:".
					 "window.opener.document.frm.penutup.value='".$arr["NOAGEN"]."';\n".
					 "window.opener.document.frm.namapenutup.value='".$arr["NAMAKLIEN1"]."';\n".
					 "window.close();\">".$arr["PREFIXAGEN"]."-".$arr["NOAGEN"]."</a>
		</td>".
