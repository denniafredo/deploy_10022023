...
//if($_POST['sbmt'] == '1'){
	...
	if(substr($arsms["KDPRODUK"],-3)!="BTN"){	
		...
		//===================SMS AGEN================
		$msgagn="Harap infokan CPP a/n ".$arsms["NAMA"]." utk membayar premi melalui cara berikut goo.gl/mH77Fq dg kode bayar ".$arsms["H2H"].", sebesar Rp ".$arsms["PREMI"]." paling lambat ".$arsms["EXPDATE"];
		...
		$mysqlins="insert into smsjiwasraya (PHONE, MESSAGE,JENIS_SMS,KODE_KANTOR,NAMA_DIVISI,NO_POLIS) VALUES('".$arsms["PHONEAGEN"]."','".$msgagn."','TAGIHAN BP3','".$arsms["PREFIXPERTANGGUNGAN"]."','PENJUALAN','".$arsms["NOPOLIS"]."')";
		 //echo $mysqlins;
		mysql_query($mysqlins);
		}
	}
...
/*ga jadi karena berat loading nya : 23 jul 2013/ iie*/
    ...
    <td bgcolor="#FFFFFF" align="center" valign="center">
        ...
        <button type="button" onClick="NewWindow('akseptasi_pending.php?<?="prefixpertanggungan=$arr[PREFIXPERTANGGUNGAN]&nopertanggungan=$arr[NOPERTANGGUNGAN]";?>','popuppage','620','500','yes')" style="padding:0px;margin:0px;">
