  ...
  switch ($premijua) {
    ...
    # 
		...
		*/
		...
		if($kdproduk=="JSP" || $kdproduk=="JSPS"){ // hitung ulang komisi agen karena premi dipotong waiver
  ...
  foreach ($result as $foo => $arr) {
    ...
    if($kdbenefit=="RISKER"){
	  ...
	  #-------------------------------------- end resiko kerja -----------------------------
		...
		} elseif (substr($arr["KDBENEFIT"],0,2)=="CP" || $arr["KDBENEFIT"]=="PA" || $arr["KDBENEFIT"]=="WAIVER" || $arr["KDBENEFIT"]=="CACAD" || $arr["KDBENEFIT"]=="CI" || $arr["KDBENEFIT"]=="TERM") {
    ...
    // tidak ada pengurangan premi rider pada investasi
		...
		*/
		...
		if((substr($arr["KDBENEFIT"],0,3)=="CPB" || substr($arr["KDBENEFIT"],0,3)=="CPM" || $arr["KDBENEFIT"]=="PA" || $arr["KDBENEFIT"]=="WAIVER" || $arr["KDBENEFIT"]=="CACAD" || $arr["KDBENEFIT"]=="CI" || $arr["KDBENEFIT"]=="TERM") && $hasilpremi > 0) {
 ...
 //echo $premisubmit;
            ...
            // tidak ada pengurangan premi rider pada investasi
             ...
             $DB->commit;
					 ...
					 if($kdproduk=="JSDG0" || $kdproduk=="JSDG0" || $kdproduk=="JSDM0" || $kdproduk=="JSDMPP" || $kdproduk=="JSP" || $kdproduk=="JSPS" || $kdproduk=="JSSHTT" || $kdproduk=="P30" ||$kdproduk=="SC5" || $kdproduk=="SC6" || $kdproduk=="ST5" || $kdproduk=="ST6"){
  					 $sql = "select sum(premi) as premirider ".
