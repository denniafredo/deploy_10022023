...
<font face="Verdana" size="2"><b>DAFTAR APPROVAL PROPOSAL BELUM BAYAR</b><br>
Kantor : <?echo $kantor; ?>
...
<form name="xxx" method="POST" action="<?=$_SERVER['PHP_SELF']?>">
  <tr>
    ...
    <td bgcolor="#C2CAED" rowspan="2" align="center"><font face="Verdana" size="1"><b>TGL APPROVAL</b></font></td>
	...
	$sql= "select ".
    	      ...
    	      "a.nopertanggungan,a.kdproduk,to_char(a.mulas,'DD/MM/YYYY') mulas,a.usia_th,".
                   ...
                   WHERE   prefixpertanggungan = a.prefixpertanggungan
                           AND nopertanggungan = a.nopertanggungan) TGLAPPROVE ".
				"from ".
				    "$DBUser.tabel_200_pertanggungan a ".
				"where ".
    				"substr(a.kdproduk,-3) in ('BTN') ".
...
//	echo "Ari ".$nilairp." - ".$PERT->premi1." - ".$TR->Kurs($PERT->valuta,$tglbp3);
  ...
  <tr>
    ...
    <td bgcolor="#FFFFFF" align="center"><font face="Verdana" size="1"><? echo $arr["TGLAPPROVE"];?></font></td>
