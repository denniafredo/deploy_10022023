                            ...
                            <form id="form-menu" class="form-horizontal" role="form" action="<?="$this->url/save-menu"?>" method="post">
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <select name="idparent" class="form-control"></select>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">Nama Menu <span class="required">*</span></label>
                                        <div class="col-md-9">
                                            <input type="text" name="menu" class="form-control" placeholder="Beranda" autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">URL</label>
                                        <div class="col-md-9">
                                            <input type="text" name="url" class="form-control" placeholder="controller/function/parameter" autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">Icon</label>
                                        <div class="col-md-9">
                                            <input type="text" name="icon" class="form-control" placeholder="fa fa-nama-icon / fa icon-xxxx" autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">Keterangan</label>
                                        <div class="col-md-9">
                                            <input type="text" name="keterangan" class="form-control" placeholder="Role Agen / Role Cabang / Role Wilayah" autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <div class="icheck-inline">
                                                <label><input type="radio" name="kdstatus" checked class="icheck" value="1"> Aktif </label>
                                                <label><input type="radio" name="kdstatus" class="icheck" value="0"> Non Aktif </label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
