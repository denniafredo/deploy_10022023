            ...
            <div class="portlet light">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-green-sharp bold uppercase">Top 10 Rekrut <?=date('Y')?></span>
                    </div>
                </div>
                    ...
                    <div class="table-scrollable">
                        <table class="table table-bordered table-hover" style="font-size: 12px;">
                            ...
                            <tr>
                                ...
                                <th style="text-align:center; vertical-align:middle;">Jml Rekrut</th>
                                <th style="text-align:center; vertical-align:middle;">Jml Premi</th>
                            </tr>
                            </thead>
                            <tbody>
                            <?php foreach($toprekrut as $i => $v) { ?>
                                <tr>
                                    <td align="center"><?=$i+1?></td>
                                    <td align="center"><?=$v['NOAGENREKR']?></td>
                                    <td><?=$v['NAMAKLIEN1']?></td>
                                    <td><?="$v[NAMAKANTOR]"?></td>
                                    <td align="center"><?=$v['JMLREKRUT']?></td>
                                    <td align="right"><?=number_format(str_replace(",", ".", $v['JMLPREMIREKR']), 2, ",", ".")?></td>
                                </tr>
                            <?php } ?>
                            </tbody>
                        </table>
