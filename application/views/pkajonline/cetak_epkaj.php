										...
										<table class="MsoTableGrid" border="0" cellspacing="0" cellpadding="0" width="615" style="border-collapse: collapse; border: medium none">
										  ...
										  <?=$tahun;?>
											...
											<tr>
												...
												<?php //crf 06/06/2022
												if($row["PERIODE_PEMBERITAHUAN"] == '1' || $row["PERIODE_PEMBERITAHUAN2"] == '1' && $row["KDJABATANAGEN"] != '26' ) { ?>
												...
												<?php } //crf untuk 22/07/2022
												else if (($row["PERIODE_PEMBERITAHUAN"] == '3' || $row["PERIODE_PEMBERITAHUAN2"] == '3') && $row["KDJABATANAGEN"] != '26') { ?> 
													bertindak dalam jabatannya tersebut berdasarkan Surat Kuasa PT Asuransi Jiwa IFG, 
													Nomor 256/SKU/AJIFG/U/VIII/2022 tanggal 01 Agustus 2022, dan karenanya berwenang 
													bertindak untuk dan atas nama PT Asuransi Jiwa IFG, berkedudukan dan berkantor di 
													Jakarta Selatan sesuai dengan Anggaran Dasar PT Asuransi Jiwa IFG yang termuat dalam 
													Akta Nomor 39 tanggal 22 Oktober 2020 yang dibuat dihadapan Notaris Hadijah, S.H., yang 
													telah disahkan oleh Kementerian Hukum dan Hak Asasi Manusia Republik Indonesia 
													melalui Surat Keputusan Nomor AHU-0055113.AH.01.01.TAHUN 2020 tanggal 22 Oktober 
													2020, sebagaimana telah diubah terakhir dengan Akta Pernyataan Keputusan Para 
													Pemegang Saham PT Asuransi Jiwa IFG Nomor 36 tanggal 16 November 2021 dan telah 
													dicatat dalam Keputusan Menteri Hukum dan Hak Asasi Manusia Republik Indonesia sesuai 
													Surat Nomor AHU-0067149.AH.01.02.TAHUN 2021 tanggal 25 November 2021, 
													selanjutnya disebut:
												<?php } else { ?>	
											...
											<tr>
												<td width="615" colspan="11" valign="top" style="width: 461.4pt; padding-left: 5.4pt; padding-right: 5.4pt; padding-top: 0in; padding-bottom: 0in">
													...
													<span style="font-family: Arial,sans-serif">
														...
														<ol type="A">
															<li>PERUSAHAAN adalah badan usaha yang bergerak di bidang asuransi jiwa yang bekerja sama dengan AGEN dengan tujuan ingin meningkatkan pemasaran dan pelayanan asuransi jiwa dan kesehatan untuk masyarakat melalui pelayanan yang baik, mudah, dan efisien sesuai ketentuan peraturan perundang-undangan yang berlaku;</li>
															<li>AGEN telah mengikuti proses rekrutmen yang hasilnya memenuhi syarat dan kriteria sebagai AGEN sesuai ketentuan di PERUSAHAAN dan telah memiliki sertifikasi dan lisensi keagenan yang diterbitkan oleh Asosiasi Asuransi Jiwa Indonesia (“AAJI”).</li>
														</ol>
														<br/><br/>
													</span>
												</td>
											...
											<tr>
												...
												<td colspan="4" valign="top" style="width: 140px; padding-left: 5.4pt; padding-right: 5.4pt; padding-top: 0in; padding-bottom: 0in">
												<p class="MsoNormal" style="text-align: justify; margin-left: -5.4pt">
												<span lang="IN" style="font-family: Arial,sans-serif">Sertifikasi dan Lisensi Keagenan </span>		</td>
												<td width="16" valign="top" style="width: 12.0pt; padding-left: 5.4pt; padding-right: 5.4pt; padding-top: 0in; padding-bottom: 0in">
												<p class="MsoNormal" style="text-align: justify">
												<span style="font-family: Arial,sans-serif">:</span></td>
												<td width="432" colspan="5" valign="top" style="width: 324.1pt; padding-left: 5.4pt; padding-right: 5.4pt; padding-top: 0in; padding-bottom: 0in">
												<p class="MsoNormal" style="text-align: justify; margin-left: -5.4pt; margin-right: -5.4pt; margin-top: 0in; margin-bottom: .0001pt">
												<span lang="IN" style="font-family: Arial,sans-serif">adalah suatu penetapan yang diterbitkan oleh AAJI yang wajib dimiliki oleh AGEN sebelum melakukan pemasaran dan/atau penjualan produk asuransi jiwa.</span></td>
											</tr>
											<tr>
												<td valign="top" style="width: 15px; padding-left: 5.4pt; padding-right: 5.4pt; padding-top: 0in; padding-bottom: 0in">
												<p class="MsoNormal" style="text-align: justify">
											...
											<tr>
												...
												<td colspan="8" valign="top" style="width: 538px; padding-left: 5.4pt; padding-right: 5.4pt; padding-top: 0in; padding-bottom: 0in">
												<p class="MsoNormal" style="text-align: justify; margin-left: -5.4pt; margin-right: -5.4pt; margin-top: 0in; margin-bottom: .0001pt">
												<span lang="IN" style="font-family: Arial,sans-serif">memperoleh informasi yang benar, tepat, dan akurat mengenai pemasaran Produk yang telah dilakukan AGEN, termasuk informasi lainnya apabila diperlukan; dan</span>	</td>
											</tr>
											<tr>
												<td valign="top" style="width: 15px; padding-left: 5.4pt; padding-right: 5.4pt; padding-top: 0in; padding-bottom: 0in">
												<p class="MsoNormal" style="text-align: justify">
											...
											<tr style="height: 17.75pt">
												...
												<img width="150" src='<?=base_url("generate/qrcode?kode=$row[QRPERUSAHAAN]&size=4")?>' >
												<br>
												<?=$row["NAMABM"];?></span></td>
												...
												<p class="MsoNormal" align="center" style="text-align: center; margin-left: -5.4pt; margin-right: -5.4pt; margin-top: 0in; margin-bottom: .0001pt">
												<span lang="IN" style="font-family: Arial,sans-serif">
												<img width="150" src='<?=base_url("generate/qrcode?kode=$row[QRAGEN]&size=4")?>' >
												<br>
