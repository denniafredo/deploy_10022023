<div class="container">
    ...
    <ul class="page-breadcrumb breadcrumb">
        ...
        <?php $cabang = rawurlencode($this->input->get('txtCabang')); $tglawal = rawurlencode($this->input->get('txtTglAwal')); $tglakhir = rawurlencode($this->input->get('txtTglAkhir')); ?>
        <li><a href="<?="$this->url/se_wilayah?txtTglAwal=$tglawal&txtTglAkhir=$tglakhir"?>">Pendapatan Agen Se-Wilayah </a><i class="fa fa-circle"></i></li>
                ...
                <div class="portlet-body">
                    <div class="form-group">
                        <div class="col-md-12 text-right">
                            <a href="<?="$this->url/se_wilayah?txtCabang=$cabang&txtTglAwal=$tglawal&txtTglAkhir=$tglakhir"?>" class="btn btn-circle btn-sm purple-wisteria tooltips" data-container="body" data-placement="top" data-original-title="<?=C_BUTTON_BACK?>">
