                ...
                <div class="portlet-body">
                    ...
                    <div class="table-scrollable">
                        <table class="table table-bordered table-hover" style="font-size: 12px;">
                            ...
                            $cabang = rawurlencode($this->input->get('txtCabang'));
                            $total = 0;
                            foreach($pendapatan as $i => $v) {
                                ...
                                <tr>
                                    ...
                                    <td align="center">
                                        <a href="<?="$this->url/agen-se-wilayah?txtCabang=$cabang&id=$v[NOAGEN]&txtTglAwal=$tglawal&txtTglAkhir=$tglakhir"?>" class="btn btn-xs blue tooltips" data-container="body" data-placement="top" data-original-title="<?=C_BUTTON_DETAIL?>">
