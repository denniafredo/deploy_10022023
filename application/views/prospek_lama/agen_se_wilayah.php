                ...
                <div class="portlet-body">
                    ...
                    <div class="table-scrollable">
                        <table class="table table-bordered table-hover" style="font-size: 12px;">
                            ...
                            <tbody>
                            <?php foreach($prospekwilayah as $i => $v) { ?>
                                <tr>
                                    <td align="center"><?=$v['NO']?></td>
                                    <td><?="$v[KDKANTOR] - $v[NOAGEN]"?></td>
                                    <td><?=$v['NAMAKLIEN1']?></td>
                                    ...
                                    <td align="center">
                                        <?php if ($v['JMLPROSPEK'] > 0) { ?>
                                            <a href="<?="$this->url/agen-se-wilayah-detail?ktr=".$this->input->get('ktr')."&id=".rawurlencode($v['NOAGEN'])."&nm=".rawurlencode(strtolower($v['NAMAKLIEN1']))?>" class="btn btn-xs yellow-gold tooltips btn-edit" data-container="body" data-placement="top" data-original-title="<?=C_BUTTON_VIEW?>"><i class="fa fa-search-plus btn-xs-tbl"></i></a>
                                        <?php } else {
                                            echo "N/A";
                                        } ?>
                                    </td>
