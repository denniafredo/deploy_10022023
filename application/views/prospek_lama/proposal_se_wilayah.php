<div class="container">
    ...
    <ul class="page-breadcrumb breadcrumb">
        ...
        <li>
            <a href="<?="$this->url/agen-se-wilayah-detail?ktr=".$this->input->get('ktr')."&id=".$this->input->get('id')."&nm=".rawurlencode($this->input->get('nm'))?>"><?=ucwords(str_replace('-', ' ', $this->input->get('nm')))?></a>
            <i class="fa fa-circle"></i>
        </li>
        <li class="active">
            <?=$this->template->title?>
            ...
            <div class="portlet light">
                ...
                <div class="portlet-body">
                    <div class="btn-group btn-group-solid pull-right">
                        <a href="<?="$this->url/agen-se-wilayah-detail?ktr=".$this->input->get('ktr')."&id=".$this->input->get('id')."&nm=".rawurlencode($this->input->get('nm'))?>" class="btn purple-wisteria tooltips" type="button" data-container="body" data-placement="top" data-original-title="<?=C_BUTTON_BACK?>"><i class="fa fa-undo"></i></a>
                    </div>
                            ...
                            <?php foreach($proposal as $i => $v) { ?>
                                <tr>
                                    ...
                                    <td class="text-center" width="76">
                                        <a href="<?="$this->url/follow-up-se-wilayah?ktr=".$this->input->get('ktr')."&id=".$this->input->get('id')."&nm=".rawurlencode($this->input->get('nm'))."&np=".$this->input->get('np')."&pr=$v[NOPROPOSAL]"?>" class="btn btn-xs blue tooltips" style="margin:0px;" data-container="body" data-placement="top" data-original-title="Follow Up"><i class="fa fa-search-plus btn-xs-tbl"></i></a>
