                    ...
                    <form>
                        <div class="form-group">
                            ...
                            <span class="input-group-btn">
                                ...
                                <a href="<?="$this->url/binaan-detail?id=".$this->input->get('id')."&nm=".rawurlencode($this->input->get('nm'))?>" class="btn grey-cascade tooltips" data-container="body" data-placement="top" data-original-title="<?=C_BUTTON_REFRESH?>"><i class="fa fa-refresh"></i></a>
                                <a href="<?="$this->url/binaan"?>" class="btn purple-wisteria tooltips" type="button" data-container="body" data-placement="top" data-original-title="<?=C_BUTTON_BACK?>"><i class="fa fa-undo"></i></a>
                            </span>
                            </div>
                        </div>
                    </form>
                            ...
                            <?php foreach($prospek as $i => $v) { ?>
                                <tr>
                                    ...
                                    <td class="text-center" width="38">
                                        <a href="<?="$this->url/proposal-binaan?id=".$this->input->get('id')."&nm=".rawurlencode($this->input->get('nm'))."&np=$v[NOPROSPEK]"?>" class="btn btn-xs blue tooltips" style="margin:0px;" data-container="body" data-placement="top" data-original-title="Proposal"><i class="fa fa-search-plus btn-xs-tbl"></i></a>
                                    </td>
                                </tr>
                            <?php } ?>
                            </tbody>
