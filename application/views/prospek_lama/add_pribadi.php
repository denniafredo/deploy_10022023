                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <div class="input-icon right">
                                                    <i class="fa"></i>
                                                    <input type="text" name="txtNamaLengkap" class="form-control" placeholder="IFG Agency Information Management">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <div class="input-icon right">
                                                    <i class="fa"></i>
                                                    <select name="kdPekerjaan" id="kdPekerjaan" class="form-control">
                                                        <option value="">Silahkan Pilih</option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <div class="input-icon right">
                                                    <i class="fa"></i>
                                                    <input type="text" id="idPhone2" name="txtPhone2" class="form-control" placeholder="08123456789">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <input type="text" id="idPhone1" name="txtPhone1" class="form-control" placeholder="0211500151">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <div class="input-icon right">
                                                    <i class="fa"></i>
                                                    <input type="text" id="idKTP" name="noKTP" class="form-control" size="16" placeholder="3377150319760001">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                *No KTP unik
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <div class="input-icon right">
                                                    <i class="fa"></i>
                                                    <input type="email" name="txtEmail" class="form-control" placeholder="Email@ifg.co.id">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
