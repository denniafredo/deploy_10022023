                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <div class="input-icon right">
                                                    <i class="fa"></i>
                                                    <input type="text" name="txtPhone2" class="form-control" value="<?=$prospek['HP']?>" placeholder="08123456789">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <input type="text" name="txtPhone1" class="form-control" value="<?=$prospek['TELP']?>" placeholder="0211500151">
                                            </div>
                                        </div>
                                        <div class="form-group">
