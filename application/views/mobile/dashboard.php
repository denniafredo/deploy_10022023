...
<div style="background: #3b434c;color: #a2abb7; position: fixed; top: 0; left: 0; z-index: 1; width: 100%;">
    <a href="<?=$this->url?>" class="btn btn-sm blue" style="float: left;">
        JAiM <i class="icon-home"></i>
    </a>

    <!--a href="javascript:;" class="btn btn-sm blue" style="float: right;">
        &nbsp;&nbsp;JAiM&nbsp;<i class="icon-home">
        </i>
    </a-->
</div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet light">
                        <div class="portlet-body">
                            <center>
                                <div class="caption">
                                    <img src="<?=base_url('asset/avatar/'.$this->session->AVATAR)?>" class="img-responsive img-circle" alt="">
                                </div>
                            ...
                            <div class="profile-usermenu">
                                <ul class="nav">
                                    <li class="">
                                        <!--<a href="<?="$this->url/ilustrasi"?>"><i class="icon-notebook"></i>Brosur Produk</a>-->
                                    </li>
                                    <li>
                                        <!--a href="<?="$this->url/simulasi"?>"><i class="icon-book-open"></i>Simulasi (POS Online)</a-->
					<a href="<?=base_url("prospek/pribadi")?>"><i class="icon-book-open"></i>Simulasi (POS Online)</a>
                                    </li>
                                    <li>
                                        <a href="<?=base_url("spaj")?>"><i class="icon-note"></i>SPAJ Online</a>
                                    </li>
                                    <li>
                                        <a href="<?="$this->url/checkin"?>"><i class="icon-book-open"></i>Check-In</a>
                                    </li>
                                    <li>
                                        <!--<a href="<?="$this->url/others"?>"><i class="icon-tag"></i>After Sales Service</a>-->
                                    </li>
                                    <li>
                                        <a href="<?="$this->url/logout-proses"?>"><i class="fa fa-sign-out"></i>Logout</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
