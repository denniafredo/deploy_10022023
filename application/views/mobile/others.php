...
<div style="background: #3b434c;color: #a2abb7; position: fixed; top: 0; left: 0; z-index: 1; width: 100%;">
    ...
    <span class="input-group-btn">
        <a href="<?=$this->url?>" class="btn btn-sm purple-wisteria tooltips pull-right">
                                        ...
                                        <div class="portlet light">
                                            <div class="portlet-title">
                                                <div class="caption">
                                                    ...
                                                    <span class="caption-subject font-green-sharp bold uppercase">Berita Terbaru</span>
                                                </div>
                                            </div>
                                            <div class="portlet-body">

                                                <?php foreach ($berita as $i => $v) { ?>
                                                    <div class="col-md-4">
                                                        <div class="news-blocks">
                                                            <h3>
                                                                <a href="http://www.jiwasraya.co.id/id/berita/berita-asuransi/<?=preg_replace("/[^a-zA-Z0-9]+/", "-", strtolower($v['JUDUL']))?>" target="_blank"><?=$v['JUDUL']?> </a>
                                                            </h3>
                                                            <div class="news-block-tags">
                                                                <em><?=date('d/m/Y', $v['TGLREKAM'])?></em>
                                                            </div>
                                                            <p>
                                                                <img class="news-block-img pull-right" src="<?=$v['GAMBAR']?>" alt=""><?=$v['DESKRIPSI']?>...
                                                            </p>
                                                            <a href="http://www.jiwasraya.co.id/id/berita/berita-asuransi/<?=preg_replace("/[^a-zA-Z0-9]+/", "-", strtolower($v['JUDUL']))?>" class="news-block-btn">
