...
<div style="background: #3b434c;color: #a2abb7; position: fixed; top: 0; left: 0; z-index: 1; width: 100%;">
    ...
    <span class="input-group-btn">
        ...
        <a href="#" onClick="javascript:history.go(-1)" class="btn btn-sm purple-wisteria tooltips pull-right" style="height:60px;width:60px;">
            <br /><i class="icon-action-undo"></i>
        </a>
    </span>
</div>
<br /><br /><br />
                                        ...
                                        <form id="form-prospek" class="form-horizontal" role="form" action="<?="$this->url/simulasi-proses"?>" method="post">
                                            <div class="form-body">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="input-icon right">
                                                    	<i class="fa"></i>
                                                    <input type="text" name="txtTglLahir" class="form-control form-control-inline input-medium date-picker" data-date-format="dd/mm/yyyy" placeholder="31/12/2015" readonly />
                                                </div>
                                            </div>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="input-icon right">
                                                            <i class="fa"></i>
                                                            <input type="text" name="txtPhone1" class="form-control" placeholder="0213845031">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <input type="text" name="txtPhone2" class="form-control" placeholder="0211500151">
                                                    </div>
                                                </div>
                                                <div class="form-group">
