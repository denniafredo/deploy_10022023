...
<head>
    <meta charset="utf-8">
    <title>JAIM | ULANG TAHUN NASABAH</title>
    ...
    <link rel="shortcut icon" href="favicon.ico">
        ...
        <div id="responsive" class="modal fade" tabindex="-1" data-width="760" >
            <div class="modal-header">
                ...
                <h4 class="modal-title">No Klien: <span id="noKlien"></span></h4>
            </div>
                    ...
                    <div class="col-md-12">
                        <div class="well">
                            <address>
                                ...
                                Alamat: <span id="txtAlamat"></span><br/>
                                Usia: <span id="txtUsia"></span><br/>
                                Tgl Lahir: <span id="txtTglLahir"></span><br/>
                                Telp: <span id="txtTelp"></span><br/>
                            </address>
                        </div>
                    </div>
                </div>
            ...
            initCalendar: function() {
                ...
                $('#calendar').fullCalendar({ //re-initialize the calendar
                    ...
                    events: [
                        ...
                        {
                            title: "<?="$v[NAMAKLIEN1]"?>",
                            start: new Date(<?=$v['YNOW']?>, <?=$v['MLAHIR']?> -1, <?=$v['DLAHIR']?>, 07, 00, 00),
                            end: new Date(<?=$v['YNOW']?>, <?=$v['MLAHIR']?> -1, <?=$v['DLAHIR']?>, 10, 00, 00),
                            backgroundColor: Metronic.getBrandColor('blue'),
                            editable: false,
                            id: "<?="$v[NOKLIEN];$v[ALAMAT];$v[USIA];$v[YLAHIR];$v[PHONETAGIH01];$v[PHONETAGIH02]"?>",
                        },
                        <?php } ?>
                    ],
                    eventClick: function(calEvent, jsEvent, view) {
                        ...
                        $("#btnModal").click();
                        $("#noKlien").text(res[0]);
                        $("#txtNama").text(calEvent.title);
                        $("#txtAlamat").text(res[1]);
                        $("#txtUsia").text(res[2]+' th');
                        $("#txtTglLahir").text(day.format('DD/MM/')+res[3]);
                        $("#txtTelp").text(res[4]+' / '+res[5]);
                    }
                });
