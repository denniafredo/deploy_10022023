                            ...
                            <form class="form-horizontal" action="<?="$this->url/save-bod-message"?>" method="post" enctype="multipart/form-data">
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="judul" class="form-control" placeholder="Judul Pesan BOD" autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">Nama <span class="required">*</span></label>
                                        <div class="col-md-9">
                                            <input type="text" name="nama" class="form-control" placeholder="Nama BOD" autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">Tempat <span class="required">*</span></label>
                                        <div class="col-md-9">
                                            <input type="text" name="tempat" class="form-control" placeholder="Tempat BOD" autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">Pesan <span class="required">*</span></label>
                                        <div class="col-md-9">
                                            <textarea id="summernote_1" name="pesan"></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
