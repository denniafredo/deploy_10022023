            ...
            <div class="portlet light">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-green-sharp bold uppercase">Daftar User Agen Kancab Kanwil</span>
                    </div>
                </div>
                    ...
                    <form>
                        <div class="form-group">
                            <div class="input-group">
                                <input type="text" name="s" class="form-control" placeholder="Pencarian... (username/noagen/nama/email)" autocomplete="off" value="<?=$this->input->get('s')?>">
                    ...
                    <div class="table-scrollable">
                        <table class="table table-bordered table-hover" style="font-size: 12px;">
                            ...
                            <tr>
                                ...
                                <th style="text-align:center; vertical-align:middle;">Mobile Token</th>
                                <th style="text-align:center; vertical-align:middle;">No Agen</th>
                                <th style="text-align:center; vertical-align:middle;">Nama</th>
                                <th style="text-align:center; vertical-align:middle;">Email</th>
                                <th style="text-align:center; vertical-align:middle;">Poin Tour</th>
                            </tr>
                            </thead>
                            <tbody>
                            <?php foreach($user as $i => $v) { ?>
                                <tr>
