                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <span class="input-group-btn">
                                ...
                                <a href="<?="$this->url/add-cabang"?>" class="btn yellow-casablanca tooltips" data-container="body" data-placement="top" data-original-title="<?=C_BUTTON_ADD?>"><i class="fa fa-plus"></i></a>
                                <a href="<?="$this->url/download-aktivasi-se-cabang"?>" class="btn yellow tooltips" data-container="body" data-placement="top" data-original-title="<?=C_BUTTON_DOWNLOAD?>"><i class="fa fa-download"></i></a>
                            </span>
                        </div>
                    </div>
                    </form>
                            ...
                            <?php foreach($aktivasi as $i => $v) { ?>
                                <tr>
                                    ...
                                    <td class="text-center" width="95">
                                        <a href="<?="$this->url/edit-cabang?id=$v[NOAKTIVASI]"?>" class="btn btn-xs yellow-gold tooltips" style="margin:0px;" data-container="body" data-placement="top" data-original-title="<?=C_BUTTON_EDIT?>"><i class="fa fa-pencil btn-xs-tbl"></i></a>
                                        <a href="<?="$this->url/monitor-cabang?id=$v[NOAKTIVASI]"?>" class="btn btn-xs blue tooltips" style="margin:0px;" data-container="body" data-placement="top" data-original-title="Monitor"><i class="fa fa-laptop btn-xs-tbl"></i></a>
                                        <?php if (!empty($v['FILEJAWABANKP']) && strlen($v['FILEJAWABANKP']) > 0) { ?>
                                        <a href="javascript:void(0);" onclick="openWin('<?=base_url("asset/notdin/aktivasi/$v[FILEJAWABANKP]")?>')" class="btn btn-xs yellow-gold tooltips" style="margin:0px;" data-container="body" data-placement="top" data-original-title="Lihat"><i class="fa fa fa-file btn-xs-tbl"></i></a>
                                        <?php } ?>
                                    </td>
                                </tr>
                            <?php } ?>
