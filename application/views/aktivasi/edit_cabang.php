                        ...
                        <div class="portlet light">
                            ...
                            <div class="portlet-body form">
                                <form id="form-aktivasi" class="form-horizontal" role="form" action="<?="$this->url/save-cabang"?>" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-body">
                                                ...
                                                <div class="input-icon right">
                                                    ...
                                                    <select name="ddlkdjeniskegiatan" class="form-control">
                                                        ...
                                                        <?php foreach($jeniskegiatan as $i => $v) {
                                                            if ($v['KDJENISKEGIATAN'] == $aktivasi['KDJENISKEGIATAN'])
                                                                echo "<option value='$v[KDJENISKEGIATAN]' selected>$v[JENISKEGIATAN]</option>";
                                                            else
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                <div class="input-icon right">
                                                    <i class="fa"></i>
                                                    <input type="text" class="form-control" name="txtPelaksanaanAwal" value="<?=$aktivasi['WAKTUPELAKSANAANAWAL']?>" data-date-format="dd/mm/yyyy" data-date-autoclose="1" placeholder="dd/mm/yyyy" readonly>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                <div class="input-icon right">
                                                    <i class="fa"></i>
                                                    <input type="text" class="form-control" name="txtPelaksanaanAkhir" value="<?=$aktivasi['WAKTUPELAKSANAANAKHIR']?>" data-date-format="dd/mm/yyyy" data-date-autoclose="1" placeholder="dd/mm/yyyy" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <div class="input-icon right">
                                                    <i class="fa"></i>
                                                    <input type="text" name="txtTempat" class="form-control" placeholder="Jakarta Pusat" value="<?=$aktivasi['TEMPAT']?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <div class="input-icon right">
                                                    <i class="fa"></i>
                                                    <textarea name="txtDeskripsi" class="form-control" rows="2" placeholder="Sosialisasi produk JS Prestasi di Sekolah"><?=$aktivasi['DESKRIPSI']?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-control height-auto">
                                                    <?php foreach ($areaoffice as $i => $v) {
                                                        $checked = null;
                                                        foreach ($pelaksana as $j => $w) {
                                                            if ($v['KDAREAOFFICE'] == $w['KDAREAOFFICE']) {
                                                                $checked = 'checked';
                                                                break;
                                                            } ?>
                                                        <?php } ?>
                                                    <label><input type="checkbox" name="kdareaoffice[]" value="<?= $v['KDAREAOFFICE'] ?>" onclick="cekPelaksana()" <?=$checked?> /><?= $v['NAMAAREAOFFICE'] ?></label>
                                                    <?php } ?>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <div class="input-icon right">
                                                    <i class="fa"></i>
                                                    <input type="text" class="form-control" name="premiberkala" value="<?=$aktivasi['POTENSIPREMIBERKALA']?>" placeholder="200000" />
                                                </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <div class="input-icon right">
                                                    <i class="fa"></i>
                                                    <input type="text" class="form-control" name="premisekaligus" value="<?=$aktivasi['POTENSIPREMISEKALIGUS']?>" placeholder="10000000" />
                                                </div>
                                                <span class="help-block">minimal: Rp10.000.000 </span>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-md-3">Potensi Prospek <span class="required">*</span></label>
                                            <div class="col-md-4">
                                                <div class="input-icon right">
                                                    <i class="fa"></i>
                                                    <input type="text" class="form-control" name="prospek" value="<?=$aktivasi['POTENSIPROSPEK']?>" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <div class="input-icon right">
                                                    ...
                                                    <select name="ddlbiaya" class="form-control">
                                                        <option value="">Silahkan Pilih</option>
                                                        <option value="cabang" <?=$aktivasi['BIAYA']=='cabang' ? 'selected' : null;?>>Cabang </option>
                                                        <option value="pusat" <?=$aktivasi['BIAYA']=='pusat' ? 'selected' : null;?>>Kantor Pusat</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group fnotadinaskp" <?=$aktivasi['BIAYA']=='cabang' ? "style='display:none;'" : null;?>>
                                            <label class="col-md-3 control-label">Upload Nota Dinas <span class="required">*</span></label>
                                            <div class="col-md-9">
                                                <div class="input-icon right">
                                                    <i class="fa"></i>
                                                    <input type="file" name="fnotadinas">
                                                    <input type="hidden" name="oldfnotadinas" value="<?=$aktivasi['FILENOTADINAS']?>" >
                                                </div>
                                    ...
                                    <span class="help-block">* Pastikan data yang anda isi benar, karena data tidak dapat diubah kembali</span>
...
<script>
    ...
    function cekPelaksana() {
        var noaktivasi = $("input[name='noaktivasi']").val();
        ...
        $.ajax({
            ...
            type: "post",
            data: "kdareaoffice="+kdareaoffice+"&noaktivasi="+noaktivasi+"&waktupelaksanaanawal="+waktupelaksanaanawal,
            async: false,
