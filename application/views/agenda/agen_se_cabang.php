                ...
                <div class="portlet-body">
                    ...
                    <div class="table-scrollable">
                        <table class="table table-bordered table-hover" style="font-size: 12px;">
                            ...
                            <tbody>
                            <?php foreach($agendacabang as $i => $v) { ?>
                                <tr>
                                    ...
                                    <td align="center">
                                        <?php if ($v['JMLAGENDA'] > 0) { ?>
                                            <a href="<?="$this->url/agenda-agen-se-cabang?id=".rawurlencode($v['NOAGEN'])."&nm=".rawurlencode(strtolower($v['NAMAKLIEN1']))?>" class="btn btn-xs yellow-gold tooltips btn-edit" data-container="body" data-placement="top" data-original-title="<?=C_BUTTON_VIEW?>"><i class="fa fa-search-plus btn-xs-tbl"></i></a>
                                        <?php } else {
                                            echo "N/A";
                                        } ?>
                                    </td>
