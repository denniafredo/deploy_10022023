                        ...
                        <div class="portlet light">
                            <div class="portlet-title">
                                <div class="caption">
                                    ...
                                    <span class="caption-subject font-green-sharp bold uppercase">Tambah Prospek</span>
                                </div>
                                <div class="tools">
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <div class="input-icon right">
                                                    <i class="fa"></i>
                                                    <input type="text" id="idKTP" name="noid" class="form-control" size="16" placeholder="3377150319760001">
                                                </div>
                                            </div>
											<div class="col-md-4">
												*No KTP tidak dapat diubah jika sudah disimpan
											</div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <div class="input-icon right">
                                                    <i class="fa"></i>
                                                    <input type="text" name="namaklien" class="form-control" placeholder="Nama Lengkap">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                                    ...
                                                    <select name="kdprovinsi" class="form-control">
                                                        ...
                                                        <?php if (!$provinsi['error']) {
															foreach($provinsi['message'] as $i => $v) {
																echo "<option value='$v[KDPROPINSI]'>$v[NAMAPROPINSI]</option>";
															}
														} ?>
                                                    </select>
                                                </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-2">
                                                <div class="input-icon right">
                                                    <i class="fa"></i>
                                                    <input type="text" name="txtKdPos" id="txtkodepos" class="form-control" placeholder="12345" readonly />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <div class="input-icon right">
                                                    <i class="fa"></i>
                                                    <textarea name="alamat" class="form-control" rows="2" placeholder="Jalan XYZ"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                <div class="input-icon right">
                                                    <i class="fa"></i>
                                                    <input type="text" name="tgllahir" class="form-control form-control-inline input-medium date-picker" data-field="date" placeholder="31-12-2015" readonly />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9 radio-list">
                                                <label class="radio-inline"><input type="radio" name="kdjeniskelamin" value="L" checked> Pria </label>
                                                <label class="radio-inline"><input type="radio" name="kdjeniskelamin" value="P"> Wanita </label>
                                            </div>
                                        </div>
										<div class="form-group">
                                            <label class="control-label col-md-3">Status Pernikahan <span class="required">*</span></label>
                                            <div class="col-md-9 radio-list">
                                                <label class="radio-inline"><input type="radio" name="meritalstatus" value="L" checked> Lajang </label>
                                                <label class="radio-inline"><input type="radio" name="meritalstatus" value="K"> Kawin </label>
						<label class="radio-inline"><input type="radio" name="meritalstatus" value="J"> Janda </label>
                                                <label class="radio-inline"><input type="radio" name="meritalstatus" value="D"> Duda </label>
                                            </div>
                                        </div>
                                        <div class="form-group">
										...
										<div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <div class="input-icon right">
                                                    <i class="fa"></i>
                                                    <input type="text" id="idPhone1" name="telepon" class="form-control" placeholder="0211500151">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <div class="input-icon right">
                                                    <i class="fa"></i>
                                                    <input type="text" id="idPhone2" name="hp" class="form-control" placeholder="08123456789">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <div class="input-icon right">
                                                    <i class="fa"></i>
                                                    <input type="email" name="email" class="form-control" placeholder="email@ifg-life.id">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
