...
class Pkajonline extends CI_Controller {
    ...
    function term_pkajonline() {
        ...
        $this->Pkaj_model->insert_history_sign('Document viewed', $this->input->get('name'), $this->input->get('name'), $this->input->get('noagen'), $this->input->get('nopkaj'), 'PDF', 'TESTING');
    ...
    function insert_pkajonline() {
        ...
        foreach($data as $i => $d) { 
            ...
            $this->Pkaj_model->insert_history_sign('Document signed', $namaklien, $noagen, $nopkaj, 'PDF', 'TESTING');
