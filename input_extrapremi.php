					...
					<table border="0" cellspacing="1" cellpadding="4" width="80%" bordercolor="#B3CFFF" style="font-size: 10px; font-family: verdana;">
						...
						<?php
							...
							while ($arr_b=$DB2->nextrow()) {
								...
								}else if(in_array($arr_b["KDBENEFIT"], array('CP19100RWI', 'CP19200RWI', 'CP19300RWI', 'CP19400RWI', 'CP19500RWI', 'CP19600RWI', 'CP19700RWI', 'CP19800RWI', 'CP19900RWI', 'CP191000RWI'))){
